...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if (unk_0xA80721FDC3BDCCDB() || iLocal_246)
		{
			unk_0x65F534DDBF48606F("RE_CR", 0);
			switch (iLocal_44)
			{
				case 0:
					if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_217, 100f, 100f, 100f, false, true, 0))
					{
						func_142();
					}
					if (iLocal_45)
...
void func_2()
{
	...
	if (!iLocal_251)
	{
		if (unk_0xD62C4419A41F106A(iLocal_222[0], 0) || unk_0xBC2FC12AD0FBF72E(iLocal_222[0]))
		{
			func_53(&uLocal_52, 4);
			iLocal_251 = 1;
		}
	...
	if (!bLocal_234)
	{
		if ((unk_0xD62C4419A41F106A(iLocal_218, 0) || unk_0xBC2FC12AD0FBF72E(iLocal_218)) || unk_0x382181E8439581B0(iLocal_218))
		{
			unk_0xB815670C37E03CDE(joaat("prop_security_case_01"));
			if (unk_0x5D98D654CDC2165A(joaat("prop_security_case_01")))
			{
				vLocal_245 = { unk_0xB06F4A08BF57E69A(iLocal_218, 1067030938, 1069547520) };
				vLocal_245.z = (vLocal_245.z + 0.3f);
				iLocal_264[0] = unk_0x3B3AEF3A73FB80C9(joaat("pickup_money_case"), vLocal_245 + Vector(-0.49f, 0f, 0f), -90f, 0f, 0f, 0, 5000, 2, 1, joaat("prop_security_case_01"));
				if (!unk_0xE38E3CF1625A4145(uLocal_268[0]))
				{
	...
	if (!bLocal_235)
	{
		if ((unk_0xD62C4419A41F106A(iLocal_219, 0) || unk_0xBC2FC12AD0FBF72E(iLocal_219)) || unk_0x382181E8439581B0(iLocal_219))
		{
			unk_0xB815670C37E03CDE(joaat("prop_security_case_01"));
			if (unk_0x5D98D654CDC2165A(joaat("prop_security_case_01")))
			{
				vLocal_245 = { unk_0xB06F4A08BF57E69A(iLocal_219, 1067030938, 1069547520) };
				vLocal_245.z = (vLocal_245.z + 0.3f);
				iLocal_264[1] = unk_0x3B3AEF3A73FB80C9(joaat("pickup_money_case"), vLocal_245 + Vector(-0.49f, 0f, 0f), -90f, 0f, 0f, 0, 5000, 2, 1, joaat("prop_security_case_01"));
				if (!unk_0xE38E3CF1625A4145(uLocal_268[1]))
				{
	...
	if (!bLocal_256)
	{
		if (!iLocal_248)
		{
			...
			{
				if (unk_0xD62C4419A41F106A(iLocal_218, 0) || unk_0xBC2FC12AD0FBF72E(iLocal_218))
				{
					if (unk_0x91BBD269506D61D2(iLocal_218, unk_0x33CD235DF1E6A94E(), 1))
					{
						unk_0x1ABDB383C83A336A(&iLocal_265);
						iLocal_248 = 1;
						bLocal_48 = true;
						unk_0xD2E80177F27FD43F(5, iLocal_241, 1862763509);
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
						{
							unk_0x277716E9E7CC0692(iLocal_219, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0x897EF720254BBEA3(iLocal_219, true);
							unk_0xC6A79A7458B90086(iLocal_219, unk_0x33CD235DF1E6A94E());
							unk_0xBCA389843909EB28(iLocal_219, 1);
							func_53(&uLocal_52, 5);
		...
		if (!iLocal_247)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_219))
			{
				if (unk_0xD62C4419A41F106A(iLocal_219, 0) || unk_0xBC2FC12AD0FBF72E(iLocal_219))
				{
					if (unk_0x91BBD269506D61D2(iLocal_219, unk_0x33CD235DF1E6A94E(), 1))
					{
						unk_0x1ABDB383C83A336A(&iLocal_266);
						iLocal_247 = 1;
						bLocal_48 = true;
						unk_0xD2E80177F27FD43F(5, iLocal_241, 1862763509);
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
						{
							unk_0x277716E9E7CC0692(iLocal_218, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0x897EF720254BBEA3(iLocal_218, true);
							unk_0xC6A79A7458B90086(iLocal_218, unk_0x33CD235DF1E6A94E());
							unk_0xBCA389843909EB28(iLocal_218, 1);
							func_38(&uLocal_52, "recsbau", "recsb_deadcr", 3, 0, 0, 0);
						}
					}
				}
		...
		if (func_37() || !unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 310.6203f, 2642.854f, 43.5173f, 150f, 150f, 180f, false, true, 0))
		{
			if (unk_0xBC2FC12AD0FBF72E(iLocal_218) && unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				if (func_37() && !unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_217, 50f, 50f, 50f, false, true, 0))
				{
					func_7();
				}
				if (bLocal_48 && !bLocal_47)
				{
					if (!unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 310.6203f, 2642.854f, 43.5173f, 150f, 150f, 180f, false, true, 0))
					{
						func_6(5);
						func_7();
					}
			...
			else if (!unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, false, true, 0))
			{
				func_5();
			}
		}
	...
	if (bLocal_256)
	{
		if (func_37())
		{
			if (unk_0xD62C4419A41F106A(iLocal_218, 0) && unk_0xD62C4419A41F106A(iLocal_219, 0))
			{
				func_7();
			}
			if (bLocal_256)
			{
				if (unk_0x765F6FEEFF39224F(iLocal_218))
				{
					if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_218, 150f, 150f, 150f, 0, 0, 0))
					{
						if (!bLocal_48)
						{
							func_6(6);
				...
				if (!unk_0x765F6FEEFF39224F(iLocal_219))
				{
					if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_219, 150f, 150f, 150f, 0, 0, 0))
					{
						if (!bLocal_48)
						{
							func_6(6);
	...
	else if (!iLocal_240 && !bLocal_47)
	{
		...
		if (((unk_0xD62C4419A41F106A(iLocal_218, 0) && unk_0xD62C4419A41F106A(iLocal_219, 0)) && unk_0x5D98D654CDC2165A(joaat("ambulance"))) && unk_0xE9CCF312047EBEE0("random@countrysiderobbery"))
		{
			unk_0x1ABDB383C83A336A(&iLocal_265);
			unk_0x1ABDB383C83A336A(&iLocal_266);
			func_53(&uLocal_52, 5);
			...
			{
				if (unk_0xE38E3CF1625A4145(iLocal_267[iVar0]))
				{
					unk_0x1ABDB383C83A336A(&(iLocal_267[iVar0]));
				}
				iVar0++;
			}
			unk_0xD2E80177F27FD43F(1, iLocal_242, 1862763509);
			unk_0xA53C1C92EE35EC0E(5, true);
			unk_0xA53C1C92EE35EC0E(3, true);
			if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 267.94f, 2700.48f, 43.6f, 15f, 15f, 15f, false, true, 0))
			{
				iLocal_227 = unk_0xC651C43AB13A15E5(joaat("ambulance"), 267.94f, 2700.48f, 43.1f, 180f, true, true, false);
			}
			else
			{
				iLocal_227 = unk_0xC651C43AB13A15E5(joaat("ambulance"), 185.94f, 2603.48f, 46.9f, 0f, true, true, false);
			}
			unk_0xF0E2D155B834E176(iLocal_227, 1);
			iLocal_220 = unk_0xE196503B36B6194B(iLocal_227, 20, joaat("s_m_m_paramedic_01"), -1, 1, true);
			iLocal_221 = unk_0xE196503B36B6194B(iLocal_227, 20, joaat("s_m_m_paramedic_01"), 0, 1, true);
			unk_0x28F648743D7DE312(iLocal_220, 17, true);
			unk_0x28F648743D7DE312(iLocal_221, 17, true);
			unk_0x5FEE418CE11E6DDE(iLocal_220, 185, true);
			unk_0x5FEE418CE11E6DDE(iLocal_221, 185, true);
			if (unk_0x765F6FEEFF39224F(iLocal_218))
			{
				unk_0x99414FB2D30425C1(&iLocal_243);
				unk_0x77C4189A8E5C57C2(0, iLocal_227, 307.1379f, 2640.042f, 43.4639f, 18f, 0, joaat("ambulance"), 786475, 5f, 5f);
				unk_0x3C0F6044C54799A8(0, iLocal_218, -1, 2f, 1f, 10f, 0);
				unk_0xC4A347124F39D998(0, iLocal_218, -1, 2052, 2);
				unk_0x11C4AF4137F2A4B5(0, iLocal_218, 0);
				...
				unk_0xC734F59A13D39AEF(iLocal_243);
				unk_0x13A2D602CD10CBAC(iLocal_220, iLocal_243);
				unk_0xA7A57E7757ED035E(&iLocal_243);
				unk_0x897EF720254BBEA3(iLocal_220, true);
			}
			if (unk_0x765F6FEEFF39224F(iLocal_219))
			{
				unk_0x99414FB2D30425C1(&iLocal_243);
				unk_0x838F76C6C0AB6849(0, 15000);
				unk_0x3C0F6044C54799A8(0, iLocal_219, -1, 2f, 1f, 10f, 0);
				unk_0xC4A347124F39D998(0, iLocal_219, -1, 2052, 2);
				unk_0x11C4AF4137F2A4B5(0, iLocal_219, 0);
				unk_0x108754262311D34F(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0x108754262311D34F(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				unk_0xC734F59A13D39AEF(iLocal_243);
				unk_0x13A2D602CD10CBAC(iLocal_221, iLocal_243);
				unk_0xA7A57E7757ED035E(&iLocal_243);
				unk_0x897EF720254BBEA3(iLocal_221, true);
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[0]) && unk_0x765F6FEEFF39224F(iLocal_226))
			{
				unk_0x5FEE418CE11E6DDE(iLocal_222[0], 185, true);
				unk_0x99414FB2D30425C1(&iLocal_243);
				unk_0x7E268975AF5EA74F(0, unk_0xFBB1F99A825CAB09(iLocal_226, false) + Vector(0f, 5f, 0f), 1f, -1, 1048576000, 0, 1193033728);
				...
				unk_0xC734F59A13D39AEF(iLocal_243);
				unk_0x13A2D602CD10CBAC(iLocal_222[0], iLocal_243);
				unk_0xA7A57E7757ED035E(&iLocal_243);
				unk_0x897EF720254BBEA3(iLocal_222[0], true);
			}
			if (!unk_0xD62C4419A41F106A(iLocal_222[1], 0) && unk_0x765F6FEEFF39224F(iLocal_223))
			{
				unk_0x5FEE418CE11E6DDE(iLocal_222[1], 185, true);
				unk_0x274C6068B660FFB4(iLocal_222[1], joaat("weapon_unarmed"), true);
				unk_0x99414FB2D30425C1(&iLocal_243);
				unk_0x7E268975AF5EA74F(0, unk_0xFBB1F99A825CAB09(iLocal_223, false) + Vector(0f, 1f, 0f), 2f, -1, 1048576000, 0, 1193033728);
				unk_0xAE5B044AA2973E2A(0, unk_0xFBB1F99A825CAB09(iLocal_223, false), -1, 2052, 2);
				unk_0x9F878FE3F23E2C8B(0, unk_0xFBB1F99A825CAB09(iLocal_223, false), 0);
				unk_0x108754262311D34F(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0x108754262311D34F(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				unk_0xC734F59A13D39AEF(iLocal_243);
				unk_0x13A2D602CD10CBAC(iLocal_222[1], iLocal_243);
				unk_0xA7A57E7757ED035E(&iLocal_243);
				unk_0x897EF720254BBEA3(iLocal_222[1], true);
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[2]) && unk_0x765F6FEEFF39224F(iLocal_219))
			{
				unk_0x5FEE418CE11E6DDE(iLocal_222[2], 185, true);
				if (unk_0x765F6FEEFF39224F(iLocal_219))
				{
					unk_0x99414FB2D30425C1(&iLocal_243);
					unk_0x7E268975AF5EA74F(0, unk_0xFBB1F99A825CAB09(iLocal_219, false) + Vector(0f, 1f, 0f), 1f, -1, 1048576000, 0, 1193033728);
					unk_0x951C731169A4F5FC(0, 0);
					...
					unk_0xC734F59A13D39AEF(iLocal_243);
					unk_0x13A2D602CD10CBAC(iLocal_222[2], iLocal_243);
					unk_0xA7A57E7757ED035E(&iLocal_243);
				}
				unk_0x897EF720254BBEA3(iLocal_222[2], true);
			}
			func_3();
			wait(0);
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[0]))
			{
				func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
				func_38(&uLocal_52, "recsbau", "recsb_ntouch", 4, 0, 0, 0);
			}
			else if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[1]))
			{
				unk_0x5464B9731013E08C(iLocal_222[1], "S_M_Y_RANGER_01_WHITE_FULL_01");
				func_53(&uLocal_52, 4);
				func_50(&uLocal_52, 4, iLocal_222[1], "RECSBCop1", 0, 1);
				func_38(&uLocal_52, "recsbau", "recsb_ntouch", 4, 0, 0, 0);
			}
			else if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[2]))
			{
				unk_0x5464B9731013E08C(iLocal_222[2], "S_M_Y_RANGER_01_WHITE_FULL_01");
				func_53(&uLocal_52, 4);
	...
	if (((((unk_0xD62C4419A41F106A(iLocal_218, 0) && unk_0xD62C4419A41F106A(iLocal_219, 0)) && unk_0xD62C4419A41F106A(iLocal_222[0], 0)) && unk_0xD62C4419A41F106A(iLocal_222[1], 0)) && unk_0xD62C4419A41F106A(iLocal_222[2], 0)) && (func_37() || !unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, false, true, 0)))
	{
...
int func_37()
{
	if (bLocal_234 || bLocal_235)
	{
		if (bLocal_234 && bLocal_235)
		{
			if (!unk_0xE38E3CF1625A4145(uLocal_268[0]) && !unk_0xE38E3CF1625A4145(uLocal_268[1]))
			{
				return 1;
			}
		}
...
int func_51(int iParam0)
{
	...
	unk_0xCE5C49921A521962(iVar0, func_52(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
	return iVar0;
}
...
void func_54()
{
	if (!iLocal_254)
	{
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
		{
			if (unk_0xF0D230FB550CD6EB(iLocal_218, 0))
			{
				iLocal_263 = unk_0xF2C96862595654B4(iLocal_218, 0);
				if (((((unk_0x91BBD269506D61D2(iLocal_263, unk_0x33CD235DF1E6A94E(), 1) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0)) && unk_0x335C0645074963FE(iLocal_263, unk_0x33CD235DF1E6A94E(), 10f, 10f, 10f, 0, 1, 0)) || unk_0x2E9A4AE2A5B4D8E8(iLocal_218)) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_263, 0)) || unk_0xE0AFBCA0EDA1DAC8(unk_0x33CD235DF1E6A94E(), iLocal_263, joaat("weapon_stickybomb"), -1))
				{
					unk_0x4A852F02088ECC9D(iLocal_218, false);
					unk_0xD2E80177F27FD43F(5, iLocal_241, 1862763509);
					if (unk_0xF0D230FB550CD6EB(iLocal_218, 0))
					{
						unk_0x697EBA5CF1A6AB57(iLocal_218, joaat("weapon_microsmg"), 200, true, true);
						unk_0x274C6068B660FFB4(iLocal_218, joaat("weapon_microsmg"), true);
						unk_0x09294EA9B5694081(iLocal_218, unk_0x33CD235DF1E6A94E(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
					}
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
					{
						if (unk_0xF0D230FB550CD6EB(iLocal_219, 0))
						{
							unk_0x4A852F02088ECC9D(iLocal_219, false);
							unk_0x697EBA5CF1A6AB57(iLocal_219, joaat("weapon_microsmg"), 200, true, true);
							unk_0x274C6068B660FFB4(iLocal_219, joaat("weapon_microsmg"), true);
							unk_0x09294EA9B5694081(iLocal_219, unk_0x33CD235DF1E6A94E(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
						}
					}
					bLocal_48 = true;
					iLocal_254 = 1;
			...
			{
				unk_0xD2E80177F27FD43F(5, iLocal_241, 1862763509);
				if ((unk_0xF0D230FB550CD6EB(iLocal_218, 0) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0)) && !unk_0xD62C4419A41F106A(iLocal_263, 0))
				{
					if (unk_0x335C0645074963FE(iLocal_263, unk_0x33CD235DF1E6A94E(), 10f, 10f, 10f, 0, 1, 0))
					{
						unk_0x4A852F02088ECC9D(iLocal_218, false);
						unk_0x697EBA5CF1A6AB57(iLocal_218, joaat("weapon_microsmg"), 200, true, true);
						unk_0x274C6068B660FFB4(iLocal_218, joaat("weapon_microsmg"), true);
				...
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
				{
					if ((unk_0xF0D230FB550CD6EB(iLocal_219, 0) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0)) && !unk_0xD62C4419A41F106A(iLocal_263, 0))
					{
						if (unk_0x335C0645074963FE(iLocal_263, unk_0x33CD235DF1E6A94E(), 10f, 10f, 10f, 0, 1, 0))
						{
							unk_0x4A852F02088ECC9D(iLocal_219, false);
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
		{
			if (unk_0xF0D230FB550CD6EB(iLocal_219, 0))
			{
				iLocal_263 = unk_0xF2C96862595654B4(iLocal_219, 0);
				if (((unk_0x91BBD269506D61D2(iLocal_263, unk_0x33CD235DF1E6A94E(), 1) || unk_0x2E9A4AE2A5B4D8E8(iLocal_219)) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_263, 0)) || unk_0xE0AFBCA0EDA1DAC8(unk_0x33CD235DF1E6A94E(), iLocal_263, joaat("weapon_stickybomb"), -1))
				{
					unk_0xD2E80177F27FD43F(5, iLocal_241, 1862763509);
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
					{
...
void func_55()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_218) && !unk_0xD62C4419A41F106A(iLocal_226, 0))
	{
		if (!unk_0x782B99DB55846C95(iLocal_218, iLocal_226, -1, 0, false) && !unk_0x782B99DB55846C95(iLocal_218, iLocal_226, 0, 0, false))
		{
			unk_0x6DA4DBA91F234052(iLocal_218, vLocal_217, 1000f, -1, 0, 0);
			unk_0x897EF720254BBEA3(iLocal_218, true);
			iLocal_257 = 1;
		}
	}
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_219) && !unk_0xD62C4419A41F106A(iLocal_226, 0))
	{
		if (!unk_0x782B99DB55846C95(iLocal_219, iLocal_226, -1, 0, false) && !unk_0x782B99DB55846C95(iLocal_219, iLocal_226, 0, 0, false))
		{
			unk_0x6DA4DBA91F234052(iLocal_219, vLocal_217, 1000f, -1, 0, 0);
			unk_0x897EF720254BBEA3(iLocal_219, true);
			iLocal_257 = 1;
		}
	}
...
void func_56()
{
	...
	{
		vLocal_245 = { unk_0xFBB1F99A825CAB09(iLocal_218, true) };
	}
	else if (!unk_0xD62C4419A41F106A(iLocal_219, 0))
	{
		vLocal_245 = { unk_0xFBB1F99A825CAB09(iLocal_219, true) };
	}
	...
	if (!unk_0xD62C4419A41F106A(iLocal_218, 0))
	{
		...
		if (!bLocal_48)
		{
			...
			unk_0xAC584348B06672DD(unk_0xE3ADC76D6418297E(vLocal_245, 1.2f, 1.5f), 1000, 5, 0);
			iLocal_253 = 1;
		}
	}
	if (!unk_0xD62C4419A41F106A(iLocal_219, 0) && !unk_0xD62C4419A41F106A(iLocal_226, 0))
	{
		if (unk_0x10930B9CAD4111C2(iLocal_219, iLocal_226, 0))
		{
			settimera(0);
			if (!unk_0xD62C4419A41F106A(iLocal_218, 0))
			{
...
void func_58()
{
	if (!bLocal_256)
	{
		...
		if (iLocal_260)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				if (unk_0x085941C2A0E1ABAF(iLocal_218))
				{
					func_3();
					wait(0);
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				if (unk_0x085941C2A0E1ABAF(iLocal_219))
				{
					func_3();
					wait(0);
					func_53(&uLocal_52, 5);
		...
		if (iLocal_239 == 1)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218) && !unk_0xD62C4419A41F106A(iLocal_226, 0))
			{
				if (unk_0x10930B9CAD4111C2(iLocal_218, iLocal_226, 0))
				{
					unk_0x33F6BE48E356DA27(iLocal_218, 2, true);
					unk_0x99414FB2D30425C1(&iLocal_243);
					unk_0x48B8A6610EAA0C89(0, iLocal_226, unk_0x33CD235DF1E6A94E(), 8, 100f, 786469, 1000f, 10f, 1);
					unk_0xC734F59A13D39AEF(iLocal_243);
					unk_0x13A2D602CD10CBAC(iLocal_218, iLocal_243);
					unk_0xA7A57E7757ED035E(&iLocal_243);
					unk_0x897EF720254BBEA3(iLocal_218, true);
					bLocal_256 = true;
				}
		...
		if (iLocal_239 == 2)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_219) && !unk_0xD62C4419A41F106A(iLocal_226, 0))
			{
				if (unk_0x10930B9CAD4111C2(iLocal_219, iLocal_226, 0))
				{
					unk_0x33F6BE48E356DA27(iLocal_219, 2, true);
					unk_0x99414FB2D30425C1(&iLocal_243);
					unk_0x48B8A6610EAA0C89(0, iLocal_226, unk_0x33CD235DF1E6A94E(), 8, 100f, 786469, 1000f, 10f, 1);
					unk_0xC734F59A13D39AEF(iLocal_243);
					unk_0x13A2D602CD10CBAC(iLocal_219, iLocal_243);
					unk_0xA7A57E7757ED035E(&iLocal_243);
					unk_0x897EF720254BBEA3(iLocal_219, true);
					bLocal_256 = true;
				}
		...
		if (iLocal_239 == 3)
		{
			if ((!unk_0xBC2FC12AD0FBF72E(iLocal_219) && !unk_0xBC2FC12AD0FBF72E(iLocal_218)) && !unk_0xD62C4419A41F106A(iLocal_226, 0))
			{
				if (unk_0x10930B9CAD4111C2(iLocal_218, iLocal_226, 0) && unk_0x10930B9CAD4111C2(iLocal_219, iLocal_226, 0))
				{
					unk_0x33F6BE48E356DA27(iLocal_218, 2, true);
					unk_0x33F6BE48E356DA27(iLocal_219, 2, true);
					unk_0x99414FB2D30425C1(&iLocal_243);
			...
			{
				func_53(&uLocal_52, 5);
				unk_0xC838CE9837D0ABAF(iLocal_219, iLocal_226, -1, -1, 2f, 8, 0);
				iLocal_239 = 2;
			}
			if (unk_0xBC2FC12AD0FBF72E(iLocal_219) && !unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				func_53(&uLocal_52, 6);
				unk_0xC838CE9837D0ABAF(iLocal_218, iLocal_226, -1, -1, 2f, 8, 0);
				iLocal_239 = 1;
			}
		}
		if (iLocal_239 == 4)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				unk_0xED68CDDDE25A144E(iLocal_218);
				unk_0x6DA4DBA91F234052(iLocal_218, vLocal_217, 1000f, -1, 0, 0);
				unk_0x897EF720254BBEA3(iLocal_218, true);
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				unk_0xED68CDDDE25A144E(iLocal_219);
				unk_0x6DA4DBA91F234052(iLocal_219, vLocal_217, 1000f, -1, 0, 0);
				unk_0x897EF720254BBEA3(iLocal_219, true);
			}
			bLocal_256 = true;
...
void func_59()
{
	if ((unk_0xD62C4419A41F106A(iLocal_222[0], 0) && unk_0xD62C4419A41F106A(iLocal_222[1], 0)) && unk_0xD62C4419A41F106A(iLocal_222[2], 0))
	{
		func_53(&uLocal_52, 4);
		iLocal_246 = 1;
		iLocal_238 = 1;
		unk_0xD2E80177F27FD43F(1, iLocal_241, 1862763509);
		if (!bLocal_48 && bLocal_47)
		{
			unk_0x1ABDB383C83A336A(&iLocal_265);
			unk_0x1ABDB383C83A336A(&iLocal_266);
		...
		if (unk_0x91D5C8283D19AF49(iLocal_226, 0))
		{
			unk_0x0D847D71D9E6142E(iLocal_226);
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218) && !unk_0x382181E8439581B0(iLocal_218))
			{
				unk_0x07957AFE79874E7D(iLocal_218, 1, 1, 1, 0);
				iLocal_239 = 1;
				unk_0xED68CDDDE25A144E(iLocal_218);
				unk_0x976357E602648DDF(iLocal_218, 1);
				unk_0x4A852F02088ECC9D(iLocal_218, true);
				unk_0x0D847D71D9E6142E(iLocal_218);
				unk_0x0D847D71D9E6142E(iLocal_226);
				unk_0x99414FB2D30425C1(&iLocal_243);
				unk_0xC838CE9837D0ABAF(0, iLocal_226, -1, -1, 2f, 9, 0);
				unk_0xC734F59A13D39AEF(iLocal_243);
				unk_0x13A2D602CD10CBAC(iLocal_218, iLocal_243);
				unk_0xA7A57E7757ED035E(&iLocal_243);
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_219) && !unk_0x382181E8439581B0(iLocal_219))
				{
					unk_0xED68CDDDE25A144E(iLocal_219);
					unk_0x4A852F02088ECC9D(iLocal_219, true);
					unk_0x0D847D71D9E6142E(iLocal_219);
					unk_0x0D847D71D9E6142E(iLocal_226);
					unk_0x976357E602648DDF(iLocal_219, 1);
					unk_0xC838CE9837D0ABAF(iLocal_219, iLocal_226, -1, 0, 2f, 1, 0);
					iLocal_239 = 3;
				}
			}
			else if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				unk_0x976357E602648DDF(iLocal_219, 1);
				unk_0x07957AFE79874E7D(iLocal_219, 1, 1, 1, 0);
				unk_0xED68CDDDE25A144E(iLocal_219);
				unk_0x4A852F02088ECC9D(iLocal_219, true);
				unk_0x0D847D71D9E6142E(iLocal_219);
				unk_0x0D847D71D9E6142E(iLocal_226);
				unk_0x99414FB2D30425C1(&iLocal_243);
				unk_0xC838CE9837D0ABAF(0, iLocal_226, -1, -1, 2f, 1, 0);
				unk_0xC734F59A13D39AEF(iLocal_243);
				unk_0x13A2D602CD10CBAC(iLocal_219, iLocal_243);
				unk_0xA7A57E7757ED035E(&iLocal_243);
				iLocal_239 = 2;
...
void func_61(int iParam0, var uParam1, int iParam2, float fParam3)
{
	...
	if (!unk_0xD62C4419A41F106A(iParam0, 0))
	{
		if (*uParam1 < 5)
		{
			...
			if (unk_0xEA8CEFB1F41E5992(unk_0x2CA911E7569D12EA(iParam0, vVar0), fParam3, 1, 1) || unk_0xEA8CEFB1F41E5992(unk_0x2CA911E7569D12EA(iParam0, vVar0), fParam3, 0, 1))
			{
				switch (*uParam1)
				{
					case 0:
					...
					case 1:
						unk_0x2C64D5082D2F968A(iParam0, iVar2);
						*uParam1++;
						break;
					...
					case 4:
						unk_0xA3B3E54143896FE9(iParam0, vVar1, 150f, 50f, 1);
						*uParam1++;
						break;
					}
				}
...
{
	if ((!unk_0xBC2FC12AD0FBF72E(iParam0) && !func_36()) && timera() > 12000)
	{
...
void func_63()
{
	if (!unk_0xD62C4419A41F106A(iLocal_218, 0))
	{
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
		{
			...
			{
				if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_218) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_218))
				{
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_218, 20f, 20f, 20f, 0, 1, 0) && unk_0xC4BA1231BBAF1161(iLocal_218, unk_0x33CD235DF1E6A94E()))
					{
						iLocal_230++;
	...
	if (!unk_0xD62C4419A41F106A(iLocal_219, 0))
	{
		if (unk_0x91BBD269506D61D2(iLocal_219, unk_0x33CD235DF1E6A94E(), 1))
		{
			bLocal_48 = true;
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
		{
			if (!func_66() && unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 4))
			{
				if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_219) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_219))
				{
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_219, 20f, 20f, 20f, 0, 1, 0) && unk_0xC4BA1231BBAF1161(iLocal_219, unk_0x33CD235DF1E6A94E()))
					{
						if ((!iLocal_232 && !unk_0xBC2FC12AD0FBF72E(iLocal_218)) && !func_64("recsb_theaim"))
						{
							func_3();
							wait(0);
							if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
	...
	{
		if (unk_0xC52B92C972695208(iLocal_264[0]))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				if (unk_0xC4BA1231BBAF1161(iLocal_218, unk_0x33CD235DF1E6A94E()) && unk_0x335C0645074963FE(iLocal_218, unk_0x33CD235DF1E6A94E(), 20f, 20f, 20f, 0, 1, 0))
				{
					bLocal_48 = true;
					func_3();
					wait(0);
			...
			{
				if (unk_0xC4BA1231BBAF1161(iLocal_219, unk_0x33CD235DF1E6A94E()) && unk_0x335C0645074963FE(iLocal_219, unk_0x33CD235DF1E6A94E(), 20f, 20f, 20f, 0, 1, 0))
				{
					bLocal_48 = true;
					func_53(&uLocal_52, 5);
					func_50(&uLocal_52, 5, iLocal_219, "RECSBRobber1", 0, 1);
	...
	{
		if (unk_0xC52B92C972695208(iLocal_264[1]))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				if (unk_0xC4BA1231BBAF1161(iLocal_218, unk_0x33CD235DF1E6A94E()) && unk_0x335C0645074963FE(iLocal_218, unk_0x33CD235DF1E6A94E(), 20f, 20f, 20f, 0, 1, 0))
	...
	if (!unk_0xD62C4419A41F106A(iLocal_226, 0))
	{
		if ((unk_0x91BBD269506D61D2(iLocal_226, unk_0x33CD235DF1E6A94E(), 1) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_226, 0)) || unk_0xE0AFBCA0EDA1DAC8(unk_0x33CD235DF1E6A94E(), iLocal_226, joaat("weapon_stickybomb"), -1))
		{
			bLocal_48 = true;
			settimera(0);
			unk_0xD2E80177F27FD43F(5, iLocal_241, 1862763509);
			...
			if (!unk_0xD62C4419A41F106A(iLocal_226, 0))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_226, 0))
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
					{
						func_60(&uLocal_52, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						unk_0xC838CE9837D0ABAF(iLocal_218, iLocal_226, -1, -1, 2f, 524296, 0);
					}
					else if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
					{
						func_53(&uLocal_52, 5);
						func_50(&uLocal_52, 5, iLocal_219, "RECSBRobber1", 0, 1);
						func_60(&uLocal_52, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						unk_0xC838CE9837D0ABAF(iLocal_219, iLocal_226, -1, -1, 2f, 524296, 0);
					}
				}
				else if (!bLocal_47)
				{
...
void func_67()
{
	...
	if (!bLocal_258)
	{
		unk_0xDFD0ACB809AD97C9(unk_0x95B959F18401C09A(), &iLocal_244);
		if (unk_0x068481DAF84B9654(iLocal_244))
		{
			iLocal_224 = unk_0x22B02EC53152632C(iLocal_244);
		}
		if ((iLocal_224 == iLocal_222[0] || iLocal_224 == iLocal_222[1]) || iLocal_224 == iLocal_222[2])
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_224))
			{
				if (!func_66() && unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 4))
				{
					if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_224) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_224))
					{
						if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_224, 20f, 20f, 20f, 0, 1, 0))
						{
							if (unk_0xC4BA1231BBAF1161(iLocal_224, unk_0x33CD235DF1E6A94E()) || unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_224, 8f, 8f, 8f, 0, 1, 0))
							{
								if (!bLocal_259)
								{
								...
								if (iLocal_228 > 40)
								{
									...
									{
										unk_0xD2E80177F27FD43F(5, iLocal_242, 1862763509);
										iVar0 = 0;
										while (iVar0 < iLocal_222)
										{
											if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar0]))
											{
												unk_0x277716E9E7CC0692(iLocal_222[iVar0], unk_0x33CD235DF1E6A94E(), 0, 16);
												unk_0x897EF720254BBEA3(iLocal_222[iVar0], true);
												unk_0xC6A79A7458B90086(iLocal_222[iVar0], unk_0x33CD235DF1E6A94E());
												unk_0xBCA389843909EB28(iLocal_222[iVar0], 1);
											}
											iVar0++;
										}
									}
	...
	{
		if (unk_0x765F6FEEFF39224F(iLocal_222[iVar1]))
		{
			if (unk_0x91BBD269506D61D2(iLocal_222[iVar1], unk_0x33CD235DF1E6A94E(), 1))
			{
				bLocal_47 = true;
			}
			if (unk_0x91D5C8283D19AF49(unk_0x8918EC905FC8975D(), 0))
			{
				if (unk_0x91BBD269506D61D2(iLocal_222[iVar1], unk_0x8918EC905FC8975D(), 1))
				{
					bLocal_47 = true;
				}
			}
	...
	if (iLocal_240)
	{
		...
		while (iVar1 < iLocal_222)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar1]))
			{
				if (unk_0xC52B92C972695208(iLocal_264[0]) || unk_0xC52B92C972695208(iLocal_264[1]))
				{
					if (unk_0xC4BA1231BBAF1161(iLocal_222[iVar1], unk_0x33CD235DF1E6A94E()) && unk_0x335C0645074963FE(iLocal_222[iVar1], unk_0x33CD235DF1E6A94E(), 20f, 20f, 20f, 0, 1, 0))
					{
						bLocal_47 = true;
						func_3();
						wait(0);
				...
				if (unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_222[iVar1]))
				{
					unk_0xD2E80177F27FD43F(3, iLocal_242, 1862763509);
					bLocal_47 = true;
				}
			}
			iVar1++;
		}
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[1]) && !unk_0xD62C4419A41F106A(iLocal_225[2], 0))
		{
			if (!unk_0x335C0645074963FE(iLocal_222[1], unk_0x33CD235DF1E6A94E(), 100f, 100f, 100f, 0, 1, 0))
			{
				unk_0x1F45B4626AC4A4C0(&(iLocal_222[1]));
				unk_0x65F544B458249682(&(iLocal_225[2]));
			}
		}
	}
	iVar1 = 0;
	...
	{
		if (!unk_0xD62C4419A41F106A(iLocal_225[iVar1], 0))
		{
			if ((unk_0x91BBD269506D61D2(iLocal_225[iVar1], unk_0x33CD235DF1E6A94E(), 1) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_225[iVar1], 0)) || unk_0xE0AFBCA0EDA1DAC8(unk_0x33CD235DF1E6A94E(), iLocal_225[iVar1], joaat("weapon_stickybomb"), -1))
			{
				bLocal_47 = true;
			}
			if (unk_0x91D5C8283D19AF49(unk_0x8918EC905FC8975D(), 0))
			{
				if (unk_0x91BBD269506D61D2(iLocal_225[iVar1], unk_0x8918EC905FC8975D(), 1))
				{
					bLocal_47 = true;
				}
			}
	...
	if (!unk_0xD62C4419A41F106A(iLocal_227, 0))
	{
		if (unk_0x91BBD269506D61D2(iLocal_227, unk_0x33CD235DF1E6A94E(), 1) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_227, 0))
		{
			bLocal_47 = true;
		}
	}
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		if (unk_0xEAB9CD768B92B81F(unk_0x33CD235DF1E6A94E(), joaat("towtruck")) || unk_0xEAB9CD768B92B81F(unk_0x33CD235DF1E6A94E(), joaat("towtruck2")))
		{
			...
			if (iLocal_240)
			{
				if (!unk_0xD62C4419A41F106A(iLocal_226, 0))
				{
					if (unk_0x221C953018491A32(iVar2, iLocal_226))
					{
						bLocal_47 = true;
						func_3();
						wait(0);
			...
			while (iVar1 < iLocal_225)
			{
				if (!unk_0xD62C4419A41F106A(iLocal_225[iVar1], 0))
				{
					if (unk_0x221C953018491A32(iVar2, iLocal_225[iVar1]))
					{
						bLocal_47 = true;
					}
				}
			...
			if (!unk_0xD62C4419A41F106A(iLocal_227, 0))
			{
				if (unk_0x221C953018491A32(iVar2, iLocal_227))
				{
					bLocal_47 = true;
				}
			}
	...
	if (bLocal_47 || bLocal_258)
	{
		...
		bLocal_47 = true;
		if (!unk_0xD62C4419A41F106A(iLocal_226, 0) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_226, 0))
		{
		}
		else
		{
			...
			else if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[0]))
			{
				func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
		...
		if (iLocal_240)
		{
			...
			while (iVar1 < iLocal_222)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar1]))
				{
					unk_0x277716E9E7CC0692(iLocal_222[iVar1], unk_0x33CD235DF1E6A94E(), 0, 16);
					unk_0x897EF720254BBEA3(iLocal_222[iVar1], true);
					unk_0xC6A79A7458B90086(iLocal_222[iVar1], unk_0x33CD235DF1E6A94E());
					unk_0x07957AFE79874E7D(iLocal_222[iVar1], 1, 1, 1, 0);
					unk_0xBCA389843909EB28(iLocal_222[iVar1], 1);
					unk_0x34A51926277F67BC(iLocal_222[iVar1], 2);
					unk_0x28F648743D7DE312(iLocal_222[iVar1], 50, true);
				}
				iVar1++;
			}
		}
	}
	if (unk_0x765F6FEEFF39224F(iLocal_220))
	{
		if (unk_0x91BBD269506D61D2(iLocal_220, unk_0x33CD235DF1E6A94E(), 1))
		{
			unk_0x11D1216D8F205785(unk_0x95B959F18401C09A(), 0);
			unk_0xD2E80177F27FD43F(5, iLocal_242, 1862763509);
			bLocal_47 = true;
	...
	if (unk_0x765F6FEEFF39224F(iLocal_221))
	{
		if (unk_0x91BBD269506D61D2(iLocal_221, unk_0x33CD235DF1E6A94E(), 1))
		{
			unk_0x11D1216D8F205785(unk_0x95B959F18401C09A(), 0);
			unk_0xD2E80177F27FD43F(5, iLocal_242, 1862763509);
			bLocal_47 = true;
...
void func_78()
{
	...
	if ((!unk_0xBC2FC12AD0FBF72E(iLocal_222[0]) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E())) && !unk_0xBC2FC12AD0FBF72E(iLocal_218))
	{
	}
	if ((unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 220.6075f, 2615.145f, 35.8465f, 440.8339f, 2684.23f, 72.6324f, 183.125f, 0, true, 0) && unk_0x73E7A21FD53144AB(vLocal_217, 1f)) || unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
	{
		iVar0 = 0;
		while (iVar0 < iLocal_222)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar0]))
			{
				unk_0x3F0ECDD5CC67FC67(iLocal_222[iVar0], true, iLocal_241);
				if (!unk_0xE38E3CF1625A4145(iLocal_267[iVar0]))
				{
					iLocal_267[iVar0] = func_79(iLocal_222[iVar0], 0, 145);
					unk_0x983D75D9630FD905(iLocal_267[iVar0], false);
				}
			}
			iVar0++;
		}
		if (!unk_0xD62C4419A41F106A(iLocal_218, 0) || (!unk_0xBC2FC12AD0FBF72E(iLocal_218) && !iLocal_249))
		{
			unk_0x3F0ECDD5CC67FC67(iLocal_218, true, iLocal_242);
			iLocal_265 = func_79(iLocal_218, 0, 145);
			unk_0x983D75D9630FD905(iLocal_265, false);
			iLocal_248 = 0;
			iLocal_249 = 1;
		}
		if (!unk_0xD62C4419A41F106A(iLocal_219, 0) || (!unk_0xBC2FC12AD0FBF72E(iLocal_219) && !iLocal_250))
		{
			unk_0x3F0ECDD5CC67FC67(iLocal_219, true, iLocal_242);
			iLocal_266 = func_79(iLocal_219, 0, 145);
			unk_0x983D75D9630FD905(iLocal_266, false);
			iLocal_247 = 0;
			iLocal_250 = 1;
		}
		settimera(0);
...
int func_80(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_52(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
...
void func_82()
{
	...
	if (!iLocal_252)
	{
		...
		{
			if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
			{
				iVar0 = 0;
				while (iVar0 < iLocal_222)
				{
					if (unk_0xE38E3CF1625A4145(iLocal_267[iVar0]))
					{
						unk_0x983D75D9630FD905(iLocal_267[iVar0], true);
					}
					iVar0++;
				}
				if (unk_0xE38E3CF1625A4145(iLocal_265))
				{
					unk_0x983D75D9630FD905(iLocal_265, true);
				}
				if (unk_0xE38E3CF1625A4145(iLocal_266))
				{
					unk_0x983D75D9630FD905(iLocal_266, true);
				}
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[0]))
				{
					func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
...
void func_84()
{
	...
	{
		if (!unk_0xD62C4419A41F106A(iLocal_225[iVar0], 0))
		{
			if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_225[iVar0], 0))
			{
				unk_0x8DD9343DCA32CE78(iLocal_225[iVar0], 0);
			}
		}
		iVar0++;
	}
	if (bLocal_48)
	{
		if (!iLocal_50)
		{
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				...
				if (!unk_0xE38E3CF1625A4145(iLocal_265))
				{
					...
					unk_0xF0BE7CB40DE62A2F(iLocal_218, true);
				}
				unk_0x277716E9E7CC0692(iLocal_218, unk_0x33CD235DF1E6A94E(), 0, 16);
				unk_0x897EF720254BBEA3(iLocal_218, true);
				unk_0xC6A79A7458B90086(iLocal_218, unk_0x33CD235DF1E6A94E());
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				...
				if (!unk_0xE38E3CF1625A4145(iLocal_266))
				{
					...
					unk_0xF0BE7CB40DE62A2F(iLocal_219, true);
				}
				unk_0x277716E9E7CC0692(iLocal_219, unk_0x33CD235DF1E6A94E(), 0, 16);
				unk_0x897EF720254BBEA3(iLocal_219, true);
				unk_0xC6A79A7458B90086(iLocal_219, unk_0x33CD235DF1E6A94E());
		...
		if (bLocal_47)
		{
			if (!iLocal_51)
			{
				...
				while (iVar0 < iLocal_222)
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar0]))
					{
						unk_0xF0BE7CB40DE62A2F(iLocal_222[iVar0], true);
						if (unk_0xE38E3CF1625A4145(iLocal_267[iVar0]))
						{
							unk_0x1ABDB383C83A336A(&(iLocal_267[iVar0]));
						}
		...
		else
		{
			...
			while (iVar0 < iLocal_222)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar0]))
				{
					unk_0xF0BE7CB40DE62A2F(iLocal_222[iVar0], false);
				}
				iVar0++;
			}
		}
	...
	else if (bLocal_47)
	{
		if (!iLocal_49)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				unk_0xF0BE7CB40DE62A2F(iLocal_218, false);
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				unk_0xF0BE7CB40DE62A2F(iLocal_219, false);
			}
			iLocal_49 = 1;
		}
		if (!iLocal_51)
		{
			...
			while (iVar0 < iLocal_222)
			{
				...
				{
					unk_0xF0BE7CB40DE62A2F(iLocal_222[iVar0], true);
					unk_0xFF615FA3B69D748D(iLocal_222[iVar0]);
					if (unk_0xE38E3CF1625A4145(iLocal_267[iVar0]))
					{
						unk_0x1ABDB383C83A336A(&(iLocal_267[iVar0]));
					}
...
void func_85()
{
	...
	{
		unk_0x8C4EA5F6857553AE(joaat("phoenix"), true);
		...
		unk_0xAF9EA4E314ED45C2(418.2996f, 2650.597f, 42.84723f, 297.8981f, 2617.968f, 53.6412f, 49.6875f, 0, false, 1);
		unk_0x5856B9BF2B4E98C4(Vector(43.4932f, 2612.694f, 328.0555f) - Vector(10f, 10f, 10f), Vector(43.4932f, 2612.694f, 328.0555f) + Vector(10f, 10f, 10f), false, 1);
		unk_0xB7350047030F7672(328.0555f, 2612.694f, 43.4932f, 5f, 0, 0, 0, 0, false, 0);
		iLocal_226 = unk_0xC651C43AB13A15E5(joaat("phoenix"), 326.78f, 2626.56f, 43.5081f, 45.21f, true, true, false);
		iLocal_225[0] = unk_0xC651C43AB13A15E5(joaat("sheriff"), 314.1008f, 2641.67f, 43.5055f, 258.9436f, true, true, false);
		iLocal_225[1] = unk_0xC651C43AB13A15E5(joaat("sheriff"), 330.7097f, 2646.913f, 43.685f, 120.9436f, true, true, false);
		iLocal_225[2] = unk_0xC651C43AB13A15E5(joaat("sheriff"), 321.4496f, 2649.388f, 43.5706f, 105.9436f, true, true, false);
		unk_0xD855ECE77A9F1F8B(iLocal_225[2], 1);
		unk_0xD855ECE77A9F1F8B(iLocal_225[1], 1);
		unk_0xD855ECE77A9F1F8B(iLocal_225[0], 1);
		unk_0xF0E2D155B834E176(iLocal_225[2], 1);
		unk_0xF0E2D155B834E176(iLocal_225[1], 1);
		unk_0xF0E2D155B834E176(iLocal_225[0], 1);
		unk_0x8DD9343DCA32CE78(iLocal_225[0], 1);
		unk_0x8DD9343DCA32CE78(iLocal_225[2], 1);
		unk_0x8DD9343DCA32CE78(iLocal_225[1], 1);
		unk_0xD266F9D236AE6C86(iLocal_226, 1);
		unk_0xD266F9D236AE6C86(iLocal_225[0], 1);
		unk_0xD266F9D236AE6C86(iLocal_225[1], 1);
		unk_0xD266F9D236AE6C86(iLocal_225[2], 1);
		iLocal_218 = unk_0x9BA5CF280376EEA4(19, joaat("a_m_y_genstreet_01"), 321.31f, 2615.66f, 43.4963f, 346f, 1, true);
		iLocal_219 = unk_0x9BA5CF280376EEA4(19, joaat("a_m_y_genstreet_01"), 326.25f, 2624.51f, 43.4846f, 341f, 1, true);
		iLocal_223 = unk_0x9BA5CF280376EEA4(6, joaat("s_m_y_ranger_01"), 325.3731f, 2631.16f, 43.5248f, 87f, 1, true);
		iLocal_222[0] = unk_0x9BA5CF280376EEA4(6, joaat("s_m_y_ranger_01"), 310.6203f, 2642.854f, 43.5173f, 226f, 1, true);
		iLocal_222[1] = unk_0x9BA5CF280376EEA4(6, joaat("s_m_y_ranger_01"), 319.5652f, 2650.067f, 43.5411f, 189f, 1, true);
		iLocal_222[2] = unk_0x9BA5CF280376EEA4(6, joaat("s_m_y_ranger_01"), 324.0396f, 2650.964f, 43.5983f, 214f, 1, true);
		unk_0xC6CDB5F78F0E3592(iLocal_222[0], "ped_cops[0]");
		unk_0xC6CDB5F78F0E3592(iLocal_222[1], "ped_cops[1]");
		unk_0xC6CDB5F78F0E3592(iLocal_222[2], "ped_cops[2]");
		unk_0x92A2FAFA76B7EC9B(iLocal_222[0], true, -1, 0);
		unk_0x92A2FAFA76B7EC9B(iLocal_222[1], true, -1, 0);
		unk_0x92A2FAFA76B7EC9B(iLocal_222[2], true, -1, 0);
		unk_0xAF4482B584BBF3B8(iLocal_219, 326.25f, 2624.51f, 43.4846f, 3.5f, 0, 0);
		unk_0xAF4482B584BBF3B8(iLocal_218, 321.31f, 2615.66f, 43.4963f, 3.5f, 0, 0);
		unk_0xAF4482B584BBF3B8(iLocal_222[0], 310.6203f, 2642.854f, 43.5173f, 3.5f, 0, 0);
		unk_0xAF4482B584BBF3B8(iLocal_222[1], 319.5652f, 2650.067f, 43.5411f, 3.5f, 0, 0);
		unk_0xAF4482B584BBF3B8(iLocal_222[2], 324.0396f, 2650.964f, 43.5983f, 3.5f, 0, 0);
		unk_0x29F342BE632ACFF4(iLocal_222[0]);
		unk_0x29F342BE632ACFF4(iLocal_222[1]);
		unk_0x29F342BE632ACFF4(iLocal_222[2]);
		unk_0x28F648743D7DE312(iLocal_222[0], 0, true);
		unk_0x28F648743D7DE312(iLocal_222[1], 0, true);
		unk_0x28F648743D7DE312(iLocal_222[2], 0, true);
		unk_0x28F648743D7DE312(iLocal_222[0], 1, true);
		unk_0x28F648743D7DE312(iLocal_222[1], 1, true);
		unk_0x28F648743D7DE312(iLocal_222[2], 1, true);
		unk_0xDE9FF07CFD5DC172(iLocal_222[0], 13);
		unk_0xDE9FF07CFD5DC172(iLocal_222[1], 13);
		unk_0xDE9FF07CFD5DC172(iLocal_222[2], 13);
		unk_0x28F648743D7DE312(iLocal_219, 0, true);
		unk_0x28F648743D7DE312(iLocal_218, 0, true);
		unk_0x28F648743D7DE312(iLocal_219, 1, true);
		unk_0x28F648743D7DE312(iLocal_218, 1, true);
		unk_0x4A3BD9D189356B69(iLocal_225[0], 0, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_225[0], 1, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_225[1], 1, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_225[1], 0, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_225[2], 1, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_225[2], 0, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_226, 1, 0, 0);
		unk_0x4A3BD9D189356B69(iLocal_226, 0, 0, 0);
		unk_0x43D47AD82DA3C6EC(iLocal_226, true, 1);
		unk_0x9315FCF6CFE2AB41("robbers", &iLocal_241);
		unk_0x9315FCF6CFE2AB41("cops", &iLocal_242);
		unk_0x7FC2040EB34E0E31(iLocal_223, 0, 0);
		unk_0x0648A75D3F60E864(iLocal_219, iLocal_241);
		unk_0x3F0ECDD5CC67FC67(iLocal_219, false, iLocal_242);
		unk_0x7FC2040EB34E0E31(iLocal_219, 300, 0);
		unk_0x697EBA5CF1A6AB57(iLocal_219, joaat("weapon_pistol"), 200, true, true);
		unk_0x18E5E2B41CD6CE17(iLocal_219, 100f);
		unk_0x5F9955D3E93BCC84(iLocal_219, 100f);
		unk_0x6377B13F4704663A(iLocal_219, 35f, 35f, 1);
		unk_0xDE9FF07CFD5DC172(iLocal_219, 13);
		unk_0x0648A75D3F60E864(iLocal_218, iLocal_241);
		unk_0x3F0ECDD5CC67FC67(iLocal_218, false, iLocal_242);
		unk_0x7FC2040EB34E0E31(iLocal_218, 300, 0);
		unk_0x697EBA5CF1A6AB57(iLocal_218, joaat("weapon_pistol"), 200, true, true);
		unk_0x18E5E2B41CD6CE17(iLocal_218, 100f);
		unk_0x5F9955D3E93BCC84(iLocal_218, 100f);
		unk_0x6377B13F4704663A(iLocal_218, 35f, 35f, 1);
		unk_0xDE9FF07CFD5DC172(iLocal_218, 13);
		unk_0x3F0ECDD5CC67FC67(iLocal_222[0], false, iLocal_241);
		unk_0x3F0ECDD5CC67FC67(iLocal_222[1], false, iLocal_241);
		unk_0x3F0ECDD5CC67FC67(iLocal_222[2], false, iLocal_241);
		unk_0x697EBA5CF1A6AB57(iLocal_222[0], joaat("weapon_pumpshotgun"), 200, true, true);
		unk_0x697EBA5CF1A6AB57(iLocal_222[1], joaat("weapon_pistol"), 200, true, true);
		unk_0x697EBA5CF1A6AB57(iLocal_222[2], joaat("weapon_pumpshotgun"), 200, true, true);
		unk_0x18E5E2B41CD6CE17(iLocal_222[0], 100f);
		unk_0x5F9955D3E93BCC84(iLocal_222[0], 100f);
		unk_0x18E5E2B41CD6CE17(iLocal_222[1], 100f);
		unk_0x5F9955D3E93BCC84(iLocal_222[1], 100f);
		unk_0x18E5E2B41CD6CE17(iLocal_222[2], 100f);
		unk_0x5F9955D3E93BCC84(iLocal_222[2], 100f);
		unk_0x0648A75D3F60E864(iLocal_222[0], iLocal_242);
		unk_0x0648A75D3F60E864(iLocal_222[1], iLocal_242);
		unk_0x0648A75D3F60E864(iLocal_222[2], iLocal_242);
		unk_0xA53C1C92EE35EC0E(5, false);
		unk_0xA53C1C92EE35EC0E(3, false);
		unk_0xD2E80177F27FD43F(1, iLocal_242, -1533126372);
		unk_0xD2E80177F27FD43F(1, -1533126372, iLocal_242);
		unk_0xD2E80177F27FD43F(1, iLocal_242, 1862763509);
		unk_0xD2E80177F27FD43F(1, iLocal_241, 1862763509);
		unk_0xD2E80177F27FD43F(5, iLocal_242, iLocal_241);
		unk_0xD2E80177F27FD43F(5, -1533126372, iLocal_241);
		unk_0xD2E80177F27FD43F(5, iLocal_241, iLocal_242);
		unk_0xB37A0BA7D41EA5E1(iLocal_222[0], iLocal_218, 3000, 0);
		unk_0xB37A0BA7D41EA5E1(iLocal_222[1], iLocal_218, 3000, 0);
		unk_0xB37A0BA7D41EA5E1(iLocal_222[2], iLocal_218, 3000, 0);
		if (func_45() == 0)
		{
			func_50(&uLocal_52, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
		}
		else if (func_45() == 1)
		{
			func_50(&uLocal_52, 0, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
		}
		else if (func_45() == 2)
		{
			func_50(&uLocal_52, 0, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
		}
		func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
		func_50(&uLocal_52, 5, iLocal_218, "RECSBRobber1", 0, 1);
		unk_0x5464B9731013E08C(iLocal_222[0], "S_M_Y_RANGER_01_WHITE_FULL_01");
		unk_0x5464B9731013E08C(iLocal_218, "G_M_Y_ArmGoon_02_White_Armenian_MINI_01");
		unk_0x5464B9731013E08C(iLocal_218, "G_M_Y_ArmGoon_02_White_Armenian_MINI_01");
		iLocal_45 = 1;
	}
}
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
		{
			...
			if (vmag2(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_140())
			{
				return 0;
			}
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_103(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_142()
{
	...
	if (iLocal_46)
	{
		...
		unk_0x5856B9BF2B4E98C4(Vector(43.4932f, 2612.694f, 328.0555f) - Vector(10f, 10f, 10f), Vector(43.4932f, 2612.694f, 328.0555f) + Vector(10f, 10f, 10f), true, 1);
		iVar0 = 0;
		while (iVar0 < iLocal_222)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_222[iVar0]))
			{
				unk_0x4A852F02088ECC9D(iLocal_222[iVar0], false);
				if (unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
				{
					unk_0x29F342BE632ACFF4(iLocal_222[iVar0]);
					unk_0x897EF720254BBEA3(iLocal_222[iVar0], true);
				}
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_218))
			{
				unk_0x5FEE418CE11E6DDE(iLocal_218, 317, true);
				unk_0x4A852F02088ECC9D(iLocal_218, false);
				if (!unk_0x91D5C8283D19AF49(iLocal_226, 0))
				{
					if (unk_0x10930B9CAD4111C2(iLocal_218, iLocal_226, 0))
					{
						unk_0x8A065911C6F917C0(iLocal_226, 1);
					}
				}
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_219))
			{
				unk_0x5FEE418CE11E6DDE(iLocal_219, 317, true);
				unk_0x4A852F02088ECC9D(iLocal_219, false);
				if (!unk_0x91D5C8283D19AF49(iLocal_226, 0))
				{
					if (unk_0x10930B9CAD4111C2(iLocal_219, iLocal_226, 0))
