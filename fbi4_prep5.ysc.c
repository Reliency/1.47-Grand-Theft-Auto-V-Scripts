...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			func_20();
			if (!unk_0x786AF4A44E1B5B4B(sLocal_189))
			{
				if (unk_0xCE3CFF625BEBAA04(sLocal_189, "PRE_FKICKOFF"))
				{
					while ((unk_0xE3903F59E2F22150() - iLocal_373) < 2000)
					{
						wait(0);
					}
				}
...
int func_89(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_37(unk_0x33CD235DF1E6A94E(), vLocal_200, 354.7487f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
...
int func_90(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x2EE8D1440C9060EF(sLocal_190, 0);
			unk_0x2EE8D1440C9060EF(sLocal_202, 6);
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_89(iLocal_81, bLocal_28))
			{
				...
				if (unk_0xE38E3CF1625A4145(iLocal_197))
				{
					unk_0xB9E84A421C105943(iLocal_197, 2);
					unk_0x5010BC506444793E(iLocal_197, 2);
				}
		...
		case 1:
			func_100();
			if (func_99(unk_0x33CD235DF1E6A94E(), vLocal_200, 2f) && func_98(28))
			{
				if (!iLocal_196)
				{
					unk_0x117A9E054B0F10FB(unk_0x95B959F18401C09A());
			...
			else
			{
				...
				else
				{
					...
					if (!func_99(unk_0x33CD235DF1E6A94E(), vLocal_200, 75f))
					{
						if (!iLocal_195)
						{
							func_21(&iLocal_197);
					...
					else if (func_99(unk_0x33CD235DF1E6A94E(), vLocal_200, 12f))
					{
						if (iLocal_195)
						{
							func_21(&iLocal_197);
...
void func_102(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!unk_0xE38E3CF1625A4145(*iParam0))
	{
		*iParam0 = func_103(vParam1, 5, bParam2);
		if (bParam3)
		{
			unk_0x1C95CD840303FC37(*iParam0, sParam4);
		}
	}
}
...
int func_172(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_141(unk_0x541D5C57194E73C4(*iParam0), 1) && unk_0xEECA910C75BFF02B(*iParam0, 24) != func_175(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xB4B3AEABE432069B(*iParam0, 24, func_175(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_174(iParam0);
	if (func_173(*iParam0))
	{
...
int func_193(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_194(iParam0, uVar1[iVar3], 1) && func_91(unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_189(vParam1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), true) < 10f)
					{
...
void func_218()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_99(unk_0x33CD235DF1E6A94E(), vLocal_200, 150f))
				{
					func_225(2);
				}
				else if (!func_99(unk_0x33CD235DF1E6A94E(), vLocal_200, 75f))
				{
					if (!bLocal_201)
					{
						unk_0xD362430CD61A9B08();
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_281(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_281(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_289(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_355(bool bParam0)
{
	...
	if (unk_0x117DAF3BF7232886(iLocal_198))
	{
		unk_0x63F0B040CE6EDF0F(false, false, 3000, 1, 0, 0);
		unk_0x2F8A4DF7D0DFF0A8(iLocal_198, 0);
	}
}
