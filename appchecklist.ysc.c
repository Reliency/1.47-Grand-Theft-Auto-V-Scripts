...
void func_4()
{
	...
	if (Global_14549 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_14534, "SET_DATA_SLOT", to_float(18), to_float(iLocal_21), to_float(0), -1f, -1f, &(Local_32[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_14549 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_32[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_14534, "SET_DATA_SLOT", to_float(18), to_float(iLocal_21), to_float(0), -1f, -1f, &(Local_32[iVar1 /*6*/]), 0, 0, 0, 0);
...
void func_10()
{
	...
	if (Global_14531 == 0)
	{
		if (func_9(2, Global_14522, 0))
		{
			...
			uLocal_30 = unk_0x614EE52A69097A4C();
			while (!unk_0xBFCC17D9792F43AF(uLocal_30))
			{
				wait(0);
			}
			iVar0 = unk_0x82D58DA03789627A(uLocal_30);
			...
			unk_0xE800DC85FDF60F85(iLocal_27);
			unk_0x36F3AA9FFAAF8606();
			unk_0x818901B332D5541D();
			unk_0xBB698266C5FDF0A7(Global_14534, "SET_DATA_SLOT");
			unk_0x4D9DA18AB3C2A466(18);
			...
			unk_0xE800DC85FDF60F85(iLocal_28);
			unk_0x36F3AA9FFAAF8606();
			unk_0x818901B332D5541D();
			func_33(Global_14534, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_15()
{
	if (Global_14531 == 0)
	{
		if (func_9(2, Global_14522, 0))
		{
			...
			iLocal_29 = unk_0x82D58DA03789627A(uLocal_30);
			if (Global_14553.f_1 > 3)
			{
				Global_14553.f_1 = 8;
				if (iLocal_29 == 0)
