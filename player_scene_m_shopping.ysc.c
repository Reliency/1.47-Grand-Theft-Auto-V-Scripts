	...
	if (!unk_0xBC2FC12AD0FBF72E(*iParam0))
	{
		...
		if (iLocal_290 >= 0)
		{
			if (unk_0x17260B4EA0652E1C(*iParam0))
			{
				...
				{
					unk_0xA5F1549010780D92(*iParam0, 0, 0);
				}
		...
		switch (iLocal_290)
		{
			...
			case 1:
				...
				else if (unk_0xDB4C79A9697E6A55(Global_91042))
				{
					...
					if (!unk_0x1CE8F0A08E65CA6A(*iParam0, &cLocal_300, &cLocal_318, 2))
					{
						unk_0xED68CDDDE25A144E(*iParam0);
						unk_0x0C6BB9365C4A5F6E(*iParam0, -16f, 1);
						unk_0xA9D10D2C7FFC0FDF(*iParam0);
						unk_0x7E268975AF5EA74F(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 1193033728);
						unk_0x13C3FE558ED056EE(*iParam0, -668482597, false, 0, 0);
					...
					else
					{
						...
						if (!unk_0x5D19BF64E3AC6863(&cLocal_300, &cLocal_318, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
				...
				{
					unk_0xED68CDDDE25A144E(*iParam0);
					if (unk_0x786AF4A44E1B5B4B(&cLocal_327))
					{
						unk_0x7E268975AF5EA74F(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 1193033728);
						unk_0x13C3FE558ED056EE(*iParam0, -668482597, false, 0, 0);
						unk_0x45C6E26B40E7F5EF(*iParam0, 2);
					...
					{
						unk_0x0BFA5DCFCE7BBE54(*iParam0, &cLocal_327, vLocal_296 + vLocal_336, (fLocal_297 + fLocal_337), 0, 0, 1);
			...
			case 2:
				...
				else
				{
					...
					{
						vVar3 = { unk_0x2CA911E7569D12EA(unk_0x33CD235DF1E6A94E(), 5f, 0f, 0f) };
			...
			case 3:
				...
				{
					if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
					{
						if (fLocal_299 == 0f)
						{
							fLocal_299 = (vmag(vLocal_298) * 0.75f);
						}
						unk_0x126A03BD41622048(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 1077936128, 1086324736);
						func_124(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
				{
					if (unk_0x89F20C4A841A3473(vLocal_296 + vLocal_298, fLocal_299, 1))
					{
						unk_0xA9128AA30F3036C7(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 0);
						unk_0xF1CFA0046BB67893(iLocal_339, 0);
						func_124(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					if (unk_0xFC05F8C42B023B2E(vVar4, 0, &vVar5, 14))
					{
						if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), vVar5) > 100f)
						{
							unk_0x7E268975AF5EA74F(*iParam0, vVar5, 1f, -1, 1048576000, 0, 1193033728);
							vVar6 = { unk_0xFBB1F99A825CAB09(*iParam0, true) - Vector(2f, 2f, 2f) };
							vVar7 = { unk_0xFBB1F99A825CAB09(*iParam0, true) + Vector(2f, 2f, 2f) };
							iLocal_339 = unk_0x0335D8135051EA56(vVar6, vVar7, 0, 0, 1, 1);
			...
			case 7:
				...
				func_7(*iParam0);
				if (unk_0x1CE8F0A08E65CA6A(*iParam0, &cLocal_300, &cLocal_309, 2))
				{
				}
				else if (unk_0x1CE8F0A08E65CA6A(*iParam0, &cLocal_300, &cLocal_318, 2))
				{
				}
				break;
			...
			case 8:
				...
				if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), unk_0xFBB1F99A825CAB09(*iParam0, true)) > (50f * 1.25f))
				{
					unk_0x7E268975AF5EA74F(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 1193033728);
...
Vector3 func_5(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_6(vVar0, unk_0x9562E33C057F7589(0f, fParam1)) };
...
void func_7(int iParam0)
{
	...
	if (unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		if (!iLocal_342 && unk_0x91BBD269506D61D2(iParam0, unk_0x33CD235DF1E6A94E(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_105(75, unk_0xFBB1F99A825CAB09(iParam0, false), 250f, -1);
	...
	else
	{
		...
		if (iLocal_340 > 0)
		{
			if (iLocal_341 == 0)
			{
				if (iLocal_340 + 15000 < unk_0xE3903F59E2F22150())
				{
			...
			else if (iLocal_340 + 10000 < unk_0xE3903F59E2F22150())
			{
...
{
	unk_0xAEED0213982928AC(iParam0, sParam1, func_9(iParam2), 1);
}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_85(Global_14534, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2430[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
int func_121(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (unk_0x5A55F54738BBF615(iParam0, 122))
		{
			return 1;
		}
	}
...
{
	unk_0xF0502D0584CCD9A6(iParam0, sParam1, sParam2, func_9(iParam3), 0);
}
...
int func_125()
{
	if (!func_127())
	{
		func_30(&uLocal_100, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
	...
	if (iLocal_293 != 0)
	{
		...
		{
			iLocal_292 = unk_0x68F833BFE3A28FEA(vLocal_296 + vLocal_294, 1f, iLocal_293, 1, 0, 1);
			if (unk_0x765F6FEEFF39224F(iLocal_292))
			{
				unk_0xBEADAF07D2339505(iLocal_292, vLocal_296 + vLocal_294, 1, false, 0, 1);
				unk_0x1C8705F667F673EA(iLocal_292, Vector(fLocal_297, 0f, 0f) + vLocal_295, 2, 1);
				unk_0xF70578F5CD9822CB(iLocal_292, true);
			}
		}
	}
	return 0;
...
void func_136()
{
	...
	if (iLocal_291 != 0)
	{
		unk_0x2D0FA45744C7540C(iLocal_291, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_291 != 0)
		{
			if (!unk_0x4FFB62F63D342B1B(iLocal_291))
			{
				bVar1 = false;
			}
		}
...
void func_138()
{
	...
	switch (iLocal_99)
	{
		...
		default:
			vLocal_298 = { unk_0x9562E33C057F7589(-50f, 50f), unk_0x9562E33C057F7589(-50f, 50f), 0f };
			fLocal_299 = (vmag(vLocal_298) * 0.75f);
			break;
	}
...
void func_161()
{
	if (iLocal_291 != 0)
	{
		unk_0x4CDF0D2C93F8CCA7(iLocal_291);
	}
