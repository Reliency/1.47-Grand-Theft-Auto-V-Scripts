...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0xA80721FDC3BDCCDB() && !unk_0x09287BFEE1D9F6EF(unk_0x95B959F18401C09A(), 0)) || iLocal_243)
		{
			if (!func_229())
			{
				if (func_228())
			...
			switch (iLocal_49)
			{
				...
				case 1:
					...
					if (!unk_0xD62C4419A41F106A(iLocal_234, 0))
					{
						if (unk_0xF0D230FB550CD6EB(iLocal_234, 0))
						{
							func_212();
						}
					}
					if (!unk_0xD62C4419A41F106A(iLocal_235, 0))
					{
						if (unk_0xF0D230FB550CD6EB(iLocal_235, 0))
						{
							func_212();
						}
					}
					...
					if (!iLocal_243)
					{
						...
						{
							if (func_197(unk_0x33CD235DF1E6A94E(), unk_0xFBB1F99A825CAB09(iLocal_236, true), 1) < IntToFloat(iLocal_256) && !unk_0xC30D5C4DCAC8020A(iLocal_236))
							{
								if (!iLocal_250)
								{
									func_195();
									...
									if (unk_0xE38E3CF1625A4145(iLocal_233))
									{
										unk_0x983D75D9630FD905(iLocal_233, true);
									}
									iLocal_250 = 1;
								}
							}
					...
					else
					{
						...
						if (!iLocal_245)
						{
							if (!unk_0xD62C4419A41F106A(iLocal_236, 0))
							{
								...
								{
									if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
									{
										unk_0x99414FB2D30425C1(&iLocal_253);
										unk_0xC838CE9837D0ABAF(0, iLocal_236, -1, -1, 2f, 524296, 0);
										unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
										unk_0xC734F59A13D39AEF(iLocal_253);
										unk_0x13A2D602CD10CBAC(iLocal_234, iLocal_253);
										unk_0xA7A57E7757ED035E(&iLocal_253);
										unk_0x897EF720254BBEA3(iLocal_234, true);
									}
									iLocal_245 = 1;
								}
							}
...
void func_2()
{
	if (!unk_0xD62C4419A41F106A(iLocal_234, 0))
	{
		if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 10f, 10f, 10f, 0, 1, 0) && !unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			if ((timerb() > 3000 && iLocal_254 == 0) && !func_3())
			{
				func_184(&uLocal_66, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				unk_0xC4A347124F39D998(iLocal_234, unk_0x33CD235DF1E6A94E(), 4000, 0, 2);
				unk_0xD2E80177F27FD43F(5, iLocal_63, 1862763509);
				settimerb(0);
				iLocal_254++;
			}
...
void func_4()
{
	...
	if (!iLocal_249)
	{
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
		{
			...
			else if (timera() > 4000)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
				{
					unk_0x277716E9E7CC0692(iLocal_234, unk_0x33CD235DF1E6A94E(), 0, 16);
					unk_0x897EF720254BBEA3(iLocal_234, true);
				}
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
			{
				if ((iLocal_257 >= 1 && unk_0x2ADCDD5710DD5A07(unk_0x33CD235DF1E6A94E(), 0)) && iLocal_246)
				{
					unk_0x108754262311D34F(iLocal_234, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
					unk_0x65BA35D6D61F1574(sLocal_259);
	...
	else
	{
		...
		{
			case 0:
				if (unk_0xE38E3CF1625A4145(iLocal_231))
				{
					if (unk_0xBC2FC12AD0FBF72E(iLocal_234))
					{
						unk_0x1ABDB383C83A336A(&iLocal_231);
					}
				}
				wait(2000);
				iLocal_260++;
			...
			case 1:
				...
				{
					func_165();
					iLocal_64 = unk_0x4382260282C96ECD(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
					func_158(1);
					unk_0x7EDEAEAED85BEE4F(500);
					wait(2000);
					if (unk_0x765F6FEEFF39224F(iLocal_234))
					{
						unk_0x1F45B4626AC4A4C0(&iLocal_234);
					}
					iLocal_260++;
				}
				else
			...
			case 2:
				...
				unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), 923.5159f, 3203.386f, 40.173f, 1, false, 0, 1);
				...
				iLocal_237 = unk_0xEB5D8A701BA05E99(0, 1063.595f, 3227.571f, 39.3899f, 1);
				iVar0 = unk_0xE196503B36B6194B(iLocal_237, 26, iLocal_240, -1, 1, true);
				iVar0 = iVar0;
				if (!iLocal_248)
				{
					if (unk_0x3C05A6D663EA1B6A("Train_Horn", false, -1))
					{
						unk_0xE9739440E5BF08EE(-1, "Warning_Once", iLocal_237, "TRAIN_HORN", false, 0);
					}
				}
			...
			case 3:
				unk_0x6BFA9158A12CC006(iLocal_64);
...
{
	iParam0->f_1 = (func_39(unk_0x0E4018692D92041D(*iParam0, 4)) - fParam1);
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_54(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_54(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_66(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_66(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_66(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_66(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_103(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_97(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_97(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_54(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_167()
{
	if ((unk_0xBC2FC12AD0FBF72E(iLocal_234) && unk_0xBC2FC12AD0FBF72E(iLocal_235)) && !iLocal_249)
	{
		func_15();
	}
	if (iLocal_50 == 1)
	{
		if (!iLocal_249)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
			{
				if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 50f, 50f, 50f, 0, 1, 0))
				{
					func_15();
				}
			}
	...
	{
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_234) && !unk_0xBC2FC12AD0FBF72E(iLocal_235))
		{
			if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 200f, 200f, 200f, 0, 1, 0) && !unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 200f, 200f, 200f, 0, 1, 0))
			{
				func_15();
			}
		}
...
void func_168()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0x2ADCDD5710DD5A07(unk_0x33CD235DF1E6A94E(), 0))
			{
				if (!unk_0x335C0645074963FE(iLocal_234, unk_0x33CD235DF1E6A94E(), 8f, 8f, 8f, 0, 1, 0) || !unk_0x18FB647D79B09657(iLocal_234, vLocal_59, 215f, 215f, 215f, false, true, 0))
				{
					if ((unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_234) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_234)) || !unk_0x18FB647D79B09657(iLocal_234, vLocal_59, 215f, 215f, 215f, false, true, 0))
					{
						if (unk_0x9ED464AAA493C8EF(unk_0x33CD235DF1E6A94E(), 6) || !unk_0x18FB647D79B09657(iLocal_234, vLocal_59, 215f, 215f, 215f, false, true, 0))
						{
							unk_0xECCD4FDA45197F97(iLocal_234, unk_0x33CD235DF1E6A94E(), 1000f, -1, 0, 0);
							unk_0x897EF720254BBEA3(iLocal_234, true);
							func_195();
							wait(0);
...
void func_169()
{
	if (iLocal_50 == 1)
	{
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
		{
			if (!unk_0x181998D7D100C503(iLocal_234))
			{
				if (iLocal_260 < 3)
				{
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 20f, 20f, 10f, 0, 1, 0))
					{
						if (func_174())
						{
							func_173(0);
	...
	else if (iLocal_50 == 2)
	{
		if (!unk_0xD62C4419A41F106A(iLocal_234, 0))
		{
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_174())
				{
					func_173(0);
		...
		else if (!unk_0xD62C4419A41F106A(iLocal_235, 0))
		{
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_235, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_174())
				{
					func_173(0);
		...
		if (!func_3())
		{
			if (!iLocal_252)
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 30f, 30f, 10f, 0, 1, 0))
				{
					if (func_194() == 0)
					{
			...
			if (iLocal_258 < unk_0xE3903F59E2F22150())
			{
				if (func_172())
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
					{
						if (!unk_0x181998D7D100C503(iLocal_234))
						{
							...
							iLocal_258 = (unk_0xE3903F59E2F22150() + unk_0x9EC3B269A34A2BEE(4500, 5000));
						}
					}
				}
				else if (!unk_0xBC2FC12AD0FBF72E(iLocal_235))
				{
					if (!unk_0x181998D7D100C503(iLocal_235))
					{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
	{
		if (!unk_0x181998D7D100C503(iLocal_234))
		{
			if ((unk_0x3AF2B3B68DD52355(iLocal_234) || unk_0x2ADCDD5710DD5A07(iLocal_234, joaat("weapon_stungun"))) || unk_0x91BBD269506D61D2(iLocal_234, unk_0x33CD235DF1E6A94E(), 1))
			{
				func_195();
				unk_0x0D847D71D9E6142E(iLocal_234);
			}
			if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, vLocal_62, 0, 1, 0) || !unk_0x18FB647D79B09657(iLocal_234, vLocal_59, 290f, 290f, 290f, false, true, 0))
			{
...
void func_175()
{
	...
	if (unk_0xE38E3CF1625A4145(iLocal_232))
	{
		if (unk_0xBC2FC12AD0FBF72E(iLocal_235))
		{
			unk_0x1ABDB383C83A336A(&iLocal_232);
		}
	}
}
...
void func_176()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
	{
		if (unk_0xF0D230FB550CD6EB(iLocal_234, 0))
		{
			if (unk_0x91D5C8283D19AF49(unk_0xF2C96862595654B4(iLocal_234, 0), 0))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					if ((((((((unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && unk_0x204DEACC5BECF723(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f))
					{
						unk_0x0848C95091F9ECB9(unk_0xF2C96862595654B4(iLocal_234, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						unk_0xE9739440E5BF08EE(-1, "SUSPENSION_SCRIPT_FORCE", unk_0xF2C96862595654B4(iLocal_234, 0), 0, false, 0);
					}
				}
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_235))
		{
			if (unk_0x91BBD269506D61D2(iLocal_235, unk_0x33CD235DF1E6A94E(), 1))
			{
				unk_0x108754262311D34F(iLocal_235, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
			}
		}
	}
}
...
void func_177()
{
	if (!unk_0xD62C4419A41F106A(iLocal_236, 0))
	{
		if ((!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_236, 0)) || iLocal_50 == 2)
		{
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_236, vLocal_61, 0, 1, 0) || iLocal_242)
			{
				if (iLocal_50 == 1)
				{
					vLocal_55 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) - Vector(-1f, 8.8f, 0f) };
					unk_0xFC05F8C42B023B2E(vLocal_55, 0, &vLocal_55, 0);
					vLocal_56 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) + Vector(-1f, 0f, 8.8f) };
					unk_0xFC05F8C42B023B2E(vLocal_56, 0, &vLocal_56, 0);
					vLocal_57 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) + Vector(-1f, 8.8f, 0f) };
					unk_0xFC05F8C42B023B2E(vLocal_57, 0, &vLocal_57, 0);
					vLocal_58 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) - Vector(-1f, 0f, 8.8f) };
					unk_0xFC05F8C42B023B2E(vLocal_58, 0, &vLocal_58, 0);
					if (!unk_0x73E7A21FD53144AB(vLocal_55, 2f))
					{
						iLocal_234 = unk_0x9BA5CF280376EEA4(19, iLocal_240, vLocal_55 - Vector(1f, 0f, 0f), func_182(vLocal_55, func_183(unk_0x95B959F18401C09A())), 1, true);
					}
					else if (!unk_0x73E7A21FD53144AB(vLocal_56, 2f))
					{
						iLocal_234 = unk_0x9BA5CF280376EEA4(19, iLocal_240, vLocal_56 - Vector(1f, 0f, 0f), func_182(vLocal_56, func_183(unk_0x95B959F18401C09A())), 1, true);
					}
					else if (!unk_0x73E7A21FD53144AB(vLocal_57, 2f))
					{
						iLocal_234 = unk_0x9BA5CF280376EEA4(19, iLocal_240, vLocal_57 - Vector(1f, 0f, 0f), func_182(vLocal_57, func_183(unk_0x95B959F18401C09A())), 1, true);
					}
					else if (!unk_0x73E7A21FD53144AB(vLocal_58, 2f))
					{
						iLocal_234 = unk_0x9BA5CF280376EEA4(19, iLocal_240, vLocal_58 - Vector(1f, 0f, 0f), func_182(vLocal_58, func_183(unk_0x95B959F18401C09A())), 1, true);
					}
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
					{
						unk_0x5464B9731013E08C(iLocal_234, "A_M_M_HillBilly_01_WHITE_MINI_02");
						unk_0x697EBA5CF1A6AB57(iLocal_234, joaat("weapon_stungun"), -1, true, true);
						unk_0x41AAD0031D053A00(iLocal_234, 100);
						unk_0x5FEE418CE11E6DDE(iLocal_234, 137, true);
						unk_0x5FEE418CE11E6DDE(iLocal_234, 188, true);
						unk_0x5FEE418CE11E6DDE(iLocal_234, 286, true);
						unk_0x2BC096AD87238048(unk_0x33CD235DF1E6A94E(), 10000);
						unk_0x28F648743D7DE312(iLocal_234, 0, false);
						unk_0x28F648743D7DE312(iLocal_234, 27, true);
						unk_0x28F648743D7DE312(iLocal_234, 13, true);
						unk_0x28F648743D7DE312(iLocal_234, 50, true);
						unk_0x34A51926277F67BC(iLocal_234, 2);
						unk_0x52F5AAAD4824B17E(iLocal_234, 2);
						unk_0x1E0350F1D7702D6A(iLocal_234, 0);
						unk_0x4099B0626C455EC7(iLocal_234, 2, 11f);
						unk_0x4099B0626C455EC7(iLocal_234, 13, 1f);
						unk_0x9FD099B0593CD91D(iLocal_234, true);
						unk_0x0648A75D3F60E864(iLocal_234, iLocal_63);
						func_181(&uLocal_66, 4, iLocal_234, "RAPIST", 0, 1);
						unk_0x53D6CDF9A1057FDB(unk_0x33CD235DF1E6A94E(), -8f);
						unk_0x4A852F02088ECC9D(iLocal_234, true);
						if (!unk_0xE38E3CF1625A4145(iLocal_231))
						{
							iLocal_231 = func_178(iLocal_234, 1, 145);
						}
						unk_0x1ABDB383C83A336A(&iLocal_233);
						unk_0x99414FB2D30425C1(&iLocal_253);
						unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
						unk_0xBA33E5509FA3F42C(0, unk_0x33CD235DF1E6A94E(), unk_0x33CD235DF1E6A94E(), 3f, 1, 3f, 1082130432, 1, 0, -957453492);
						unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
						unk_0xC734F59A13D39AEF(iLocal_253);
						unk_0x13A2D602CD10CBAC(iLocal_234, iLocal_253);
						unk_0xA7A57E7757ED035E(&iLocal_253);
						unk_0x897EF720254BBEA3(iLocal_234, true);
						unk_0x880B00F3FAE4C022(iLocal_234, 0, 0);
						iLocal_243 = 1;
					}
				}
				else if (iLocal_50 == 2)
				{
					...
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_235))
					{
						...
						unk_0x7FC2040EB34E0E31(iLocal_235, 200, 0);
						unk_0x99414FB2D30425C1(&iLocal_253);
						...
						unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
						unk_0xC734F59A13D39AEF(iLocal_253);
						unk_0x13A2D602CD10CBAC(iLocal_235, iLocal_253);
						unk_0xA7A57E7757ED035E(&iLocal_253);
						unk_0x897EF720254BBEA3(iLocal_235, true);
					}
					func_195();
					wait(0);
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_234) && !unk_0xBC2FC12AD0FBF72E(iLocal_235))
...
int func_179(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_180(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_180(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(iVar0, bParam1);
	}
...
void func_198()
{
	if (unk_0x91D5C8283D19AF49(iLocal_236, 0))
	{
		if (!func_229())
		{
			if (func_197(unk_0x33CD235DF1E6A94E(), unk_0xFBB1F99A825CAB09(iLocal_236, true), 1) < IntToFloat(iLocal_255))
			{
				if (unk_0xE38E3CF1625A4145(iLocal_233))
				{
					unk_0x1ABDB383C83A336A(&iLocal_233);
				...
				unk_0x983D75D9630FD905(iLocal_233, false);
				if (!unk_0xD62C4419A41F106A(unk_0x8918EC905FC8975D(), 0))
				{
					iLocal_238 = unk_0x8918EC905FC8975D();
				}
				func_200(1);
				func_199(1);
			}
	...
	if (iLocal_50 == 1)
	{
		if (!unk_0xD62C4419A41F106A(iLocal_234, 0))
		{
			if ((((unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_234, 13f, 13f, 13f, 0, 1, 0) && !unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0)) || unk_0x91BBD269506D61D2(unk_0x33CD235DF1E6A94E(), iLocal_234, 1)) || unk_0x91BBD269506D61D2(iLocal_234, unk_0x33CD235DF1E6A94E(), 1)) || unk_0x73E7A21FD53144AB(unk_0xFBB1F99A825CAB09(iLocal_234, true), 2f))
			{
				iLocal_242 = 1;
				settimerb(0);
				if (!unk_0xD62C4419A41F106A(iLocal_234, 0))
				{
					...
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_234))
					{
						unk_0xC4A347124F39D998(iLocal_234, unk_0x33CD235DF1E6A94E(), 30000, 0, 2);
					}
				}
			}
		}
...
void func_211()
{
	if (!unk_0xD62C4419A41F106A(iLocal_236, 0))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0x18FB647D79B09657(iLocal_236, vLocal_59, 15f, 15f, 15f, false, true, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((unk_0x91BBD269506D61D2(iLocal_236, unk_0x33CD235DF1E6A94E(), 1) || unk_0xE5472B649A9E9734(unk_0x33CD235DF1E6A94E(), vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f), 0, 1)) || unk_0x1041083D5BD8F51E(2, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x1041083D5BD8F51E(4, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x1041083D5BD8F51E(0, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x1041083D5BD8F51E(1, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0xB05EBD564C7A1480(vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x4A83E23BE6BCA7B0(vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_236, 50f, 50f, 50f, 0, 1, 2) && unk_0x1578197A616E70FA(unk_0x95B959F18401C09A())))
			{
				if (!unk_0xD62C4419A41F106A(unk_0x8918EC905FC8975D(), 0))
				{
					iLocal_238 = unk_0x8918EC905FC8975D();
...
void func_214()
{
	unk_0x8C4EA5F6857553AE(joaat("surfer"), true);
	if (iLocal_50 == 1)
	{
		unk_0x0335D8135051EA56(vLocal_59 - Vector(20f, 50f, 50f), vLocal_59 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	}
	else if (iLocal_50 == 2)
	{
		unk_0x0335D8135051EA56(vLocal_59 - Vector(50f, 100f, 100f), vLocal_59 + Vector(50f, 100f, 100f), 0, 1, 1, 1);
	}
	unk_0xB7350047030F7672(vLocal_54, 50f, 0, 0, 0, 0, false, 0);
	unk_0x4B06B5746CBEC99F(0.1f);
	unk_0xB815670C37E03CDE(iLocal_240);
	...
	unk_0x7E2EAC500C9B54E3(sLocal_259);
	unk_0xCB7F618CC6FABC72(0);
	unk_0xDEFB5E2E5CBD460A("RE_ABANDONED_VEHICLE_SCENE");
	while (((((!unk_0x5D98D654CDC2165A(iLocal_240) || !unk_0x5D98D654CDC2165A(iLocal_241)) || !unk_0xE9CCF312047EBEE0("random@train_tracks")) || !unk_0xE9CCF312047EBEE0("amb@world_human_guard_patrol@male@idle_b")) || !unk_0x7E2EAC500C9B54E3(sLocal_259)) || !unk_0x7C71681384076318("RE_ABANDONED_VEHICLE_SCENE"))
	{
		wait(0);
	}
	if (func_194() == 0)
	{
		func_181(&uLocal_66, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
	}
	else if (func_194() == 1)
	{
		func_181(&uLocal_66, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
	}
	else if (func_194() == 2)
	{
		func_181(&uLocal_66, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
	}
	unk_0xA53C1C92EE35EC0E(3, false);
	unk_0xA53C1C92EE35EC0E(5, false);
	iLocal_236 = unk_0xC651C43AB13A15E5(iLocal_241, vLocal_59, fLocal_60, true, true, false);
	unk_0x3D258435016D9F74(iLocal_236, 10000);
	unk_0xFDAF3D5C2E2300E8(iLocal_236);
	unk_0x18A74017AFD59D9B(iLocal_236, 5f);
	unk_0x71CA80D41E1338B4(iLocal_241);
	unk_0x7B1011A61F402324(iLocal_236, "RE_ABANDONED_VEHICLE_MOTORHOME", 0);
	unk_0x6D056AC3FCCA974B(iLocal_236, 3);
	unk_0x9315FCF6CFE2AB41("Redneck", &iLocal_63);
	unk_0xD2E80177F27FD43F(5, iLocal_63, 1862763509);
	unk_0xD2E80177F27FD43F(5, -1533126372, iLocal_63);
	unk_0xD2E80177F27FD43F(5, iLocal_63, -1533126372);
	if (iLocal_50 == 1)
	{
		unk_0x4A3BD9D189356B69(iLocal_236, 0, 1, 0);
		unk_0x4A3BD9D189356B69(iLocal_236, 1, 1, 0);
		unk_0xA3B3E54143896FE9(iLocal_236, vLocal_59, 0f, 1700f, 1);
		unk_0x9FABD0AB045A5D6E(iLocal_236, false, true, 0);
		unk_0x26E0FFDB1AD22AC5(iLocal_236, 2);
	}
	else if (iLocal_50 == 2)
	{
		unk_0x9FABD0AB045A5D6E(iLocal_236, false, true, 0);
		unk_0x26E0FFDB1AD22AC5(iLocal_236, 1);
		iLocal_234 = unk_0xE196503B36B6194B(iLocal_236, 26, iLocal_240, -1, 1, true);
		unk_0x93AA93DA1B137032(iLocal_234, 0, 0, 2, 0);
		unk_0x93AA93DA1B137032(iLocal_234, 2, 1, 2, 0);
		unk_0x93AA93DA1B137032(iLocal_234, 3, 1, 0, 0);
		unk_0x93AA93DA1B137032(iLocal_234, 4, 0, 0, 0);
		unk_0x93AA93DA1B137032(iLocal_234, 8, 0, 0, 0);
		unk_0x4A852F02088ECC9D(iLocal_234, true);
		unk_0x0648A75D3F60E864(iLocal_234, iLocal_63);
		unk_0x697EBA5CF1A6AB57(iLocal_234, joaat("weapon_sawnoffshotgun"), -1, false, true);
		unk_0x28F648743D7DE312(iLocal_234, 1, false);
		unk_0xDE9FF07CFD5DC172(iLocal_234, 25);
		unk_0x9FD099B0593CD91D(iLocal_234, true);
		unk_0x5464B9731013E08C(iLocal_234, "A_M_M_HillBilly_02_WHITE_MINI_01");
		func_181(&uLocal_66, 4, iLocal_234, "INCESTBRO1", 0, 1);
		iLocal_235 = unk_0xE196503B36B6194B(iLocal_236, 26, iLocal_240, 0, 1, true);
		unk_0x93AA93DA1B137032(iLocal_235, 0, 0, 0, 0);
		unk_0x93AA93DA1B137032(iLocal_235, 2, 0, 0, 0);
		unk_0x93AA93DA1B137032(iLocal_235, 3, 0, 2, 0);
		unk_0x93AA93DA1B137032(iLocal_235, 4, 1, 0, 0);
		unk_0x93AA93DA1B137032(iLocal_235, 8, 0, 0, 0);
		unk_0x7FC2040EB34E0E31(iLocal_235, 100000000, 0);
		unk_0x4A852F02088ECC9D(iLocal_235, true);
		unk_0x0648A75D3F60E864(iLocal_235, iLocal_63);
		unk_0x697EBA5CF1A6AB57(iLocal_235, joaat("weapon_pistol"), -1, false, true);
		unk_0x28F648743D7DE312(iLocal_235, 1, false);
		unk_0xDE9FF07CFD5DC172(iLocal_235, 25);
		unk_0x9FD099B0593CD91D(iLocal_235, true);
		unk_0x5464B9731013E08C(iLocal_235, "A_M_M_HillBilly_02_WHITE_MINI_02");
		func_181(&uLocal_66, 5, iLocal_235, "INCESTBRO2", 0, 1);
		unk_0x108754262311D34F(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0x108754262311D34F(iLocal_235, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0x71CA80D41E1338B4(iLocal_240);
	}
	iLocal_51 = 1;
}
...
int func_216()
{
	...
	{
		if (vdist2(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_48) < (75f * 75f))
		{
			return 1;
		}
		if (vmag2(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_227())
		{
			return 0;
		}
	}
...
void func_230()
{
	if (iLocal_52)
	{
		...
		unk_0x33854B8151B6D8EC(sLocal_259);
		...
		if (!unk_0xD62C4419A41F106A(iLocal_238, 0))
		{
			if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_238, 0) && !unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_238, 50f, 50f, 50f, 0, 1, 0))
			{
				func_258(iLocal_238, 0, 145);
			}
		}
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_234) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
		{
			unk_0x0BDE9076965FCC2C(iLocal_234);
			unk_0xECCD4FDA45197F97(iLocal_234, unk_0x33CD235DF1E6A94E(), 1000f, -1, 0, 0);
			unk_0x897EF720254BBEA3(iLocal_234, true);
		}
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_235) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
		{
			unk_0x0BDE9076965FCC2C(iLocal_235);
			unk_0xECCD4FDA45197F97(iLocal_235, unk_0x33CD235DF1E6A94E(), 1000f, -1, 0, 0);
			unk_0x897EF720254BBEA3(iLocal_235, true);
		}
	}
	func_231(-1);
...
{
	return (shift_right(iParam0, 26) & 31 * func_240(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
Vector3 func_311()
{
	...
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		fVar0 = unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_261, true);
		iLocal_263 = 1;
		if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_262, true) < fVar0)
		{
			fVar0 = unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_262, true);
			iLocal_263 = 2;
		}
		if (iLocal_263 == 1)
		{
