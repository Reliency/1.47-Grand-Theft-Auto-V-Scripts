...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 3:
			if (!func_69(iLocal_71))
			{
				if (((func_66() && !func_65()) && func_64()) && !func_63(0))
				{
					if (iLocal_73 != 0)
					{
						if (unk_0x43C3AA6EE008FA3B(iLocal_73))
						{
		...
		case 4:
			...
			{
				unk_0x9DED39101E732CEA(iLocal_66, 0.75f);
			}
			if (!func_69(4))
			{
		...
		case 6:
			if (!func_28(3))
			{
				if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, 0, true, 0))
				{
					func_27(3, 1);
				}
			}
			if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0))
			{
				if (func_28(3))
				{
			...
			if (!func_28(2))
			{
				if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0) || unk_0xBB5E373390A5F824())
				{
					unk_0x17D569F7C0516CDF(vLocal_58, 200f, -1241212535, 0);
					func_27(2, 1);
				}
			}
			if (func_66() && !func_65())
			...
			if (func_28(1))
			{
				if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, 0, true, 0))
				{
...
void func_3()
{
	switch (Global_106565.f_10043.f_134)
	{
		...
		case 1:
			...
			unk_0x0F8EAEEC97DDBCB3(-1, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
...
void func_27(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		unk_0x8950ED5730F62EE8(&iLocal_78, iParam0);
	}
	else
	{
		unk_0xCE689A8E8C42ED78(&iLocal_78, iParam0);
	}
}

bool func_28(int iParam0)
{
	return unk_0x0E4018692D92041D(iLocal_78, iParam0);
}
...
void func_29()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_51, vLocal_57, true, true, 0))
				{
					if (func_55())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_52, vLocal_57, true, true, 0))
				{
					func_48(0);
					iLocal_60 = 3;
					func_54(0, 800);
		...
		case 2:
			...
			{
				func_39(24, 0);
				func_38(unk_0x33CD235DF1E6A94E(), vLocal_55, fLocal_56);
				...
				unk_0x1F6A09AE9372AE6C(vLocal_55, 20f, 0);
				func_33(24, &iLocal_59);
				unk_0xDDF57F769FD85704(iLocal_59);
				iLocal_72 = (unk_0xE3903F59E2F22150() + 40000);
				while ((!unk_0x4E1190A8D88ABDB7() || !unk_0x5FC25A9F19EB39FA(iLocal_59)) && iLocal_72 > unk_0xE3903F59E2F22150())
				{
					wait(0);
				}
				unk_0x4ABB9EF39DA515D7();
				if (iLocal_72 <= unk_0xE3903F59E2F22150())
				{
					unk_0x2F7BF094F3C2A257(iLocal_59);
					func_38(unk_0x33CD235DF1E6A94E(), vLocal_53, fLocal_54);
					func_54(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_43()
{
	...
	{
		case 0:
			if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				func_47(sLocal_76);
				iLocal_61++;
			}
		...
		case 2:
			...
			if (unk_0x833B1A3D9F713E03(2, 51))
			{
				...
				{
					iLocal_72 = unk_0xE3903F59E2F22150() + 300;
					unk_0x0B1F8038F56C12B7("CamPushInNeutral", 0, 0);
					unk_0x0F8EAEEC97DDBCB3(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", false);
				}
				else
				{
					iLocal_72 = 0;
...
int func_56()
{
	...
	if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_63(0))
...
void func_61(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		...
		if (!bParam2)
		{
			unk_0x0F8EAEEC97DDBCB3(iLocal_69, sLocal_67, sLocal_68, false);
		}
		func_62();
	}
	else
...
bool func_71(vector3 vParam0)
{
	...
	return unk_0x2663979B26E8B87E(vParam0, &uVar0, &uVar1);
}
...
void func_75()
{
	if (func_60(unk_0x33CD235DF1E6A94E()))
	{
		vLocal_70 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false) };
	}
}
...
void func_77()
{
	switch (iLocal_71)
	{
		...
		case 4:
			func_79(-671910391);
			func_78(sLocal_74);
			iLocal_66 = unk_0x9BA5CF280376EEA4(26, -671910391, func_68(4), 184.5548f, 1, true);
			unk_0x71CA80D41E1338B4(-671910391);
			unk_0x108754262311D34F(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			unk_0x4A852F02088ECC9D(iLocal_66, true);
			unk_0x897EF720254BBEA3(iLocal_66, true);
			unk_0xF70578F5CD9822CB(iLocal_66, true);
			unk_0x9FD099B0593CD91D(iLocal_66, true);
			unk_0x167979048B7CE51D(iLocal_66, true);
			unk_0x5FEE418CE11E6DDE(iLocal_66, 118, false);
			unk_0x5FEE418CE11E6DDE(iLocal_66, 208, true);
			unk_0x9611832841071B69(iLocal_66, true);
			unk_0x0648A75D3F60E864(iLocal_66, 1862763509);
			break;
		
		case 5:
			iLocal_63 = 731806707;
			unk_0x1D8D48272A2B8F0F(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, 1, 0);
			unk_0x046ED2CF120C8949(iLocal_63, 1, 1, 0);
			iLocal_62 = unk_0xB1A92B63D6757EEF(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_79(732742363);
			iLocal_64 = unk_0x9BA5CF280376EEA4(26, 732742363, func_68(6), 22.9631f, 1, true);
			unk_0x73D993BCA1CEC58D(iLocal_64, 0, 0, 0, false);
			unk_0x71CA80D41E1338B4(732742363);
			unk_0x9FD099B0593CD91D(iLocal_64, true);
			unk_0x167979048B7CE51D(iLocal_64, true);
			unk_0xC65888009006911B(iLocal_64, joaat("weapon_sniperrifle"));
			unk_0x0648A75D3F60E864(iLocal_64, 1862763509);
			iLocal_65 = unk_0xDD9A603448A23A17(130556722, -543.71f, 1986.2f, 126.05f, true, true, false);
			break;
	}
}
...
void func_80(int iParam0, vector3 vParam1, float fParam2)
{
	*iParam0 = unk_0x8ADCD6A9E17A45C0();
	...
	{
		unk_0x2136E753816C9B70(*iParam0, vParam1, fParam2);
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			unk_0x8C12D452EEB914C9(iLocal_73);
			iLocal_73 = 0;
			break;
		...
		case 4:
			...
			{
				unk_0x1F45B4626AC4A4C0(&iLocal_66);
			}
			unk_0xFF2DEA68E2D3602E(sLocal_74);
			break;
		
		case 5:
			if (unk_0x36CDBD83DF514AC4(iLocal_63))
			{
				unk_0x7D212A857AEA88CA(iLocal_63);
			}
			if (unk_0x117DAF3BF7232886(iLocal_62))
			{
		...
		case 6:
			...
			{
				unk_0x1F45B4626AC4A4C0(&iLocal_64);
			}
			if (unk_0x765F6FEEFF39224F(iLocal_65))
			{
				unk_0x26ABAE1D971CEACD(&iLocal_65);
			}
			if (func_28(2))
			{
				unk_0x1BFBC1E2615E22FC(vLocal_58, 200f, -1241212535, false);
			}
			break;
	}
}
