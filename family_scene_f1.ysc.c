	...
	if (Global_88735 != 8)
	{
		if (Global_88736 == -1)
		{
			...
			if (func_7())
			{
				...
				iVar12 = unk_0x9EC3B269A34A2BEE(0, iVar9);
				switch (iVar12)
				{
					case 0:
						iVar11 = 19;
...
void func_8(vector3 vParam0, vector3 vParam1, var uParam2)
{
	...
	{
		if (unk_0xCC2F38B1BC216A44(vParam0, vParam1, 1, 1))
		{
			*uParam2++;
			if (*uParam2 > 6)
			{
		...
		else if ((unk_0x1041083D5BD8F51E(0, vParam0, vParam1) || unk_0x1041083D5BD8F51E(2, vParam0, vParam1)) || unk_0x7EEE8B447AB73C25(vParam0, vParam1, joaat("weapon_grenadelauncher"), 1))
		{
			Global_88735 = 5;
		}
	}
...
void func_9(vector3 vParam0, vector3 vParam1)
{
	...
	if (unk_0x96C4B46F194803A7(unk_0x33CD235DF1E6A94E(), &iVar0, 1))
	{
		...
		{
			if (unk_0x1041083D5BD8F51E(3, vParam0, vParam1))
			{
				Global_88735 = 2;
			}
		}
...
void func_12(vector3 vParam0, vector3 vParam1, var uParam2)
{
	...
	{
		if (unk_0xFA97BC0260D58ADD(unk_0x33CD235DF1E6A94E(), vParam0, vParam1, 0, 1, 0))
		{
			if (*uParam2 < 0)
			{
				*uParam2 = unk_0xE3903F59E2F22150();
			}
			else if (unk_0xE3903F59E2F22150() > *uParam2 + 10000)
			{
				Global_88735 = 1;
			}
		}
...
void func_13(vector3 vParam0, vector3 vParam1)
{
	...
	if (unk_0x96C4B46F194803A7(unk_0x33CD235DF1E6A94E(), &iVar0, 1))
	{
		...
		{
			if (unk_0x7EEE8B447AB73C25(vParam0, vParam1, iVar0, 1))
			{
				Global_88735 = 0;
			}
		}
...
void func_32(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam5)
{
	...
	else if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		*uParam2 = unk_0x65F35477FEAD6F0F(unk_0x33CD235DF1E6A94E());
		if (!unk_0x786AF4A44E1B5B4B(sParam5))
		{
			...
			{
				*uParam3 = unk_0x30B9FCF52BAAEB11(vParam4, sParam5);
			}
		}
		func_34(iParam1);
		*uParam0 = 0;
	...
	if (unk_0xDE9B75BB528AC06E(*uParam2) && unk_0x5FC25A9F19EB39FA(*uParam2))
	{
		...
		else if (!unk_0x786AF4A44E1B5B4B(sParam5))
		{
			vVar1 = { unk_0xB720980077E47817(*uParam2, 0f, 0f, 0f) };
...
{
	iParam0->f_1 = (func_36(unk_0x0E4018692D92041D(*iParam0, 4)) - fParam1);
...
int func_41(int iParam0, vector3 vParam1, float fParam2)
{
	...
	if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vParam1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_93732)
...
void func_47()
{
	...
	func_48(&uLocal_153, 0, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
}
...
int func_69()
{
	...
	while (iVar6 < 11)
	{
		...
		if (unk_0x8FCF53827AC6136E(vVar1, 10f, iVar0, 0))
		{
			iVar7 = unk_0x68F833BFE3A28FEA(vVar1, 10f, iVar0, 0, 0, 1);
			if (unk_0x765F6FEEFF39224F(iVar7))
			{
				if (iVar3 == 825812850)
				{
					unk_0x1C8705F667F673EA(iVar7, 0f, 0f, 21f, 2, 1);
				}
				unk_0x26ABAE1D971CEACD(&iVar7);
			}
		}
		if (iVar2 != 226)
		{
		}
		else if (!unk_0x36CDBD83DF514AC4(iVar3))
		{
		}
		else
		{
			unk_0x046ED2CF120C8949(iVar3, 3, 1, 1);
			unk_0x1ABC36611CBE0E84(iVar3, 0f, 1, 1);
			if (((iVar6 != 6 && iVar6 != 7) && iVar6 != 8) && iVar6 != 9)
			{
				unk_0x7D212A857AEA88CA(iVar3);
			}
		}
		iVar6++;
	}
...
void func_74(int iParam0)
{
	...
	{
		if (unk_0xD76D6BCC14B95CE1(*iParam0, -2017877118) != 0)
		{
