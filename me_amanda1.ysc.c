...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			unk_0x41E36A540F8F323F(iLocal_296, 124, true);
		}
		func_525();
		switch (iLocal_292)
		{
...
void func_1()
{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_296) && unk_0xBC2FC12AD0FBF72E(iLocal_296))
	{
		func_2(2);
	}
	else if (func_526(iLocal_296) && func_526(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0x91BBD269506D61D2(iLocal_296, unk_0x33CD235DF1E6A94E(), 1))
		{
			if (unk_0x792D8D44CDA437C2(iLocal_296, 0, 2) || unk_0x1235B764F6C5379B(iLocal_296))
			{
				func_2(1);
			}
		}
...
void func_3()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			{
				if (unk_0xBC2FC12AD0FBF72E(iLocal_296))
				{
					iLocal_294 = 2;
				}
				else if (unk_0x91BBD269506D61D2(iLocal_296, unk_0x33CD235DF1E6A94E(), 1))
				{
					iLocal_294 = 1;
				}
			}
...
void func_4(bool bParam0, bool bParam1)
{
	...
	{
		if (func_526(iLocal_296) && unk_0xE214B9FCEDF6364A(iLocal_296))
		{
			unk_0x5D94F4D6FE7DA516(iLocal_296);
		}
		if (bParam1)
		{
			func_16(&iLocal_296, 1, 0, 1);
		}
		else if (func_526(iLocal_296) && unk_0x18FB647D79B09657(iLocal_296, vLocal_282, 50f, 50f, 50f, false, true, 0))
		{
			func_11(iLocal_296);
		}
		else
	...
	if (unk_0x765F6FEEFF39224F(iLocal_302))
	{
		func_6(&uLocal_55, 6);
		bVar0 = true;
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_302))
		{
			if (unk_0x71E0DAA57FE7D5C7(iLocal_302, 0) && !func_5(iLocal_302) == joaat("weapon_pistol"))
			{
				unk_0xED68CDDDE25A144E(iLocal_302);
				unk_0xBD4591245C650283(iLocal_302, 1193033728, 0);
			}
		}
		if (bParam0)
		{
	...
	unk_0x47B5CF91AC5D5FFA(vLocal_279, vLocal_280, 0);
	unk_0x252F9CE6A90B6B86(vLocal_279, vLocal_280, true, 0);
...
void func_35()
{
	...
	if (func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_296))
	{
		unk_0x41E36A540F8F323F(iLocal_296, 60, true);
		...
		switch (iLocal_293)
		{
			case 0:
				...
				iLocal_247 = unk_0x392F736BA9C4A337("DEFAULT_SCRIPTED_CAMERA", -1392.254f, 367.9411f, 75.0046f, -44.2648f, 0f, -119.873f, 48.4f, 0, 2);
				unk_0x189377BFBDC9127F(iLocal_247, true);
				...
				{
					unk_0x11C4AF4137F2A4B5(unk_0x33CD235DF1E6A94E(), iLocal_296, 0);
					unk_0x99414FB2D30425C1(&iVar2);
					unk_0x7E268975AF5EA74F(0, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 2f, 20000, 1048576000, 0, 1193033728);
					unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), 3000);
					unk_0x7E268975AF5EA74F(0, vLocal_239, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0xC734F59A13D39AEF(iVar2);
					unk_0x13A2D602CD10CBAC(iLocal_296, iVar2);
			...
			case 3:
				...
				if (unk_0xF0D230FB550CD6EB(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_51(iLocal_296, -828834893))
					{
						if (unk_0x61DFE32FB87BC784(iVar0))
						{
							...
							unk_0x13A2D602CD10CBAC(iLocal_296, iVar3);
				...
				else if (func_50(iLocal_296, vLocal_239, 1.5f) || func_52(&iLocal_334, 10000))
				{
					...
					unk_0x2F8A4DF7D0DFF0A8(iLocal_247, 0);
					func_36();
				}
				break;
			}
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_80(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_80(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_92(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_92(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_92(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_92(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_80(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
		...
		switch (iLocal_293)
		{
			case 0:
				...
				if (func_9(iVar1) && unk_0x17260B4EA0652E1C(iVar1))
				{
					...
					unk_0x87A1F7523B14E2C9(unk_0xFBB1F99A825CAB09(iVar1, true), 2.5f);
					unk_0x40EF19475E844CE3(unk_0xFBB1F99A825CAB09(iVar1, true), 2.5f);
				...
				iLocal_334 = -1;
				func_67(0f, 0f, 0f, 1, 1, 1, 1, 1, 1, 1, 1, 1, 0);
				iLocal_247 = unk_0x392F736BA9C4A337("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f, -110.4f, 48.4f, 0, 2);
				unk_0x189377BFBDC9127F(iLocal_247, true);
				unk_0x63F0B040CE6EDF0F(true, false, 3000, 1, 0, 0);
				if (func_8(iVar0))
				{
					...
					{
						unk_0x5FEE418CE11E6DDE(iLocal_296, 179, true);
					}
					func_65(iVar0, 1093140480, 1, 1056964608, 0, 1, 0);
				...
				else
				{
					...
					unk_0x31826EF4A8BC8E9F(iLocal_296);
					func_192(iLocal_296, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) + Vector(0f, 2f, 2f));
					unk_0x3C990C409B3845DE(iLocal_296, -155.84f);
					unk_0x3C990C409B3845DE(unk_0x33CD235DF1E6A94E(), -43.04f);
					unk_0x11C4AF4137F2A4B5(unk_0x33CD235DF1E6A94E(), iLocal_296, 0);
					unk_0x99414FB2D30425C1(&iVar3);
					unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), 3000);
					unk_0x7E268975AF5EA74F(0, vLocal_238, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0xC734F59A13D39AEF(iVar3);
					unk_0x13A2D602CD10CBAC(iLocal_296, iVar3);
					unk_0xA7A57E7757ED035E(&iVar3);
					unk_0x87A1F7523B14E2C9(vLocal_341, 2.5f);
					unk_0x40EF19475E844CE3(vLocal_341, 2.5f);
					iLocal_293 = 2;
				}
				break;
				...
				if (unk_0xF0D230FB550CD6EB(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_51(iLocal_296, 242628503))
					{
						if (unk_0x61DFE32FB87BC784(iVar0))
						{
							...
							unk_0x13A2D602CD10CBAC(iLocal_296, iVar4);
...
void func_204()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_526(iLocal_296))
			{
				if (unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
				{
			...
			iLocal_258 = unk_0xE3903F59E2F22150() + 1000;
			iLocal_293 = 1;
			break;
		...
		case 1:
			if (func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_296))
			{
				...
				if (unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
				{
					if (func_212(unk_0x33CD235DF1E6A94E(), iLocal_296) < 5f)
					{
						func_211();
					}
				}
				else if (((func_8(iLocal_298) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0)) && unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0)) || (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0) && !unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0)))
				{
					func_211();
				}
				func_209();
				if (func_212(unk_0x33CD235DF1E6A94E(), iLocal_296) > 200f)
				{
					func_2(4);
				}
			}
...
void func_205()
{
	...
	if (unk_0xE3903F59E2F22150() > iLocal_273)
	{
		if ((((func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_296)) && unk_0xF0D230FB550CD6EB(iLocal_296, 0)) && !func_208()) && func_212(unk_0x33CD235DF1E6A94E(), iLocal_296) < 10f)
		{
			iVar0 = unk_0xF2C96862595654B4(iLocal_296, 0);
			if (func_8(iVar0) && !unk_0xEE984ED4E4A374BE(unk_0x33CD235DF1E6A94E(), iVar0))
			{
				if (unk_0x91BBD269506D61D2(iVar0, unk_0x33CD235DF1E6A94E(), 1))
				{
					...
					iLocal_273 = unk_0xE3903F59E2F22150() + 5000;
					unk_0x0D847D71D9E6142E(iLocal_298);
				}
			}
...
void func_209()
{
	if (((func_9(iLocal_298) && func_526(iLocal_296)) && unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0)) && func_212(unk_0x33CD235DF1E6A94E(), iLocal_296) < 10f)
	{
		if (unk_0xE3903F59E2F22150() > iLocal_258)
		{
			if (!func_208())
			{
				func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				if ((func_210("MEA1_03", 0, 0) || func_210("MEA1_05", 0, 0)) || func_210("MEA1_06", 0, 0))
				{
					...
					{
						iLocal_258 = unk_0xE3903F59E2F22150() + 9000;
					}
				}
...
void func_215()
{
	unk_0x140D4A6561E11695(iLocal_296, func_220());
	unk_0x9AA80CA39F863D9D(iLocal_296, 0);
	unk_0xDD02EC6C22FD1487(iLocal_296, 1);
	unk_0xF0BE7CB40DE62A2F(iLocal_296, false);
	unk_0x139C6344B571F912(iLocal_296, 0);
	unk_0x8F470523AA8D48AF(iLocal_296, 0);
...
void func_227()
{
	...
	if (func_526(iLocal_296))
	{
		unk_0x61D0E1067EE522FE(iLocal_296, 1);
	}
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_251())
			{
				if (unk_0xE9CCF312047EBEE0(sLocal_278))
				{
					unk_0x511559F67646F1C0(iLocal_296, sLocal_278, 1048576000);
				}
				iLocal_270 = unk_0xE3903F59E2F22150() + 20000;
		...
		case 1:
			if (iLocal_317)
			{
				if (unk_0xE3903F59E2F22150() > iLocal_246)
				{
					if (!func_208())
					{
						if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0) && unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0))
						{
			...
			{
				iLocal_311 = unk_0xE3903F59E2F22150() + 1000;
				unk_0xBADACD2849BC0E8C(unk_0x95B959F18401C09A());
				iLocal_293 = 2;
			}
			break;
		...
		case 2:
			if (func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_296))
			{
				...
				if (!unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
				{
					if (func_8(iLocal_298))
					{
						if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0))
						{
							func_251();
						}
					}
				...
				if (func_212(unk_0x33CD235DF1E6A94E(), iLocal_296) > 15f)
				{
					func_231();
					iLocal_293 = 0;
					iLocal_292 = 5;
...
void func_228()
{
	if (func_526(iLocal_306) && func_212(unk_0x33CD235DF1E6A94E(), iLocal_306) > 100f)
	{
		func_16(&iLocal_306, 0, 0, 1);
	}
	if (func_526(iLocal_302) && func_212(unk_0x33CD235DF1E6A94E(), iLocal_302) > 100f)
	{
...
void func_229()
{
	...
	if (((iLocal_337 && !unk_0xC4B7D5901EDA35B5()) && func_526(unk_0x33CD235DF1E6A94E())) && func_526(iLocal_296))
	{
		if (unk_0x5C415D10D5CBF689(unk_0x33CD235DF1E6A94E()))
		{
			iVar0 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
			if ((func_8(iVar0) && !unk_0x10930B9CAD4111C2(iLocal_296, iVar0, 1)) && !func_230(iVar0))
			{
...
void func_233()
{
	...
	if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vVar0, 1f, 1f, 2f, true, true, 0) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vVar0, true) < 2.75f)
	{
		bVar1 = false;
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			...
			if (func_8(iVar2))
			{
				if (unk_0x156573D1AADB54ED(iVar2))
				{
					bVar1 = true;
				}
			}
...
void func_234()
{
	...
	{
		if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_310, 0) && unk_0x10930B9CAD4111C2(iLocal_296, iLocal_310, 0))
		{
			if (((unk_0x67001C5CC88C66A8(iLocal_310, 2, 5000) || unk_0x67001C5CC88C66A8(iLocal_310, 3, 5000)) || unk_0x67001C5CC88C66A8(iLocal_310, 0, 5000)) || unk_0x67001C5CC88C66A8(iLocal_310, 1, 5000))
			{
				if (iLocal_313 == iLocal_312)
				{
					iLocal_312++;
					iLocal_315 = unk_0xE3903F59E2F22150() + 5000;
				}
				else if (unk_0xE3903F59E2F22150() > iLocal_315 && !func_208())
				{
					func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
void func_237()
{
	...
	if (func_526(unk_0x33CD235DF1E6A94E()) && unk_0xE3903F59E2F22150() > iLocal_311)
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			iVar0 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
			if (iVar0 != iLocal_310)
			{
				...
				else
				{
					if (func_8(iLocal_310))
					{
						unk_0x65F544B458249682(&iLocal_310);
					}
					iLocal_310 = iVar0;
				}
			}
...
void func_238()
{
	if ((((iLocal_272 < 3 && !func_208()) && func_236()) && func_239()) && unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
	{
		if (unk_0xE3903F59E2F22150() > iLocal_270)
		{
			func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
int func_239()
{
	...
	{
		iVar0 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
		if (func_8(iVar0) && unk_0x10930B9CAD4111C2(iLocal_296, iVar0, 0))
		{
			return 1;
		}
	}
...
void func_240()
{
	...
	if ((((iLocal_261 < 3 && unk_0xE3903F59E2F22150() > iLocal_259) && func_236()) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0)) && func_239())
	{
		iVar0 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
		if (func_8(iVar0) && func_64(unk_0x541D5C57194E73C4(iVar0)))
		{
			bLocal_262 = unk_0x162506C338A20AF7(iVar0);
			if (bLocal_262)
			{
				if (!func_208() && bLocal_263 == 0)
				{
					...
					if (func_235(&uLocal_55, "MEA1AUD", "MEA1_SIREN", sLocal_260[iLocal_261], 7, 0, 0))
					{
						...
						iLocal_259 = unk_0xE3903F59E2F22150() + 9000;
					}
				}
			}
			else
	...
	else if (bLocal_263 && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		iVar1 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
		if (func_8(iVar1) && func_64(unk_0x541D5C57194E73C4(iVar1)))
		{
			bLocal_263 = unk_0x162506C338A20AF7(iVar1);
		}
	}
}
...
void func_241()
{
	if (((iLocal_257 < 3 && unk_0xE3903F59E2F22150() > iLocal_254) && func_236()) && func_239())
	{
			...
			if (iLocal_255 > 180)
			{
				if (!func_208() && !func_210("MEA1_04", 0, 0))
				{
					...
					else if (func_235(&uLocal_55, "MEA1AUD", "MEA1_STILL", sLocal_256[iLocal_257], 7, 0, 0))
					{
						iLocal_257++;
						iLocal_255 = 0;
						iLocal_254 = unk_0xE3903F59E2F22150() + 9000;
					}
				}
			}
		}
...
void func_242()
{
	...
	if (((iLocal_253 < 4 && unk_0xE3903F59E2F22150() > iLocal_251) && func_236()) && func_239())
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xD93CFE80D83E2106(unk_0x33CD235DF1E6A94E()))
		{
			...
			if (func_8(iVar0))
			{
				if (unk_0x0D386FBDF1E8CD84(iVar0))
				{
					if (!func_208())
					{
						if (((((iLocal_253 == 0 && func_8(iLocal_298)) && unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0)) && func_243(iLocal_296, 0) == 2) || (((iLocal_253 == 1 || iLocal_253 == 2) && unk_0xF0D230FB550CD6EB(iLocal_296, 0)) && (func_243(iLocal_296, 0) == 2 || func_243(iLocal_296, 0) == 1))) || (iLocal_253 == 3 && unk_0x66D2F163EA29BDEE(unk_0x33CD235DF1E6A94E())))
						{
							func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
							if (func_235(&uLocal_55, "MEA1AUD", "MEA1_CRASH", sLocal_252[iLocal_253], 7, 0, 0))
							{
								iLocal_253++;
								iLocal_251 = unk_0xE3903F59E2F22150() + 9000;
							}
						}
						else
						{
...
void func_244()
{
	if ((((iLocal_241 < 4 && !func_208()) && func_236()) && (func_239() || func_245())) && unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
	{
		if (iLocal_242 == iLocal_241)
		{
			iLocal_241++;
			iLocal_246 = unk_0xE3903F59E2F22150() + 2000;
		}
		else if (unk_0xE3903F59E2F22150() > iLocal_246)
		{
			func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
int func_245()
{
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) || unk_0xF0D230FB550CD6EB(iLocal_296, 0))
	{
		return 0;
	}
	return 1;
...
void func_246()
{
	if (iLocal_324)
	{
		if (func_208())
		{
			if (unk_0xE3903F59E2F22150() > iLocal_327)
			{
				unk_0xE9739440E5BF08EE(iLocal_326, "MICHAEL_EVENT_AMANDA_REMOVE_HANDCUFFS_MASTER", iLocal_296, 0, false, 0);
				iLocal_324 = 0;
			}
		}
	}
		...
		else if (!func_208())
		{
			...
			if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0) && unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0))
			{
				if (func_252(&uLocal_55, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2", "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) || func_52(&iLocal_332, 5000))
				{
					...
					unk_0xAE5B044AA2973E2A(0, unk_0x2CA911E7569D12EA(iLocal_298, 2f, 2f, 0f), 2000, 2050, 4);
					...
					unk_0x13A2D602CD10CBAC(iLocal_296, iVar0);
					unk_0xA7A57E7757ED035E(&iVar0);
					iLocal_327 = unk_0xE3903F59E2F22150() + 9000;
					iLocal_324 = 1;
					return 1;
				}
			}
...
void func_256()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			func_217(&uLocal_343);
			iLocal_293 = 1;
			iLocal_291 = unk_0xE3903F59E2F22150() + 10000;
			iLocal_332 = -1;
			break;
		...
		case 1:
			...
			if (iLocal_325)
			{
				...
				{
					iLocal_326 = unk_0x8CCC0A0504C52531();
					iLocal_325 = 0;
				}
			}
			func_262();
			if (func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_296))
			{
				...
				if (unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
				{
					if (func_212(unk_0x33CD235DF1E6A94E(), iLocal_296) > (15f * 2f))
					{
						func_231();
						iLocal_293 = 0;
						iLocal_292 = 5;
				...
				else if (((func_8(iLocal_298) && unk_0xEE984ED4E4A374BE(iLocal_296, iLocal_298)) && !unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0)) && !func_255(iLocal_298))
				{
					func_231();
					iLocal_293 = 0;
					iLocal_292 = 5;
	...
	func_229();
	func_205();
	if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, false, true, 0) || unk_0x18FB647D79B09657(iLocal_296, -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, false, true, 0))
	{
...
void func_257()
{
	if (func_526(iLocal_296) && !unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
	{
		if (func_8(iLocal_298))
		{
			if (((unk_0x67001C5CC88C66A8(iLocal_298, 2, 30000) || unk_0x67001C5CC88C66A8(iLocal_298, 3, 30000)) || unk_0x67001C5CC88C66A8(iLocal_298, 0, 7000)) || unk_0x67001C5CC88C66A8(iLocal_298, 1, 40000))
			{
				func_2(5);
			}
		}
...
void func_258()
{
	if (((((func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_302)) && !unk_0x17260B4EA0652E1C(iLocal_302)) && !unk_0xF7C907E9E8E2BB22(iLocal_302)) && !unk_0x96154DF4E29A9998(iLocal_302)) && !unk_0x3AF2B3B68DD52355(iLocal_302))
	{
		if (unk_0xE3903F59E2F22150() > iLocal_291)
		{
			if (!func_5(iLocal_302) == joaat("weapon_pistol"))
			{
				unk_0x8A5F86362E03852B(iLocal_302, true);
				unk_0x697EBA5CF1A6AB57(iLocal_302, joaat("weapon_pistol"), -1, false, true);
			}
			if (!unk_0x71E0DAA57FE7D5C7(iLocal_302, 0))
			{
				unk_0xED68CDDDE25A144E(iLocal_302);
				unk_0xFEC326A8E632C9AE(iLocal_302, unk_0x33CD235DF1E6A94E());
...
void func_259()
{
	if (((((iLocal_266 < 9 && !func_208()) && func_236()) && func_239()) && unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) > 0) && !func_261(unk_0x33CD235DF1E6A94E()))
	{
		if (unk_0xE3903F59E2F22150() > iLocal_264)
		{
			func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			iLocal_268 = unk_0x9EC3B269A34A2BEE(0, 4);
			...
			{
				iLocal_264 = unk_0xE3903F59E2F22150() + 9000;
				iLocal_266++;
...
void func_262()
{
	...
	{
		if ((func_264(iLocal_306, 1090519040, 1097859072) || unk_0x5DACF31D3AC5ED8D(unk_0x33CD235DF1E6A94E())) || (func_526(iLocal_302) && unk_0x5DACF31D3AC5ED8D(iLocal_302)))
		{
			if (unk_0x1CE8F0A08E65CA6A(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0x1CE8F0A08E65CA6A(iLocal_306, sLocal_277, sLocal_233, 2))
			{
				unk_0x0C6BB9365C4A5F6E(iLocal_306, -8f, 1);
			}
			unk_0xECCD4FDA45197F97(iLocal_306, unk_0x33CD235DF1E6A94E(), 500f, -1, 0, 0);
			func_263(1);
		}
	}
}
...
{
	if (((((func_526(iLocal_302) && func_526(unk_0x33CD235DF1E6A94E())) && !unk_0x17260B4EA0652E1C(iLocal_302)) && !unk_0xF7C907E9E8E2BB22(iLocal_302)) && !unk_0x96154DF4E29A9998(iLocal_302)) && !unk_0x3AF2B3B68DD52355(iLocal_302))
	{
		if (!func_5(iLocal_302) == joaat("weapon_pistol"))
		{
			unk_0x8A5F86362E03852B(iLocal_302, true);
	...
	if ((func_526(iLocal_306) && !unk_0xD82CBCB7E04DDA8A(iLocal_306)) && !unk_0x71E0DAA57FE7D5C7(iLocal_306, 0))
	{
		if (unk_0x1CE8F0A08E65CA6A(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0x1CE8F0A08E65CA6A(iLocal_306, sLocal_277, sLocal_233, 2))
		{
			unk_0x0C6BB9365C4A5F6E(iLocal_306, -8f, 1);
...
int func_264(int iParam0, float fParam1, float fParam2)
{
	if (func_9(iParam0))
	{
		if (unk_0x416C37C19CCE0077(unk_0xFBB1F99A825CAB09(iParam0, true), fParam1, 0))
		{
			return 1;
		}
...
int func_267(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_201(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_201(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_269()
{
	if ((iLocal_320 && unk_0xE3903F59E2F22150() > iLocal_316) && func_239())
	{
		func_6(&uLocal_55, 4);
...
void func_270()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			func_359();
			iLocal_248 = unk_0xE3903F59E2F22150() + 7000;
			iVar0 = unk_0x8918EC905FC8975D();
			if (func_8(iVar0) && unk_0x541D5C57194E73C4(iVar0) != iLocal_299)
			{
		...
		case 1:
			...
			func_296();
			func_292();
			if (((func_526(unk_0x33CD235DF1E6A94E()) && func_8(iLocal_298)) && unk_0x91BBD269506D61D2(iLocal_298, unk_0x33CD235DF1E6A94E(), 1)) && !unk_0x3AF2B3B68DD52355(unk_0x33CD235DF1E6A94E()))
			{
				unk_0xF70578F5CD9822CB(iLocal_298, false);
				func_263(1);
			}
			func_300();
			break;
		...
		case 2:
			if (func_8(iLocal_298))
			{
				if (func_526(iLocal_302))
				{
					...
					{
						func_291();
						iLocal_316 = unk_0xE3903F59E2F22150() + 1000;
						iLocal_221 = 4;
						iLocal_234 = 5;
					}
				}
...
void func_271()
{
	...
	if (func_274(unk_0x33CD235DF1E6A94E(), vLocal_222, 100f))
	{
		if (iLocal_323)
		{
			func_273(0);
	...
	else if (func_208())
	{
		if (!iLocal_323)
		{
			Var0 = { func_225() };
			sVar1 = func_272(&Var0);
			if (unk_0xCE3CFF625BEBAA04(sVar1, "MEA1_SCENE"))
			{
				func_273(1);
				iLocal_323 = 1;
			}
...
void func_275()
{
	...
	iVar0 = unk_0x8918EC905FC8975D();
	if (((((unk_0xBC2FC12AD0FBF72E(iLocal_302) || unk_0xBC2FC12AD0FBF72E(iLocal_306)) || func_277(iLocal_302, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_277(iLocal_306, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || ((func_8(iVar0) && func_8(iLocal_298)) && unk_0x4ED4D1D8B2023FD8(iVar0, iLocal_298))) || (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) > 0 && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_281, true) < 30f))
	{
		if (!unk_0x10930B9CAD4111C2(iLocal_296, iLocal_298, 0))
		{
			if (!unk_0x731F434EAFE6E9FE(iLocal_296, func_220()))
			{
				func_231();
				iLocal_221 = 5;
				iLocal_234 = 5;
				if (unk_0xDB4C79A9697E6A55(iLocal_220))
				{
					fVar1 = unk_0x4EDDCE9AAE0FC976(iLocal_220);
					unk_0x0C6BB9365C4A5F6E(iLocal_296, -1000f, 1);
					unk_0x0C6BB9365C4A5F6E(iLocal_298, -1000f, 1);
					if (fVar1 > 0.75f)
					{
						unk_0x0C6BB9365C4A5F6E(iLocal_296, -1000f, 0);
						func_276(iLocal_296, iLocal_298, 2);
					}
					else
					{
						unk_0x0C6BB9365C4A5F6E(iLocal_296, -1000f, 1);
						unk_0x23298AB8A7D0F403(iLocal_296, true, 0);
					}
					if (func_526(iLocal_302))
					{
						unk_0x0C6BB9365C4A5F6E(iLocal_302, -1000f, 1);
					}
					if (func_526(iLocal_306))
					{
						unk_0x0C6BB9365C4A5F6E(iLocal_306, -1000f, 1);
					}
				}
				unk_0xF70578F5CD9822CB(iLocal_296, false);
				unk_0xF70578F5CD9822CB(iLocal_298, false);
				if ((func_8(iVar0) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iVar0, 0)) && unk_0x67FFBB75D2430704(iVar0, 0, 0))
				{
					...
					{
						unk_0xC838CE9837D0ABAF(iLocal_296, iVar0, 20000, 0, 3f, 1, 0);
					}
				}
				else if (func_212(iLocal_296, unk_0x33CD235DF1E6A94E()) > 10f)
				{
					if (!func_51(iLocal_296, 1227113341))
					{
						unk_0x3C0F6044C54799A8(iLocal_296, unk_0x33CD235DF1E6A94E(), 20000, 7f, 2f, 1073741824, 0);
					}
				}
				else
				{
					unk_0xED68CDDDE25A144E(iLocal_296);
				}
				func_215();
				func_34(&iLocal_295);
				iLocal_322 = 1;
...
bool func_280(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (unk_0xE3903F59E2F22150() - Local_52[iVar2 /*4*/].f_3) < iParam4);
}
...
int func_284(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_201(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_291()
{
	...
	if (func_526(unk_0x33CD235DF1E6A94E()))
	{
		...
		else
		{
			...
			if (func_526(iLocal_296))
			{
				unk_0xE0DAC4ABE9900D9A(iLocal_296);
			}
			unk_0x78713C03966ED44F(vLocal_329, vLocal_330, fLocal_331, 1);
			iLocal_325 = 1;
			iLocal_320 = 1;
			iLocal_332 = -1;
			if ((((func_526(iLocal_302) && !unk_0x17260B4EA0652E1C(iLocal_302)) && !unk_0xF7C907E9E8E2BB22(iLocal_302)) && !unk_0x96154DF4E29A9998(iLocal_302)) && !unk_0x3AF2B3B68DD52355(iLocal_302))
			{
				if (!func_51(iLocal_302, 1392476864))
				{
					if (unk_0x1CE8F0A08E65CA6A(iLocal_302, sLocal_277, sLocal_228, 2) || unk_0x1CE8F0A08E65CA6A(iLocal_302, sLocal_277, sLocal_232, 2))
					{
						unk_0x0C6BB9365C4A5F6E(iLocal_302, -8f, 1);
					}
					unk_0x99414FB2D30425C1(&iVar0);
					unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), 1500);
					unk_0xFEC326A8E632C9AE(0, unk_0x33CD235DF1E6A94E());
					unk_0xC734F59A13D39AEF(iVar0);
					unk_0x13A2D602CD10CBAC(iLocal_302, iVar0);
					unk_0xA7A57E7757ED035E(&iVar0);
				}
			}
			if (func_526(iLocal_306) && !unk_0xD82CBCB7E04DDA8A(iLocal_306))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0x1CE8F0A08E65CA6A(iLocal_306, sLocal_277, sLocal_233, 2))
				{
					unk_0x0C6BB9365C4A5F6E(iLocal_306, -8f, 1);
...
void func_292()
{
	...
	if (((func_8(iLocal_298) && func_526(unk_0x33CD235DF1E6A94E())) && func_526(iLocal_302)) && func_526(iLocal_306))
	{
		switch (iLocal_250)
		{
			case 0:
				if (func_208())
				{
					...
					{
						Local_249 = { func_295() };
						if ((((((((func_294(unk_0x33CD235DF1E6A94E(), iLocal_298, 5f, 1) || func_294(unk_0x33CD235DF1E6A94E(), iLocal_302, 5f, 1)) && !unk_0xCE3CFF625BEBAA04(&Local_249, "MEA1_SCENE_1")) && !unk_0xCE3CFF625BEBAA04(&Local_249, "MEA1_SCENE_2")) && !unk_0xCE3CFF625BEBAA04(&Local_249, "MEA1_SCENE_3")) && !unk_0xCE3CFF625BEBAA04(&Local_249, "MEA1_SCENE_4")) && !unk_0xCE3CFF625BEBAA04(&Local_249, "MEA1_SCENE_5")) && !unk_0xCE3CFF625BEBAA04(&Local_249, "MEA1_SCENE_6")) && func_279(iLocal_302, 1126825984))
						{
			...
			case 1:
				fVar2 = func_213(unk_0x33CD235DF1E6A94E(), iLocal_302, 1);
				fVar3 = func_213(unk_0x33CD235DF1E6A94E(), iLocal_298, 1);
				bVar4 = false;
				func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				if (fVar2 < fVar3)
				{
				...
				if (bVar4)
				{
					unk_0xC4A347124F39D998(iLocal_302, unk_0x33CD235DF1E6A94E(), 2000, 2048, 4);
					iLocal_250 = 2;
				}
				break;
			...
			case 2:
				if (!func_208())
				{
					if (!unk_0xCE3CFF625BEBAA04(&Local_249, "") && !unk_0xCE3CFF625BEBAA04(&Local_249, "NULL"))
					{
						func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
void func_296()
{
	...
	if (func_526(unk_0x33CD235DF1E6A94E()) && iLocal_221 != 5)
	{
		bVar0 = false;
		if ((func_526(iLocal_302) && unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_302)) || (((func_526(iLocal_306) && unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_306)) && !((func_277(iLocal_302, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_277(iLocal_306, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || unk_0x5DACF31D3AC5ED8D(unk_0x33CD235DF1E6A94E()))) && unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) == 0))
		{
			if (unk_0x3AF2B3B68DD52355(iLocal_302) || unk_0x3AF2B3B68DD52355(iLocal_306))
			{
				bVar0 = true;
			}
			else if (iLocal_335)
		...
		if (((((((((((unk_0x765F6FEEFF39224F(iLocal_302) && unk_0x91BBD269506D61D2(iLocal_302, unk_0x33CD235DF1E6A94E(), 1)) || (unk_0x765F6FEEFF39224F(iLocal_302) && unk_0xBC2FC12AD0FBF72E(iLocal_302))) || func_289(iLocal_302, 1, 0, 0, 0)) || func_278(iLocal_302, 1126825984)) || func_278(iLocal_306, 1126825984)) || (unk_0x765F6FEEFF39224F(iLocal_306) && unk_0x91BBD269506D61D2(iLocal_306, unk_0x33CD235DF1E6A94E(), 1))) || (unk_0x765F6FEEFF39224F(iLocal_306) && unk_0xBC2FC12AD0FBF72E(iLocal_306))) || unk_0x5DACF31D3AC5ED8D(unk_0x33CD235DF1E6A94E())) || bVar0) || func_264(iLocal_306, 1090519040, 1097859072)) || unk_0x5DACF31D3AC5ED8D(unk_0x33CD235DF1E6A94E()))
		{
			unk_0x47B5CF91AC5D5FFA(vLocal_279, vLocal_280, 0);
			unk_0x252F9CE6A90B6B86(vLocal_279, vLocal_280, true, 0);
			if (bVar0)
			...
			if ((((func_526(iLocal_302) && !unk_0x17260B4EA0652E1C(iLocal_302)) && !unk_0xF7C907E9E8E2BB22(iLocal_302)) && !unk_0x96154DF4E29A9998(iLocal_302)) && !unk_0x3AF2B3B68DD52355(iLocal_302))
			{
				...
				if (!unk_0x71E0DAA57FE7D5C7(iLocal_302, 0) && !func_51(iLocal_302, 1392476864))
				{
					func_231();
					unk_0x8A5F86362E03852B(iLocal_302, true);
					unk_0x697EBA5CF1A6AB57(iLocal_302, joaat("weapon_pistol"), -1, false, true);
...
void func_297()
{
	if ((func_526(unk_0x33CD235DF1E6A94E()) && func_8(iLocal_298)) && func_526(iLocal_296))
	{
		if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 0) || func_255(iLocal_298))
		{
			func_231();
			func_34(&iLocal_295);
			unk_0xF70578F5CD9822CB(iLocal_298, false);
		...
		else if (func_294(unk_0x33CD235DF1E6A94E(), iLocal_298, 6.5f, 1))
		{
			if (iLocal_321)
			{
				unk_0xF70578F5CD9822CB(iLocal_298, false);
		...
		{
			unk_0xF70578F5CD9822CB(iLocal_298, true);
			iLocal_321 = 1;
		}
	}
}
...
void func_298()
{
	if ((((func_526(iLocal_302) && func_526(iLocal_306)) && func_526(iLocal_296)) && func_8(iLocal_298)) && unk_0xE9CCF312047EBEE0(sLocal_277))
	{
		switch (iLocal_221)
		{
			case 0:
				func_299();
				iLocal_220 = unk_0x38A6890195DD00D1(vLocal_222, vLocal_223, 2);
				unk_0x6359F1F7F5174D4A(iLocal_220, true);
				unk_0x34C803C2BC1CAFB2(iLocal_220, false);
				iLocal_328 = 1;
				unk_0x08798CBF817BA887(iLocal_302, iLocal_220, sLocal_277, sLocal_224, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x08798CBF817BA887(iLocal_306, iLocal_220, sLocal_277, sLocal_225, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x08798CBF817BA887(iLocal_296, iLocal_220, sLocal_277, sLocal_226, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xCF73ED7F74F29138(iLocal_298, iLocal_220, sLocal_227, sLocal_277, 1000f, -8f, 1, 1148846080);
				iLocal_333 = -1;
				iLocal_234 = 1;
				iLocal_221 = 2;
				break;
			...
			case 1:
				func_299();
				iLocal_220 = unk_0x38A6890195DD00D1(vLocal_222, vLocal_223, 2);
				unk_0x6359F1F7F5174D4A(iLocal_220, false);
				unk_0x34C803C2BC1CAFB2(iLocal_220, false);
				unk_0x08798CBF817BA887(iLocal_302, iLocal_220, sLocal_277, sLocal_228, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0x08798CBF817BA887(iLocal_306, iLocal_220, sLocal_277, sLocal_229, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x08798CBF817BA887(iLocal_296, iLocal_220, sLocal_277, sLocal_230, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0xCF73ED7F74F29138(iLocal_298, iLocal_220, sLocal_231, sLocal_277, 1000f, -8f, 1, 1148846080);
				unk_0xDD450B93C16ACEA7(iLocal_220, 0.622f);
				iLocal_221 = 3;
				break;
			...
			case 3:
				...
				if (!unk_0xDB4C79A9697E6A55(iLocal_220))
				{
					iLocal_220 = unk_0x38A6890195DD00D1(vLocal_222, vLocal_223, 2);
					unk_0x6359F1F7F5174D4A(iLocal_220, true);
					unk_0x08798CBF817BA887(iLocal_302, iLocal_220, sLocal_277, sLocal_232, 1000f, -4f, 1, 16, 1148846080, 0);
					unk_0x08798CBF817BA887(iLocal_306, iLocal_220, sLocal_277, sLocal_233, 1000f, -4f, 1, 16, 1148846080, 0);
					if (unk_0x67FFBB75D2430704(iLocal_298, 2, 0))
					{
						unk_0x094626C0798AE1F8(iLocal_296, iLocal_298, 2);
						unk_0xB40411FADDCA9CC8(iLocal_298, 3, 1);
						unk_0x9152A6430680BF0A(iLocal_298, 1);
						unk_0xC4A347124F39D998(iLocal_296, unk_0x33CD235DF1E6A94E(), -1, 2050, 4);
					}
					if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_298, 1))
					{
				...
				else if (unk_0x4EDDCE9AAE0FC976(iLocal_220) >= 0.9f)
				{
					if (unk_0x1CE8F0A08E65CA6A(iLocal_296, sLocal_277, sLocal_230, 2))
					{
						unk_0x0C6BB9365C4A5F6E(iLocal_296, -1000f, 0);
						if (unk_0x67FFBB75D2430704(iLocal_298, 2, 0))
						{
				...
				else if (unk_0x4EDDCE9AAE0FC976(iLocal_220) >= 0.85f)
				{
					if (unk_0x1CE8F0A08E65CA6A(iLocal_298, sLocal_277, sLocal_231, 2))
					{
						unk_0x23298AB8A7D0F403(iLocal_296, false, 0);
						unk_0x0C6BB9365C4A5F6E(iLocal_298, -4f, 1);
						unk_0xB40411FADDCA9CC8(iLocal_298, 3, 1);
					}
				}
				break;
			...
			case 4:
				...
				if (func_526(iLocal_302))
				{
					unk_0x11C4AF4137F2A4B5(iLocal_302, unk_0x33CD235DF1E6A94E(), -1);
				}
				iLocal_221 = 5;
				break;
			}
	...
	switch (iLocal_234)
	{
		...
		case 1:
			if (!func_208())
			{
				...
				{
					if (func_274(unk_0x33CD235DF1E6A94E(), vLocal_222, 90f))
					{
						func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				...
				else if (func_274(unk_0x33CD235DF1E6A94E(), vLocal_222, (90f * 2f)))
				{
					func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
		...
		case 2:
			if (!func_208())
			{
				if ((func_274(unk_0x33CD235DF1E6A94E(), vLocal_222, 90f) && !func_210("MEA1_02", 0, 0)) && !func_210("MEA1_03", 0, 0))
				{
					func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
		...
		case 3:
			if (func_208())
			{
				...
				{
					Local_235 = { func_224() };
					if (unk_0xCE3CFF625BEBAA04(&Local_235, "") || unk_0xCE3CFF625BEBAA04(&Local_235, "NULL"))
					{
						iLocal_234 = 5;
					}
					else
		...
		case 4:
			if (func_208())
			{
				if (!func_274(unk_0x33CD235DF1E6A94E(), vLocal_222, 91f))
				{
					Local_235 = { func_224() };
					if (unk_0xCE3CFF625BEBAA04(&Local_235, "") || unk_0xCE3CFF625BEBAA04(&Local_235, "NULL"))
					{
...
void func_304()
{
	...
	{
		if (unk_0x10930B9CAD4111C2(iLocal_302, iLocal_298, 0))
		{
			unk_0xF70578F5CD9822CB(iLocal_298, false);
			if (func_51(iLocal_302, -258271821))
			{
				if (unk_0xE3903F59E2F22150() > iLocal_286)
				{
					func_2(3);
				}
			}
			...
			{
				unk_0x21D56A8927F5A92A(iLocal_302, iLocal_298, 30f, 786469);
				iLocal_286 = unk_0xE3903F59E2F22150() + 2000;
			}
		}
	}
}
...
void func_305()
{
	...
	if (iLocal_319)
	{
		unk_0x47B5CF91AC5D5FFA(vLocal_279, vLocal_280, 0);
		unk_0x252F9CE6A90B6B86(vLocal_279, vLocal_280, true, 0);
		if ((func_526(iLocal_302) && func_8(iLocal_298)) && unk_0x67FFBB75D2430704(iLocal_298, -1, 0))
		{
			func_231();
			func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			...
			{
				unk_0x99414FB2D30425C1(&iVar0);
				unk_0xC838CE9837D0ABAF(0, iLocal_298, 20000, -1, 1f, 1, 0);
				unk_0x21D56A8927F5A92A(0, iLocal_298, 50f, 786597);
				unk_0xC734F59A13D39AEF(iVar0);
				unk_0x13A2D602CD10CBAC(iLocal_302, iVar0);
				unk_0xA7A57E7757ED035E(&iVar0);
				unk_0xF70578F5CD9822CB(iLocal_298, false);
	...
	if (unk_0x765F6FEEFF39224F(unk_0x8918EC905FC8975D()))
	{
		if (unk_0x91D5C8283D19AF49(unk_0x8918EC905FC8975D(), 0))
		{
			if (func_358(24) != unk_0x8918EC905FC8975D())
			{
				if (iParam2 == 1)
				{
					if (func_355(unk_0xFBB1F99A825CAB09(unk_0x8918EC905FC8975D(), true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_309(unk_0x8918EC905FC8975D(), vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_333(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_360(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_413(unk_0xD178EF744F20B712(), 1);
			if (iVar4 != -1)
			{
...
void func_377(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_382(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x078B659F6F2C8960(iVar5, &Var7) && !func_379(Var7.f_1)) && iVar9 < 51)
			{
...
int func_387(var uParam0)
{
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (func_410())
		{
			*uParam0 = func_393(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), 6, -1, 0, 1, -1);
...
int func_393(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_409(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(vParam0, func_394(iVar0, 0), true);
...
void func_423()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			unk_0x1C95CD840303FC37(iLocal_295, "MEA1_AMA");
			unk_0xB9E84A421C105943(iLocal_295, 3);
			unk_0x1C316779E36C1967(iLocal_295, true);
			func_430(&iLocal_295, -838.47f, -177.11f, 36.92f, 31.44f);
			func_428();
			iLocal_246 = unk_0xE3903F59E2F22150() + 10000;
			iLocal_244 = -1;
			iLocal_245 = -1;
			iLocal_322 = 0;
			iLocal_323 = 0;
		...
		case 1:
			if (func_526(unk_0x33CD235DF1E6A94E()))
			{
				if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_281, true) < 200f)
				{
					iLocal_293 = 2;
				}
			}
		...
		case 2:
			func_425();
			if ((((func_526(unk_0x33CD235DF1E6A94E()) && func_526(iLocal_296)) && unk_0x765F6FEEFF39224F(iLocal_306)) && unk_0x765F6FEEFF39224F(iLocal_302)) && func_8(iLocal_298))
			{
				if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_281, true) < 30f)
				{
					iLocal_332 = -1;
					iLocal_293 = 0;
					iLocal_292 = 2;
...
void func_424()
{
	if ((((iLocal_244 < 1 && func_526(unk_0x33CD235DF1E6A94E())) && !func_208()) && !func_210("MEA1_01", 0, 0)) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_281, true) > (30f * 3f))
	{
...
void func_425()
{
	if (!unk_0x765F6FEEFF39224F(iLocal_298))
	{
		if (unk_0x5D98D654CDC2165A(iLocal_299))
		{
			iLocal_298 = unk_0xC651C43AB13A15E5(iLocal_299, vLocal_300, fLocal_301, true, true, false);
			unk_0x9FABD0AB045A5D6E(iLocal_298, true, true, 0);
			unk_0xF70578F5CD9822CB(iLocal_298, true);
			unk_0x26D5EA44545890ED(iLocal_298, 0);
			unk_0x9152A6430680BF0A(iLocal_298, 0);
			unk_0x3A3707C1ECABF993(iLocal_298, 2, true);
			iLocal_321 = 1;
			unk_0x71CA80D41E1338B4(iLocal_299);
			unk_0xAF9EA4E314ED45C2(vLocal_329, vLocal_330, fLocal_331, 0, false, 1);
		}
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_296))
	{
		if (func_8(iLocal_298) && unk_0x5D98D654CDC2165A(func_15(17)))
		{
			func_426(&iLocal_296, 17, iLocal_298, 2, 1);
			unk_0x36E897473E9398F4(iLocal_296, 2, 4, 0);
			unk_0x36E897473E9398F4(iLocal_296, 3, 5, 0);
			unk_0x36E897473E9398F4(iLocal_296, 4, 5, 0);
			unk_0x36E897473E9398F4(iLocal_296, 8, 1, 0);
			unk_0x36E897473E9398F4(iLocal_296, 1, 0, 0);
			unk_0x36E897473E9398F4(iLocal_296, 10, 1, 0);
			unk_0x93AA93DA1B137032(iLocal_296, 2, 4, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_296, 3, 5, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_296, 4, 5, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_296, 8, 1, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_296, 1, 0, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_296, 10, 1, 0, 0);
			unk_0x73D993BCA1CEC58D(iLocal_296, 1, 0, 0, false);
			unk_0xF0BE7CB40DE62A2F(iLocal_296, false);
			unk_0x5FEE418CE11E6DDE(iLocal_296, 29, false);
			unk_0x5FEE418CE11E6DDE(iLocal_296, 116, false);
			unk_0x5FEE418CE11E6DDE(iLocal_296, 104, true);
			unk_0x4A852F02088ECC9D(iLocal_296, true);
			unk_0x0648A75D3F60E864(unk_0x33CD235DF1E6A94E(), iLocal_297);
			unk_0x0648A75D3F60E864(iLocal_296, iLocal_297);
			unk_0x139C6344B571F912(iLocal_296, 1);
			unk_0x8F470523AA8D48AF(iLocal_296, 1);
			unk_0x61D0E1067EE522FE(iLocal_296, 1);
			iLocal_221 = 0;
		}
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_302))
	{
		if (unk_0x5D98D654CDC2165A(iLocal_303))
		{
			iLocal_302 = unk_0x9BA5CF280376EEA4(6, iLocal_303, vLocal_304, fLocal_305, 1, true);
			func_63(&uLocal_55, 6, iLocal_302, "MEAmandaCop", 1, 1);
			unk_0x8A5F86362E03852B(iLocal_302, false);
			unk_0x73D993BCA1CEC58D(iLocal_302, 1, 0, 0, false);
			unk_0xDE9FF07CFD5DC172(iLocal_302, 25);
			unk_0xC7C47D4054903839(iLocal_302, vLocal_304, 0, 0, 1);
			unk_0x7FC2040EB34E0E31(iLocal_302, 110, 0);
			unk_0x71CA80D41E1338B4(iLocal_303);
		}
	}
	if (!unk_0x765F6FEEFF39224F(iLocal_306))
	{
		...
		{
			iLocal_306 = unk_0x9BA5CF280376EEA4(4, iLocal_307, vLocal_308, fLocal_309, 1, true);
			unk_0x4A852F02088ECC9D(iLocal_306, true);
			unk_0xC7C47D4054903839(iLocal_306, vLocal_308, 0, 0, 1);
			func_63(&uLocal_55, 5, iLocal_306, "MEAmandaShop", 1, 1);
			unk_0x71CA80D41E1338B4(iLocal_307);
			unk_0x9C47E5CDFB45F474(vLocal_304, 50f, 0);
			unk_0x47B5CF91AC5D5FFA(vLocal_279, vLocal_280, 1);
			unk_0x252F9CE6A90B6B86(vLocal_279, vLocal_280, false, 0);
			unk_0x798B28A324675954(vLocal_279, vLocal_280);
			unk_0x0335D8135051EA56(vLocal_279, vLocal_280, 0, 1, 1, 1);
		}
	}
}
...
void func_428()
{
	unk_0xB815670C37E03CDE(iLocal_299);
	unk_0xB815670C37E03CDE(iLocal_303);
	func_429(func_15(17));
	unk_0xB815670C37E03CDE(iLocal_307);
	unk_0x0483D0035D6E46FD(sLocal_277);
	unk_0x0483D0035D6E46FD(sLocal_278);
}
...
void func_431()
{
	...
	if (unk_0x8A7F864DAB908749(0))
	{
		if (func_526(unk_0x33CD235DF1E6A94E()))
		{
			func_63(&uLocal_55, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 1, 1);
			unk_0x61D0E1067EE522FE(unk_0x33CD235DF1E6A94E(), 1);
		}
		func_63(&uLocal_55, 4, 0, "AMANDA", 0, 1);
		if (func_526(unk_0x33CD235DF1E6A94E()))
		{
			iLocal_297 = unk_0xC408CC95C7202D67(unk_0x33CD235DF1E6A94E());
		}
		...
		if (func_33(0) && func_526(unk_0x33CD235DF1E6A94E()))
		{
			...
			fVar2 = unk_0xC472E34C8FBEC678(unk_0x33CD235DF1E6A94E());
			func_456(&iVar0, vVar1, fVar2, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
			unk_0xB7350047030F7672(vVar1, 100f, 0, 0, 0, 0, false, 0);
		}
		if (func_455())
		{
			iVar3 = func_454();
			...
			switch (iVar3)
			{
				case 0:
					...
					{
						unk_0xBEADAF07D2339505(iVar4, -822.4044f, 182.6078f, 71.37809f, 1, false, 0, 1);
						unk_0x3C990C409B3845DE(iVar4, 135.6541f);
					}
					func_7(&iVar4);
					func_446();
					iLocal_293 = 0;
					iLocal_292 = 1;
					unk_0xB7350047030F7672(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 100f, 0, 0, 0, 0, false, 0);
					func_68(500, 1);
					break;
				...
				case 2:
					func_432(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 1112014848, 12, 5000, 0, 0);
...
void func_440()
{
	...
	if (func_526(unk_0x33CD235DF1E6A94E()))
	{
		unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), -832.1946f, -178.313f, 36.5807f, 1, false, 0, 1);
		unk_0x3C990C409B3845DE(unk_0x33CD235DF1E6A94E(), 41.9602f);
		iVar0 = unk_0x8918EC905FC8975D();
		if (func_8(iVar0))
		{
			unk_0xBEADAF07D2339505(iVar0, -836.72f, -179.78f, 37.1f, 1, false, 0, 1);
		...
		unk_0xB7350047030F7672(-836.72f, -179.78f, 37.1f, 100f, 0, 0, 0, 0, false, 0);
		unk_0xD6EDA274D82E8678(0f, 1065353216);
		unk_0xC7E6A5D90DED6E0B(0f);
...
void func_446()
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		{
			iVar1 = unk_0x541D5C57194E73C4(iVar0);
			unk_0x8C4EA5F6857553AE(iVar1, true);
		}
	}
}
...
int func_493(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_484(unk_0x541D5C57194E73C4(*iParam0), 1) && unk_0xEECA910C75BFF02B(*iParam0, 24) != func_496(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xB4B3AEABE432069B(*iParam0, 24, func_496(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_495(iParam0);
	if (func_494(*iParam0))
	{
...
int func_506(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_507(iParam0, uVar1[iVar3], 1) && func_452(unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_348(vParam1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), true) < 10f)
					{
						unk_0x7AC8DF0B83EB4C6B(&iParam0);
						return 1;
					}
...
void func_523()
{
	...
	fVar0 = func_524(unk_0x33CD235DF1E6A94E(), vLocal_281, 1);
...
void func_525()
{
	if (func_526(iLocal_296))
	{
		if (iLocal_328)
		{
			if (unk_0xF0D230FB550CD6EB(iLocal_296, 0))
			{
				unk_0x93AA93DA1B137032(iLocal_296, 8, 0, 0, 0);
				iLocal_328 = 0;
			}
		}
		else if (!unk_0xF0D230FB550CD6EB(iLocal_296, 1))
		{
			unk_0x93AA93DA1B137032(iLocal_296, 8, 1, 0, 0);
			iLocal_328 = 1;
		}
