...
void __EntryFunction__()
{
	...
	iLocal_373 = unk_0x12772FC739A13F81(iLocal_368);
	iLocal_374 = unk_0x12772FC739A13F81(iLocal_369);
	...
	while (true)
	{
		...
		func_464();
		if (unk_0x765F6FEEFF39224F(Local_48.f_2))
		{
...
void func_1()
{
	...
	switch (Local_43.f_1)
	{
		case 0:
			...
			if (unk_0xCE3CFF625BEBAA04(sVar0, sLocal_381))
			{
				func_503(1);
			}
			else
...
void func_2(bool bParam0)
{
	if (Local_45.f_4 == 1)
	{
		...
		{
			if (unk_0x765F6FEEFF39224F(Local_45))
			{
				if (func_463(Local_45))
				{
					unk_0x4A852F02088ECC9D(Local_45, false);
					unk_0xAD3D24C8070DA056(Local_45, false);
				}
...
void func_10(bool bParam0)
{
	...
	{
		unk_0x43D47AD82DA3C6EC(Local_48.f_2, false, 1);
	}
	if (bParam0)
	{
		func_7(&(Local_48.f_2));
	...
	unk_0xCBE6AF58552C63B2(Local_48.f_6);
	unk_0xCBE6AF58552C63B2(Local_48.f_7);
	Local_48 = 0;
}
...
void func_17()
{
	switch (Local_43.f_1)
	{
		case 0:
			if (func_463(Local_48.f_2))
			{
				...
				if (func_220(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", 8, 0, 0, 0))
				{
					...
					iLocal_189 = unk_0xE3903F59E2F22150() + 5000;
					Local_43.f_1 = 1;
				}
			}
			else
		...
		case 1:
			if ((unk_0xE3903F59E2F22150() > iLocal_189 && !func_18()) || !func_463(Local_48.f_2))
			{
				func_19();
			}
			break;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_92(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_92(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_70(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_70(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_70(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_70(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_103(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_103(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_92(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_233()
{
	...
	if (Local_43.f_3 == 1)
	{
		...
		while (!unk_0x765F6FEEFF39224F(Local_48.f_2))
		{
			func_364();
			wait(0);
		}
		...
		unk_0xB815670C37E03CDE(iLocal_377);
		...
		{
			func_342(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 1112014848, 12, 5000, 0, 0);
		}
		Local_43.f_3 = 0;
	}
	if (Local_43.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			if (bLocal_180)
			{
				...
				wait(3000);
				if (unk_0x765F6FEEFF39224F(Local_48.f_2) && unk_0xBC2FC12AD0FBF72E(Local_48.f_2))
				{
					unk_0x8822A7E5068264C6(Local_48.f_2);
				}
				if (func_463(Local_48.f_2))
				{
					unk_0x7FC2040EB34E0E31(Local_48.f_2, 110, 0);
					unk_0xEF6624A3AFF02A02(Local_48.f_2, "Orleans", 0, 0, 0);
				}
				unk_0xA1DB7AA6D905E3C9(vLocal_49, 0);
				wait(0);
				unk_0x65F534DDBF48606F("SF_TheLastOne", 0);
			...
			else
			{
				...
				if (func_463(Local_48.f_2))
				{
					unk_0x7FC2040EB34E0E31(Local_48.f_2, 110, 0);
					unk_0xEF6624A3AFF02A02(Local_48.f_2, "Orleans", 0, 0, 0);
					unk_0x36E897473E9398F4(Local_48.f_2, 0, 1, 1);
					unk_0x36E897473E9398F4(Local_48.f_2, 1, 1, 0);
					unk_0x36E897473E9398F4(Local_48.f_2, 8, 1, 0);
					unk_0x36E897473E9398F4(Local_48.f_2, 7, 1, 0);
				}
			...
			func_8(0);
			func_2(1);
			iLocal_411 = unk_0xE3903F59E2F22150() + 500;
			iLocal_412 = 1;
			iVar0 = unk_0x8918EC905FC8975D();
			unk_0xCE04CE961AF41AB9(vLocal_386, 200f, 1, 0, 0, false);
			iLocal_197 = (unk_0x2873410B0C800927() - 300);
			iLocal_198 = 1;
			if (func_330(iVar0))
			{
				unk_0xBEADAF07D2339505(iVar0, vLocal_386, 1, false, 0, 1);
				unk_0x3C990C409B3845DE(iVar0, fLocal_387);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			iLocal_385 = unk_0x8918EC905FC8975D();
			if (!func_330(iLocal_385) && unk_0x5D98D654CDC2165A(iLocal_377))
			{
				iLocal_385 = unk_0xC651C43AB13A15E5(iLocal_377, vLocal_386, fLocal_387, true, true, false);
				if (func_330(iLocal_385))
				{
					unk_0xD6D2420F0051065A(iLocal_385, 1);
				}
			}
		}
		if (func_329())
		{
			if (iLocal_198)
			{
				if (unk_0x7E15D709E86EB560() > iLocal_197)
				{
		...
		if (func_463(Local_48.f_2))
		{
			if (unk_0x3CA08F647CEAD042("Orleans", 0))
			{
				...
				unk_0x5FEE418CE11E6DDE(Local_48.f_2, 185, true);
				unk_0x1096811DB3A77EC1(Local_48.f_2, 0);
				unk_0x99414FB2D30425C1(&iVar1);
				unk_0x108754262311D34F(0, sLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				unk_0x108754262311D34F(0, sLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
				unk_0xC734F59A13D39AEF(iVar1);
				unk_0x13A2D602CD10CBAC(Local_48.f_2, iVar1);
				unk_0xA7A57E7757ED035E(&iVar1);
				unk_0x880B00F3FAE4C022(Local_48.f_2, 1, 0);
				unk_0xF8E07C228A90E953(Local_48.f_2, 0);
				unk_0x9247930CE6A29BC3(Local_48.f_2, 1, 0.81f, 0.733f, 1);
				unk_0x9247930CE6A29BC3(Local_48.f_2, 0, 0.94f, 0.59f, 1);
				if (func_463(unk_0x33CD235DF1E6A94E()) && unk_0x3CA08F647CEAD042("FRANKLIN", 0))
				{
					unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), Local_48.f_2, -1, 2050, 4);
					unk_0xC4A347124F39D998(Local_48.f_2, unk_0x33CD235DF1E6A94E(), -1, 2050, 4);
				}
			}
			if (iLocal_412)
			{
				if (unk_0xE3903F59E2F22150() > iLocal_411)
				{
					unk_0x93AA93DA1B137032(Local_48.f_2, 0, 1, 1, 0);
					unk_0x93AA93DA1B137032(Local_48.f_2, 1, 1, 0, 0);
					unk_0x93AA93DA1B137032(Local_48.f_2, 8, 1, 0, 0);
					unk_0x93AA93DA1B137032(Local_48.f_2, 7, 1, 0, 0);
					iLocal_412 = 0;
				}
			}
		}
...
void func_246()
{
	...
	unk_0xCE5C49921A521962(Local_48.f_3, 1f);
...
void func_247(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_218(unk_0xD178EF744F20B712(), 1);
			if (iVar4 != -1)
			{
...
void func_273(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_278(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_284(var uParam0)
{
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (func_306())
		{
			*uParam0 = func_289(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), 6, -1, 0, 1, -1);
...
int func_289(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_305(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(vParam0, func_290(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_313(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
int func_353(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		{
			if (!func_358(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_361()
{
	...
	{
		unk_0xB815670C37E03CDE(iLocal_376);
		if (unk_0x5D98D654CDC2165A(iLocal_376))
		{
			Local_46 = unk_0xDD9A603448A23A17(iLocal_376, vLocal_388, true, true, false);
			if (unk_0x765F6FEEFF39224F(Local_46))
			{
				unk_0x1C8705F667F673EA(Local_46, vLocal_389, 2, 1);
				unk_0x71CA80D41E1338B4(iLocal_376);
				unk_0xF70578F5CD9822CB(Local_46, true);
			}
			else
			{
				return 0;
...
{
	unk_0xF70578F5CD9822CB(iParam0, !bParam1);
...
int func_364()
{
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		Local_48.f_2 = unk_0x9BA5CF280376EEA4(25, iLocal_370, Local_47.f_1[1 /*14*/].f_1, 0f, 1, true);
	}
	else
	{
		Local_48.f_2 = unk_0x9BA5CF280376EEA4(25, iLocal_370, Local_47.f_1[0 /*14*/].f_1, 0f, 1, true);
	}
	if (func_463(Local_48.f_2))
	{
		iLocal_188 = func_365(unk_0x33CD235DF1E6A94E(), Local_48.f_2, 0f);
		unk_0x43D47AD82DA3C6EC(Local_48.f_2, true, 1);
		unk_0x6B8FD1D1616EE677(Local_48.f_2, false);
		unk_0xF0BE7CB40DE62A2F(Local_48.f_2, false);
		unk_0x4A852F02088ECC9D(Local_48.f_2, true);
		unk_0x697EBA5CF1A6AB57(Local_48.f_2, joaat("weapon_unarmed"), -1, true, true);
		unk_0xF8E07C228A90E953(Local_48.f_2, 0);
		unk_0x93AA93DA1B137032(Local_48.f_2, 0, 1, 0, 0);
		unk_0x93AA93DA1B137032(Local_48.f_2, 1, 0, 0, 0);
		unk_0x93AA93DA1B137032(Local_48.f_2, 8, 0, 0, 0);
		unk_0x5FEE418CE11E6DDE(Local_48.f_2, 185, true);
		unk_0x28F648743D7DE312(Local_48.f_2, 46, true);
		unk_0x9FD099B0593CD91D(Local_48.f_2, true);
		unk_0x167979048B7CE51D(Local_48.f_2, true);
		unk_0x9E280E42C0773A3A(Local_48.f_2, 1);
		func_232(&uLocal_199, 3, Local_48.f_2, "ORLEANS", 0, 1);
		func_363(Local_48.f_2, 0);
		Local_48 = 0;
		Local_48.f_1 = 2;
		Local_48.f_4 = 0;
		Local_48.f_5 = unk_0x8CCC0A0504C52531();
		Local_48.f_6 = unk_0x8CCC0A0504C52531();
		Local_48.f_7 = unk_0x8CCC0A0504C52531();
		Local_48.f_11 = 0;
		return 1;
	}
	return 0;
...
int func_367()
{
	if ((unk_0x5D98D654CDC2165A(iLocal_370) && unk_0xE9CCF312047EBEE0(sLocal_379)) && unk_0xE9CCF312047EBEE0(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_371()
{
	if (Local_43.f_3 == 1)
	{
		...
		{
			unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), vLocal_402, 1, false, 0, 1);
			unk_0x3C990C409B3845DE(unk_0x33CD235DF1E6A94E(), fLocal_403);
		}
		while (!func_362())
		{
			wait(0);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			if (unk_0xCA12322D8FBBDBEE(-1, unk_0xFBB1F99A825CAB09(Local_48.f_2, true), 4f) || iLocal_171)
			{
			...
			else
			{
				func_245(4);
				func_397();
				iLocal_364 = unk_0xE3903F59E2F22150() + 3000;
				Local_43.f_1 = 3;
				func_11(&(Local_48.f_3));
			}
		}
		else if (unk_0xCA12322D8FBBDBEE(-1, unk_0xFBB1F99A825CAB09(Local_48.f_2, true), 4f))
		{
			if (unk_0xE3903F59E2F22150() > iLocal_186)
			{
				iLocal_185++;
				iLocal_186 = unk_0xE3903F59E2F22150() + 1000;
				func_396(807, 1, 0);
			}
			if ((iLocal_179 && iLocal_185 > 0) || (!iLocal_179 && iLocal_185 > 1))
			{
				if (func_463(Local_48.f_2))
				{
					unk_0x7FC2040EB34E0E31(Local_48.f_2, 99, 0);
				}
		...
		else
		{
			...
			{
				Local_47 = 0;
				if (Local_47.f_352 == 0 && !unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					Local_47.f_352 = 2;
				}
				else
			...
			if (func_379(unk_0x33CD235DF1E6A94E(), Local_47.f_1[10 /*14*/].f_5, 100f))
			{
				unk_0x3427206E004F448F("sas_2_rcm_t7", 8);
			}
			if (iLocal_170 == 0)
			{
				...
				iLocal_170 = 1;
				iLocal_184 = unk_0xE3903F59E2F22150() + 1000;
			}
			else if (iLocal_183 == 0)
			{
				if (iLocal_184 < unk_0xE3903F59E2F22150())
				{
					func_377("SAS1_H0", -1);
					iLocal_183 = 1;
				}
			...
			else if (iLocal_178 == 0)
			{
				if (Local_47.f_352 < 5)
				{
					...
					{
						func_232(&uLocal_199, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
			...
			else if (iLocal_179 == 0)
			{
				...
				{
					if (!func_18() && unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_392, 35f, 35f, 35f, false, true, 0))
					{
						func_374();
						func_232(&uLocal_199, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
						if (func_220(&uLocal_199, "SAS1AUD", "SAS1_CHASE3", 7, 0, 0, 0))
						{
							unk_0x07081B6E272EC7C2(Local_48.f_2, -1536.6f, 4543.7f, 45.5f, -1538.2f, 4536.2f, 48.6f, 5f, 0, 0);
							iLocal_179 = 1;
						}
					}
				}
			...
			if (iLocal_168 == 0)
			{
				if (!func_373(&uLocal_63, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true)))
				{
					func_378("SAS1_C2", 7500, 0);
					iLocal_168 = 1;
					iLocal_172 = unk_0xE3903F59E2F22150() + 30000;
				}
			}
			else if (unk_0xE3903F59E2F22150() > iLocal_172)
			{
				if (func_373(&uLocal_63, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true)))
				{
					iLocal_168 = 0;
...
void func_372()
{
	unk_0xD362430CD61A9B08();
	func_11(&(Local_48.f_3));
	if (func_373(&uLocal_115, unk_0xFBB1F99A825CAB09(Local_48.f_2, false)))
	{
		bLocal_180 = false;
	}
	else
...
void func_374()
{
	...
	while (iVar0 < iLocal_60)
	{
		...
		{
			unk_0xECCD4FDA45197F97(Local_59[iVar0 /*16*/], unk_0x33CD235DF1E6A94E(), 500f, -1, 0, 0);
			func_4(&(Local_59[iVar0 /*16*/]), 1, 0, 1);
		}
		iVar0++;
	}
...
bool func_376(int iParam0, int iParam1)
{
	...
	return (unk_0xE3903F59E2F22150() - Local_42[iParam0 /*13*/].f_4) < iParam1;
}
...
void func_380()
{
	if (unk_0xEA8CEFB1F41E5992(unk_0xFBB1F99A825CAB09(Local_48.f_2, true), 1.5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			func_381();
	...
	else if (unk_0xEA8CEFB1F41E5992(unk_0xFBB1F99A825CAB09(Local_48.f_2, true), 5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			if (!func_18())
...
void func_381()
{
	...
	{
		unk_0xCBE6AF58552C63B2(Local_48.f_6);
		unk_0xE9739440E5BF08EE(Local_48.f_6, "WOUNDED", Local_48.f_2, "SASQUATCH_01_SOUNDSET", false, 0);
		Local_48.f_10 = 1;
	}
}
...
void func_385(int iParam0)
{
	...
	switch (iParam0->f_1)
	{
		case 1:
			...
			else if (func_386(*iParam0, unk_0x33CD235DF1E6A94E(), iParam0->f_15, 1))
			{
	...
	switch (Local_48)
	{
		case 1:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0xBEADAF07D2339505(Local_48.f_2, uParam0->f_1, 1, false, 0, 1);
					if (*uParam0 == 1)
					{
						func_394(Local_48.f_2, uParam0->f_5);
					}
					Local_48.f_4 = (unk_0xE3903F59E2F22150() + iVar1);
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					else if (unk_0xE3903F59E2F22150() > Local_48.f_4)
					{
						Local_48 = 2;
						Local_48.f_1 = 0;
					}
		...
		case 2:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					Local_48.f_12 = (unk_0xE3903F59E2F22150() + 60000);
					Local_48.f_4 = 0;
					Local_48.f_1 = 1;
				}
				else if (fVar0 == -1f || func_386(Local_48.f_2, unk_0x33CD235DF1E6A94E(), fVar0, 1))
				{
				...
				else if (unk_0xE38E3CF1625A4145(Local_48.f_3))
				{
					iVar2 = (unk_0x163940E51B9C8A0D(Local_48.f_3) - 5);
					if (iVar2 > 0)
					{
						unk_0xE447A1B9434714F3(Local_48.f_3, iVar2);
					}
					else
					{
						func_11(&(Local_48.f_3));
				...
				else if (unk_0xE3903F59E2F22150() > Local_48.f_12)
				{
					Local_48.f_11 = 1;
				}
				else if (unk_0xE3903F59E2F22150() > Local_48.f_4)
				{
					if ((unk_0x66DE54BD13B1BD88(Local_48.f_6) && unk_0x66DE54BD13B1BD88(Local_48.f_6)) && unk_0x66DE54BD13B1BD88(Local_48.f_7))
					{
						unk_0xE9739440E5BF08EE(Local_48.f_5, "ALERT", Local_48.f_2, "SASQUATCH_01_SOUNDSET", false, 0);
						unk_0x50B82DFEB5B3A3AF(unk_0xFBB1F99A825CAB09(Local_48.f_2, true), 30f, 6);
					}
					Local_48.f_4 = unk_0xE3903F59E2F22150() + 7500;
				}
		...
		case 3:
			if (func_463(Local_48.f_2))
			{
				...
				{
					func_363(Local_48.f_2, 1);
					unk_0x2A25AECBD792A364(Local_48.f_2, uParam0->f_5, 3f, -1, 1193033728, 1056964608);
					if ((unk_0x66DE54BD13B1BD88(Local_48.f_6) && unk_0x66DE54BD13B1BD88(Local_48.f_6)) && unk_0x66DE54BD13B1BD88(Local_48.f_7))
					{
						unk_0xE9739440E5BF08EE(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", false, 0);
					}
					Local_48.f_10 = 0;
					if (!unk_0xE38E3CF1625A4145(Local_48.f_3))
					{
						Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
						unk_0xCE5C49921A521962(Local_48.f_3, 1f);
					}
					...
					{
						unk_0xE447A1B9434714F3(Local_48.f_3, 255);
					}
					if (Local_47.f_352 == (Local_47.f_353 - 1))
					{
						unk_0x6B8FD1D1616EE677(Local_48.f_2, true);
						unk_0xF0BE7CB40DE62A2F(Local_48.f_2, true);
						unk_0x7FC2040EB34E0E31(Local_48.f_2, 110, 0);
					}
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					{
						unk_0x108754262311D34F(Local_48.f_2, sLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0, 0, 0, 0);
						Local_48.f_1 = 2;
					}
					...
					else if ((unk_0x66DE54BD13B1BD88(Local_48.f_6) && unk_0x66DE54BD13B1BD88(Local_48.f_6)) && unk_0x66DE54BD13B1BD88(Local_48.f_7))
					{
						if (Local_48.f_10 == 0)
						{
							unk_0xE9739440E5BF08EE(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", false, 0);
					...
					if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
					{
						...
						if (func_330(iVar3) && unk_0x4ED4D1D8B2023FD8(iVar3, Local_48.f_2))
						{
							Local_48 = 6;
							Local_48.f_1 = 0;
						}
				...
				{
					unk_0xED68CDDDE25A144E(Local_48.f_2);
					if (Local_47.f_352 < (Local_47.f_353 - 1))
					{
						if ((unk_0x66DE54BD13B1BD88(Local_48.f_6) && unk_0x66DE54BD13B1BD88(Local_48.f_6)) && unk_0x66DE54BD13B1BD88(Local_48.f_7))
						{
							unk_0xE9739440E5BF08EE(Local_48.f_7, "COUGH", Local_48.f_2, "SASQUATCH_01_SOUNDSET", false, 0);
						}
						Local_48 = 4;
						Local_48.f_1 = 0;
					}
		...
		case 4:
			...
			if (func_463(Local_48.f_2))
			{
				if (unk_0xE38E3CF1625A4145(Local_48.f_3))
				{
					...
					iVar4 = (unk_0x163940E51B9C8A0D(Local_48.f_3) - iVar5);
					if (iVar4 > 0)
					{
						unk_0xE447A1B9434714F3(Local_48.f_3, iVar4);
					}
					else
					{
						func_11(&(Local_48.f_3));
		...
		case 5:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0x13A2D602CD10CBAC(Local_48.f_2, iVar6);
					func_374();
					Local_48.f_1 = 1;
					Local_48.f_9 = 0;
				}
				else if (Local_48.f_1 == 1)
				{
					if (Local_48.f_9 == 0)
					{
						if (func_386(unk_0x33CD235DF1E6A94E(), Local_48.f_2, 20f, 1))
						{
							unk_0x7FC2040EB34E0E31(Local_48.f_2, 110, 0);
							unk_0x0648A75D3F60E864(Local_48.f_2, -2065892691);
							unk_0x5FEE418CE11E6DDE(Local_48.f_2, 185, true);
							func_374();
							iLocal_366 = 0;
					...
					{
						if (unk_0xE3903F59E2F22150() > iLocal_367)
						{
							if (func_390(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", sLocal_365[iLocal_366], 7, 0, 0))
							{
								iLocal_367 = (unk_0xE3903F59E2F22150() + unk_0x9EC3B269A34A2BEE(3000, 5000));
								iLocal_366 = unk_0x9EC3B269A34A2BEE(0, 4);
							}
						}
					}
					func_389();
		...
		case 6:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					unk_0x6B8FD1D1616EE677(Local_48.f_2, true);
					unk_0xF0BE7CB40DE62A2F(Local_48.f_2, true);
					unk_0x7FC2040EB34E0E31(Local_48.f_2, 120, 0);
					func_363(Local_48.f_2, 1);
					if (!unk_0xE38E3CF1625A4145(Local_48.f_3))
					{
						Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
					...
					iLocal_171 = 1;
					unk_0x277716E9E7CC0692(Local_48.f_2, unk_0x33CD235DF1E6A94E(), 0, 16);
					func_374();
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
...
void func_389()
{
	if (unk_0x91BBD269506D61D2(Local_48.f_2, unk_0x33CD235DF1E6A94E(), 1))
	{
		unk_0x7FC2040EB34E0E31(Local_48.f_2, 99, 0);
	}
}
...
void func_391()
{
	if (iLocal_191 < 0)
	{
		iLocal_191 = unk_0xE3903F59E2F22150() + 7000;
		iLocal_192 = -1;
	}
	else if (unk_0xE3903F59E2F22150() > iLocal_191)
	{
...
void func_392()
{
	if (iLocal_192 < 0)
	{
		iLocal_192 = unk_0xE3903F59E2F22150() + 7000;
		iLocal_191 = -1;
	}
	else if (unk_0xE3903F59E2F22150() > iLocal_192)
	{
		if ((!func_18() && !unk_0xC4B7D5901EDA35B5()) && !unk_0xD93CFE80D83E2106(unk_0x33CD235DF1E6A94E()))
		{
...
int func_393(var uParam0)
{
	...
	vVar0 = { func_336(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) - uParam0->f_1) };
	...
	if ((vVar0.x * vVar1.x) + (vVar0.y * vVar1.y)) < cos(to_float(uParam0->f_11))
	{
		...
		return !unk_0x642585888A1136CB(vVar2, vVar3, 0, 1, 0, 0, 0, 0, 0);
	}
	return 0;
}
...
void func_400()
{
	unk_0x71CA80D41E1338B4(iLocal_378);
}
...
void func_402()
{
	...
	while (iVar0 < iLocal_60)
	{
		Local_59[iVar0 /*16*/] = unk_0x9BA5CF280376EEA4(25, iLocal_378, Local_59[iVar0 /*16*/].f_11, Local_59[iVar0 /*16*/].f_14, 1, true);
		if (func_463(Local_59[iVar0 /*16*/]))
		{
			unk_0x4A852F02088ECC9D(Local_59[iVar0 /*16*/], true);
			unk_0x9E280E42C0773A3A(Local_59[iVar0 /*16*/], 1);
			unk_0x126A03BD41622048(Local_59[iVar0 /*16*/], Local_59[iVar0 /*16*/].f_11, 15f, 1077936128, 1086324736);
			unk_0x28F648743D7DE312(Local_59[iVar0 /*16*/], 46, true);
			unk_0xE18BDD1E31C07544(Local_59[iVar0 /*16*/], joaat("weapon_cougar"), -1, true);
...
bool func_403()
{
	return unk_0x5D98D654CDC2165A(iLocal_378);
}

void func_404()
{
	unk_0xB815670C37E03CDE(iLocal_378);
}
...
void func_405()
{
	...
	if (unk_0xE3903F59E2F22150() > iLocal_187 && iLocal_187 > 0)
	{
		if (func_236(unk_0x33CD235DF1E6A94E()))
		{
			unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), true, 0);
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_442())
		{
			...
			if (func_463(Local_45))
			{
				unk_0x5FEE418CE11E6DDE(Local_45, 185, true);
				unk_0x1096811DB3A77EC1(Local_45, 0);
			}
			iLocal_61 = unk_0x9B8C51EA76FFD393(vLocal_390, 75f);
			unk_0xB9E84A421C105943(iLocal_61, 5);
			unk_0xE447A1B9434714F3(iLocal_61, 128);
			unk_0x983D75D9630FD905(iLocal_61, false);
			unk_0xCE04CE961AF41AB9(vLocal_404, 100f, 1, 0, 0, false);
			unk_0xCE04CE961AF41AB9(vLocal_405, 100f, 1, 0, 0, false);
			unk_0xCE04CE961AF41AB9(vLocal_406, 100f, 1, 0, 0, false);
			unk_0xCE04CE961AF41AB9(vLocal_407, 100f, 1, 0, 0, false);
			iLocal_167 = 0;
			iLocal_168 = 0;
			iLocal_169 = 0;
			iLocal_174 = 0;
			...
			iLocal_181 = 1;
			iLocal_182 = 1;
			iLocal_196 = (unk_0xE3903F59E2F22150() + 40000);
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if ((func_426(Local_45, 0, 70f, 170f, 1, 0, 0, 0) || !func_379(Local_45, vLocal_397, 1.5f)) || unk_0x3AF2B3B68DD52355(Local_45))
		{
			unk_0x0648A75D3F60E864(Local_45, -2065892691);
			unk_0x277716E9E7CC0692(Local_45, unk_0x33CD235DF1E6A94E(), 0, 16);
			func_397();
			func_245(6);
			Local_43.f_9 = 3;
			Local_43.f_1 = 3;
		...
		{
			bVar0 = func_373(&uLocal_63, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true));
			if (iLocal_182 && func_379(unk_0x33CD235DF1E6A94E(), vLocal_388, 250f))
			{
				func_368();
				func_404();
				iLocal_182 = 0;
			...
			else if (iLocal_175 == 0)
			{
				...
				{
					func_232(&uLocal_199, 4, Local_45, "HUNTER", 0, 1);
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), Local_45, 25f, 25f, 25f, 0, 1, 0))
					{
			...
			else if (iLocal_167 == 0)
			{
				...
				if (func_18())
				{
					if (func_407(unk_0x33CD235DF1E6A94E(), Local_45) > 25f)
					{
						func_397();
					}
				}
			...
			else
			{
				if (iLocal_169 == 0)
				{
					if (func_379(unk_0x33CD235DF1E6A94E(), vLocal_388, 5f))
					{
						func_232(&uLocal_199, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
				...
				if (iLocal_176 == 0)
				{
					if (func_379(unk_0x33CD235DF1E6A94E(), Local_47.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_364())
						{
							func_11(&iLocal_61);
							Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
							unk_0xCE5C49921A521962(Local_48.f_3, 1f);
							unk_0xEC95D37A139F1D5C(Local_48.f_5, "ALERT", -1541.965f, 4692.725f, 44.0651f, "SASQUATCH_01_SOUNDSET", 0, 0, 0);
							unk_0x50B82DFEB5B3A3AF(unk_0xFBB1F99A825CAB09(Local_48.f_2, true), 30f, 6);
							unk_0xAE5B044AA2973E2A(unk_0x33CD235DF1E6A94E(), Local_47.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_176 = 1;
							iLocal_190 = -1;
							func_406();
						}
				...
				else if (iLocal_177 == 0)
				{
					if (!func_18())
					{
						if (iLocal_190 < 0)
						{
							iLocal_190 = unk_0xE3903F59E2F22150() + 2000;
						}
						else if (unk_0xE3903F59E2F22150() > iLocal_190)
						{
							func_232(&uLocal_199, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
...
void func_406()
{
	...
	unk_0xCE04CE961AF41AB9(vLocal_404, 50f, 1, 0, 0, false);
	unk_0xCE04CE961AF41AB9(vLocal_405, 50f, 1, 0, 0, false);
	unk_0xCE04CE961AF41AB9(vLocal_406, 50f, 1, 0, 0, false);
	unk_0xCE04CE961AF41AB9(vLocal_407, 20f, 1, 0, 0, false);
	iVar0 = unk_0x8918EC905FC8975D();
	if (unk_0x765F6FEEFF39224F(iVar0) && !unk_0xD62C4419A41F106A(iVar0, 0))
	{
		...
		{
			unk_0xBEADAF07D2339505(iVar0, vLocal_383, 1, false, 0, 1);
			unk_0x3C990C409B3845DE(iVar0, fLocal_384);
			unk_0x1B2303F9DC2D90D5(iVar0, 1084227584);
		}
	}
}
...
void func_409()
{
	if (iLocal_173)
	{
		if (!func_330(Local_44.f_35[0]) && func_407(unk_0x33CD235DF1E6A94E(), Local_45) < 25f)
		{
			func_397();
...
void func_413()
{
	if (func_463(Local_45) && func_463(unk_0x33CD235DF1E6A94E()))
	{
		if (func_386(unk_0x33CD235DF1E6A94E(), Local_45, 50f, 1))
		{
			...
			if (unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), Local_45))
			{
...
int func_421(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_336(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_336(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_431(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_336(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_433()
{
	...
	{
		if (unk_0x1CE8F0A08E65CA6A(Local_45, sLocal_379, "hunter_leadout", 3))
		{
			if (unk_0x204DEACC5BECF723(Local_45, sLocal_379, "hunter_leadout") > 0.9f)
			{
				if (unk_0xE9CCF312047EBEE0(sLocal_379))
				{
					unk_0x99414FB2D30425C1(&iVar0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x656E3BB78935070E(iVar0, 1);
					unk_0xC734F59A13D39AEF(iVar0);
					unk_0x13A2D602CD10CBAC(Local_45, iVar0);
...
void func_434()
{
	...
	while (iVar0 < Local_42)
	{
		if (!(Local_42[iVar0 /*13*/].f_11 == 3 && unk_0xE3903F59E2F22150() < Local_42[iVar0 /*13*/].f_10))
		{
...
int func_435(var uParam0)
{
	...
	if (!func_236(uParam0->f_1) || !func_236(uParam0->f_2))
	{
		if (uParam0->f_5 != 0)
		{
			iVar5 = unk_0x819B6E76423AE494(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
			uParam0->f_5 = 0;
		}
	...
	vVar7 = { unk_0xFBB1F99A825CAB09(uParam0->f_1, true) };
	vVar8 = { unk_0xFBB1F99A825CAB09(uParam0->f_2, true) };
	if (uParam0->f_3 > 0f)
	{
		vVar9 = { func_336(vVar8 - vVar7) };
		fVar10 = func_422(unk_0xB969B7304D29679F(uParam0->f_1), vVar9);
		if (fVar10 <= cos(fVar6))
		{
			if (uParam0->f_5 != 0)
			{
	...
	if (uParam0->f_5 == 0)
	{
		vVar7 = { unk_0x61B226C460A8FCC2(uParam0->f_1, 31086, 0f, 0.6f, 0f) };
		uParam0->f_7 = { vVar8 + unk_0x43D8A2CCB19FE8A8(uParam0->f_2) * FtoV(unk_0x7C475FA8D877007F()) };
		vVar0 = { uParam0->f_7 - vVar7 * Vector(1.25f, 1.25f, 1.25f) + vVar7 };
		uParam0->f_5 = unk_0x36FB861F8CCF0EA4(vVar7, vVar0, 511, 0, 7);
		return 2;
	}
	bVar12 = false;
	iVar5 = unk_0x819B6E76423AE494(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
	...
	{
		fVar13 = unk_0x7EECA16E87982278((unk_0x8BB475EA09C9A0EB(uParam0->f_1) * unk_0x7C475FA8D877007F()));
		fVar13 = 0f;
		fVar11 = unk_0x16E00F066AFFEA0D(uParam0->f_7, vVar2, false);
		...
		if (bVar12 && unk_0x7EECA16E87982278((uParam0->f_7.f_2 - vVar2.z)) > 1f)
		{
			bVar12 = false;
		}
		uParam0->f_6 = bVar12;
...
void func_438()
{
	...
	unk_0x71CA80D41E1338B4(iLocal_373);
	unk_0x71CA80D41E1338B4(iLocal_374);
	unk_0x71CA80D41E1338B4(iLocal_375);
}
...
void func_439(bool bParam0)
{
	if (Local_45.f_4 == 0)
	{
		if (bParam0)
		{
			if (func_463(unk_0x33CD235DF1E6A94E()) && !func_352())
			{
				unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), vLocal_393, 1, false, 0, 1);
				unk_0x3C990C409B3845DE(unk_0x33CD235DF1E6A94E(), fLocal_394);
				unk_0xC7E6A5D90DED6E0B(0f);
				unk_0xD6EDA274D82E8678(0f, 1065353216);
			}
			if (func_463(Local_44.f_28[0]))
			{
				...
				unk_0xBEADAF07D2339505(Local_45, vLocal_395, 1, false, 0, 1);
				unk_0x3C990C409B3845DE(Local_45, fLocal_396);
			}
			else
			{
				Local_45 = unk_0x9BA5CF280376EEA4(26, iLocal_371, vLocal_395, fLocal_396, 1, true);
			...
			if (func_441(Local_45, 1862763509, iLocal_368))
			{
				if (func_463(unk_0x33CD235DF1E6A94E()))
				{
					unk_0xC4A347124F39D998(Local_45, unk_0x33CD235DF1E6A94E(), -1, 1024, 2);
				}
			}
		}
		func_440();
...
void func_440()
{
	...
	if (!unk_0xECCFCAB0A094EB5B(Local_45.f_2))
	{
		Local_45.f_2 = unk_0x3B3AEF3A73FB80C9(joaat("pickup_weapon_sniperrifle"), vLocal_398, vLocal_399, iVar0, 100, 0, 1, 0);
	}
	if (!unk_0xECCFCAB0A094EB5B(Local_45.f_3))
	{
		if (vLocal_400.z != 0f)
		{
			Local_45.f_3 = unk_0x3B3AEF3A73FB80C9(joaat("pickup_weapon_pumpshotgun"), vLocal_400, vLocal_401, iVar0, 48, 0, 1, 0);
		}
	}
}
...
int func_441(int iParam0, int iParam1, int iParam2)
{
	if (func_463(iParam0))
	{
		...
		unk_0x5FEE418CE11E6DDE(iParam0, 132, true);
		unk_0x4A852F02088ECC9D(iParam0, true);
		unk_0xAD3D24C8070DA056(iParam0, true);
		unk_0xF0BE7CB40DE62A2F(iParam0, false);
		if (iParam2 != joaat("weapon_unarmed"))
		{
			unk_0x697EBA5CF1A6AB57(iParam0, iParam2, 100, true, true);
...
int func_442()
{
	if (((((((unk_0x5D98D654CDC2165A(iLocal_371) && unk_0x5D98D654CDC2165A(iLocal_372)) && unk_0x5D98D654CDC2165A(iLocal_373)) && unk_0x5D98D654CDC2165A(iLocal_374)) && unk_0x5D98D654CDC2165A(iLocal_375)) && unk_0x4FFB62F63D342B1B(iLocal_372)) && unk_0xE9CCF312047EBEE0(sLocal_379)) && unk_0xE9CCF312047EBEE0(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_443()
{
	...
	unk_0xB815670C37E03CDE(iLocal_374);
	unk_0xB815670C37E03CDE(iLocal_375);
	unk_0x2D0FA45744C7540C(iLocal_372, 3);
	unk_0x0483D0035D6E46FD(sLocal_379);
	unk_0x0483D0035D6E46FD(sLocal_380);
}
...
void func_452()
{
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			...
			if (func_463(Local_44.f_28[0]))
			{
				unk_0xEF6624A3AFF02A02(Local_44.f_28[0], "Hunter", 0, 0, 0);
				iLocal_62 = func_454(Local_44.f_28[0], 1, 0, 0, 0, 0);
				if (unk_0x765F6FEEFF39224F(iLocal_62))
				{
					unk_0xEF6624A3AFF02A02(iLocal_62, "SAS_SniperRifle", 0, 0, 0);
				}
			}
			func_350(500, 0);
			unk_0x252F9CE6A90B6B86(vLocal_408, vLocal_409, false, 0);
			unk_0xCC323859A8DA2B88("WORLD_HUMAN_HIKER", false);
			unk_0xCC323859A8DA2B88("WORLD_MOUNTAIN_LION_WANDER", false);
			func_453();
			unk_0x2EC4FFC8740228D3(0);
			wait(0);
			unk_0x65F534DDBF48606F("SF_TheLastOne", 0);
			...
			unk_0xCE04CE961AF41AB9(-1561.793f, 4668.806f, 48.04337f, 218.9074f, 1, 0, 0, false);
			func_443();
			if (func_236(unk_0x33CD235DF1E6A94E()))
			{
		...
		if (func_463(Local_44.f_28[0]))
		{
			if (unk_0x3CA08F647CEAD042("Hunter", 0))
			{
				...
				if (func_441(Local_45, 1862763509, iLocal_368))
				{
					if (unk_0xE9CCF312047EBEE0(sLocal_379))
					{
						unk_0x108754262311D34F(Local_45, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
					}
				}
			}
		}
	...
	if (Local_43.f_1 == 3)
	{
		if (unk_0x15661F4AC08D433A())
		{
			...
			func_494(&Local_44, 0, 1);
			func_5(&iLocal_62);
			iLocal_187 = unk_0xE3903F59E2F22150() + 500;
			func_245(2);
			func_234();
		}
	}
...
int func_455(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_276(iVar2, iVar6) != 0)
	{
		if (!unk_0xD62C4419A41F106A(iParam0, 0))
		{
			if (unk_0xCC2C88B9353CAF70(iParam0, iVar2, func_276(iVar2, iVar6)))
			{
				if (func_458(func_276(iVar2, iVar6)))
				{
					iVar7 = unk_0x70418C66CB4C3F79(func_276(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_276(iVar2, iVar6) != 0)
	{
		if (!unk_0xD62C4419A41F106A(iParam0, 0))
		{
			if (unk_0xCC2C88B9353CAF70(iParam0, iVar2, func_276(iVar2, iVar6)))
			{
				unk_0x062CA5B6A29665F1(iVar1, func_276(iVar2, iVar6));
...
void func_460()
{
	...
	if ((((unk_0x3C05A6D663EA1B6A("SCRIPT\SAS_BANK_01", false, -1) && unk_0x3C05A6D663EA1B6A("SCRIPT\SAS_BANK_02", false, -1)) && unk_0x3C05A6D663EA1B6A("SAS_BANK_03", false, -1)) && func_362()) && func_361())
	{
		if (unk_0x5B3AD7A02822334D("AZ_DISTANT_SASQUATCH"))
		{
			unk_0x5F70D43CDB987564("AZ_DISTANT_SASQUATCH", 0, 1);
		}
		unk_0xE44D3FEE07A9EF2C(iLocal_378, true);
		if (func_463(unk_0x33CD235DF1E6A94E()))
		{
			func_232(&uLocal_199, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
		}
		if (func_499())
		{
			...
			{
				iVar1 = unk_0x0CE47CAB83B87E4B(unk_0x33CD235DF1E6A94E(), joaat("weapon_pumpshotgun"));
				if (unk_0x0757D4E12D1DE916(unk_0x33CD235DF1E6A94E(), iVar1) < 8)
				{
					unk_0x697EBA5CF1A6AB57(unk_0x33CD235DF1E6A94E(), joaat("weapon_pumpshotgun"), 8, true, true);
				}
			}
			else
			{
...
int func_495(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0x9BA5CF280376EEA4(25, iLocal_38, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
			if (func_463(uParam0->f_28[0]))
			{
				unk_0x697EBA5CF1A6AB57(uParam0->f_28[0], joaat("weapon_sniperrifle"), 100, true, true);
...
void func_500()
{
	...
	unk_0xE44D3FEE07A9EF2C(iLocal_378, false);
	func_10(0);
	func_8(0);
	func_2(0);
	func_449(&iLocal_385);
	unk_0xBBC0B8E2F3D2EEEC(vLocal_408, vLocal_409, 0);
	unk_0xCC323859A8DA2B88("WORLD_HUMAN_HIKER", true);
	unk_0xCC323859A8DA2B88("WORLD_MOUNTAIN_LION_WANDER", true);
...
int func_505(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_508())
	{
		...
		{
			iVar2 = func_318(unk_0xD178EF744F20B712());
			if (iVar2 > -1)
			{
