...
void func_182(int iParam0)
{
	...
	if ((unk_0xE3903F59E2F22150() - iLocal_58) > 1250)
	{
		if (func_126(iParam0->f_28[0]) && !unk_0x3F219400E5FE4B69(iParam0->f_28[0]))
		{
			if (func_126(unk_0x33CD235DF1E6A94E()) && !func_183(unk_0x33CD235DF1E6A94E(), iParam0->f_28[0], 50f, 1))
			{
				...
				unk_0x3C990C409B3845DE(iParam0->f_28[0], fVar2);
			}
		}
...
void func_184()
{
	...
	unk_0xBB698266C5FDF0A7(iLocal_56, "SET_COLOUR");
	...
	unk_0xBB698266C5FDF0A7(iLocal_56, "SET_DISTANCE");
	unk_0x8DAB5B12D7B9AD29(10f);
	unk_0x818901B332D5541D();
	unk_0x93B6B00E52590FB9(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x5A2C46836B4DF5B3(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0xE3903F59E2F22150() - iLocal_58) > 1250)
	{
		unk_0xEC95D37A139F1D5C(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0xE3903F59E2F22150();
	}
}
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	...
	if (!*uParam6 == 3)
	{
		if (func_173(2))
		{
			if (!func_145())
			{
				if ((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && func_192(unk_0x33CD235DF1E6A94E(), vParam1, 1) < 20f)
				{
			...
			if (func_192(unk_0x33CD235DF1E6A94E(), vParam1, 1) < 20f && *uParam6 == 1)
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !unk_0x1CE8F0A08E65CA6A(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_221(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_228(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_240()
{
	iLocal_56 = unk_0x199B24FF79A52CCF("digiscanner");
	while (!unk_0x11AE7F6A404414C9(iLocal_56))
	{
		wait(0);
	}
	...
	if (unk_0x464516DA815840A7("digiscanner"))
	{
		iLocal_57 = unk_0x61A52F6201AA9959("digiscanner");
	}
	iLocal_59 = unk_0x8CCC0A0504C52531();
	iLocal_58 = unk_0xE3903F59E2F22150();
}
...
int func_242(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			unk_0x5856B9BF2B4E98C4(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, false, 1);
			unk_0xB7350047030F7672(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_251(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				uParam0->f_41[0] = unk_0x7CA67831169E8AA6(iVar0[1], 2468.51f, 3437.39f, 55f, true, true, false);
			}
			if (!unk_0x765F6FEEFF39224F(uParam0->f_41[1]))
			{
				uParam0->f_41[1] = unk_0x7CA67831169E8AA6(iVar0[2], 2468.51f, 3437.39f, 57f, true, true, false);
			}
...
void func_265(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 45)
	{
		unk_0x5856B9BF2B4E98C4(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, true, 1);
	}
	if (bParam1)
	{
