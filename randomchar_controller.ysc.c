				...
				if (!func_42(74))
				{
					...
					else if (func_22(iLocal_56))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (unk_0xE38E3CF1625A4145(Global_26140[iVar3 /*23*/].f_19))
								{
									unk_0x0E734BC61706D976(Global_26140[iVar3 /*23*/].f_19, 1);
									unk_0x43598712EC9E921C(Global_26140[iVar3 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
{
	return (shift_right(iParam0, 26) & 31 * func_30(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (!func_76(iVar0) || iVar0 == 52)
	{
		if (!unk_0x0E4018692D92041D(Global_106565.f_18568.f_390[iLocal_52], iLocal_51))
		{
			...
			else if (Global_105652[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (unk_0x0E4018692D92041D(Global_26140[iLocal_54[Global_105652[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
...
void func_77(int iParam0)
{
	...
	if (unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 0) && !unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 3))
	{
		if (!Global_106565.f_18568[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				iVar2 = unk_0x9EC3B269A34A2BEE(3, 11);
				iVar2 *= 30;
	...
	else if (Global_105652[iParam0 /*10*/].f_3)
	{
		...
		if (!func_114() && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), Var0.f_6, false) > fVar13)
		{
			Global_105652[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar14 = 0;
	if ((((iVar12 && !unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 3)) && unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 0)) && unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 1)) && unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 2))
	{
	...
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!func_44(35))
		{
			if (unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 2) && !unk_0x0E4018692D92041D(Global_106565.f_18568[iParam0 /*6*/], 3))
			{
				...
				{
					if (vdist2(Var0.f_6, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true)) < 81f)
					{
						sVar16 = "";
						...
						if (!unk_0x786AF4A44E1B5B4B(sVar16))
						{
