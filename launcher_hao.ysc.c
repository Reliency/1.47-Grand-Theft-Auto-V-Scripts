...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0x0335D8135051EA56(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_197(-72.323f, -1258.643f, 28.648f, unk_0xFBB1F99A825CAB09(Var0.f_35[0], true), 1056964608))
			{
...
int func_181(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0x33CD235DF1E6A94E()) && func_126(uParam0->f_28[0])) && !func_145()) && (unk_0xE3903F59E2F22150() - uParam0->f_60) > iParam6) && func_185(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_186(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_185(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_185(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_191(iParam0);
				}
			}
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_217(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_224(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_235(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_242(&iVar0) || !unk_0xE9CCF312047EBEE0(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_35[0]))
			{
				...
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 0, 2, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 1, 1, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 2, 1, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 3, 1, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 4, 1, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 6, 0, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 7, 2, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 10, 0, false);
				unk_0xB4B3AEABE432069B(uParam0->f_35[0], 23, 20, false);
				unk_0xBCD21D2535E4A2C9(uParam0->f_35[0], 18, true);
				unk_0xBCD21D2535E4A2C9(uParam0->f_35[0], 17, true);
				unk_0xBCD21D2535E4A2C9(uParam0->f_35[0], 22, true);
		...
		case 3:
			...
			{
				iVar5 = unk_0x89DDAAE6EFF42DD9(uParam0->f_35[0], "chassis_dummy");
				vVar6 = { unk_0x2D49816199C51B0C(uParam0->f_35[0], iVar5) };
				iVar2 = unk_0x38A6890195DD00D1(vVar6, unk_0x60B5C1FD066CB864(uParam0->f_35[0], 2), 2);
				unk_0x6359F1F7F5174D4A(iVar2, true);
				unk_0x34C803C2BC1CAFB2(iVar2, false);
				unk_0x08798CBF817BA887(uParam0->f_28[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_257(int iParam0, bool bParam1)
{
	...
	unk_0xF1CFA0046BB67893(iLocal_54, 0);
	if (bParam1)
	{
		func_193(*iParam0);
	}
