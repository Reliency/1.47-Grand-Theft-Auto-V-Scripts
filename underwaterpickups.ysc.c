...
void __EntryFunction__()
{
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false) };
	func_1();
	while (true)
	{
		wait(0);
		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x6413BF5F9B062200(iVar1, vVar2, iVar4, iVar5, 1, 0);
					}
				}
				else if (vdist2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0x6413BF5F9B062200(iVar1, vVar2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x3B3AEF3A73FB80C9(iVar1, vVar2, vVar3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (vdist2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x3B3AEF3A73FB80C9(iVar1, vVar2, vVar3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()
{
	...
	while (iVar0 < 20)
	{
		if (unk_0xECCFCAB0A094EB5B(iLocal_3[iVar0]))
		{
			unk_0x40A22CF588A191A1(iLocal_3[iVar0]);
		}
		iVar0++;
	}
}
