...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		...
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (func_2(iLocal_34, unk_0x33CD235DF1E6A94E(), 1) > 850f)
				{
					func_3(2);
					return;
				}
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (func_2(iLocal_34, unk_0x33CD235DF1E6A94E(), 1) > 100f)
				{
					func_3(2);
					return;
				}
				else if ((unk_0x67001C5CC88C66A8(iLocal_34, 3, 30000) || unk_0x67001C5CC88C66A8(iLocal_34, 1, 40000)) || unk_0x67001C5CC88C66A8(iLocal_34, 0, 7000))
				{
					func_3(3);
					return;
				}
...
void func_28()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			unk_0xF70578F5CD9822CB(iLocal_34, false);
		}
		...
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
				{
					unk_0x0FF06FD8DEB3AB01(unk_0x33CD235DF1E6A94E(), iLocal_34, 0);
				}
			}
		}
		iLocal_76 = 1;
	...
	if (iLocal_54 == 1)
	{
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 1))
				{
					unk_0xB40411FADDCA9CC8(iLocal_34, 0, 0);
					unk_0xB40411FADDCA9CC8(iLocal_34, 1, 0);
					unk_0xD303E20CB0AE4AD0(iLocal_34, 2);
					unk_0x9152A6430680BF0A(iLocal_34, 0);
					unk_0xF70578F5CD9822CB(iLocal_34, true);
					func_29();
				}
			}
		}
...
void func_34()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_39, 0))
				{
					unk_0x094626C0798AE1F8(unk_0x33CD235DF1E6A94E(), iLocal_39, -1);
				}
			}
			else
			{
			...
			if (func_20() == 2)
			{
				if (unk_0x765F6FEEFF39224F(iLocal_34))
				{
					if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
					{
						if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
						{
							unk_0x094626C0798AE1F8(unk_0x33CD235DF1E6A94E(), iLocal_34, -1);
						}
						unk_0xF70578F5CD9822CB(iLocal_34, false);
					}
				}
...
void func_36()
{
	...
	{
		case 2:
			unk_0xCE04CE961AF41AB9(-1588.1f, 2794.9f, 17.2f, 20f, 1, 0, 0, false);
			...
			if (!unk_0x765F6FEEFF39224F(iLocal_34))
			{
				unk_0xCE04CE961AF41AB9(vLocal_118, 10f, 1, 0, 0, false);
				iLocal_34 = unk_0xC651C43AB13A15E5(joaat("cargobob"), vLocal_118, fLocal_122, 1, 1, 0);
				unk_0x5C307B2D58FCF9BC(iLocal_34, 0);
				unk_0xF70578F5CD9822CB(iLocal_34, true);
				unk_0x43D47AD82DA3C6EC(iLocal_34, 1, 1);
				unk_0x71CA80D41E1338B4(joaat("cargobob"));
				unk_0x8C4EA5F6857553AE(joaat("cargobob"), 1);
				unk_0xA155CCFA52A9A0C4(iLocal_34, 1);
				unk_0xD460482B9A347153(iLocal_34, 0);
			...
			if (!unk_0x765F6FEEFF39224F(iLocal_35[0]))
			{
				...
				{
					unk_0xCE04CE961AF41AB9(-1866.446f, 3071.395f, 31.8104f, 10f, 1, 0, 0, false);
					iLocal_35[0] = unk_0xC651C43AB13A15E5(joaat("buzzard"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, 1, 1, 0);
					unk_0x43D47AD82DA3C6EC(iLocal_35[0], 1, 1);
					unk_0x5C307B2D58FCF9BC(iLocal_35[0], 1);
					unk_0x1B2303F9DC2D90D5(iLocal_35[0], 1084227584);
					unk_0x7B1011A61F402324(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					unk_0x71CA80D41E1338B4(joaat("buzzard"));
					unk_0x9152A6430680BF0A(iLocal_35[0], 0);
				}
			}
			if (func_267())
			{
				if (!unk_0x765F6FEEFF39224F(iLocal_39))
				{
					if (func_107())
					{
						if (!unk_0x097E7778E3E162E8(func_106()) && !unk_0x57D74362A8BD1490(func_106()))
						{
							...
							unk_0x09993E7216CF52C4(iLocal_39, true);
							unk_0xA155CCFA52A9A0C4(iLocal_39, 1);
						}
					}
				}
			}
		...
		case 3:
			...
			if (!unk_0x765F6FEEFF39224F(iLocal_34))
			{
				...
				unk_0xF70578F5CD9822CB(iLocal_34, true);
				unk_0x43D47AD82DA3C6EC(iLocal_34, 1, 1);
				unk_0x44D61A9D5B660538(iLocal_34);
				unk_0x71CA80D41E1338B4(joaat("cargobob"));
				unk_0x8C4EA5F6857553AE(joaat("cargobob"), 1);
				unk_0xA155CCFA52A9A0C4(iLocal_34, 1);
				unk_0xD460482B9A347153(iLocal_34, 0);
			...
			if (!unk_0x765F6FEEFF39224F(iLocal_31[0]))
			{
				iLocal_31[0] = unk_0xE196503B36B6194B(iLocal_35[0], 26, joaat("s_m_m_pilot_02"), -1, 1, true);
				unk_0x71CA80D41E1338B4(joaat("s_m_m_pilot_02"));
			}
			else if (!unk_0x10930B9CAD4111C2(iLocal_31[0], iLocal_35[0], 0))
			{
				unk_0x094626C0798AE1F8(iLocal_31[0], iLocal_35[0], -1);
			}
			unk_0x697EBA5CF1A6AB57(unk_0x33CD235DF1E6A94E(), joaat("gadget_parachute"), -1, false, true);
			unk_0xF2376062423B42B9("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", true);
		...
		case 4:
			...
			{
				unk_0xCE04CE961AF41AB9(vLocal_118, 10f, 1, 0, 0, false);
				iLocal_34 = unk_0xC651C43AB13A15E5(joaat("cargobob"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, 1, 1, 0);
				unk_0x43D47AD82DA3C6EC(iLocal_34, 1, 1);
				unk_0x71CA80D41E1338B4(joaat("cargobob"));
				unk_0x8C4EA5F6857553AE(joaat("cargobob"), 1);
				unk_0xD460482B9A347153(iLocal_34, 0);
				unk_0xA155CCFA52A9A0C4(iLocal_34, 1);
				unk_0x9FABD0AB045A5D6E(iLocal_34, true, 1, 0);
				unk_0x44D61A9D5B660538(iLocal_34);
				unk_0x4522AD7364B6AA54(iLocal_34, 30f);
				func_102(iLocal_34, 0);
			}
			unk_0x697EBA5CF1A6AB57(unk_0x33CD235DF1E6A94E(), joaat("gadget_parachute"), -1, false, true);
			break;
		...
		case 5:
			...
			if (!unk_0x765F6FEEFF39224F(iLocal_34))
			{
				unk_0xCE04CE961AF41AB9(1749.61f, 3272.95f, 40.1533f, 5f, 1, 0, 0, false);
				iLocal_34 = unk_0xC651C43AB13A15E5(joaat("cargobob"), 1749.61f, 3272.95f, 40.1533f, 51.128f, 1, 1, 0);
				unk_0x43D47AD82DA3C6EC(iLocal_34, 1, 1);
				unk_0x71CA80D41E1338B4(joaat("cargobob"));
				unk_0xA155CCFA52A9A0C4(iLocal_34, 1);
				unk_0xD460482B9A347153(iLocal_34, 0);
			...
			{
				iLocal_36[0] = unk_0xC651C43AB13A15E5(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, 1, 1, 0);
				unk_0xF70578F5CD9822CB(iLocal_36[0], true);
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_8(vParam1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), true) < 10f)
					{
...
void func_99()
{
	if (iLocal_80 == 0)
	{
		...
		{
			if (!unk_0x765F6FEEFF39224F(iLocal_32[0]))
			{
				iLocal_32[0] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -1590.523f, 2796.302f, 15.9184f, 247.0896f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[1]))
			{
				iLocal_32[1] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2303.8f, 3387.99f, 30.034f, 58.5763f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[2]))
			{
				iLocal_32[2] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -1697.329f, 2909.941f, 31.9506f, 245.656f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[3]))
			{
				iLocal_32[3] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -1696.369f, 2905.772f, 31.9454f, 6.3714f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[4]))
			{
				iLocal_32[4] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -1843.707f, 2821.611f, 31.8528f, 271.6265f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[5]))
			{
				iLocal_32[5] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2006.877f, 2955.101f, 31.8103f, 332.0101f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[6]))
			{
				iLocal_32[6] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2010.022f, 2956.805f, 31.8103f, 288.1283f, 1, true);
			}
			if (iLocal_28 != 3)
			{
				if (!unk_0x765F6FEEFF39224F(iLocal_32[7]))
				{
					iLocal_32[7] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2140.213f, 3034.609f, 31.81f, 302.4493f, 1, true);
				}
				if (!unk_0x765F6FEEFF39224F(iLocal_32[8]))
				{
					iLocal_32[8] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2136.053f, 3031.494f, 31.81f, 38.6856f, 1, true);
				}
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[9]))
			{
				iLocal_32[9] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2035.429f, 3058.876f, 31.8103f, 169.8222f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[10]))
			{
				iLocal_32[10] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2146.467f, 3160.749f, 31.8106f, 356.4766f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[11]))
			{
				iLocal_32[11] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2280.087f, 3172.423f, 31.8103f, 353.663f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_32[12]))
			{
				iLocal_32[12] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_y_marine_01"), -2277.376f, 3177.8f, 31.8103f, 175.0685f, 1, true);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_31[0]))
			{
				iLocal_31[0] = unk_0x9BA5CF280376EEA4(26, joaat("s_m_m_pilot_02"), -1859.831f, 3071.758f, 31.8104f, 139.3607f, 1, true);
				unk_0x73D993BCA1CEC58D(iLocal_31[0], 0, 2, 0, false);
				unk_0x93AA93DA1B137032(iLocal_31[0], 8, 0, 0, 0);
				unk_0x43D47AD82DA3C6EC(iLocal_31[0], 1, 1);
				unk_0x697EBA5CF1A6AB57(iLocal_31[0], joaat("weapon_assaultrifle"), 2000, true, true);
				unk_0x0648A75D3F60E864(iLocal_31[0], iLocal_44);
				unk_0xDE9FF07CFD5DC172(iLocal_31[0], 0);
				unk_0x4A852F02088ECC9D(iLocal_31[0], 1);
			...
			while (iLocal_55 <= 12)
			{
				...
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_55]))
					{
						unk_0x43D47AD82DA3C6EC(iLocal_32[iLocal_55], 1, 1);
						unk_0x697EBA5CF1A6AB57(iLocal_32[iLocal_55], joaat("weapon_assaultrifle"), 2000, true, true);
						unk_0x0648A75D3F60E864(iLocal_32[iLocal_55], iLocal_44);
						unk_0xDE9FF07CFD5DC172(iLocal_32[iLocal_55], 10);
						func_101(iLocal_32[iLocal_55], 595);
						func_100(iLocal_32[iLocal_55], 0);
						unk_0x4A852F02088ECC9D(iLocal_32[iLocal_55], 1);
...
void func_115()
{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
	{
		unk_0x4B8B69DAE5BAC592(&(iLocal_31[0]));
	}
	iLocal_55 = 0;
	while (iLocal_55 <= 12)
	{
		if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_55]))
		{
			unk_0x4B8B69DAE5BAC592(&(iLocal_32[iLocal_55]));
		}
		iLocal_55++;
	}
	if (func_20() == 2)
	{
		if (unk_0x765F6FEEFF39224F(uLocal_124[0]))
		{
			unk_0x4B8B69DAE5BAC592(&(uLocal_124[0]));
		}
	}
	if (func_20() == 0)
	{
		if (unk_0x765F6FEEFF39224F(uLocal_124[2]))
		{
			unk_0x4B8B69DAE5BAC592(&(uLocal_124[2]));
		}
	}
	if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
	{
		unk_0xA6E32819044BBB6A(iLocal_35[0], 0);
	}
	...
	if (unk_0x765F6FEEFF39224F(iLocal_39))
	{
		unk_0x7AC8DF0B83EB4C6B(&iLocal_39);
	}
	if (unk_0x765F6FEEFF39224F(iLocal_34))
	{
		unk_0x7AC8DF0B83EB4C6B(&iLocal_34);
	}
	if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
	{
		unk_0x7AC8DF0B83EB4C6B(&(iLocal_35[0]));
	}
	...
	if (unk_0x765F6FEEFF39224F(iLocal_36[0]))
	{
		unk_0x7AC8DF0B83EB4C6B(&(iLocal_36[0]));
	}
	if (unk_0x765F6FEEFF39224F(iLocal_42))
	{
		unk_0xEC26F4BFC9942A0C(&iLocal_42);
	}
	if (unk_0x765F6FEEFF39224F(iLocal_43))
	{
		unk_0xEC26F4BFC9942A0C(&iLocal_43);
	}
	if (unk_0x117DAF3BF7232886(iLocal_40))
	{
		if (unk_0x49D25022440E65EE(iLocal_40))
		{
			unk_0x63F0B040CE6EDF0F(false, false, 3000, 1, 0, 0);
		}
		unk_0x2F8A4DF7D0DFF0A8(iLocal_40, 0);
	}
}

void func_116()
{
	if (unk_0xE38E3CF1625A4145(iLocal_45))
	{
		unk_0x1ABDB383C83A336A(&iLocal_45);
	}
	if (unk_0xE38E3CF1625A4145(iLocal_46))
	{
		unk_0x1ABDB383C83A336A(&iLocal_46);
	}
	if (unk_0xE38E3CF1625A4145(iLocal_48))
	{
		unk_0x1ABDB383C83A336A(&iLocal_48);
	}
	iLocal_55 = 0;
	while (iLocal_55 <= 12)
	{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_34))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
		{
			if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
			{
				...
				if (iLocal_107 == 1)
				{
					if (unk_0xE3903F59E2F22150() < iLocal_68 + 7500)
					{
						unk_0xD362430CD61A9B08();
					}
				}
				...
				if (iLocal_28 == 3)
				{
					if (!unk_0xE38E3CF1625A4145(uLocal_47[0]))
					{
			...
			else if (iLocal_28 != 5)
			{
				...
				if (iLocal_28 == 3)
				{
					if (unk_0xE38E3CF1625A4145(uLocal_47[0]))
					{
						unk_0x1ABDB383C83A336A(&(uLocal_47[0]));
					}
				}
				if (iLocal_28 == 4)
				{
					if (iLocal_78 == 1)
					{
						if (unk_0xE3903F59E2F22150() < iLocal_69 + 7500)
						{
							unk_0xD362430CD61A9B08();
						}
					}
...
int func_120(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_121(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_121(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(iVar0, bParam1);
	}
	...
	if (iLocal_54 == 0)
	{
		...
		while (iLocal_55 <= 12)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_55]))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_55]))
				{
					unk_0x897EF720254BBEA3(iLocal_32[iLocal_55], true);
					unk_0x1F45B4626AC4A4C0(&(iLocal_32[iLocal_55]));
				}
			}
			iLocal_55++;
		}
		if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
		{
			unk_0x65F544B458249682(&(iLocal_35[0]));
		}
		if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
		{
			unk_0x1F45B4626AC4A4C0(&(iLocal_31[0]));
		}
		if (!unk_0x7C71681384076318("DH_P_2B_ENTER_CHOPPER"))
		{
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_115 == 0)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_34))
			{
				if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
				{
					if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
					{
						if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_118, true) > 800f)
						{
		...
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
				{
					if (unk_0x7DD221C91135596A(iLocal_34))
					{
						if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_118, true) > 800f)
						{
							if (iLocal_111 == 0 && iLocal_78 == 1)
							{
								if (!unk_0xC4B7D5901EDA35B5())
								{
									if (!func_124() || !unk_0x75E8D03BBC787BAD())
									{
										func_143(&uLocal_198, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
		...
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
				{
					if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_119, 2f, 2f, 2f, 1, true, 0))
					{
					}
					if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (!unk_0x7DD221C91135596A(iLocal_34) && unk_0x61DFE32FB87BC784(iLocal_34))
						{
							func_127(1, 600);
...
void func_144(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_211(unk_0xD178EF744F20B712(), 1);
			if (iVar4 != -1)
			{
...
void func_164(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_169(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x078B659F6F2C8960(iVar5, &Var7) && !func_166(Var7.f_1)) && iVar9 < 51)
			{
...
int func_174(var uParam0)
{
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (func_197())
		{
			*uParam0 = func_180(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), 6, -1, 0, 1, -1);
...
int func_180(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_196(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(vParam0, func_181(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_204(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_223()
{
	if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_119, true) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!unk_0x765F6FEEFF39224F(iLocal_36[0]))
	...
	{
		if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_119, true) > 550f)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_36[0]))
			{
				unk_0x7AC8DF0B83EB4C6B(&(iLocal_36[0]));
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_83[0] == 1)
		{
			...
			if (unk_0x765F6FEEFF39224F(iLocal_34))
			{
				if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
				{
					if (unk_0xD4B4F68F3449CBEC(iLocal_34, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
						{
							unk_0x98F04A4FFB4AD01C(unk_0x95B959F18401C09A(), 0, 0);
...
void func_228()
{
	iLocal_37 = unk_0xACC2D6D9762C28BB(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 300f, joaat("lazer"), 4);
	iLocal_38 = unk_0xACC2D6D9762C28BB(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 300f, joaat("lazer"), 16386);
	if (unk_0x765F6FEEFF39224F(iLocal_37) && unk_0x7DD221C91135596A(iLocal_37))
	{
		if (!unk_0xE38E3CF1625A4145(iLocal_48))
		{
			iLocal_48 = unk_0x8848A15CBDADDC60(iLocal_37);
			unk_0xBF11C8A43770C598(iLocal_48, false);
		}
	}
	if (unk_0x765F6FEEFF39224F(iLocal_38) && unk_0x7DD221C91135596A(iLocal_38))
	{
		if (!unk_0xE38E3CF1625A4145(iLocal_49))
		{
			iLocal_49 = unk_0x8848A15CBDADDC60(iLocal_38);
			unk_0xBF11C8A43770C598(iLocal_49, false);
		}
	}
}
...
void func_229()
{
	if (iLocal_28 == 3)
	{
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
				{
					vLocal_121 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) };
					if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
					{
						if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
						{
							if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
								{
									if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_31[0], 1) < 600f)
									{
										if (unk_0x16E00F066AFFEA0D(vLocal_121, -75.8f, -819.9f, 326f, true) > 1600f && unk_0x16E00F066AFFEA0D(vLocal_121, -2159f, 3067f, 33f, true) < 1000f)
										{
											if (vLocal_121.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (unk_0x16E00F066AFFEA0D(vLocal_121, -75.8f, -819.9f, 326f, true) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
											...
											if (unk_0x16E00F066AFFEA0D(vLocal_121, -2159f, 3067f, 33f, true) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
				...
				else if (unk_0x16E00F066AFFEA0D(vLocal_121, -75.8f, -819.9f, 326f, true) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_90[0] = 1;
			...
			if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
			{
				if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
				{
					if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
					{
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
						{
							if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_31[0], 1) < 200f)
							{
								vLocal_120 = { unk_0xFBB1F99A825CAB09(iLocal_35[0], true) };
								unk_0xED68CDDDE25A144E(iLocal_31[0]);
								unk_0xAF4482B584BBF3B8(iLocal_31[0], vLocal_120, 10f, 0, 0);
								unk_0x77631BBB824DF500(iLocal_31[0], 250f, 0);
								iLocal_81[0] = 1;
							}
						}
					}
				...
				if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
				{
					if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
					{
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
						{
							...
							vLocal_120 = { unk_0xFBB1F99A825CAB09(iLocal_35[0], true) };
							unk_0xED68CDDDE25A144E(iLocal_31[0]);
							unk_0x99414FB2D30425C1(&uLocal_367);
							if (!unk_0x10930B9CAD4111C2(iLocal_31[0], iLocal_35[0], 0))
							{
								unk_0xC838CE9837D0ABAF(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							unk_0x9DB29D916EF1BFB2(0, iLocal_35[0], 0, 0, vLocal_120.x, vLocal_120.y, (vLocal_120.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
							unk_0x9DB29D916EF1BFB2(0, iLocal_35[0], 0, unk_0x33CD235DF1E6A94E(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1f, 0);
							unk_0xC734F59A13D39AEF(uLocal_367);
							unk_0x13A2D602CD10CBAC(iLocal_31[0], uLocal_367);
							unk_0xA7A57E7757ED035E(&uLocal_367);
							iLocal_81[0] = 1;
						}
					}
				}
			...
			if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
			{
				if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
					{
						if (unk_0x10930B9CAD4111C2(iLocal_31[0], iLocal_35[0], 0))
						{
							if (unk_0xE3903F59E2F22150() > (iLocal_67 + 90000))
							{
								if (iLocal_104 == 0)
								{
									unk_0xDE9FF07CFD5DC172(iLocal_31[0], 100);
									iLocal_103 = 0;
									iLocal_104 = 1;
								}
							}
							else if (unk_0xE3903F59E2F22150() > iLocal_67 + 10000 && !unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
							{
								if (iLocal_104 == 0)
								{
									unk_0xDE9FF07CFD5DC172(iLocal_31[0], 100);
							...
							if (func_2(iLocal_35[0], unk_0x33CD235DF1E6A94E(), 1) < 300f)
							{
								if (iLocal_106 == 0)
								{
									unk_0xE9FB70AC1925C2B4(iLocal_31[0], joaat("vehicle_weapon_space_rocket"));
									unk_0x5BFA1F420ED32CFF(iLocal_31[0], -1857128337);
									iLocal_105 = 0;
									iLocal_106 = 1;
								}
							}
							...
							{
								unk_0xE9FB70AC1925C2B4(iLocal_31[0], joaat("vehicle_weapon_player_buzzard"));
								unk_0x5BFA1F420ED32CFF(iLocal_31[0], 1566631136);
								iLocal_106 = 0;
								iLocal_105 = 1;
							}
						}
					...
					if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
					{
						if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
						{
							if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
								{
									unk_0x9DB29D916EF1BFB2(iLocal_31[0], iLocal_35[0], 0, unk_0x33CD235DF1E6A94E(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
					{
						if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
						{
							if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
								{
									unk_0x9DB29D916EF1BFB2(iLocal_31[0], iLocal_35[0], 0, unk_0x33CD235DF1E6A94E(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
					{
						if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
						{
							if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
								{
									unk_0x9DB29D916EF1BFB2(iLocal_31[0], iLocal_35[0], 0, unk_0x33CD235DF1E6A94E(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
					{
						if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
						{
							if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
								{
									unk_0x9DB29D916EF1BFB2(iLocal_31[0], iLocal_35[0], 0, 0, unk_0x2CA911E7569D12EA(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, unk_0xC472E34C8FBEC678(iLocal_35[0]), round(unk_0x98DA32975E6E1DD8(iLocal_35[0], unk_0xFBB1F99A825CAB09(iLocal_35[0], true), 1, 1)), 100, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
						...
						if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
						{
							if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
							{
								if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
								{
									if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
									{
										unk_0x9DB29D916EF1BFB2(iLocal_31[0], iLocal_35[0], 0, unk_0x33CD235DF1E6A94E(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1f, 0);
										iLocal_102 = 1;
									}
								}
							}
					...
					if (unk_0x765F6FEEFF39224F(iLocal_35[0]))
					{
						if (unk_0x91D5C8283D19AF49(iLocal_35[0], 0))
						{
							if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
								{
									unk_0x9DB29D916EF1BFB2(iLocal_31[0], iLocal_35[0], 0, unk_0x33CD235DF1E6A94E(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
			...
			if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
				{
					if (unk_0x10930B9CAD4111C2(iLocal_31[0], iLocal_35[0], 0))
					{
						if (unk_0xE38E3CF1625A4145(uLocal_47[0]))
						{
							unk_0xCE5C49921A521962(uLocal_47[0], 1f);
						}
					}
					if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_31[0], 1) > 600f)
					{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_31[0]))
	{
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_31[0]))
		{
			if (unk_0x8AE34E8B10270D31(iLocal_31[0]))
			{
				unk_0xED68CDDDE25A144E(iLocal_31[0]);
				unk_0x7FC2040EB34E0E31(iLocal_31[0], 0, 0);
				if (unk_0xE38E3CF1625A4145(uLocal_47[0]))
				{
					unk_0x1ABDB383C83A336A(&(uLocal_47[0]));
				}
...
void func_230()
{
	if (iLocal_85 == 0)
	{
		if ((((func_231(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 3, 0, 0) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1601.514f, 2794.148f, 14.84222f, -1587.692f, 2806.101f, 20.29557f, 16f, 0, true, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1598.278f, 2803.98f, 17.01772f, -1665.98f, 2895.398f, 34.58953f, 14.5f, 0, true, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1648.554f, 2873.74f, 24.85017f, -1673.864f, 2889.698f, 38.18856f, 14.5f, 0, true, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1647.446f, 2873.969f, 24.82373f, -1667.316f, 2914.302f, 39.39478f, 14.5f, 0, true, 0))
		{
			iLocal_85 = 1;
		}
	}
	...
	if (iLocal_80 == 1)
	{
				...
				if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_55]))
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_55]))
					{
						if (unk_0x765F6FEEFF39224F(iLocal_34))
						{
							if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
							{
								if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0) || iLocal_87 == 1)
								{
									if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[iLocal_55], 1) < 39f)
									{
										if (iLocal_91[iLocal_55] == 0)
										{
											unk_0xED68CDDDE25A144E(iLocal_32[iLocal_55]);
											unk_0xAF4482B584BBF3B8(iLocal_32[iLocal_55], unk_0xFBB1F99A825CAB09(iLocal_32[iLocal_55], true), 50f, 0, 0);
											unk_0x277716E9E7CC0692(iLocal_32[iLocal_55], unk_0x33CD235DF1E6A94E(), 0, 16);
											unk_0x28F648743D7DE312(iLocal_32[iLocal_55], 51, true);
											unk_0x28F648743D7DE312(iLocal_32[iLocal_55], 43, true);
									...
									else if (iLocal_92[iLocal_55] == 0)
									{
										unk_0xED68CDDDE25A144E(iLocal_32[iLocal_55]);
										unk_0x99414FB2D30425C1(&uLocal_367);
										unk_0x7E268975AF5EA74F(0, unk_0xFBB1F99A825CAB09(iLocal_34, true), 2f, -1, 20f, 0, 1193033728);
										unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
										unk_0xC734F59A13D39AEF(uLocal_367);
										unk_0x13A2D602CD10CBAC(iLocal_32[iLocal_55], uLocal_367);
										unk_0xA7A57E7757ED035E(&uLocal_367);
										iLocal_93[iLocal_55] = 0;
										iLocal_94[iLocal_55] = 0;
								...
								else
								{
									...
									if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[iLocal_55], 1) > 41f && func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[iLocal_55], 1) < 400f)
									{
										if (iLocal_94[iLocal_55] == 0)
										{
											iLocal_74 = unk_0x9EC3B269A34A2BEE(0, 4);
											unk_0xED68CDDDE25A144E(iLocal_32[iLocal_55]);
											unk_0xAF4482B584BBF3B8(iLocal_32[iLocal_55], unk_0xFBB1F99A825CAB09(iLocal_32[iLocal_55], true), 50f, 0, 0);
											unk_0x99414FB2D30425C1(&uLocal_367);
											if (iLocal_74 == 0)
											{
												unk_0x3C0F6044C54799A8(0, unk_0x33CD235DF1E6A94E(), -1, 25f, 2f, 1073741824, 0);
											}
											else if (iLocal_74 == 1)
											{
		...
		if (((iLocal_85 == 0 && iLocal_98 == 0) && iLocal_109 == 0) && iLocal_86 == 0)
		{
			...
			while (iLocal_72 <= 1)
			{
				if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_72]))
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_72]))
					{
						if (func_2(iLocal_32[iLocal_72], unk_0x33CD235DF1E6A94E(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								if (!unk_0x3F219400E5FE4B69(iLocal_32[iLocal_72]))
								{
									unk_0x31826EF4A8BC8E9F(iLocal_32[iLocal_72]);
								}
								else
								{
									unk_0xED68CDDDE25A144E(iLocal_32[iLocal_72]);
								}
								unk_0x4DDF5809B68AA635(iLocal_32[iLocal_72], unk_0x33CD235DF1E6A94E(), -1, 0);
								iLocal_101[iLocal_72] = 1;
							}
							if (iLocal_110 == 1)
							{
								if (unk_0xE3903F59E2F22150() > iLocal_70 + 20000)
								{
									iLocal_109 = 1;
								}
							}
						}
						else if (func_2(iLocal_32[iLocal_72], unk_0x33CD235DF1E6A94E(), 1) > 30f)
						{
...
void func_232()
{
		...
		if (!unk_0x765F6FEEFF39224F(iLocal_35[0]))
		{
			if (unk_0x765F6FEEFF39224F(Global_90209[1]))
			{
				if (unk_0x91D5C8283D19AF49(Global_90209[1], 0))
				{
					...
					unk_0x5C307B2D58FCF9BC(iLocal_35[0], 1);
					unk_0x43D47AD82DA3C6EC(iLocal_35[0], 1, 1);
					unk_0xF70578F5CD9822CB(iLocal_35[0], false);
					unk_0x7B1011A61F402324(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					unk_0x9152A6430680BF0A(iLocal_35[0], 0);
				}
			}
	...
	if (iLocal_54 == 1)
	{
		if (unk_0xB98788B42580C4A8("ARMY_GUARD"))
		{
			...
			{
				unk_0x8411BDAD24F96365("ARMY_GUARD", false);
			}
		}
		func_99();
		if (iLocal_86 == 0)
		{
			if (unk_0xE3903F59E2F22150() > iLocal_61 + 3000)
			{
				iLocal_63 = 0;
				while (iLocal_63 <= 12)
				{
					if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_63]))
					{
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_63]))
						{
							if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[iLocal_63], 1) < 40f)
							{
								if (unk_0xDAAA48CE50D80F52(iLocal_32[iLocal_63], unk_0x33CD235DF1E6A94E()))
								{
									if (unk_0x085941C2A0E1ABAF(unk_0x33CD235DF1E6A94E()))
									{
										unk_0xF2376062423B42B9("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", false);
										unk_0xE4F4DE6178AB3FC1("AZ_AFB_ALARM_SPEECH", 1, 1);
										iLocal_86 = 1;
									}
									if (iLocal_85 == 1)
									...
									else if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && !func_237(0))
									{
										if (func_236(unk_0x33CD235DF1E6A94E()) != joaat("weapon_unarmed"))
										{
											if (unk_0xE3903F59E2F22150() > iLocal_73 + 3000)
											{
												unk_0xF2376062423B42B9("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", false);
												unk_0xE4F4DE6178AB3FC1("AZ_AFB_ALARM_SPEECH", 1, 1);
												iLocal_86 = 1;
		...
		if (unk_0x765F6FEEFF39224F(iLocal_34))
		{
			if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
			{
				if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_34, 1) < 30f)
				{
					iLocal_87 = 1;
				}
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
	...
	if (unk_0x765F6FEEFF39224F(Global_97130.f_4))
	{
		if (unk_0x91D5C8283D19AF49(Global_97130.f_4, 0))
		{
			if (func_249(24) != Global_97130.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_246(unk_0xFBB1F99A825CAB09(Global_97130.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_250()
{
	if (iLocal_54 == 0)
	{
		...
		func_254(4, 0);
		func_254(12, 0);
		unk_0x9315FCF6CFE2AB41("MarineGroupHash", &iLocal_44);
		unk_0xD2E80177F27FD43F(5, iLocal_44, 1862763509);
		unk_0xD2E80177F27FD43F(5, -472287501, 1862763509);
		unk_0xD2E80177F27FD43F(1, iLocal_44, -472287501);
		unk_0xD2E80177F27FD43F(1, -472287501, iLocal_44);
		unk_0xD2E80177F27FD43F(1, -1533126372, iLocal_44);
		unk_0xD2E80177F27FD43F(1, iLocal_44, -1533126372);
		unk_0xD2E80177F27FD43F(1, -1533126372, -472287501);
		unk_0xD2E80177F27FD43F(1, -472287501, -1533126372);
		if (func_267())
		{
			if (Global_87889 == 1)
			{
...
void func_251()
{
	...
	if (!unk_0x765F6FEEFF39224F(iLocal_34))
	{
		...
		iLocal_34 = unk_0xC651C43AB13A15E5(joaat("cargobob"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, 1, 1, 0);
		unk_0xB40411FADDCA9CC8(iLocal_34, 0, 1);
		unk_0xB40411FADDCA9CC8(iLocal_34, 1, 1);
		unk_0xD303E20CB0AE4AD0(iLocal_34, 2);
		unk_0xA155CCFA52A9A0C4(iLocal_34, 1);
		unk_0xF70578F5CD9822CB(iLocal_34, true);
		unk_0xD460482B9A347153(iLocal_34, 0);
	...
	if (unk_0x765F6FEEFF39224F(iLocal_34))
	{
		if (unk_0x91D5C8283D19AF49(iLocal_34, 0))
		{
			if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_34, 0))
				{
					if (unk_0xEE984ED4E4A374BE(unk_0x33CD235DF1E6A94E(), iLocal_34))
					{
						if (func_257(unk_0x33CD235DF1E6A94E(), iLocal_34) == -1)
						{
...
void func_258()
{
	if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		{
			if (func_231(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 3, 200, 0) || iLocal_86 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) != 0 && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_118, true) > 1000f)
			{
				unk_0x98F04A4FFB4AD01C(unk_0x95B959F18401C09A(), 0, 0);
				unk_0x66D901F8097E8E86(unk_0x95B959F18401C09A(), 0);
			}
...
void func_260()
{
	if (iLocal_98 == 0)
	{
		...
		while (iLocal_64 <= 12)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_64]))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_64]))
				{
					if (unk_0xDAAA48CE50D80F52(iLocal_32[iLocal_64], unk_0x33CD235DF1E6A94E()))
					{
						if (func_2(iLocal_32[iLocal_64], unk_0x33CD235DF1E6A94E(), 1) < 40f)
						{
						...
						if (func_2(iLocal_32[iLocal_64], unk_0x33CD235DF1E6A94E(), 1) < 25f)
						{
							if (func_236(unk_0x33CD235DF1E6A94E()) != joaat("weapon_unarmed"))
							{
	...
	if (iLocal_85 == 0)
	{
		...
		while (iLocal_71 <= 1)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_71]))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_71]))
				{
					if (iLocal_99 == 0 && iLocal_100 == 0)
					{
						if (!func_124())
						{
							if (!unk_0xC4B7D5901EDA35B5() || !unk_0x75E8D03BBC787BAD())
							{
								if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (unk_0xDAAA48CE50D80F52(iLocal_32[iLocal_71], unk_0x33CD235DF1E6A94E()))
									{
										if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && !func_237(0))
										{
											if (func_236(unk_0x33CD235DF1E6A94E()) != joaat("weapon_unarmed"))
											{
												if (unk_0x765F6FEEFF39224F(iLocal_32[0]))
												{
													if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[0]))
													{
														if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[0], 1) < 30f)
														{
												...
												if (unk_0x765F6FEEFF39224F(iLocal_32[1]))
												{
													if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[1]))
													{
														if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[1], 1) < 30f)
														{
					...
					if (iLocal_99 == 1 || iLocal_100 == 1)
					{
						if (iLocal_98 == 0 && iLocal_85 == 0)
						{
							if (iLocal_117 == 0)
							{
								if (unk_0xE3903F59E2F22150() > iLocal_65 + 8000)
								{
									if (!func_124())
									{
										if (!unk_0xC4B7D5901EDA35B5() || !unk_0x75E8D03BBC787BAD())
							...
							if (unk_0xE3903F59E2F22150() > iLocal_66 + 8000)
							{
								if (!func_124())
								{
									if (!unk_0xC4B7D5901EDA35B5() || !unk_0x75E8D03BBC787BAD())
	...
	if (unk_0xE3903F59E2F22150() > iLocal_56 + 12000)
	{
		if (iLocal_85 == 1 || iLocal_98 == 1)
		{
			if (!unk_0xC4B7D5901EDA35B5() || !unk_0x75E8D03BBC787BAD())
			{
				if (!func_124())
				{
					if (func_264())
					{
						iLocal_60 = unk_0x9EC3B269A34A2BEE(0, 6);
						if (iLocal_60 == 0)
						{
...
{
	unk_0xAEED0213982928AC(iParam0, sParam1, func_262(iParam2), 1);
}
...
int func_263()
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		unk_0x730FAC2C24A116EC(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 30f, 0, 1, &iVar0, 0, 1, -1);
	}
	iLocal_58 = 0;
	while (iLocal_58 <= 9)
	{
		if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_58]))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_58]))
			{
...
int func_264()
{
	...
	while (iLocal_59 <= 9)
	{
		if (unk_0x765F6FEEFF39224F(iLocal_32[iLocal_59]))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_32[iLocal_59]))
			{
				if (func_2(unk_0x33CD235DF1E6A94E(), iLocal_32[iLocal_59], 1) < 25f)
				{
					return 1;
				}
			}
...
void func_266()
{
	if (unk_0xB98788B42580C4A8("ARMY_HELI"))
	{
		...
		{
			unk_0x8411BDAD24F96365("ARMY_HELI", false);
		}
	}
}
...
void func_268()
{
	...
	unk_0x5856B9BF2B4E98C4(-2024.2f, 2968f, 30.2f, -2004f, 2921.5f, 37.6f, false, 1);
	unk_0x5856B9BF2B4E98C4(-2133.3f, 2993.7f, 41.1f, -2152.7f, 3039.4f, 31.6f, false, 1);
	unk_0x5856B9BF2B4E98C4(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, false, 1);
	iLocal_50 = unk_0x0335D8135051EA56(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, 0, 1, 1, 1);
	iLocal_52 = unk_0x0335D8135051EA56(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, 0, 1, 1, 1);
	unk_0xCE04CE961AF41AB9(-1876.8f, 2806.1f, 32.3f, 8f, 1, 0, 0, false);
	unk_0xCE04CE961AF41AB9(-1857.7f, 2797.9f, 32.4f, 8f, 1, 0, 0, false);
	unk_0xBDD4EE948C7B9BB5("WantedMusicOnMission", 1);
	unk_0x8C4EA5F6857553AE(joaat("buzzard"), 1);
	unk_0x5856B9BF2B4E98C4(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, false, 1);
	unk_0x7F327D8D184FAB7F(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, 0);
	unk_0x5856B9BF2B4E98C4(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, false, 1);
...
void func_270()
{
	...
	unk_0x7FAC83ACC79AB3AB(1);
	unk_0x5856B9BF2B4E98C4(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, true, 1);
	unk_0x5856B9BF2B4E98C4(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, true, 1);
	unk_0x458484959AA7E2D0();
	unk_0xF1CFA0046BB67893(iLocal_50, 0);
	unk_0xF1CFA0046BB67893(iLocal_51, 0);
	unk_0xF1CFA0046BB67893(iLocal_52, 0);
	func_254(1, 1);
	func_254(2, 1);
	func_254(7, 1);
	func_254(8, 1);
	...
	if (unk_0xB98788B42580C4A8("ARMY_GUARD"))
	{
		if (!unk_0x7FC8FAE3451A21AD("ARMY_GUARD"))
		{
			unk_0x8411BDAD24F96365("ARMY_GUARD", true);
		}
	}
	unk_0x4CCF49FD38F157B1("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 1);
	unk_0xE4F4DE6178AB3FC1("AZ_AFB_ALARM_SPEECH", 0, 0);
	...
	if (unk_0xB98788B42580C4A8("ARMY_HELI"))
	{
		if (!unk_0x7FC8FAE3451A21AD("ARMY_HELI"))
		{
			unk_0x8411BDAD24F96365("ARMY_HELI", true);
		}
	}
	unk_0xCEE359851F3C8198(iLocal_44);
