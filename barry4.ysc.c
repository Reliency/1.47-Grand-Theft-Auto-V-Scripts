...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_215(&uLocal_83, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
...
int func_303(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_273(unk_0x541D5C57194E73C4(*iParam0), 1) && unk_0xEECA910C75BFF02B(*iParam0, 24) != func_306(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xB4B3AEABE432069B(*iParam0, 24, func_306(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_305(iParam0);
	if (func_304(*iParam0))
	{
...
int func_321(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_323(iParam0, uVar1[iVar3], 1) && func_322(unk_0xFBB1F99A825CAB09(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_317(vParam1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, 1), unk_0xFBB1F99A825CAB09(uVar1[iVar3], 1), true) < 10f)
					{
...
int func_365(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_371())
	{
		...
		{
			iVar2 = func_366(unk_0xD178EF744F20B712());
			if (iVar2 > -1)
			{
