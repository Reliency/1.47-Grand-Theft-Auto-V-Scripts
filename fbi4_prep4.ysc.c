	...
	switch (iLocal_81)
	{
		case 0:
			...
			if (!unk_0x786AF4A44E1B5B4B(sLocal_187))
			{
				...
				{
					while ((unk_0xE3903F59E2F22150() - iLocal_199) < 3000)
					{
						wait(0);
					}
				}
...
void func_22()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (func_87(unk_0x33CD235DF1E6A94E(), vLocal_196, 2f) && func_81(21))
			{
			...
			else
			{
				...
				else if (!func_87(unk_0x33CD235DF1E6A94E(), vLocal_195, 75f))
				{
					if (!iLocal_201)
					{
						func_21(&iLocal_192);
				...
				else if (func_87(unk_0x33CD235DF1E6A94E(), vLocal_196, 12f))
				{
					if (iLocal_201)
					{
						func_21(&iLocal_192);
					...
					if (unk_0xE38E3CF1625A4145(iLocal_192))
					{
						unk_0xB9E84A421C105943(iLocal_192, 2);
						unk_0x5010BC506444793E(iLocal_192, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((unk_0xE3903F59E2F22150() - iLocal_198) > 2000)
			{
				func_21(&iLocal_192);
...
int func_88(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (bParam1)
			{
				func_89(unk_0x33CD235DF1E6A94E(), vLocal_196, 261.2839f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
...
int func_91(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			unk_0x2EE8D1440C9060EF(sLocal_203, 6);
...
void func_95()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_87(unk_0x33CD235DF1E6A94E(), vLocal_195, 60f))
				{
		...
		case 3:
			func_89(unk_0x33CD235DF1E6A94E(), vLocal_196, 0f);
			func_23(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
int func_170(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_139(unk_0x541D5C57194E73C4(*iParam0), 1) && unk_0xEECA910C75BFF02B(*iParam0, 24) != func_173(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xB4B3AEABE432069B(*iParam0, 24, func_173(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_172(iParam0);
	if (func_171(*iParam0))
	{
...
int func_191(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_192(iParam0, uVar1[iVar3], 1) && func_92(unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_187(vParam1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), true) < 10f)
					{
	...
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			if (!bLocal_190)
			{
				...
				{
					iLocal_199 = unk_0xE3903F59E2F22150();
					func_221(4);
					return;
				}
			}
			...
			if (!bLocal_190)
			{
				if (!func_87(unk_0x33CD235DF1E6A94E(), vLocal_195, 150f))
				{
					func_221(2);
				}
				else if (!func_87(unk_0x33CD235DF1E6A94E(), vLocal_195, 75f))
...
void func_278(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_271(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_271(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_279(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_345(bool bParam0)
{
	...
	if (unk_0x117DAF3BF7232886(iLocal_193))
	{
		unk_0x63F0B040CE6EDF0F(false, false, 3000, 1, 0, 0);
		unk_0x2F8A4DF7D0DFF0A8(iLocal_193, 0);
	}
}
