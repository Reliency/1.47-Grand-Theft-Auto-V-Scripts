...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (Global_106565.f_24980.f_2)
		{
			...
			case 2:
				if (!unk_0x8ED4328770BEE4A1(iLocal_213))
				{
...
void func_110(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_115(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x078B659F6F2C8960(iVar5, &Var7) && !func_112(Var7.f_1)) && iVar9 < 51)
			{
...
int func_127(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_143(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(vParam0, func_128(iVar0, 0), true);
...
void func_146(int iParam0)
{
	...
	iLocal_213 = start_new_script_with_args(&Var0, &Local_43, 8, 28000);
		...
		while (iVar7 < 2)
		{
			if (iVar6[iVar7] != 0)
			{
					...
					if (unk_0x765F6FEEFF39224F(uVar5[iVar8]))
					{
						if (unk_0x541D5C57194E73C4(uVar5[iVar8]) == iVar6[iVar7])
						{
							if (!unk_0xD62C4419A41F106A(uVar5[iVar8], 0))
							{
								if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
								{
									if (vdist2(unk_0xFBB1F99A825CAB09(uVar5[iVar8], 1), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1)) < 6400f)
									{
										return 0;
									}
								}
				...
				if (unk_0x765F6FEEFF39224F(iVar9))
				{
					if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
					{
						if (vdist2(unk_0xFBB1F99A825CAB09(iVar9, 1), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1)) < 6400f)
						{
							return 0;
						}
					}
...
int func_221(int iParam0, int iParam1, float fParam2)
{
	...
	if (!unk_0xD62C4419A41F106A(iParam0, 0))
	{
		...
		if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, 1), Var0, true) < fVar1)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
...
int func_228(float fParam0, bool bParam1)
{
	...
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		...
		while (iVar6 < 63)
		{
			...
			{
				func_229(iVar1, &Var0);
				fVar4 = unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), Var0.f_6, true);
				if (fVar4 < fVar3)
				{
					bVar7 = true;
					if (bParam1)
...
int func_239()
{
	...
	vVar0 = { func_240(unk_0x3EE1295CEFBEFED4()) };
	fVar1 = Local_43.f_3;
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
...
void func_242()
{
	...
	if (iLocal_219 != 0)
	{
		...
		{
			case 1:
				iLocal_214 = unk_0x199B24FF79A52CCF("MIDSIZED_MESSAGE");
				iLocal_219 = 2;
				break;
			...
			case 2:
				...
				if (unk_0x11AE7F6A404414C9(iLocal_214))
				{
					unk_0xBB698266C5FDF0A7(iLocal_214, "SHOW_SHARD_MIDSIZED_MESSAGE");
					unk_0x713FEBE56D2BD403("BBS_MP");
					unk_0x36F3AA9FFAAF8606();
					unk_0x713FEBE56D2BD403(sVar0);
					unk_0xFA6BEE2B1507FF1E(sLocal_218);
					unk_0x36F3AA9FFAAF8606();
			...
			case 3:
				if (unk_0x11AE7F6A404414C9(iLocal_214))
				{
					unk_0xFF524AE40FB6301A(iLocal_214, 255, 255, 255, 255, 0);
				...
				if ((unk_0xE3903F59E2F22150() - iLocal_217) > 7000)
				{
					if (!iLocal_46)
					{
						unk_0xBB698266C5FDF0A7(iLocal_214, "SHARD_ANIM_OUT");
				...
				if ((unk_0xE3903F59E2F22150() - iLocal_217) > 7500)
				{
					iLocal_219 = 4;
				}
				break;
			...
			case 4:
				unk_0x83A1D480DB0B52CC(&iLocal_214);
				iLocal_46 = 0;
				func_243();
				break;
			}
