...
void __EntryFunction__()
{
	...
	iLocal_62 = unk_0x378BD4B3881338C2(unk_0x95B959F18401C09A());
	iLocal_68 = 0;
	...
	if (unk_0x1BCDA92AD0A7835B(unk_0x535C9C52117DA0AD()) > 1 && !func_179(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
	...
	while (true)
	{
		...
		if (unk_0x765F6FEEFF39224F(iLocal_62) && !unk_0xD62C4419A41F106A(iLocal_62, 0))
		{
			vLocal_64 = { unk_0xFBB1F99A825CAB09(iLocal_62, true) };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					if (!func_177(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (unk_0xCE3CFF625BEBAA04(&(Global_93682.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_164(3) && !Global_93716)
						{
							...
							{
								if ((!func_179(uLocal_67, 1) || !unk_0x765F6FEEFF39224F(func_163())) && !Global_93716)
								{
									func_172(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), vLocal_86, vLocal_87, fLocal_88, 1, false, iLocal_76) || (fLocal_90 > 0f && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), func_138(vLocal_86, vLocal_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							else if (fLocal_89 > 0f)
							{
								if (unk_0x7EECA16E87982278((vLocal_64.z - vLocal_86.z)) > fLocal_89)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_137(uLocal_63))
								{
									...
									else if (!func_179(uLocal_67, 2048) || !unk_0xFAC8F20FBC764F4D())
									{
										func_135(&iLocal_69);
									...
									if (func_133(iLocal_69, 1))
									{
										...
										func_135(&iLocal_69);
										func_185(&uLocal_67, 2048);
										unk_0x8F59DE352CFE248B(&cLocal_53);
				...
				case 5:
					unk_0x144904D2EAA84341(0, 51);
					if (unk_0x07AB0925A06BD5AD(&cLocal_53))
					{
						if (iLocal_69 != -1)
						{
							func_135(&iLocal_69);
						...
						if (iVar3 == 1)
						{
							...
							unk_0x841080481716E87C(&cLocal_53);
							Local_52 = { cLocal_53 };
				...
				case 6:
					...
					if (func_179(uLocal_67, 2097152))
					{
						if (!func_164(3) && !unk_0x8ED4328770BEE4A1(iLocal_51))
						{
							func_172(10);
						}
					}
					if (!unk_0x8ED4328770BEE4A1(iLocal_51))
					{
						unk_0x198BCB9897710EAB(round((func_11(&iLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&iLocal_80);
						...
						if (iLocal_72 != -1)
						{
							if (func_179(Global_105216, 0))
							{
								unk_0x4F729C0B5CCB6FEE(func_19(iLocal_72), 0, Global_93719, 0);
				...
				case 7:
					...
					if (!unk_0x786AF4A44E1B5B4B(sLocal_74))
					{
						if (func_1(sLocal_74))
						{
...
void func_44(int iParam0, int iParam1, var uParam2)
{
	...
	while (iVar0 <= 11)
	{
		...
		{
			unk_0x36E897473E9398F4(iParam0, iVar0, Var1.f_3, Var1.f_4);
		}
		iVar0++;
	}
	...
	while (iVar2 <= 8)
	{
		...
		if (uVar6[iVar2] != iVar5)
		{
			...
			{
				unk_0xD09A1C8B934D92C9(iParam0, iVar4, Var1.f_3, Var1.f_4);
			}
		}
		iVar2++;
	}
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_51(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_57(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_57(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_51(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_145()
{
	if (func_166(6) || func_166(7))
	{
		...
		{
			switch (func_146(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true)))
			{
				case 1:
					return func_165(96);
					break;
...
void func_168()
{
	...
	if (bLocal_93 && unk_0x1BCDA92AD0A7835B(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			iVar1 = unk_0x9EC3B269A34A2BEE(1, 4);
			iVar2[0] = unk_0x9EC3B269A34A2BEE(2, 8);
			iVar3 = 1;
...
void func_188()
{
	...
	if (unk_0x8ED4328770BEE4A1(iLocal_51))
	{
		unk_0x0432BBEFF2AF18F4(iLocal_51, 3);
	}
	if (!unk_0x6D2E2622CA149402(&cLocal_53))
	{
		if (unk_0x625A8786A9CA5F9A(&cLocal_53) != 0)
		{
			unk_0x841080481716E87C(&cLocal_53);
		}
	}
