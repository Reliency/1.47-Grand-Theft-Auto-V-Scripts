...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xB98788B42580C4A8("DEALERSHIP"))
		{
			...
			{
				unk_0x8411BDAD24F96365("DEALERSHIP", false);
			}
		}
		fVar0 = (unk_0x3755019F750A4797() + 20f);
		if (vdist2(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), vLocal_57) < (fVar0 * fVar0))
		{
			unk_0x4AC1EB89981AFAFD();
		}
		if (vdist2(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), vLocal_59) < (fVar0 * fVar0))
		{
			unk_0x4AC1EB89981AFAFD();
		}
		...
		else if (bLocal_72)
		{
			...
			if (func_2(iLocal_48))
			{
				if (func_1(iLocal_48, unk_0x33CD235DF1E6A94E(), 1) > 120f)
				{
					func_94();
				}
			}
		...
		case 1:
			...
			if (func_2(iLocal_48))
			{
				if (func_52())
				{
					if (!iLocal_66)
					{
						...
						if (!bLocal_64)
						{
							...
							unk_0x13A2D602CD10CBAC(iLocal_48, iLocal_87);
						...
						else
						{
							if (!bLocal_65)
							{
								unk_0x99414FB2D30425C1(&iLocal_87);
								unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
								if (func_1(iLocal_48, unk_0x33CD235DF1E6A94E(), 1) <= 4f)
								{
									unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), 1500);
								}
					...
					{
						func_35();
						unk_0xA9E472293522522F(iLocal_48, 2f);
						if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(iLocal_48, false), true) >= 100f && !unk_0x73E7A21FD53144AB(unk_0xFBB1F99A825CAB09(iLocal_48, false), 3f))
						{
				...
				else
				{
					...
					if (Local_45[0 /*20*/].f_18 >= 5 && Local_45[1 /*20*/].f_18 >= 5)
					{
						if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -69.62395f, -1087.37f, 24.59833f, -11.27861f, -1108.28f, 34.17205f, 47.5f, 0, true, 0))
						{
							func_4();
						}
					}
					if (func_2(iLocal_48))
					{
						unk_0x41E36A540F8F323F(iLocal_48, 60, true);
					}
				}
			}
			else
...
{
	unk_0xAEED0213982928AC(iParam0, sParam1, func_37(iParam2), 1);
}
...
int func_52()
{
	if (func_2(iLocal_48))
	{
		if (!bLocal_64)
		{
			if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(iLocal_48, false), true) <= 7f || unk_0xD76D6BCC14B95CE1(iLocal_48, 242628503) == 7)
			{
				if (!iLocal_66)
				{
					if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(iLocal_48, false), true) <= 7f)
					{
					}
					if (unk_0xD76D6BCC14B95CE1(iLocal_48, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(iLocal_48, false), true) <= 4.5f || unk_0xD76D6BCC14B95CE1(iLocal_48, 242628503) == 7)
		{
			if (!iLocal_66)
			{
				if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(iLocal_48, false), true) <= 4.5f)
				{
				}
				if (unk_0xD76D6BCC14B95CE1(iLocal_48, 242628503) == 7)
				{
...
void func_53()
{
	if (func_2(iLocal_48))
	{
		if (unk_0x1CE8F0A08E65CA6A(iLocal_48, "cellphone@", "cellphone_call_out", 3))
		{
			if (unk_0x204DEACC5BECF723(iLocal_48, "cellphone@", "cellphone_call_out") >= 0.24f)
			{
				if (unk_0x765F6FEEFF39224F(iLocal_52))
				{
					unk_0xEC26F4BFC9942A0C(&iLocal_52);
...
int func_54()
{
	...
	iVar0 = unk_0x90D2E06562D440E1(Local_45[0 /*20*/].f_10);
	if (iVar0 != 0)
	{
					...
					if (func_59())
					{
						if (iLocal_71 == 0)
						{
							if (bLocal_63)
							{
								...
								unk_0x108754262311D34F(0, "cellphone@", "cellphone_call_out", 8f, -8f, -1, 0, 0, 0, 0, 0);
								unk_0xC734F59A13D39AEF(iLocal_87);
								unk_0x13A2D602CD10CBAC(iLocal_48, iLocal_87);
								unk_0xA7A57E7757ED035E(&iLocal_87);
							}
						...
						{
							if ((unk_0xE3903F59E2F22150() - iLocal_55) >= iLocal_56)
							{
								func_56();
...
void func_56()
{
	if (func_49() == 1)
	{
		func_50(&uLocal_92, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_50(&uLocal_92, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
	}
...
int func_59()
{
	if (!unk_0xB05EBD564C7A1480(vLocal_78, vLocal_79) && !(unk_0xA58C083E829597F7(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && unk_0xA58C083E829597F7(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (unk_0x90D54DCF679C0BBE(unk_0x33CD235DF1E6A94E()) == unk_0x36163153849DFDA1("rm_showroom"))
		{
			if (!func_123())
			{
				if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -41.19015f, -1104.137f, 24.42232f, -33.7943f, -1107.183f, 28.67232f, 8.5f, 0, true, 0))
				{
					bLocal_64 = true;
					func_71(0);
				}
	...
	else if (unk_0xB05EBD564C7A1480(vLocal_78, vLocal_79) || (unk_0xA58C083E829597F7(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && unk_0xA58C083E829597F7(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (unk_0x90D54DCF679C0BBE(unk_0x33CD235DF1E6A94E()) == unk_0x36163153849DFDA1("rm_showroom"))
		{
...
void func_71(bool bParam0)
{
	if (bParam0)
	{
		if (func_2(iLocal_50))
		{
			unk_0x0CDD28A9DFCE2FCE(iLocal_50, true, 0);
			unk_0xF70578F5CD9822CB(iLocal_50, false);
			unk_0x6B8FD1D1616EE677(iLocal_50, true);
			iLocal_48 = iLocal_50;
			iLocal_52 = iLocal_54;
			func_60(&iLocal_49);
			func_72(&iLocal_53);
	...
	{
		unk_0x0CDD28A9DFCE2FCE(iLocal_49, true, 0);
		unk_0xF70578F5CD9822CB(iLocal_49, false);
		unk_0x6B8FD1D1616EE677(iLocal_49, true);
		iLocal_48 = iLocal_49;
		iLocal_52 = iLocal_53;
		func_60(&iLocal_50);
		func_72(&iLocal_54);
...
void func_73()
{
	switch (iLocal_47)
	{
		case 0:
			...
			unk_0x5856B9BF2B4E98C4(-51.89f, -1097.35f, 23.42f, -45.71f, -1092.1f, 27.42f, false, 1);
		...
		case 1:
			if (!func_2(iLocal_49) || !func_2(iLocal_50))
			{
				...
				if (func_2(iLocal_49))
				{
					unk_0x0CDD28A9DFCE2FCE(iLocal_49, false, 0);
					unk_0x6B8FD1D1616EE677(iLocal_49, false);
					unk_0xF0BE7CB40DE62A2F(iLocal_49, false);
					unk_0x4A852F02088ECC9D(iLocal_49, true);
					unk_0x0648A75D3F60E864(iLocal_49, iLocal_90);
					unk_0xAD3D24C8070DA056(iLocal_49, true);
					unk_0x697EBA5CF1A6AB57(iLocal_49, joaat("weapon_pistol"), 999, false, false);
					unk_0x3F0ECDD5CC67FC67(iLocal_49, false, iLocal_88);
					unk_0xD2E80177F27FD43F(5, iLocal_88, 1862763509);
					unk_0x43D47AD82DA3C6EC(iLocal_49, true, 1);
					unk_0x5FEE418CE11E6DDE(iLocal_49, 104, true);
					iLocal_53 = unk_0x7CA67831169E8AA6(iLocal_74, unk_0xFBB1F99A825CAB09(iLocal_49, true), true, true, false);
					unk_0x2F0A6390D863D337(iLocal_53, iLocal_49, unk_0xFCAF61876D23D31D(iLocal_49, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					unk_0x99414FB2D30425C1(&iLocal_87);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_d", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x656E3BB78935070E(iLocal_87, 1);
					unk_0xC734F59A13D39AEF(iLocal_87);
					unk_0x13A2D602CD10CBAC(iLocal_49, iLocal_87);
					unk_0xA7A57E7757ED035E(&iLocal_87);
					unk_0xF70578F5CD9822CB(iLocal_49, true);
				}
				func_75(&iLocal_50, 18, vLocal_59, fLocal_60, 1);
				if (func_2(iLocal_50))
				{
					unk_0x0CDD28A9DFCE2FCE(iLocal_50, false, 0);
					unk_0x6B8FD1D1616EE677(iLocal_50, false);
					unk_0xF0BE7CB40DE62A2F(iLocal_50, false);
					unk_0x4A852F02088ECC9D(iLocal_50, true);
					unk_0x0648A75D3F60E864(iLocal_50, iLocal_90);
					unk_0xAD3D24C8070DA056(iLocal_50, true);
					unk_0x697EBA5CF1A6AB57(iLocal_50, joaat("weapon_pistol"), 999, false, false);
					unk_0x3F0ECDD5CC67FC67(iLocal_50, false, iLocal_88);
					unk_0xD2E80177F27FD43F(5, iLocal_88, 1862763509);
					unk_0x43D47AD82DA3C6EC(iLocal_50, true, 1);
					unk_0x5FEE418CE11E6DDE(iLocal_50, 104, true);
					iLocal_54 = unk_0x7CA67831169E8AA6(iLocal_74, unk_0xFBB1F99A825CAB09(iLocal_50, true), true, true, false);
					unk_0x2F0A6390D863D337(iLocal_54, iLocal_50, unk_0xFCAF61876D23D31D(iLocal_50, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					unk_0x99414FB2D30425C1(&iLocal_87);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					...
					unk_0x656E3BB78935070E(iLocal_87, 1);
					unk_0xC734F59A13D39AEF(iLocal_87);
					unk_0x13A2D602CD10CBAC(iLocal_50, iLocal_87);
					unk_0xA7A57E7757ED035E(&iLocal_87);
					unk_0xF70578F5CD9822CB(iLocal_49, true);
				}
			}
			...
			{
				func_74();
				iLocal_75 = unk_0xC651C43AB13A15E5(joaat("baller2"), -46.2722f, -1097.466f, 25.42f, 112.5363f, true, true, false);
				unk_0xD6D2420F0051065A(iLocal_75, 7);
				unk_0xBF98CE54BD141AFF(iLocal_75, 3);
				unk_0xD303E20CB0AE4AD0(iLocal_75, 2);
				unk_0x9152A6430680BF0A(iLocal_75, 0);
				iLocal_76 = unk_0xC651C43AB13A15E5(joaat("tailgater"), -41.07354f, -1099.567f, 25.42f, 138.4292f, true, true, false);
				unk_0xD6D2420F0051065A(iLocal_76, 12);
				unk_0xD303E20CB0AE4AD0(iLocal_76, 2);
				unk_0x9152A6430680BF0A(iLocal_76, 0);
				iLocal_77 = unk_0xC651C43AB13A15E5(joaat("bjxl"), -36.74456f, -1101.583f, 25.42f, 155.1573f, true, true, false);
				unk_0xD6D2420F0051065A(iLocal_77, 4);
				unk_0xBF98CE54BD141AFF(iLocal_77, 3);
				unk_0xD303E20CB0AE4AD0(iLocal_77, 2);
				unk_0x9152A6430680BF0A(iLocal_77, 0);
				iLocal_47 = 2;
			}
			break;
...
int func_78()
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		if (vmag2(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_89())
		{
			return 0;
		}
	}
...
int func_90()
{
	if (((((((((((unk_0x5D98D654CDC2165A(Local_45[0 /*20*/]) && unk_0x5D98D654CDC2165A(Local_45[1 /*20*/])) && unk_0x045F471986387527(Local_45[0 /*20*/].f_17)) && unk_0x045F471986387527(Local_45[1 /*20*/].f_17)) && func_54()) && unk_0xE9CCF312047EBEE0("cellphone@")) && unk_0xE9CCF312047EBEE0("cellphone@str")) && unk_0xB6596C29F3179D0C("reyetarian_simeonoffice")) && unk_0x5D98D654CDC2165A(iLocal_74)) && unk_0x5D98D654CDC2165A(joaat("bjxl"))) && unk_0x5D98D654CDC2165A(joaat("tailgater"))) && unk_0x5D98D654CDC2165A(joaat("baller2")))
	{
		return 1;
	}
	return 0;
	...
	switch (Local_45[iParam0 /*20*/].f_18)
	{
		...
		case 1:
			if (!Local_45[iParam0 /*20*/].f_19)
			{
				...
				{
					Local_45[iParam0 /*20*/].f_1 = unk_0x9BA5CF280376EEA4(22, Local_45[iParam0 /*20*/], Local_45[iParam0 /*20*/].f_10, Local_45[iParam0 /*20*/].f_13, 1, true);
					if (func_2(Local_45[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							unk_0x0BFA5DCFCE7BBE54(Local_45[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", vLocal_80[iParam0 /*3*/], fLocal_81[iParam0], 0, 0, 1);
							unk_0x3E2A39F699947160(Local_45[iParam0 /*20*/].f_1);
							unk_0x5AC3AF52F52EEA94(Local_45[iParam0 /*20*/].f_1, 1);
							unk_0xAF4482B584BBF3B8(Local_45[iParam0 /*20*/].f_1, -37.34785f, -1102.022f, 25.42232f, 3f, 0, 0);
							unk_0x28F648743D7DE312(Local_45[iParam0 /*20*/].f_1, 37, true);
						}
						unk_0x4A852F02088ECC9D(Local_45[iParam0 /*20*/].f_1, true);
						unk_0x0648A75D3F60E864(Local_45[iParam0 /*20*/].f_1, iLocal_88);
						unk_0x3F0ECDD5CC67FC67(Local_45[iParam0 /*20*/].f_1, false, iLocal_88);
						unk_0x28F648743D7DE312(Local_45[iParam0 /*20*/].f_1, 23, false);
						unk_0x28F648743D7DE312(Local_45[iParam0 /*20*/].f_1, 1, false);
						unk_0x28F648743D7DE312(Local_45[iParam0 /*20*/].f_1, 28, true);
						unk_0xE53211B793893FFD(Local_45[iParam0 /*20*/].f_1, 0.7f, 0.3f);
						iLocal_70[iParam0] = 0;
						if (func_49() == 0)
						{
							unk_0x697EBA5CF1A6AB57(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_17, -1, true, true);
						}
						unk_0x71CA80D41E1338B4(Local_45[iParam0 /*20*/]);
		...
		case 2:
			if (func_2(Local_45[iParam0 /*20*/].f_1))
			{
				if (iLocal_67)
				{
					...
					unk_0xED68CDDDE25A144E(Local_45[iParam0 /*20*/].f_1);
					unk_0x92A2FAFA76B7EC9B(Local_45[iParam0 /*20*/].f_1, true, -1, "DEFAULT_ACTION");
					unk_0x99414FB2D30425C1(&iLocal_87);
					unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 12, 2);
					unk_0x7E268975AF5EA74F(0, Local_45[iParam0 /*20*/].f_14, 1f, -1, 3f, 0, 1193033728);
					unk_0x11C4AF4137F2A4B5(0, unk_0x33CD235DF1E6A94E(), 0);
					unk_0xC734F59A13D39AEF(iLocal_87);
					unk_0x13A2D602CD10CBAC(Local_45[iParam0 /*20*/].f_1, iLocal_87);
					unk_0xA7A57E7757ED035E(&iLocal_87);
					Local_45[iParam0 /*20*/].f_18 = 3;
				}
				if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(Local_45[iParam0 /*20*/].f_1, false), true) >= 250f)
				{
		...
		case 3:
			...
			{
				func_93(Local_45[iParam0 /*20*/].f_1, &(Local_45[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				if (unk_0xD76D6BCC14B95CE1(Local_45[iParam0 /*20*/].f_1, 242628503) == 7 || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(Local_45[iParam0 /*20*/].f_1, false), true) <= 5f)
				{
					unk_0xC4A347124F39D998(Local_45[iParam0 /*20*/].f_1, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
					unk_0x277716E9E7CC0692(Local_45[iParam0 /*20*/].f_1, unk_0x33CD235DF1E6A94E(), 0, 16);
					unk_0x3309862CD9166E87(Local_45[iParam0 /*20*/].f_1, 3);
					unk_0x897EF720254BBEA3(Local_45[iParam0 /*20*/].f_1, true);
		...
		case 4:
			...
			else
			{
				if (iLocal_70[iParam0] == 0)
				{
					...
					{
						unk_0x697EBA5CF1A6AB57(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_17, -1, false, true);
						iLocal_70[iParam0] = 1;
					}
				}
				if (unk_0xD76D6BCC14B95CE1(Local_45[iParam0 /*20*/].f_1, 780511057) == 7)
				{
					unk_0x277716E9E7CC0692(Local_45[iParam0 /*20*/].f_1, unk_0x33CD235DF1E6A94E(), 0, 16);
				}
				if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), unk_0xFBB1F99A825CAB09(Local_45[iParam0 /*20*/].f_1, false), true) >= 75f)
				{
					Local_45[iParam0 /*20*/].f_18 = 5;
				}
			}
		...
		case 5:
			...
			if (unk_0x765F6FEEFF39224F(Local_45[iParam0 /*20*/].f_1))
			{
				unk_0x1F45B4626AC4A4C0(&(Local_45[iParam0 /*20*/].f_1));
			}
...
void func_94()
{
	...
	func_95(-1);
	unk_0xCEE359851F3C8198(iLocal_88);
	unk_0xCEE359851F3C8198(iLocal_89);
	unk_0xCEE359851F3C8198(iLocal_90);
	if (iLocal_61 == 0)
	{
	...
	if (unk_0x765F6FEEFF39224F(iLocal_48))
	{
		unk_0x1F45B4626AC4A4C0(&iLocal_48);
		if (unk_0xE38E3CF1625A4145(iLocal_51))
		{
			unk_0x1ABDB383C83A336A(&iLocal_51);
		}
	...
	unk_0xF1CFA0046BB67893(iLocal_82, 0);
	...
	if (iLocal_84 != -1)
	{
		unk_0xF4BF002874250DB7(iLocal_84);
	}
	if (iLocal_85 != -1)
	{
		unk_0xF4BF002874250DB7(iLocal_85);
	}
	if (iLocal_86 != -1)
	{
		unk_0xF4BF002874250DB7(iLocal_86);
	}
	if (unk_0xB98788B42580C4A8("DEALERSHIP"))
	{
		if (!unk_0x7FC8FAE3451A21AD("DEALERSHIP"))
		{
			unk_0x8411BDAD24F96365("DEALERSHIP", true);
		}
	}
	unk_0x5856B9BF2B4E98C4(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, true, 1);
	unk_0x5894DC159447E10A();
}
...
void func_124()
{
	...
	fLocal_81[1] = 136.57f;
	unk_0x9315FCF6CFE2AB41("GoonGroup", &iLocal_88);
	unk_0x9315FCF6CFE2AB41("PlayerGroup", &iLocal_89);
	unk_0x9315FCF6CFE2AB41("YetarianGroup", &iLocal_90);
	unk_0xD2E80177F27FD43F(1, iLocal_90, 1862763509);
	unk_0xD2E80177F27FD43F(1, 1862763509, iLocal_90);
	unk_0xD2E80177F27FD43F(5, iLocal_88, 1862763509);
	unk_0xD2E80177F27FD43F(5, 1862763509, iLocal_88);
	unk_0x5856B9BF2B4E98C4(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, false, 1);
	iLocal_82 = unk_0x0335D8135051EA56(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, 0, 1, 1, 1);
	unk_0xDDDBE90DAF7935B0(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, 1, 1, 1, 0);
	if (iLocal_86 == -1)
	{
		iLocal_86 = unk_0x6E6EB18FDAB9A074(-29.3f, -1086.35f, 25.57f, 5.5f, 3f, 2f, -10f, 0, 7);
	}
	func_125(196, 0);
	func_125(197, 0);
	func_125(194, 0);
	func_125(195, 0);
	unk_0xB815670C37E03CDE(Local_45[0 /*20*/]);
	unk_0xB815670C37E03CDE(Local_45[1 /*20*/]);
	unk_0xB815670C37E03CDE(iLocal_74);
	unk_0xB815670C37E03CDE(joaat("bjxl"));
	unk_0xB815670C37E03CDE(joaat("tailgater"));
	unk_0xB815670C37E03CDE(joaat("baller2"));
	unk_0x98C1605C20B2E0B9(Local_45[0 /*20*/].f_17, 31, 0);
	unk_0x98C1605C20B2E0B9(Local_45[1 /*20*/].f_17, 31, 0);
