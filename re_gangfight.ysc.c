		...
		if (unk_0xA80721FDC3BDCCDB())
		{
			...
			if (!func_93())
			{
				...
				switch (iLocal_44)
				{
					...
					case 1:
						...
						{
							if ((!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[0])) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[1]))
							{
								if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, false, true, 0))
								{
									iLocal_56 = func_74(iLocal_58, 0, 145);
									unk_0xC51C58C963968740(iLocal_56, 9);
									iLocal_57[0] = func_74(iLocal_59[0], 1, 145);
									iLocal_57[1] = func_74(iLocal_59[1], 1, 145);
									unk_0x983D75D9630FD905(iLocal_56, false);
									unk_0x983D75D9630FD905(iLocal_57[0], false);
									unk_0x983D75D9630FD905(iLocal_57[1], false);
									func_64(1);
								}
							}
						}
						else
						{
							...
							{
								if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]))
								{
									unk_0xECCD4FDA45197F97(iLocal_59[iVar0], unk_0x33CD235DF1E6A94E(), 150f, -1, 0, 0);
								}
								iVar0++;
							}
			...
			else
			{
				...
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
				{
					...
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 150f, 150f, 50f, 0, 1, 0))
					{
						...
						switch (iLocal_45)
						{
							...
							case 1:
								if (iLocal_46 < 7 && !unk_0xBC2FC12AD0FBF72E(iLocal_58))
								{
									if (unk_0x910FF514D7BC5674(unk_0x33CD235DF1E6A94E(), iLocal_58, 90f))
									{
										if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_58) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_58))
										{
											func_58();
										}
									}
				...
				else
				{
					...
					if (((!unk_0xBC2FC12AD0FBF72E(iLocal_59[0]) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[1])) && !unk_0xD62C4419A41F106A(iLocal_61[0], 0)) && !unk_0xD62C4419A41F106A(iLocal_61[1], 0))
					{
						func_63();
					}
					iVar1 = 0;
					...
					{
						if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar2]))
						{
							unk_0x277716E9E7CC0692(iLocal_59[iVar2], unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0x897EF720254BBEA3(iLocal_59[iVar2], true);
							if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_59[iVar2], 150f, 150f, 50f, 0, 1, 0))
							{
								func_63();
							}
							iVar1 = 1;
						}
						else if (unk_0xE38E3CF1625A4145(iLocal_57[iVar2]))
						{
							unk_0x1ABDB383C83A336A(&(iLocal_57[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_49 && !iLocal_54)
	{
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
		{
			unk_0xAD3D24C8070DA056(iLocal_58, false);
			unk_0x4A852F02088ECC9D(iLocal_58, false);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_59)
		{
			if (unk_0xE38E3CF1625A4145(iLocal_57[iVar0]))
			{
				unk_0x1ABDB383C83A336A(&(iLocal_57[iVar0]));
			}
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
			{
				if (iVar0 < 2)
				{
					if (!unk_0xD62C4419A41F106A(iLocal_61[iVar0], 0))
					{
						unk_0x48B8A6610EAA0C89(iLocal_59[iVar0], iLocal_61[iVar0], unk_0x33CD235DF1E6A94E(), 8, 20f, 786469, 150f, 10f, 1);
						unk_0x897EF720254BBEA3(iLocal_59[iVar0], true);
					}
					else
					{
						unk_0xECCD4FDA45197F97(iLocal_59[iVar0], unk_0x33CD235DF1E6A94E(), 200f, -1, 0, 0);
					}
				}
				else
				{
				...
				unk_0x4A852F02088ECC9D(iLocal_59[iVar0], false);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_61)
		{
			if (!unk_0xD62C4419A41F106A(iLocal_61[iVar0], 0))
			{
				unk_0x65F544B458249682(&(iLocal_61[iVar0]));
	...
	if (unk_0x16E00F066AFFEA0D(func_2(unk_0x95B959F18401C09A()), vLocal_48, true) > 50f)
	{
		func_140();
	}
}
	...
	switch (iLocal_46)
	{
		case 0:
			if (timerb() > 2000)
			{
				...
				while (iVar0 < iLocal_59)
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]) && !unk_0xD62C4419A41F106A(iLocal_61[iVar0], 0))
					{
						if (!unk_0xE38E3CF1625A4145(iLocal_57[iVar0]))
						{
							iLocal_57[iVar0] = func_74(iLocal_59[iVar0], 1, 145);
							if (unk_0xF0D230FB550CD6EB(iLocal_59[iVar0], 0))
							{
								if (!bLocal_51)
								{
									unk_0x09294EA9B5694081(iLocal_59[iVar0], unk_0x33CD235DF1E6A94E(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									...
									unk_0x13A2D602CD10CBAC(iLocal_59[iVar0], iLocal_62);
		...
		case 1:
			...
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar1]))
				{
					if (unk_0x18FB647D79B09657(iLocal_59[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, false, true, 0))
					{
						if (!unk_0xD62C4419A41F106A(iLocal_61[iVar1], 0))
						{
							unk_0xA6E32819044BBB6A(iLocal_61[iVar1], 0);
						}
						if (unk_0xF0D230FB550CD6EB(iLocal_59[iVar1], 0))
						{
							unk_0x99414FB2D30425C1(&iLocal_62);
							unk_0x07C339D4328CA16C(0, 0, 0);
							unk_0x277716E9E7CC0692(0, unk_0x33CD235DF1E6A94E(), 0, 16);
							unk_0xC734F59A13D39AEF(iLocal_62);
							unk_0x13A2D602CD10CBAC(iLocal_59[iVar1], iLocal_62);
							unk_0xA7A57E7757ED035E(&iLocal_62);
							unk_0x897EF720254BBEA3(iLocal_59[iVar1], true);
						}
					}
					if (!unk_0xF0D230FB550CD6EB(iLocal_59[iVar1], 0))
					{
						unk_0x277716E9E7CC0692(iLocal_59[iVar1], unk_0x33CD235DF1E6A94E(), 0, 16);
						unk_0x897EF720254BBEA3(iLocal_59[iVar1], true);
					}
					if (!unk_0xD62C4419A41F106A(iLocal_61[iVar1], 0))
					{
						if (unk_0x9DC577E2A517CC1E(iLocal_61[iVar1]))
						{
						}
					}
				}
				if (unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar1]))
				{
					if (unk_0xE38E3CF1625A4145(iLocal_57[iVar1]))
					{
						unk_0x1ABDB383C83A336A(&(iLocal_57[iVar1]));
					}
				}
				iVar1++;
			}
			if (((unk_0xBC2FC12AD0FBF72E(iLocal_59[2]) && unk_0xBC2FC12AD0FBF72E(iLocal_59[3])) && unk_0xBC2FC12AD0FBF72E(iLocal_59[4])) && unk_0xBC2FC12AD0FBF72E(iLocal_59[5]))
			{
				unk_0x7CED302277C0F3D3("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
				iLocal_46++;
			}
		...
		case 2:
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				...
				unk_0xC734F59A13D39AEF(iLocal_62);
				unk_0x13A2D602CD10CBAC(iLocal_58, iLocal_62);
				unk_0xA7A57E7757ED035E(&iLocal_62);
			}
			if (!unk_0xD62C4419A41F106A(iLocal_60, 0))
			{
				unk_0x0D847D71D9E6142E(iLocal_60);
				if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 6f, 6f, 6f, 0, 1, 0))
				{
					if (unk_0x910FF514D7BC5674(iLocal_58, unk_0x33CD235DF1E6A94E(), 60f))
					{
						if (!func_8())
						{
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (!unk_0x335C0645074963FE(iLocal_58, unk_0x33CD235DF1E6A94E(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!unk_0xD62C4419A41F106A(iLocal_60, 0))
			{
				if (unk_0x91BBD269506D61D2(iLocal_60, unk_0x33CD235DF1E6A94E(), 0))
				{
					func_63();
				}
			}
		...
		case 6:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && unk_0xF0D230FB550CD6EB(iLocal_58, 0))
					{
						unk_0xAC584348B06672DD(unk_0x2CA911E7569D12EA(unk_0xF2C96862595654B4(iLocal_58, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_46++;
					}
				}
			}
...
void func_53()
{
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xC4A347124F39D998(iLocal_58, unk_0x33CD235DF1E6A94E(), -1, 2060, 2);
		...
		case 4:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (unk_0x18FB647D79B09657(iLocal_58, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, false, true, 0))
				{
					if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) || unk_0xA2F0EA9AB6142D97(unk_0x33CD235DF1E6A94E()))
					{
						...
						{
							func_40(1000);
							if ((!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[2])) && !unk_0xD62C4419A41F106A(iLocal_60, 0))
							{
								unk_0x99414FB2D30425C1(&iLocal_62);
								unk_0xB470BF3A9F5DA9A5(0, iLocal_60, -1, -1, 1f);
								unk_0xC4A347124F39D998(0, iLocal_59[2], 2000, 0, 2);
								unk_0x11C4AF4137F2A4B5(0, iLocal_59[2], 0);
								unk_0xC734F59A13D39AEF(iLocal_62);
								unk_0x13A2D602CD10CBAC(iLocal_58, iLocal_62);
								unk_0xA7A57E7757ED035E(&iLocal_62);
								func_40(2000);
								...
								if ((!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xD62C4419A41F106A(iLocal_60, 0)) && unk_0xF0D230FB550CD6EB(iLocal_58, 0))
								{
									iLocal_46++;
								}
								else
								{
									if (!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[2]))
									{
										unk_0x99414FB2D30425C1(&iLocal_62);
		...
		case 7:
			if ((((!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xD62C4419A41F106A(iLocal_60, 0)) && !unk_0x10930B9CAD4111C2(iLocal_58, iLocal_60, 0)) && !unk_0xB5D4E8F757C24136(iLocal_58, 0)) && !unk_0x743EC1E3DC1090F3(iLocal_58))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_59)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]) && !unk_0xD62C4419A41F106A(iLocal_61[iVar0], 0))
				{
					if (((((unk_0xE5472B649A9E9734(unk_0x33CD235DF1E6A94E(), (916.3351f - 100f), (3602.048f - 100f), (31.9209f - 100f), (916.3351f + 100f), (3602.048f + 100f), (31.9209f + 100f), 0, 1) || unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_59[iVar0], 5f, 5f, 5f, 0, 1, 0)) || unk_0x91BBD269506D61D2(iLocal_59[iVar0], unk_0x33CD235DF1E6A94E(), 1)) || unk_0x91BBD269506D61D2(iLocal_61[iVar0], unk_0x33CD235DF1E6A94E(), 1)) || unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_59[iVar0])) || unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), iLocal_61[iVar0]))
					{
						bLocal_51 = true;
						settimerb(2000);
						iLocal_46 = 0;
			...
			if (unk_0x18FB647D79B09657(iLocal_59[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, false, true, 0) || timerb() > 13000)
			{
				func_40(2000);
				iVar0 = 0;
				while (iVar0 < iLocal_59)
				{
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]))
					{
						if (!unk_0xD62C4419A41F106A(iLocal_61[iVar0], 0))
						{
							if (unk_0x10930B9CAD4111C2(iLocal_59[iVar0], iLocal_61[iVar0], 0))
							{
								unk_0x48B8A6610EAA0C89(iLocal_59[iVar0], iLocal_61[iVar0], unk_0x33CD235DF1E6A94E(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
							}
						}
					}
					iVar0++;
...
int func_56()
{
	...
	if (((((((!unk_0x765F6FEEFF39224F(iLocal_61[2]) && !unk_0x765F6FEEFF39224F(iLocal_61[3])) && !unk_0x765F6FEEFF39224F(iLocal_61[4])) && !unk_0x765F6FEEFF39224F(iLocal_61[5])) && !unk_0x765F6FEEFF39224F(iLocal_59[2])) && !unk_0x765F6FEEFF39224F(iLocal_59[3])) && !unk_0x765F6FEEFF39224F(iLocal_59[4])) && !unk_0x765F6FEEFF39224F(iLocal_59[5]))
	{
		...
		{
			iLocal_61[2] = unk_0xC651C43AB13A15E5(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, true, true, false);
			iLocal_61[3] = unk_0xC651C43AB13A15E5(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, true, true, false);
			iLocal_61[4] = unk_0xC651C43AB13A15E5(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, true, true, false);
			iLocal_61[5] = unk_0xC651C43AB13A15E5(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, true, true, false);
			unk_0x71CA80D41E1338B4(joaat("hexer"));
			unk_0x6D056AC3FCCA974B(iLocal_61[2], 3);
			unk_0x6D056AC3FCCA974B(iLocal_61[4], 3);
			iLocal_55 = unk_0xE3903F59E2F22150() + 1500;
		}
		...
		{
			iLocal_59[2] = unk_0xE196503B36B6194B(iLocal_61[2], 22, joaat("g_m_y_lost_01"), -1, 1, true);
			iLocal_59[3] = unk_0xE196503B36B6194B(iLocal_61[3], 22, joaat("g_m_y_lost_02"), -1, 1, true);
			iLocal_59[4] = unk_0xE196503B36B6194B(iLocal_61[4], 22, joaat("g_m_y_lost_01"), -1, 1, true);
			iLocal_59[5] = unk_0xE196503B36B6194B(iLocal_61[5], 22, joaat("g_m_y_lost_02"), -1, 1, true);
			...
			while (iVar0 < iLocal_59)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]) && !unk_0xD62C4419A41F106A(iLocal_61[iVar0], 0))
				{
					unk_0x7B1011A61F402324(iLocal_61[iVar0], "RE_COUNTRYSIDE_GANG_BIKES", 0);
					unk_0x5FEE418CE11E6DDE(iLocal_59[iVar0], 137, true);
					unk_0xC475906893AEB995(iLocal_59[iVar0], 0);
					unk_0x34A51926277F67BC(iLocal_59[iVar0], 2);
					unk_0x28F648743D7DE312(iLocal_59[iVar0], 50, true);
					unk_0x52F5AAAD4824B17E(iLocal_59[iVar0], 2);
					unk_0x16D56D398FB73BE7(iLocal_59[iVar0], 50f, 20);
					unk_0x1E0350F1D7702D6A(iLocal_59[iVar0], 1);
					unk_0xDE9FF07CFD5DC172(iLocal_59[iVar0], 13);
					unk_0x5F9955D3E93BCC84(iLocal_59[iVar0], 100f);
					unk_0x18E5E2B41CD6CE17(iLocal_59[iVar0], 100f);
					unk_0x0648A75D3F60E864(iLocal_59[iVar0], iLocal_228);
					unk_0x4A852F02088ECC9D(iLocal_59[iVar0], true);
					unk_0x66CDA3DCBCEDF782(iLocal_59[iVar0], 3);
					unk_0x2B4A2E9ED65D5C93(iLocal_59[iVar0], 0);
					unk_0xF0BE7CB40DE62A2F(iLocal_59[iVar0], true);
					unk_0x428C55A965F78103(iLocal_59[iVar0], 1, 1000f);
					if (iVar0 > 1 && iVar0 < 5)
					{
						unk_0x697EBA5CF1A6AB57(iLocal_59[iVar0], joaat("weapon_pistol"), -1, true, true);
					}
					else
					{
						unk_0x697EBA5CF1A6AB57(iLocal_59[iVar0], joaat("weapon_sawnoffshotgun"), -1, true, true);
					}
					unk_0x99414FB2D30425C1(&iLocal_62);
					unk_0x77C4189A8E5C57C2(0, iLocal_61[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, vLocal_48, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(iLocal_62);
					unk_0x13A2D602CD10CBAC(iLocal_59[2], iLocal_62);
					unk_0xA7A57E7757ED035E(&iLocal_62);
					unk_0x99414FB2D30425C1(&iLocal_62);
					unk_0x77C4189A8E5C57C2(0, iLocal_61[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, vLocal_48, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(iLocal_62);
					unk_0x13A2D602CD10CBAC(iLocal_59[3], iLocal_62);
					unk_0xA7A57E7757ED035E(&iLocal_62);
					unk_0x897EF720254BBEA3(iLocal_59[3], true);
					unk_0x99414FB2D30425C1(&iLocal_62);
					unk_0x77C4189A8E5C57C2(0, iLocal_61[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, vLocal_48, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(iLocal_62);
					unk_0x13A2D602CD10CBAC(iLocal_59[4], iLocal_62);
					unk_0xA7A57E7757ED035E(&iLocal_62);
					unk_0x99414FB2D30425C1(&iLocal_62);
					unk_0x77C4189A8E5C57C2(0, iLocal_61[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xAE5B044AA2973E2A(0, vLocal_48, 5000, 0, 2);
					unk_0xC734F59A13D39AEF(iLocal_62);
					unk_0x13A2D602CD10CBAC(iLocal_59[5], iLocal_62);
					unk_0xA7A57E7757ED035E(&iLocal_62);
				}
				iVar0++;
			}
...
void func_58()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
	{
		unk_0xECCD4FDA45197F97(iLocal_58, unk_0x33CD235DF1E6A94E(), 200f, -1, 0, 0);
		unk_0x897EF720254BBEA3(iLocal_58, true);
		if (!unk_0xD62C4419A41F106A(iLocal_59[0], 0) && !unk_0xD62C4419A41F106A(iLocal_59[1], 0))
		{
			unk_0x7FC2040EB34E0E31(iLocal_58, 101, 0);
			unk_0xAD3D24C8070DA056(iLocal_58, false);
			unk_0x0B303ED4E12A5F06(iLocal_59[0], iLocal_58, 1000, 0);
			unk_0x0B303ED4E12A5F06(iLocal_59[1], iLocal_58, 1000, 0);
		}
		else
		{
			func_4();
...
{
	unk_0xAEED0213982928AC(iParam0, sParam1, func_60(iParam2), 1);
}
...
void func_61()
{
	...
	{
		case 0:
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 45f, 45f, 20f, 0, 1, 0))
			{
				if (!func_8())
				{
					if (func_48() == 0)
		...
		case 1:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_58))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 40f, 40f, 20f, 0, 1, 0))
				{
		...
		case 3:
			if ((!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[0])) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[1]))
			{
				...
				if (timera() < 28000)
				{
					if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 12f, 12f, 2.5f, 0, 1, 0))
					{
						if (((unk_0xDAAA48CE50D80F52(iLocal_59[0], unk_0x33CD235DF1E6A94E()) || unk_0xDAAA48CE50D80F52(iLocal_59[1], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_59[0], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_59[1], unk_0x33CD235DF1E6A94E()))
						{
							unk_0xC4A347124F39D998(iLocal_59[0], unk_0x33CD235DF1E6A94E(), 4000, 2056, 4);
							unk_0xC4A347124F39D998(iLocal_59[1], unk_0x33CD235DF1E6A94E(), 4000, 2056, 4);
							if (!iLocal_53)
							{
								func_4();
								func_40(0);
					...
					else if (!unk_0x1CE8F0A08E65CA6A(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						if (!unk_0x910FF514D7BC5674(iLocal_59[0], iLocal_58, 10f))
						{
							unk_0x4DDF5809B68AA635(iLocal_59[0], iLocal_58, -1, 0);
						}
					}
				}
				else if (!unk_0xD62C4419A41F106A(iLocal_61[0], 0) && !unk_0xD62C4419A41F106A(iLocal_61[1], 0))
				{
					func_4();
					func_40(0);
		...
		case 4:
			...
			while (iVar0 < iLocal_59)
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[iVar0]))
				{
					unk_0x41E36A540F8F323F(iLocal_59[iVar0], 156, true);
					unk_0x277716E9E7CC0692(iLocal_59[iVar0], unk_0x33CD235DF1E6A94E(), 0, 16);
					unk_0x897EF720254BBEA3(iLocal_59[iVar0], true);
				}
				iVar0++;
			}
		...
		case 5:
			...
			if (unk_0xBC2FC12AD0FBF72E(iLocal_59[0]) && unk_0xBC2FC12AD0FBF72E(iLocal_59[1]))
			{
				iLocal_46 = 0;
				iLocal_45 = 1;
			}
...
void func_62()
{
	if (!unk_0x73E7A21FD53144AB(916.4631f, 3601.261f, 31.9327f, 3f))
	{
		...
		{
			if (unk_0x18FB647D79B09657(unk_0x8918EC905FC8975D(), 916.4631f, 3601.261f, 31.9327f, 2f, 2f, 2f, false, true, 0))
			{
				unk_0xBEADAF07D2339505(unk_0x8918EC905FC8975D(), 915.6531f, 3595.061f, 32.0774f, 1, false, 0, 1);
			}
		}
	}
}
...
int func_75(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_76(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_76(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(iVar0, bParam1);
	}
...
int func_77()
{
	...
	if (!bLocal_51)
	{
		unk_0xD2E80177F27FD43F(255, iLocal_228, 1862763509);
		if (!unk_0xD62C4419A41F106A(iLocal_59[0], 0) && !unk_0xD62C4419A41F106A(iLocal_59[1], 0))
		{
			if (unk_0x91BBD269506D61D2(iLocal_59[0], unk_0x33CD235DF1E6A94E(), 1) || unk_0x91BBD269506D61D2(iLocal_59[1], unk_0x33CD235DF1E6A94E(), 1))
			{
				func_4();
				return 1;
			}
			if (!unk_0xD62C4419A41F106A(unk_0x8918EC905FC8975D(), 0))
			{
				if (unk_0x91BBD269506D61D2(iLocal_59[0], unk_0x8918EC905FC8975D(), 1) || unk_0x91BBD269506D61D2(iLocal_59[1], unk_0x8918EC905FC8975D(), 1))
				{
					func_4();
					return 1;
				}
		...
		if (!unk_0xD62C4419A41F106A(iLocal_61[0], 0) && !unk_0xD62C4419A41F106A(iLocal_61[1], 0))
		{
			if (((unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_61[0], 0) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_61[1], 0)) || unk_0x91BBD269506D61D2(iLocal_61[0], unk_0x33CD235DF1E6A94E(), 1)) || unk_0x91BBD269506D61D2(iLocal_61[1], unk_0x33CD235DF1E6A94E(), 1))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[0]) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[1]))
				{
					if (func_93())
		...
		vVar0 = { 15f, 15f, 15f };
		vVar1 = { -15f, -15f, -15f };
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_59[0]))
		{
			if (unk_0x416C37C19CCE0077(unk_0x61B226C460A8FCC2(iLocal_59[0], 31086, 0f, 0f, 0f), 5f, 1))
			{
				func_4();
				return 1;
			}
			vVar0 = { vVar0 + unk_0x61B226C460A8FCC2(iLocal_59[0], 31086, 0f, 0f, 0f) };
			vVar1 = { vVar1 + unk_0x61B226C460A8FCC2(iLocal_59[0], 31086, 0f, 0f, 0f) };
			if (((unk_0x7EEE8B447AB73C25(vVar1, vVar0, joaat("weapon_smokegrenade"), 1) || unk_0x7EEE8B447AB73C25(vVar1, vVar0, joaat("weapon_grenade"), 1)) || unk_0x7EEE8B447AB73C25(vVar1, vVar0, joaat("weapon_grenadelauncher"), 1)) || unk_0x7EEE8B447AB73C25(vVar1, vVar0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
			if (unk_0x4141DE783FB62352(unk_0x61B226C460A8FCC2(iLocal_59[0], 31086, 0f, 0f, 0f), 3f))
			{
				func_4();
				return 1;
			}
		...
		if ((!unk_0xBC2FC12AD0FBF72E(iLocal_58) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[0])) && !unk_0xBC2FC12AD0FBF72E(iLocal_59[1]))
		{
			if (iLocal_47 != -1)
			{
				if (((unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_59[0]) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_59[1])) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_59[0])) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_59[1]))
				{
					func_4();
					return 1;
				}
			...
			if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_58, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((unk_0xDAAA48CE50D80F52(iLocal_59[0], unk_0x33CD235DF1E6A94E()) || unk_0xDAAA48CE50D80F52(iLocal_59[1], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_59[0], unk_0x33CD235DF1E6A94E())) || unk_0xC4BA1231BBAF1161(iLocal_59[1], unk_0x33CD235DF1E6A94E()))
				{
					if (!iLocal_50)
					{
						unk_0x4DDF5809B68AA635(iLocal_59[0], unk_0x33CD235DF1E6A94E(), -1, 0);
						iLocal_50 = 1;
					}
					if (unk_0xE38E3CF1625A4145(iLocal_56))
					{
					...
					if (unk_0xE38E3CF1625A4145(iLocal_57[0]))
					{
						unk_0x983D75D9630FD905(iLocal_57[0], true);
					}
					if (unk_0xE38E3CF1625A4145(iLocal_57[1]))
					{
						unk_0x983D75D9630FD905(iLocal_57[1], true);
					}
					if ((!func_8() || func_6("RECGF_SHUTUP")) || func_6("RECGF_PAYUP"))
					{
						if (iLocal_47 == -1)
						{
							iLocal_47 = unk_0xE3903F59E2F22150();
							if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
							{
								func_4();
								func_40(0);
			...
			if (iLocal_47 != -1 && unk_0xE3903F59E2F22150() > iLocal_47 + 10000)
			{
				func_4();
				func_40(0);
...
void func_78()
{
	if (unk_0x91D5C8283D19AF49(iLocal_60, 0))
	{
		if ((!unk_0x18FB647D79B09657(iLocal_60, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, false, true, 0) && !unk_0x10930B9CAD4111C2(iLocal_58, iLocal_60, 0)) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_60, 1))
		{
			func_58();
		}
	}
...
int func_79()
{
	...
	if (((((!unk_0x765F6FEEFF39224F(iLocal_58) && !unk_0x765F6FEEFF39224F(iLocal_59[0])) && !unk_0x765F6FEEFF39224F(iLocal_59[1])) && !unk_0x765F6FEEFF39224F(iLocal_60)) && !unk_0x765F6FEEFF39224F(iLocal_61[0])) && !unk_0x765F6FEEFF39224F(iLocal_61[1]))
	{
		...
		{
			unk_0x8C4EA5F6857553AE(joaat("picador"), true);
			unk_0x8C4EA5F6857553AE(joaat("hexer"), true);
			unk_0xAF9EA4E314ED45C2(417.901f, 3578.002f, 31.176f, 1305.897f, 3604.306f, 40.1064f, 100.0625f, 0, false, 1);
			unk_0x0335D8135051EA56(vLocal_48 - Vector(20f, 50f, 80f), vLocal_48 + Vector(20f, 50f, 70f), 0, 1, 1, 1);
			unk_0xA53C1C92EE35EC0E(3, false);
			unk_0xA53C1C92EE35EC0E(5, false);
			unk_0x9315FCF6CFE2AB41("rghLost", &iLocal_228);
			unk_0xD2E80177F27FD43F(5, iLocal_228, 1862763509);
			iLocal_58 = unk_0x9BA5CF280376EEA4(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, true);
			unk_0x93AA93DA1B137032(iLocal_58, 0, 0, 1, 0);
			unk_0x93AA93DA1B137032(iLocal_58, 2, 1, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_58, 3, 1, 2, 0);
			unk_0x93AA93DA1B137032(iLocal_58, 4, 0, 0, 0);
			unk_0x71CA80D41E1338B4(joaat("a_m_m_skidrow_01"));
			unk_0x4A852F02088ECC9D(iLocal_58, true);
			unk_0x28F648743D7DE312(iLocal_58, 17, true);
			unk_0xF0BE7CB40DE62A2F(iLocal_58, false);
			unk_0xAD3D24C8070DA056(iLocal_58, true);
			unk_0x5FEE418CE11E6DDE(iLocal_58, 185, true);
			unk_0xBE470ACBEDCBF6FC(iLocal_58, 16);
			unk_0x5464B9731013E08C(iLocal_58, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_57(&uLocal_63, 1, iLocal_58, "RECGFDealer", 0, 1);
			unk_0x9FD099B0593CD91D(iLocal_58, true);
			unk_0x108754262311D34F(iLocal_58, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x511559F67646F1C0(iLocal_58, "move_m@gangster@var_i", 1048576000);
			iLocal_60 = unk_0xC651C43AB13A15E5(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, true, true, false);
			unk_0x65EA11CF317FE4FA(iLocal_60, 37, 0);
			unk_0x4A7AB87632044178(iLocal_60, 4, 0);
			unk_0xD266F9D236AE6C86(iLocal_60, 1);
			unk_0x6F10E9B95245828B(iLocal_60, "WDU 696");
			iLocal_59[0] = unk_0x9BA5CF280376EEA4(22, joaat("g_m_y_lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, 1, true);
			func_57(&uLocal_63, 3, iLocal_59[0], "RECGFLost2", 0, 1);
			iLocal_59[1] = unk_0x9BA5CF280376EEA4(22, joaat("g_m_y_lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, 1, true);
			func_57(&uLocal_63, 2, iLocal_59[1], "RECGFLost1", 0, 1);
			unk_0x71CA80D41E1338B4(joaat("g_m_y_lost_01"));
			unk_0x71CA80D41E1338B4(joaat("g_m_y_lost_02"));
			iLocal_61[0] = unk_0xC651C43AB13A15E5(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, true, true, false);
			iLocal_61[1] = unk_0xC651C43AB13A15E5(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, true, true, false);
			unk_0x71CA80D41E1338B4(joaat("hexer"));
			unk_0x108754262311D34F(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x108754262311D34F(iLocal_59[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_59)
			{
				if (iVar0 < 2)
				{
					...
					unk_0x34A51926277F67BC(iLocal_59[iVar0], 2);
					unk_0x28F648743D7DE312(iLocal_59[iVar0], 50, true);
					unk_0x1E0350F1D7702D6A(iLocal_59[iVar0], 0);
					unk_0x697EBA5CF1A6AB57(iLocal_59[0], joaat("weapon_pistol"), -1, true, true);
					unk_0x697EBA5CF1A6AB57(iLocal_59[1], joaat("weapon_sawnoffshotgun"), -1, true, true);
					unk_0x897EF720254BBEA3(iLocal_59[iVar0], true);
					unk_0x4A852F02088ECC9D(iLocal_59[iVar0], true);
					unk_0x43D47AD82DA3C6EC(iLocal_59[iVar0], true, 1);
				}
				iVar0++;
			}
			iLocal_55 = unk_0xE3903F59E2F22150() + 1500;
			if (func_48() == 0)
			{
				func_57(&uLocal_63, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
			}
			else if (func_48() == 1)
			{
				func_57(&uLocal_63, 0, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
			}
			else if (func_48() == 2)
			{
				func_57(&uLocal_63, 0, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
			}
			return 1;
		}
	}
...
int func_80()
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		if (vmag2(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_91())
		{
			return 0;
		}
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_112(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
