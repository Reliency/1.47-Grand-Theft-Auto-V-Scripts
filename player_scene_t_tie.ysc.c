...
int func_2()
{
	...
	fVar0 = vdist2(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			{
				unk_0xB815670C37E03CDE(iLocal_69[iVar0]);
				if (!unk_0x5D98D654CDC2165A(iLocal_69[iVar0]))
				{
					unk_0xB815670C37E03CDE(iLocal_69[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0x786AF4A44E1B5B4B(&cLocal_75))
		{
			unk_0x0483D0035D6E46FD(&cLocal_75);
			if (!unk_0xE9CCF312047EBEE0(&cLocal_75))
			{
				unk_0x0483D0035D6E46FD(&cLocal_75);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x9BA5CF280376EEA4(26, iLocal_69[iVar0], vLocal_70 + vLocal_72[iVar0 /*3*/], 0f, 1, true);
			unk_0x1C8705F667F673EA(iLocal_68[iVar0], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 2, 1);
			unk_0xC475906893AEB995(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				unk_0x93AA93DA1B137032(iLocal_68[iVar0], 3, 1, 0, 0);
				unk_0x93AA93DA1B137032(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0xC475906893AEB995(iLocal_68[iVar0], 0);
			}
			unk_0x28F648743D7DE312(iLocal_68[iVar0], 13, false);
			...
			unk_0x548FEB9052C36FFD(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), vLocal_70 + vLocal_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 1000f, -8f, -1, iLocal_81, 0, 2, 0);
			unk_0x880B00F3FAE4C022(iLocal_68[iVar0], 0, 0);
			unk_0x897EF720254BBEA3(iLocal_68[iVar0], true);
			unk_0x41E36A540F8F323F(iLocal_68[iVar0], 55, true);
			if (iLocal_83[iVar0] > 0)
			{
				unk_0xB957AD9B5155A2E4(iLocal_68[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x9247930CE6A29BC3(iLocal_68[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x9247930CE6A29BC3(iLocal_68[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x9247930CE6A29BC3(iLocal_68[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x9247930CE6A29BC3(iLocal_68[iVar0], 2, 0f, 0.15f, 2);
				unk_0x9247930CE6A29BC3(iLocal_68[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x9247930CE6A29BC3(iLocal_68[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0x05CD36A082654514(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x05CD36A082654514(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x05CD36A082654514(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x05CD36A082654514(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x05CD36A082654514(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_82)
	{
		if (iLocal_83[iVar0] > 0)
		{
			...
			fVar10 = 1f;
			fVar11 = -1f;
			iLocal_82[iVar0] = unk_0x8B096ED4BB378AA7(iLocal_83[iVar0], vLocal_70 + vLocal_84[iVar0 /*3*/], vVar3, vVar4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, 0, 0, 0);
			wait(0);
		}
		iVar0++;
	}
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_83[4] = 1015;
			iLocal_83[5] = 1015;
			vLocal_84[4 /*3*/] = { vLocal_84[0 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x9562E33C057F7589(0.5f, 0.5f), unk_0x9562E33C057F7589(0.5f, 0.5f)) };
			vLocal_84[5 /*3*/] = { vLocal_84[1 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x9562E33C057F7589(0.5f, 0.5f), unk_0x9562E33C057F7589(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 17, 1785177548, 1785177548, unk_0x9562E33C057F7589(-5f, 5f), unk_0x9562E33C057F7589(-5f, 5f), 0f, unk_0x9562E33C057F7589(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 144, 1785177548, 1785177548, unk_0x9562E33C057F7589(-5f, 5f), unk_0x9562E33C057F7589(-5f, 5f), 0f, unk_0x9562E33C057F7589(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 43, 1785177548, 1785177548, unk_0x9562E33C057F7589(-5f, 5f), unk_0x9562E33C057F7589(-5f, 5f), 0f, unk_0x9562E33C057F7589(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_33()
{
	...
	while (iVar0 < iLocal_69)
	{
		if (iLocal_69[iVar0] != 0)
		{
			unk_0x71CA80D41E1338B4(iLocal_69[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0x786AF4A44E1B5B4B(&cLocal_75))
	{
		unk_0xFF2DEA68E2D3602E(&cLocal_75);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_82)
	{
		if (unk_0x6A679F5037F6430D(iLocal_82[iVar0]))
		{
		}
		iVar0++;
	}
