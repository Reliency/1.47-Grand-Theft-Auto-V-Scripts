...
void __EntryFunction__()
{
	...
	iLocal_54 = -1;
	iLocal_56 = unk_0x8CCC0A0504C52531();
	...
	if (Var0 == 17)
	{
		iLocal_57 = unk_0x0335D8135051EA56(vVar1 - Vector(40f, 40f, 40f), vVar1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0xCC323859A8DA2B88("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
		iLocal_57 = unk_0x0335D8135051EA56(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		{
			func_194(&Var0);
			if (unk_0x66DE54BD13B1BD88(iLocal_56))
			{
				func_189(&Var0, vVar1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_188() && func_187(Var0.f_28[0])) && !unk_0x8B76D954998C9E96(Var0.f_28[0])) && unk_0x66DE54BD13B1BD88(iLocal_56)) && unk_0x3C05A6D663EA1B6A("EXTREME_04_DOM_A", false, -1)) && unk_0x3C05A6D663EA1B6A("EXTREME_04_DOM_B", false, -1)) && unk_0x3C05A6D663EA1B6A("EXTREME_04_DOM_C", false, -1))
			{
				unk_0xE9739440E5BF08EE(iLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_55 == 0 && func_187(unk_0x33CD235DF1E6A94E())) && unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vVar1, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
		...
		if (func_171(&Var0, 0) || func_169(&Var0))
		{
			...
			{
				unk_0xCBE6AF58552C63B2(iLocal_56);
			}
			if (func_1(&Var0))
			{
				func_270(&Var0, 0);
...
int func_169(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
			{
...
int func_189(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_187(unk_0x33CD235DF1E6A94E()) && func_187(iParam0->f_28[0])) && !func_188()) && (unk_0xE3903F59E2F22150() - iParam0->f_60) > iParam6) && func_193(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_195(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_193(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_198(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_193(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !unk_0x1CE8F0A08E65CA6A(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_223(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_230(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_28[0]))
			{
				...
				{
					unk_0x5FEE418CE11E6DDE(uParam0->f_28[0], 118, false);
					unk_0x5FEE418CE11E6DDE(uParam0->f_28[0], 208, true);
					unk_0x697EBA5CF1A6AB57(uParam0->f_28[0], joaat("gadget_parachute"), 1, false, false);
		...
		case 2:
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_28[0]))
			{
				if (func_250(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					...
					unk_0x23298AB8A7D0F403(uParam0->f_28[0], false, 0);
					unk_0x93AA93DA1B137032(uParam0->f_28[0], 8, 1, 0, 0);
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_35[2]))
			{
				...
				unk_0x1C2B995BA5ADE8FF(uParam0->f_35[2], false, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_270(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 17)
	{
		unk_0xF1CFA0046BB67893(iLocal_57, 0);
