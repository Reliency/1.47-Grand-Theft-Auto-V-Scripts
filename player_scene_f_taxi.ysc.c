...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { unk_0xFBB1F99A825CAB09(iLocal_68, false) };
		fVar2 = vdist2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0x21D56A8927F5A92A(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xDB4C79A9697E6A55(Global_91042))
		{
			...
			if (!func_5(Global_93403, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0x094626C0798AE1F8(Global_93403, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0xF70578F5CD9822CB(iLocal_68, false);
				iLocal_172 = 1;
			}
			unk_0x78893508441AD74F(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_93403, iLocal_70, 2))
			...
			unk_0x0C6BB9365C4A5F6E(iLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0x99414FB2D30425C1(&iVar2);
				unk_0x78893508441AD74F(0, iLocal_70, 24, 50);
				unk_0x838F76C6C0AB6849(0, 2000);
				unk_0x77C4189A8E5C57C2(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0xC734F59A13D39AEF(iVar2);
				unk_0x13A2D602CD10CBAC(iLocal_68, iVar2);
...
void func_21()
{
	...
	unk_0x8C4EA5F6857553AE(iLocal_69, true);
	iLocal_70 = unk_0x5E65439BE0A05829(vLocal_173 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0x765F6FEEFF39224F(Global_93403) || !unk_0x765F6FEEFF39224F(iLocal_70)) || (!unk_0x5D98D654CDC2165A(iLocal_69) && iVar0 < 400))
	{
	...
	{
		unk_0x9FABD0AB045A5D6E(iLocal_70, true, true, 0);
		unk_0xD303E20CB0AE4AD0(iLocal_70, 2);
		unk_0x1B2303F9DC2D90D5(iLocal_70, 1084227584);
		iLocal_68 = unk_0xE196503B36B6194B(iLocal_70, 4, iLocal_69, -1, 1, true);
		unk_0xC475906893AEB995(iLocal_68, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 17, 1785177548, 1785177548, unk_0x9562E33C057F7589(-5f, 5f), unk_0x9562E33C057F7589(-5f, 5f), 0f, unk_0x9562E33C057F7589(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 144, 1785177548, 1785177548, unk_0x9562E33C057F7589(-5f, 5f), unk_0x9562E33C057F7589(-5f, 5f), 0f, unk_0x9562E33C057F7589(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 43, 1785177548, 1785177548, unk_0x9562E33C057F7589(-5f, 5f), unk_0x9562E33C057F7589(-5f, 5f), 0f, unk_0x9562E33C057F7589(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_49()
{
	if (!unk_0xD62C4419A41F106A(iLocal_68, 0) && unk_0x9E08E12414BD4476(iLocal_68, 1))
	{
		unk_0x1F45B4626AC4A4C0(&iLocal_68);
	}
	if (!unk_0xD62C4419A41F106A(iLocal_70, 0) && unk_0x9E08E12414BD4476(iLocal_70, 1))
	{
		unk_0x65F544B458249682(&iLocal_70);
	}
	unk_0x8C4EA5F6857553AE(iLocal_69, false);
	unk_0x71CA80D41E1338B4(iLocal_69);
