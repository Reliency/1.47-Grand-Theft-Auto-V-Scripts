...
void __EntryFunction__()
{
	...
	if (unk_0x1BCDA92AD0A7835B(unk_0x535C9C52117DA0AD()) > 1 && !func_86(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
		...
		if (unk_0x765F6FEEFF39224F(iLocal_53) && !unk_0xD62C4419A41F106A(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_72(3) && !Global_93716)
						{
							...
							{
								if ((!func_86(uLocal_58, 1) || !unk_0x765F6FEEFF39224F(func_71())) && !Global_93716)
								{
									func_79(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (!unk_0x18FB647D79B09657(iLocal_53, ScriptParam_93.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, false, true, iLocal_67))
							{
								bVar2 = false;
							}
							...
							if (bVar2)
							{
								...
								if (func_44(uLocal_54))
								{
									...
									else if (!func_86(uLocal_58, 2048) || !unk_0xFAC8F20FBC764F4D())
									{
										func_42(&iLocal_60);
				...
				case 6:
					...
					if (func_86(uLocal_58, 2097152))
					{
						if (!func_72(3) && !unk_0x8ED4328770BEE4A1(iLocal_50))
						{
							func_79(10);
						}
					}
...
void func_23()
{
	if (bLocal_85)
	{
		if (bLocal_86)
		{
			...
			{
				unk_0x65F544B458249682(&iLocal_83);
			}
			if (unk_0x765F6FEEFF39224F(iLocal_84))
			{
				unk_0x65F544B458249682(&iLocal_84);
			}
		}
	}
}
...
void func_38()
{
	...
	if ((unk_0x765F6FEEFF39224F(iLocal_84) && !unk_0xD62C4419A41F106A(iLocal_84, 0)) && !unk_0x17260B4EA0652E1C(iLocal_84))
	{
		unk_0xD303E20CB0AE4AD0(iLocal_84, 2);
		unk_0xE043FB70A76DE4AE(iLocal_84, 1);
		unk_0x1C2B995BA5ADE8FF(iLocal_84, false, 0);
		unk_0x23F395CF89089EB2(iLocal_84, 1);
		iLocal_82 = iLocal_84;
		if (unk_0x765F6FEEFF39224F(iLocal_83) && !unk_0xD62C4419A41F106A(iLocal_83, 0))
		{
			unk_0xE043FB70A76DE4AE(iLocal_83, 1);
			unk_0x23F395CF89089EB2(iLocal_83, 1);
			unk_0x1C2B995BA5ADE8FF(iLocal_83, false, 0);
			unk_0x26E0FFDB1AD22AC5(iLocal_83, 1);
		}
	}
	else
	{
		if ((unk_0x765F6FEEFF39224F(iLocal_84) && unk_0xD62C4419A41F106A(iLocal_84, 0)) || !unk_0x765F6FEEFF39224F(iLocal_84))
		{
			func_39(0);
		}
		if ((unk_0x765F6FEEFF39224F(iLocal_83) && unk_0xD62C4419A41F106A(iLocal_83, 0)) || !unk_0x765F6FEEFF39224F(iLocal_83))
		{
			func_39(0);
		}
		if ((iLocal_88 && unk_0xE9CCF312047EBEE0("oddjobs@hunterIntro")) && unk_0xE9CCF312047EBEE0("oddjobs@hunterOutro"))
		{
	...
	else if ((iLocal_88 && unk_0xE9CCF312047EBEE0("oddjobs@hunterIntro")) && unk_0xE9CCF312047EBEE0("oddjobs@hunterOutro"))
	{
		unk_0xFF2DEA68E2D3602E("oddjobs@hunterIntro");
		unk_0xFF2DEA68E2D3602E("oddjobs@hunterOutro");
		iLocal_88 = 0;
...
void func_76()
{
	if (bLocal_85)
	{
		...
		if (!iLocal_87)
		{
			unk_0xB7350047030F7672(-1702.46f, 4666.36f, 22.1255f, 10f, 0, 0, 0, 0, false, 0);
			if (!unk_0x765F6FEEFF39224F(iLocal_83))
			{
				iLocal_83 = unk_0xC651C43AB13A15E5(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, true, true, false);
			}
			if (!unk_0x765F6FEEFF39224F(iLocal_84))
			{
				iLocal_84 = unk_0xC651C43AB13A15E5(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, true, true, false);
				unk_0x09993E7216CF52C4(iLocal_84, true);
			}
			iLocal_87 = 1;
		}
	}
