...
void __EntryFunction__()
{
	...
	iLocal_44 = 49;
	iLocal_45 = 64;
	iLocal_50 = unk_0xFD411B1045595D7D();
	...
	while (true)
	{
		...
		if (iLocal_363 > unk_0xE3903F59E2F22150())
		{
...
int func_2()
{
	switch (iLocal_54)
	{
		...
		case 4:
			if ((unk_0xE3903F59E2F22150() - iLocal_258) > 15000)
			{
				func_22(&uLocal_56, 3);
		...
		case 5:
			...
			{
				iLocal_258 = unk_0xE3903F59E2F22150();
				iLocal_54 = 4;
			}
			break;
...
int func_24(int iParam0)
{
	...
	if (unk_0x020A28FAE1C09250() != iLocal_251)
	{
		iVar0 = (60 * ((24 - iLocal_252) + unk_0x13348E86D5B8A052()));
		iVar0 = ((iVar0 - iLocal_253) + unk_0x7EA67BD818402745());
	}
	else
	{
		iVar0 = (((60 * unk_0x13348E86D5B8A052()) + unk_0x7EA67BD818402745()) - (iLocal_253 + (60 * iLocal_252)));
	}
	if (iVar0 >= (60 * iParam0))
	{
		return 1;
...
{
	unk_0x2E38114179FC5F06(vLocal_282[iParam0 /*3*/].f_2);
}
...
void func_34()
{
	...
	{
		case 0:
			if (unk_0x660BC449336F0502(iLocal_233) < 1f)
			{
				unk_0xFA05791B9B8FA536(iLocal_233, 10f);
			}
			if (unk_0x787CBB9DB6BA1A49(iLocal_233) < 1f)
			{
				unk_0xB81134EAAC434D76(iLocal_233, 10f);
			}
			if (func_179(iLocal_233, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_331)
				{
					...
					unk_0x0FF06FD8DEB3AB01(0, iLocal_233, 0);
					unk_0x7E268975AF5EA74F(0, vLocal_330, 1f, 20000, 1048576000, 0, 1193033728);
				...
				unk_0xED68CDDDE25A144E(iLocal_239);
				unk_0x13A2D602CD10CBAC(iLocal_239, iVar0);
				unk_0xA7A57E7757ED035E(&iVar0);
				unk_0x5FEE418CE11E6DDE(iLocal_239, 104, true);
				iLocal_314 = 0;
				if (func_178())
				{
					bLocal_318 = true;
				...
				unk_0xB7350047030F7672(vLocal_329, 8f, 1, 0, 0, 0, false, 0);
				if (!bLocal_331)
				{
					unk_0xB7350047030F7672(-820.2315f, 176.7027f, 70.6122f, 8f, 1, 0, 0, 0, false, 0);
				}
				if (bLocal_331)
				{
					iLocal_316 = unk_0xE3903F59E2F22150() + 10000;
					iLocal_315 = unk_0x392F736BA9C4A337("DEFAULT_SCRIPTED_CAMERA", -1315.612f, 402.8979f, 76.0077f, -26.827f, 0f, 175.0236f, 48.4f, 0, 2);
				}
				else
				{
					iLocal_316 = unk_0xE3903F59E2F22150() + 5000;
					iLocal_315 = unk_0x392F736BA9C4A337("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f, -110.4f, 48.4f, 0, 2);
				}
				unk_0x189377BFBDC9127F(iLocal_315, true);
		...
		case 1:
			...
			if (!iLocal_314)
			{
				if (func_3(&uLocal_56, "MET1AUD", "MET1_ATHOME", 7, 0, 0, 0) || unk_0xE3903F59E2F22150() > iLocal_316)
				{
					iLocal_314 = 1;
				}
			}
			...
			else if ((func_56(iLocal_239, vLocal_330, 2f) || (unk_0xE3903F59E2F22150() - iLocal_316) > 5000) || bLocal_317)
			{
				if (bLocal_318)
				{
					...
					iLocal_319 = 1;
					iLocal_320 = unk_0xE3903F59E2F22150() + 300;
				}
				else
				{
					iLocal_53 = 2;
			...
			if (!bLocal_331)
			{
				unk_0x41E36A540F8F323F(iLocal_239, 247, true);
			}
			break;
		...
		case 2:
			...
			else
			{
				if (bLocal_317)
				{
					unk_0x31826EF4A8BC8E9F(iLocal_239);
					unk_0xBEADAF07D2339505(iLocal_239, -813.7761f, 179.4943f, 71.1592f, 0, false, 0, 1);
					unk_0x880B00F3FAE4C022(iLocal_239, 0, 0);
				}
				if (func_23())
				{
					func_54();
				}
				unk_0xB40411FADDCA9CC8(iLocal_233, 1, 1);
				func_51(iLocal_239);
			}
			unk_0x63F0B040CE6EDF0F(false, false, 3000, 1, 0, 0);
			func_40(1, 1, 1, 1);
			unk_0xC7E6A5D90DED6E0B(0f);
			unk_0x2F8A4DF7D0DFF0A8(iLocal_315, 0);
			func_35(0);
			break;
	}
}
	...
	if (iParam1 == 1)
	{
		if ((iLocal_36 != 0 && iLocal_36 != joaat("object")) && iLocal_36 != joaat("gadget_parachute"))
		{
			if (func_26(unk_0x33CD235DF1E6A94E()))
			{
				...
				{
					unk_0x274C6068B660FFB4(unk_0x33CD235DF1E6A94E(), iLocal_36, false);
				}
			}
		}
	}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_72(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_72(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_84(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_84(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_84(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_84(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_115(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_115(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_72(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_181()
{
	switch (iLocal_53)
	{
		case 0:
			...
			if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
			{
				if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) < 0)
				{
			...
			{
				if (!unk_0xE38E3CF1625A4145(iLocal_248))
				{
		...
		case 1:
			...
			if (iLocal_255)
			{
				...
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
				{
					...
					func_27(&iLocal_248);
					unk_0xD362430CD61A9B08();
					if (!unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0))
					{
						iLocal_256 = 1;
						iLocal_257 = 0;
				...
				else if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 160f, 1))
				{
					sLocal_340 = "MET1ABANDON";
					iLocal_52 = 11;
					iLocal_53 = 0;
				}
				else if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 60f, 1))
				{
					func_28(6);
				}
			}
			else if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
			{
				iLocal_255 = 1;
				unk_0xD362430CD61A9B08();
				func_27(&iLocal_247);
			...
			else if (iLocal_256)
			{
				...
				{
					iLocal_257 = 1;
					unk_0xC838CE9837D0ABAF(iLocal_239, iLocal_233, 20000, 0, 2f, 1, 0);
				}
				if (unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0))
				{
					iLocal_256 = 0;
				...
				{
					if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 60f, 1))
					{
						func_28(6);
					}
				}
			...
			else if (!unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0))
			{
				iLocal_256 = 1;
				iLocal_257 = 0;
				unk_0xD362430CD61A9B08();
			...
			else if (iLocal_259)
			{
				if (iLocal_260)
				{
					if (unk_0x37FBC14B2F5D54DB(203) == 0 || (iLocal_308 >= 4 && !func_23()))
					{
						func_28(3);
						iLocal_260 = 0;
					}
...
void func_182(int iParam0)
{
	if (iLocal_341 != iParam0)
	{
		...
		while (iLocal_339 <= 7)
		{
			...
			{
				if (!unk_0xCE3CFF625BEBAA04(sLocal_342[iLocal_339], "NONE"))
				{
					unk_0xDEFB5E2E5CBD460A(sLocal_342[iLocal_339]);
				}
				iLocal_341 = iParam0;
			}
			else if (unk_0x7C71681384076318(sLocal_342[iLocal_339]))
			{
				unk_0x7CED302277C0F3D3(sLocal_342[iLocal_339]);
			}
			iLocal_339++;
		}
	}
...
int func_183()
{
	if (bLocal_331)
	{
		if (func_56(unk_0x33CD235DF1E6A94E(), vLocal_328, 30f))
		{
			return 1;
		}
	}
...
int func_184()
{
	if (bLocal_331)
	{
		if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_329, 3.5f, 3.5f, 2f, true, true, 0))
		{
			return 1;
		}
	}
	else if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_329, 4.5f, 4.5f, 2f, true, true, 0) && (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -828.7069f, 176.6418f, 69.66212f, -824.0747f, 184.5666f, 72.91872f, 5.75f, 0, true, 0) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -827.9308f, 182.0454f, 70.08909f, -820.2387f, 180.1781f, 72.71543f, 6.5f, 0, true, 0)))
	{
		return 1;
	}
	return 0;
...
void func_185()
{
	...
	if (iLocal_308 == 0)
	{
		if (bLocal_277)
		{
			if (bLocal_278)
			{
				...
				{
					unk_0x99414FB2D30425C1(&iVar0);
					unk_0x108754262311D34F(0, sLocal_246, "react_intro", 8f, -8f, 4900, 8, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_246, "react_loop", 8f, -4f, 12400, 8, 0, 0, 0, 0);
					unk_0xC734F59A13D39AEF(iVar0);
					unk_0xED68CDDDE25A144E(iLocal_239);
					unk_0x13A2D602CD10CBAC(iLocal_239, iVar0);
					iLocal_308 += 4;
	...
	else
	{
		...
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_309) > vLocal_307[3 /*3*/] && !func_56(unk_0x33CD235DF1E6A94E(), vLocal_329, 50f))
			{
				if (func_3(&uLocal_56, vLocal_307[3 /*3*/].f_1, vLocal_307[3 /*3*/].f_2, 7, 0, 0, 0))
				{
					if (!bLocal_278)
					{
						...
						unk_0xED68CDDDE25A144E(iLocal_239);
						unk_0x13A2D602CD10CBAC(iLocal_239, iVar1);
					}
					iLocal_308++;
				}
			}
		...
		if (iLocal_308 == 8)
		{
			...
			{
				if ((unk_0xE80842D7B53F8525(iLocal_233) < 900 || unk_0x787CBB9DB6BA1A49(iLocal_233) < 900f) || unk_0x660BC449336F0502(iLocal_233) < 900f)
				{
					iLocal_308++;
					iLocal_309 = unk_0xE3903F59E2F22150();
				}
		...
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_309) > vLocal_307[4 /*3*/] && !func_56(unk_0x33CD235DF1E6A94E(), vLocal_329, 50f))
			{
		...
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_309) > vLocal_307[5 /*3*/] && !func_56(unk_0x33CD235DF1E6A94E(), vLocal_329, 50f))
			{
		...
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_309) > vLocal_307[6 /*3*/] && !func_56(unk_0x33CD235DF1E6A94E(), vLocal_329, 50f))
			{
		...
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_309) > vLocal_307[7 /*3*/] && !func_56(unk_0x33CD235DF1E6A94E(), vLocal_329, 50f))
			{
...
int func_188()
{
	if (iLocal_234 && unk_0x948A37B10533FA15(iLocal_233))
	{
		return 1;
	}
	return 0;
...
void func_195()
{
	if (bLocal_262 == 0)
	{
		if ((unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0) && unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0)) && unk_0x8BB475EA09C9A0EB(iLocal_233) > 30f)
		{
			fLocal_265 = (fLocal_265 + (1f * timestep()));
		}
		if (unk_0xE3903F59E2F22150() > iLocal_264 && unk_0x7E8740F26D4CAB87(unk_0x95B959F18401C09A()))
		{
			iLocal_263++;
			unk_0xBADACD2849BC0E8C(unk_0x95B959F18401C09A());
			iLocal_264 = unk_0xE3903F59E2F22150() + 2000;
		}
...
void func_198(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_273(unk_0xD178EF744F20B712(), 1);
			if (iVar4 != -1)
			{
...
void func_225(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_230(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x078B659F6F2C8960(iVar5, &Var7) && !func_227(Var7.f_1)) && iVar9 < 51)
			{
...
int func_236(var uParam0)
{
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (func_259())
		{
			*uParam0 = func_242(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), 6, -1, 0, 1, -1);
...
{
	return (shift_right(iParam0, 26) & 31 * func_266(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_284()
{
	...
	{
		case 0:
			unk_0x0483D0035D6E46FD(sLocal_246);
			if (func_26(iLocal_240))
			{
				unk_0xED68CDDDE25A144E(iLocal_240);
				unk_0x33F6BE48E356DA27(iLocal_240, 2, false);
				if (unk_0xF0D230FB550CD6EB(iLocal_240, 0))
				{
					unk_0x99414FB2D30425C1(&iVar0);
					unk_0x07C339D4328CA16C(0, 0, 257);
					unk_0x6DA4DBA91F234052(0, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 2000f, -1, 0, 0);
					unk_0xC734F59A13D39AEF(iVar0);
					unk_0x13A2D602CD10CBAC(iLocal_240, iVar0);
					unk_0xA7A57E7757ED035E(&iVar0);
				}
				else
				{
					unk_0x6DA4DBA91F234052(iLocal_240, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), 2000f, -1, 0, 0);
				}
				iLocal_300 = 0;
				bLocal_301 = false;
				iLocal_302 = 0;
				...
				bLocal_346 = false;
				func_338();
				uLocal_347[0] = unk_0xE3903F59E2F22150() + 10000;
				uLocal_347[1] = unk_0xE3903F59E2F22150() + 10000;
				func_27(&iLocal_247);
				iLocal_247 = func_193(iLocal_240, 1, 0, 5);
				func_337(&iLocal_247, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_249, &iLocal_250, 1, 1);
				unk_0x428C55A965F78103(iLocal_240, 1, 0);
		...
		case 1:
			...
			if (func_26(iLocal_240))
			{
				if (!func_191(iLocal_240, unk_0x33CD235DF1E6A94E(), 80f, 1) && !unk_0x3F219400E5FE4B69(iLocal_240))
				{
					func_33(&iLocal_240);
					bLocal_278 = func_296();
					iLocal_53 = 2;
				...
				else
				{
					...
					else if ((((unk_0xA1248DEAD0B27B8E(iLocal_240) && !unk_0x3AF2B3B68DD52355(iLocal_240)) && !unk_0xF7C907E9E8E2BB22(iLocal_240)) && !unk_0x17260B4EA0652E1C(iLocal_240)) && !unk_0x7DD221C91135596A(iLocal_240))
					{
					...
					func_308(&uLocal_221, iLocal_240, 0, 0, 1, 1, 1);
					func_287();
					unk_0xA9E472293522522F(iLocal_240, 2.2f);
					func_307();
				}
			}
			else
...
void func_287()
{
	if (!bLocal_345)
	{
		if ((unk_0xE3903F59E2F22150() - iLocal_344) > 3000)
		{
			func_290(1);
			if (((func_289(vLocal_343[0 /*3*/], vLocal_343[2 /*3*/], 1f) && !unk_0xA08B8AEC5B1A55D6(iLocal_240)) && !unk_0x3AF2B3B68DD52355(iLocal_240)) && !unk_0xF7C907E9E8E2BB22(iLocal_240))
			{
				unk_0xE0345C3A81F4471A(iLocal_240, -1);
				bLocal_345 = true;
			}
		}
		if (!bLocal_345)
		{
			if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xF0D230FB550CD6EB(iLocal_240, 0))
			{
				if (((unk_0xE3903F59E2F22150() > uLocal_347[0] && func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 20f, 1)) && !unk_0x3AF2B3B68DD52355(iLocal_240)) && !unk_0xF7C907E9E8E2BB22(iLocal_240))
				{
					func_288(0, 0);
				}
				else if (unk_0xE3903F59E2F22150() > uLocal_347[1])
				{
					if ((unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), unk_0x2CA911E7569D12EA(iLocal_240, 0f, 1f, -2f), unk_0x2CA911E7569D12EA(iLocal_240, 0f, 7f, 5f), 5f, 0, true, 0) && !unk_0x3AF2B3B68DD52355(iLocal_240)) && !unk_0xF7C907E9E8E2BB22(iLocal_240))
					{
						func_288(0, 1);
					}
					else
					{
						uLocal_347[1] = unk_0xE3903F59E2F22150() + 2000;
					}
				}
			}
			else if (!bLocal_346 && !unk_0xF0D230FB550CD6EB(iLocal_240, 0))
			{
				func_288(1, 1);
			}
		}
...
void func_288(int iParam0, bool bParam1)
{
	...
	{
		unk_0xECCD4FDA45197F97(iLocal_240, unk_0x33CD235DF1E6A94E(), 2000f, -1, 0, 0);
		uLocal_347[0] = unk_0xE3903F59E2F22150() + 10000;
		if (bParam1)
		{
			uLocal_347[1] = unk_0xE3903F59E2F22150() + 10000;
...
{
	iLocal_344 = unk_0xE3903F59E2F22150();
	...
	if (bParam0)
	{
		vLocal_343[5 /*3*/] = { unk_0xFBB1F99A825CAB09(iLocal_240, true) };
	}
	else
	{
		vLocal_343[5 /*3*/] = { unk_0xFBB1F99A825CAB09(Local_237, true) };
	}
}
...
void func_291()
{
	...
	if (func_294() && unk_0xE3903F59E2F22150() > iLocal_299)
	{
		if (iLocal_294 == 0 || iLocal_294 == 1)
		{
			if (func_26(iLocal_233) && (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0) || func_191(unk_0x33CD235DF1E6A94E(), iLocal_233, 15f, 1)))
			{
				iLocal_294 = 4;
			}
		}
	...
	{
		case 0:
			if ((unk_0xE3903F59E2F22150() - iLocal_288) > 4000)
			{
		...
		case 1:
			if (func_26(iLocal_233) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
			{
				bVar0 = true;
			}
			else
			...
			if (func_26(iLocal_240))
			{
				if (func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 25f, 1))
				{
				...
				{
					if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, (80f * 0.75f), 1))
					{
						if (!bLocal_301)
						{
							iLocal_304 = 8;
				...
				else if ((!bLocal_301 && !func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, (80f * 0.5f), 1)) && func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 15f, 1))
				{
					iLocal_304 = 8;
				}
			}
		...
		case 10:
			if (!func_23())
			{
				...
				if (bLocal_297)
				{
					iLocal_299 = unk_0xE3903F59E2F22150() + 15000;
				}
				iLocal_288 = unk_0xE3903F59E2F22150();
				iLocal_304 = 0;
			}
			else if (bLocal_289 && func_26(iLocal_240))
			{
				...
				if (unk_0x91BBD269506D61D2(iLocal_240, unk_0x33CD235DF1E6A94E(), 1))
				{
					if (func_292() == 4)
					{
						func_54();
					}
					unk_0x0D847D71D9E6142E(iLocal_240);
				}
			}
			else if (bLocal_290 && func_26(iLocal_233))
			{
				if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 1) && !func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 25f, 1))
				{
					func_189();
				}
			}
	...
	if (Global_15866 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (unk_0xEAF855A7DC28BC8D(&(Global_14734[iVar0 /*6*/])))
			{
				...
				sVar2 = unk_0x874DC40B8D8FD604(unk_0x434854E9CAE13C4A(&cVar1), iVar0 * 3, iVar0 * 3 + 1);
...
int func_294()
{
	...
	{
		iVar0 = (unk_0xE3903F59E2F22150() - iLocal_298);
...
int func_296()
{
	if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0) && unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0))
	{
		return 1;
	}
	else if (bLocal_277)
	{
		if (func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 10f, 1))
		{
			return 1;
		}
		else if (func_56(iLocal_239, unk_0xFBB1F99A825CAB09(iLocal_240, false), 10f))
		{
			return 1;
		}
		else if (func_297(iLocal_239, unk_0x33CD235DF1E6A94E(), 1126825984, 1, 250, 7))
		{
			return 1;
		}
...
int func_301(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_303(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_303(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_307()
{
	func_297(iLocal_239, unk_0x33CD235DF1E6A94E(), 1126825984, 1, 250, 7);
...
int func_317(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_324() || func_323(Global_4456448.f_161209)) || func_322())
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			...
			if (((unk_0x3FCD3FCFAFC3878C(iVar0, iVar1) || (unk_0x541D5C57194E73C4(iVar0) == 562680400 && iVar1 != -1)) || (unk_0x541D5C57194E73C4(iVar0) == 1181327175 && iVar1 != -1)) || (((unk_0x541D5C57194E73C4(iVar0) == -1693015116 && iVar1 == 0) && func_320(iVar0, 10)) && unk_0xEECA910C75BFF02B(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_338()
{
	...
	vVar0 = { unk_0xFBB1F99A825CAB09(iLocal_240, true) };
...
void func_339()
{
	switch (iLocal_53)
	{
		case 0:
			...
			{
				func_308(&uLocal_221, iLocal_240, 0, 0, 1, 1, 1);
				if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 220f, 1))
				{
					func_27(&iLocal_247);
				...
				else
				{
					...
					iLocal_298 = (unk_0xE3903F59E2F22150() - 4500);
					iLocal_294 = 0;
					iLocal_286 = 0;
					iLocal_287 = 0;
					bLocal_289 = false;
					...
					iLocal_291 = 0;
					bLocal_297 = false;
					iLocal_292 = (unk_0xE3903F59E2F22150() - 1000);
					...
					if (!iLocal_274)
					{
						iLocal_274 = 1;
						unk_0xED68CDDDE25A144E(iLocal_240);
						unk_0x48B8A6610EAA0C89(iLocal_240, Local_237, unk_0x33CD235DF1E6A94E(), 8, 25f, 786477, 100f, 1f, 1);
					}
					iLocal_344 = unk_0xE3903F59E2F22150();
					if (func_26(Local_237))
					{
						vLocal_343[0 /*3*/] = { unk_0xFBB1F99A825CAB09(Local_237, true) };
					...
					if (unk_0xE38E3CF1625A4145(iLocal_247))
					{
		...
		case 1:
			if (func_26(iLocal_240))
			{
				...
				else if (!unk_0xF0D230FB550CD6EB(iLocal_240, 0))
				{
					iLocal_53 = 0;
					iLocal_52 = 6;
				}
				else if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 220f, 1))
				{
					func_27(&iLocal_247);
					sLocal_340 = "MET1ESCAPE";
					iLocal_52 = 11;
				...
				if ((unk_0xE38E3CF1625A4145(iLocal_247) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0)) && unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0))
				{
					func_354(iLocal_247, iLocal_240, 220f, 0.75f, 0);
				}
				func_308(&uLocal_221, iLocal_240, 0, 0, 1, 1, 1);
...
void func_340()
{
	...
	iLocal_293 = (unk_0xE3903F59E2F22150() - iLocal_292);
	if ((((iLocal_293 > 0 && iLocal_293 < 250) && (iLocal_294 == 0 || iLocal_294 == 1)) && unk_0x8BB475EA09C9A0EB(iLocal_233) < 1.5f) && unk_0x8BB475EA09C9A0EB(Local_237) > 3f)
	{
		iLocal_294 = 8;
	}
	if (func_342())
	...
	{
		case 0:
			if ((((unk_0xE3903F59E2F22150() - iLocal_288) > 4000 && func_26(iLocal_240)) && !func_186()) && !func_23())
			{
				func_21(&uLocal_56, 4, iLocal_240, "Stalker", 0, 1);
				iLocal_294 = 1;
			}
		...
		case 1:
			if (func_26(iLocal_240))
			{
				if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, (220f * 0.75f), 1))
				{
					if (unk_0xF0D230FB550CD6EB(iLocal_240, 0))
					{
						iLocal_294 = 8;
				...
				else if (func_341() && (unk_0xE3903F59E2F22150() - iLocal_272) > 6000)
				{
					iLocal_294 = 7;
				}
				else if (func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 50f, 1))
				{
...
int func_342()
{
	if (unk_0x0D386FBDF1E8CD84(iLocal_233))
	{
		if (func_26(Local_237) && unk_0x4ED4D1D8B2023FD8(iLocal_233, Local_237))
		{
			return 0;
		}
		return 1;
...
void func_343()
{
	if ((unk_0xE3903F59E2F22150() - iLocal_271) > 3000)
	{
		...
		vLocal_270[2 /*3*/] = { unk_0xFBB1F99A825CAB09(iLocal_233, true) };
		iLocal_271 = unk_0xE3903F59E2F22150();
	}
}
...
int func_345()
{
	...
	if (func_26(Local_237))
	{
		fVar0 = func_346(unk_0x582A50CDE1F806AE(Local_237), 0f, 360f);
...
int func_348()
{
	if (func_56(iLocal_233, unk_0x2CA911E7569D12EA(Local_237, 0f, 3.2f, 0.5f), 3f) || func_56(iLocal_233, unk_0x2CA911E7569D12EA(Local_237, 0f, -3.2f, 0.5f), 3f))
	{
		return 1;
	}
	return 0;
...
void func_349()
{
	if (iLocal_356 == 0)
	{
		if (bLocal_348 && (unk_0xE3903F59E2F22150() - iLocal_352) > iLocal_354)
		{
			iLocal_352 = unk_0xE3903F59E2F22150();
			iLocal_356 = 2;
		}
		else if ((unk_0xE3903F59E2F22150() - iLocal_352) > iLocal_355 && unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), unk_0x2CA911E7569D12EA(Local_237, 0f, -0.5f, -1.5f), unk_0x2CA911E7569D12EA(Local_237, 0f, 6f, 2f), 12f, 0, true, 0))
		{
			iLocal_352 = unk_0xE3903F59E2F22150();
			iLocal_356 = 1;
		}
	...
	if (iLocal_356 == 1)
	{
		...
		else if ((unk_0xE3903F59E2F22150() - iLocal_352) < iLocal_353 && func_350(1))
		{
			unk_0xC87D718F567156BE(iLocal_240, 1, unk_0x33CD235DF1E6A94E(), 0, 0f, 0f, 0f, 0, 300, 300);
		}
		else
		{
			iLocal_352 = unk_0xE3903F59E2F22150();
	...
	if (iLocal_356 == 2)
	{
		if ((unk_0xE3903F59E2F22150() - iLocal_352) < iLocal_353 && func_350(0))
		{
			unk_0xC87D718F567156BE(iLocal_240, 1, unk_0x33CD235DF1E6A94E(), 0, 0f, 0f, 0f, 0, 150, 400);
		}
		else
		{
			iLocal_352 = unk_0xE3903F59E2F22150();
...
int func_351()
{
	if (unk_0x765F6FEEFF39224F(Local_237))
	{
		if (unk_0xD62C4419A41F106A(Local_237, 0) || !unk_0x91D5C8283D19AF49(Local_237, 0))
		{
			return 1;
		}
		...
		if (unk_0x948A37B10533FA15(Local_237))
		{
			if (iLocal_268)
			{
				if ((unk_0xE3903F59E2F22150() - iLocal_269) > 7000)
				{
					return 1;
				}
			}
...
int func_353(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	...
	if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
	{
		...
		vVar1 = { func_303(unk_0xFBB1F99A825CAB09(iVar0, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
		vVar2 = { unk_0x43D8A2CCB19FE8A8(iParam0) - unk_0x43D8A2CCB19FE8A8(iVar0) };
		...
		case 0:
			if (!func_361())
			{
				...
				if (func_357(Local_237.f_6, Local_237.f_9, 0))
				{
					...
					iLocal_274 = 0;
					iLocal_276 = 0;
					unk_0x4522AD7364B6AA54(Local_237, Local_237.f_10);
					unk_0x99414FB2D30425C1(&iVar0);
					unk_0x6ED1018181C54CFB(0, Local_237, unk_0xFBB1F99A825CAB09(iLocal_233, true), 4, 35f, 2883621, 10f, 12f, 1);
					unk_0x9BE82A9A1E3A6DF7(0, Local_237, iLocal_233, -1, 25f, 2883621, -1f, 20, 20f);
					unk_0xC734F59A13D39AEF(iVar0);
					unk_0x13A2D602CD10CBAC(iLocal_240, iVar0);
					unk_0xA7A57E7757ED035E(&iVar0);
		...
		case 1:
			...
			if (func_26(iLocal_240))
			{
				if (func_26(Local_237))
				{
					if (!iLocal_276)
					{
						if (unk_0xE9CCF312047EBEE0("missmichael_event@tracy") && func_3(&uLocal_56, "MET1AUD", "MET1_TENDb", 7, 0, 0, 0))
						{
							unk_0x108754262311D34F(iLocal_239, "missmichael_event@tracy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
							unk_0xFF2DEA68E2D3602E("missmichael_event@tracy");
							if (!unk_0xE38E3CF1625A4145(iLocal_247))
							{
								iLocal_247 = func_196(Local_237, 0, 5);
								unk_0x1C95CD840303FC37(iLocal_247, "MET1LBSTALK");
								func_182(4);
							}
							iLocal_276 = 1;
						}
					...
					else
					{
						...
						if (!iLocal_273)
						{
							if (unk_0x91BBD269506D61D2(Local_237, unk_0x33CD235DF1E6A94E(), 1) || unk_0x91BBD269506D61D2(iLocal_240, unk_0x33CD235DF1E6A94E(), 1))
							{
								unk_0x0D847D71D9E6142E(iLocal_240);
								unk_0x0D847D71D9E6142E(Local_237);
								iLocal_273 = 1;
							}
							else if (func_191(unk_0x33CD235DF1E6A94E(), iLocal_240, 15f, 1))
							{
								iLocal_273 = 1;
							}
						}
...
int func_357(vector3 vParam0, float fParam1, int iParam2)
{
	...
	{
		unk_0xB815670C37E03CDE(iLocal_241);
		unk_0xB815670C37E03CDE(Local_237.f_1);
		iLocal_242 = 1;
	}
	...
	{
		if (unk_0x5D98D654CDC2165A(iLocal_241) && unk_0x5D98D654CDC2165A(Local_237.f_1))
		{
			unk_0xB7350047030F7672(Local_237.f_6, 5f, 0, 0, 0, 0, false, 0);
			Local_237 = unk_0xC651C43AB13A15E5(Local_237.f_1, vParam0, fParam1, true, true, false);
			unk_0x71CA80D41E1338B4(Local_237.f_1);
			unk_0x65EA11CF317FE4FA(Local_237, 145, 111);
			unk_0x1B2303F9DC2D90D5(Local_237, 1084227584);
			unk_0x474234FD6A8029F8(Local_237, 1);
			unk_0xA133A899BFAC42B4(Local_237, 1);
			unk_0x9FABD0AB045A5D6E(Local_237, true, true, 0);
			unk_0x43D47AD82DA3C6EC(Local_237, true, 1);
			unk_0x320D9994786BCA17(Local_237);
			func_358(Local_237, 0);
			unk_0x7B1011A61F402324(Local_237, "M_E_TRACEY_STALKERS_CAR_GROUP", 0);
			iLocal_267 = 1;
			iLocal_240 = unk_0xE196503B36B6194B(Local_237, 26, iLocal_241, -1, 1, true);
			unk_0x93AA93DA1B137032(iLocal_240, 9, 0, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_240, 8, 0, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_240, 0, 0, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_240, 2, 1, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_240, 3, 0, 0, 0);
			unk_0x93AA93DA1B137032(iLocal_240, 4, 1, 0, 0);
			unk_0x71CA80D41E1338B4(iLocal_241);
			unk_0x4A852F02088ECC9D(iLocal_240, true);
			unk_0x897EF720254BBEA3(iLocal_240, true);
			func_21(&uLocal_56, 4, iLocal_240, "Stalker", 0, 1);
			unk_0x5FEE418CE11E6DDE(iLocal_240, 281, true);
			iLocal_242 = 0;
			iLocal_363 = unk_0xE3903F59E2F22150() + 1000;
			return 1;
		}
	}
	else
...
void func_359()
{
	...
	if (func_56(unk_0x33CD235DF1E6A94E(), Local_325[3 /*8*/], Local_325[3 /*8*/].f_3))
	{
		if (unk_0xCC9A41DD2CD0C58B(Local_237.f_1, vLocal_337[0 /*3*/], 0))
		{
			iVar0 = 0;
		}
		else
	...
	else
	{
		if (func_360())
		{
			if (unk_0xCC9A41DD2CD0C58B(Local_237.f_1, vLocal_337[2 /*3*/], 0))
			{
				iVar0 = 2;
			}
			else
		...
		else if (unk_0xCC9A41DD2CD0C58B(Local_237.f_1, vLocal_337[4 /*3*/], 0))
		{
			iVar0 = 4;
		}
		else
...
void func_362()
{
	if (iLocal_362 == 1 && unk_0xE3903F59E2F22150() > iLocal_361)
	{
	...
	switch (iLocal_53)
	{
		case 0:
			if (func_26(iLocal_233))
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 1))
				{
					iLocal_255 = 0;
				}
				else
				...
				if (unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 1))
				{
					iLocal_256 = 0;
				}
				else
			...
			if (!func_361())
			{
				...
				if (iLocal_255)
				{
					if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
					{
						...
						{
							iLocal_256 = 0;
							if (iLocal_266 == 5 && !func_56(unk_0x33CD235DF1E6A94E(), Local_325[iLocal_326 /*8*/], Local_325[iLocal_326 /*8*/].f_3))
							{
					...
					{
						unk_0xED68CDDDE25A144E(iLocal_239);
						unk_0xECCD4FDA45197F97(iLocal_239, unk_0x33CD235DF1E6A94E(), 200f, -1, 0, 0);
						if (func_23())
						{
							if (func_292() == 3)
							{
				...
				else
				{
					switch (iLocal_266)
					{
						...
						case 2:
							if (func_23())
							{
								if (unk_0xF26F606F8B36E2AC() >= Local_325[iLocal_326 /*8*/].f_7)
								{
									iLocal_247 = func_283(Local_325[iLocal_326 /*8*/], 5, 1);
									iLocal_266 = 3;
								}
						...
						case 3:
							...
							if (func_56(unk_0x33CD235DF1E6A94E(), Local_325[iLocal_326 /*8*/], Local_325[iLocal_326 /*8*/].f_3))
							{
								iLocal_266 = 5;
							}
							else if (!func_23())
						...
						case 4:
							...
							else if (!func_23() && unk_0xE3903F59E2F22150() > iLocal_334)
							{
								if (!func_188())
								{
									if (bLocal_262 && !unk_0xCE3CFF625BEBAA04(Local_325[iLocal_326 /*8*/].f_6, "NULL"))
									{
						...
						case 5:
							...
							else if (!unk_0xE38E3CF1625A4145(iLocal_247))
							{
								iLocal_247 = func_283(Local_325[iLocal_326 /*8*/], 5, 1);
							}
							else
						...
						case 6:
							...
							{
								iLocal_336 = 1;
								iLocal_334 = (unk_0xE3903F59E2F22150() + iLocal_335);
								iLocal_266 = 7;
							}
							break;
						...
						case 7:
							...
							{
								iLocal_334 = unk_0xE3903F59E2F22150();
								iLocal_266 = 0;
							}
							else
							{
...
void func_363()
{
	if (((!func_23() && !func_188()) && unk_0x10930B9CAD4111C2(iLocal_239, iLocal_233, 0)) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
	{
		if (func_341() && (unk_0xE3903F59E2F22150() - iLocal_272) > 18000)
		{
...
void func_364()
{
	...
	Var3.f_1 = 3;
	Var3.f_1.f_4 = 3;
	vVar1[0 /*3*/] = { unk_0x2CA911E7569D12EA(iLocal_233, -8f, 2f, 0f) };
	vVar1[1 /*3*/] = { unk_0x2CA911E7569D12EA(iLocal_233, -8f, 8f, 0f) };
	vVar1[2 /*3*/] = { unk_0x2CA911E7569D12EA(iLocal_233, 8f, 2f, 0f) };
	vVar1[3 /*3*/] = { unk_0x2CA911E7569D12EA(iLocal_233, 8f, 8f, 0f) };
	Var3[0 /*4*/][0] = unk_0x9EC3B269A34A2BEE(0, 3);
	if (Var3[0 /*4*/][0] < 2)
	{
		Var3[0 /*4*/][1] = unk_0x9EC3B269A34A2BEE(2, 3);
	}
	else
	{
		Var3[0 /*4*/][1] = unk_0x9EC3B269A34A2BEE(0, 1);
	}
	if (Var3[0 /*4*/][0] > 1)
	{
		Var3[0 /*4*/][2] = unk_0x9EC3B269A34A2BEE(2, 3);
	}
	else
	{
		Var3[0 /*4*/][2] = unk_0x9EC3B269A34A2BEE(0, 1);
	}
	Var2[0 /*5*/][0] = unk_0x9EC3B269A34A2BEE(300, 600);
	Var2[0 /*5*/][1] = unk_0x9EC3B269A34A2BEE(400, 1000);
	Var2[0 /*5*/][2] = unk_0x9EC3B269A34A2BEE(500, 1000);
	Var2[0 /*5*/][3] = unk_0x9EC3B269A34A2BEE(500, 1000);
	unk_0x99414FB2D30425C1(&(uVar0[0]));
	unk_0x838F76C6C0AB6849(0, Var2[0 /*5*/][0]);
	unk_0xAE5B044AA2973E2A(0, vVar1[Var3[0 /*4*/][0] /*3*/], Var2[0 /*5*/][1], 2048, 2);
	unk_0xAE5B044AA2973E2A(0, vVar1[Var3[0 /*4*/][1] /*3*/], Var2[0 /*5*/][2], 2048, 2);
	unk_0xAE5B044AA2973E2A(0, vVar1[Var3[0 /*4*/][2] /*3*/], Var2[0 /*5*/][3], 2048, 2);
	unk_0xC734F59A13D39AEF(uVar0[0]);
	unk_0x13A2D602CD10CBAC(iLocal_239, uVar0[0]);
	unk_0xA7A57E7757ED035E(&(uVar0[0]));
	Var3[1 /*4*/][0] = unk_0x9EC3B269A34A2BEE(0, 3);
	...
	if (Var3[1 /*4*/][0] < 2)
	{
		Var3[1 /*4*/][1] = unk_0x9EC3B269A34A2BEE(2, 3);
	}
	else
	{
		Var3[1 /*4*/][1] = unk_0x9EC3B269A34A2BEE(0, 1);
	}
	if (Var3[1 /*4*/][0] > 1)
	{
		Var3[1 /*4*/][1] = unk_0x9EC3B269A34A2BEE(2, 3);
	...
	Var2[1 /*5*/][0] = 0;
	Var2[1 /*5*/][1] = unk_0x9EC3B269A34A2BEE(500, 1000);
	Var2[1 /*5*/][2] = unk_0x9EC3B269A34A2BEE(500, 1000);
	Var2[1 /*5*/][3] = unk_0x9EC3B269A34A2BEE(500, 1000);
	unk_0x99414FB2D30425C1(&(uVar0[1]));
	unk_0x838F76C6C0AB6849(0, Var2[1 /*5*/][0]);
	unk_0xAE5B044AA2973E2A(0, vVar1[Var3[1 /*4*/][0] /*3*/], Var2[1 /*5*/][1], 2048, 2);
	unk_0xAE5B044AA2973E2A(0, vVar1[Var3[1 /*4*/][1] /*3*/], Var2[1 /*5*/][2], 2048, 2);
	unk_0xAE5B044AA2973E2A(0, vVar1[Var3[1 /*4*/][2] /*3*/], Var2[1 /*5*/][3], 2048, 2);
...
int func_373(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_303(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_53)
	{
		case 0:
			...
			if (!func_361())
			{
				if (!func_2())
				{
					if (((func_388(&iLocal_239, vLocal_323, fLocal_324, 1) && func_378(&iLocal_233, 15, vLocal_321, fLocal_322, 1, 0)) && unk_0xE9CCF312047EBEE0(sLocal_246)) && func_26(iLocal_233))
					{
						iLocal_243 = 1;
						unk_0x4A852F02088ECC9D(iLocal_239, true);
						func_22(&uLocal_56, 3);
						func_21(&uLocal_56, 3, iLocal_239, "TRACEY", 0, 1);
						unk_0x5FEE418CE11E6DDE(iLocal_239, 32, false);
						unk_0x5FEE418CE11E6DDE(iLocal_239, 26, true);
						func_377();
						unk_0x108754262311D34F(iLocal_239, sLocal_246, "nervous_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0x897EF720254BBEA3(iLocal_239, true);
						unk_0x43D47AD82DA3C6EC(iLocal_233, true, 1);
						unk_0xA155CCFA52A9A0C4(iLocal_233, true);
						unk_0x474234FD6A8029F8(iLocal_233, 1);
						unk_0x320D9994786BCA17(iLocal_233);
						unk_0x09993E7216CF52C4(iLocal_233, true);
		...
		case 1:
			if (iLocal_55 == 0)
			{
				if (func_56(unk_0x33CD235DF1E6A94E(), vLocal_321, 200f))
				{
					iLocal_55 = 1;
				}
			}
			else if (!func_56(unk_0x33CD235DF1E6A94E(), vLocal_321, 300f))
			{
				iLocal_55 = 0;
			}
			if (!func_2())
			{
				if (!func_361())
				{
					...
					{
						case 0:
							if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 246.1479f, -39.21085f, 67.89664f, 202.6635f, -23.77725f, 72.90416f, 22f, 0, true, 0) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 233.7891f, -45.51515f, 67.57388f, 229.9916f, -55.96275f, 72.28979f, 12.5f, 0, true, 0))
							{
								if (func_23())
								{
									func_54();
								...
								unk_0x99414FB2D30425C1(&iVar0);
								unk_0x108754262311D34F(0, sLocal_246, "breakout", 8f, -4f, -1, 0, 0, 0, 0, 0);
								unk_0xC838CE9837D0ABAF(0, iLocal_233, 60000, 0, 2f, 1, 0);
								unk_0xC734F59A13D39AEF(iVar0);
								unk_0xED68CDDDE25A144E(iLocal_239);
								unk_0xC4A347124F39D998(iLocal_239, unk_0x33CD235DF1E6A94E(), 4000, 0, 3);
								unk_0x13A2D602CD10CBAC(iLocal_239, iVar0);
								unk_0xA7A57E7757ED035E(&iVar0);
								unk_0x5FEE418CE11E6DDE(unk_0x33CD235DF1E6A94E(), 170, true);
								unk_0xF68C9C9A191F2B68(3);
								iLocal_361 = unk_0xE3903F59E2F22150() + 10000;
								iLocal_362 = 1;
								iLocal_254 = 1;
							}
							else
						...
						case 1:
							if (func_3(&uLocal_56, "MET1AUD", "MET1_SEES", 7, 1, 0, 0) || unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
							{
							...
							unk_0xC4A347124F39D998(iLocal_239, unk_0x33CD235DF1E6A94E(), 2000, 2048, 4);
							break;
						
						case 2:
							if (((!iLocal_261 && !func_23()) && !func_187("MET1TCAR", 0, 0)) && !unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
							{
							...
							if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
							{
								...
								else if (func_194(2))
								{
									func_27(&iLocal_247);
									iLocal_247 = func_193(iLocal_239, 1, 1, 5);
									unk_0x1C95CD840303FC37(iLocal_247, "MET1LBTRAC");
									func_28(2);
								}
							}
							unk_0xC4A347124F39D998(iLocal_239, unk_0x33CD235DF1E6A94E(), 2000, 2048, 4);
					...
					if (iLocal_254 != 0)
					{
						if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 100f, 1))
						{
							sLocal_340 = "MET1ABANDON";
							iLocal_52 = 11;
							iLocal_53 = 0;
						}
						else if (!func_191(unk_0x33CD235DF1E6A94E(), iLocal_239, 50f, 1))
						{
							func_28(6);
						}
					}
...
void func_376()
{
	...
	{
		case 0:
			if ((unk_0xE3903F59E2F22150() - iLocal_283) > 5000 && func_191(iLocal_239, unk_0x33CD235DF1E6A94E(), 25f, 1))
			{
				iLocal_285 = 9;
			}
			break;
...
void func_377()
{
	if (!iLocal_244)
	{
		unk_0x9315FCF6CFE2AB41("FRIENDLIES", &iLocal_245);
		unk_0xD2E80177F27FD43F(1, iLocal_245, 1862763509);
		unk_0xD2E80177F27FD43F(1, 1862763509, iLocal_245);
		iLocal_244 = 1;
	}
	if (unk_0xE214B9FCEDF6364A(iLocal_239))
	{
		unk_0x5D94F4D6FE7DA516(iLocal_239);
	}
	unk_0x0648A75D3F60E864(iLocal_239, iLocal_245);
}
...
int func_378(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	...
	if (!func_12(iParam1))
	{
		...
		if (unk_0x765F6FEEFF39224F(*iParam0))
		{
			if (unk_0x541D5C57194E73C4(*iParam0) != Var0)
			{
			}
			return 1;
		}
		if ((iParam1 == 17 && Global_106565.f_2357.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_106565.f_2357.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			unk_0xB815670C37E03CDE(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/]);
			if (unk_0x5D98D654CDC2165A(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/]))
			{
				*iParam0 = unk_0xC651C43AB13A15E5(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/], vParam2, fParam3, false, false, false);
				...
				Var0.f_3 = 1250;
				unk_0x65EA11CF317FE4FA(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_5, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_6);
				unk_0x4A7AB87632044178(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_7, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_8);
				unk_0x62B7B895D641DC81(*iParam0, Var0.f_2);
				iVar2 = 0;
				while (iVar2 < 12)
				{
					unk_0x3A3707C1ECABF993(*iParam0, iVar2 + 1, !Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_11[iVar2]);
					iVar2++;
				}
				...
				unk_0x6F10E9B95245828B(*iParam0, &(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_27));
				if (Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_26 >= 0 && Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_26 < unk_0x0E8FDE8C0E616A4C())
				{
					unk_0x177C85C6D06E7E04(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_26);
				}
				unk_0x4D394438E3492CCE(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_84, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_85, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_86);
				unk_0x4459178BAF2918E1(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_88);
				unk_0xBF98CE54BD141AFF(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_87);
				unk_0xB8A3AC2A7B2465FD(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_93, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_94, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_95);
				unk_0xA7CD654BB1AF9419(*iParam0, 2, unk_0x0E4018692D92041D(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_92, 28));
				unk_0xA7CD654BB1AF9419(*iParam0, 3, unk_0x0E4018692D92041D(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_92, 29));
				unk_0xA7CD654BB1AF9419(*iParam0, 0, unk_0x0E4018692D92041D(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_92, 30));
				unk_0xA7CD654BB1AF9419(*iParam0, 1, unk_0x0E4018692D92041D(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_92, 31));
				if (unk_0x864DE9BC3905751B(*iParam0) > 1 && Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_89 >= 0)
				{
					unk_0x40DFA7AAEFC8F34C(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_89);
				}
				if (Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_90 > -1)
				{
					if (!unk_0xC3622EC0E0215A79(unk_0x541D5C57194E73C4(*iParam0)))
					{
						if (unk_0x9E374B5F44A76AE2(unk_0x541D5C57194E73C4(*iParam0)))
						{
							...
							{
								unk_0x4FF8F6D30BFBB224(*iParam0, Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_90);
							}
						}
						else
						{
				...
				if (bParam4)
				{
					unk_0x71CA80D41E1338B4(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar1 /*98*/]);
				}
				func_381(*iParam0);
				return 1;
			}
		...
		{
			unk_0xB815670C37E03CDE(Var0);
			if (unk_0x5D98D654CDC2165A(Var0))
			{
				*iParam0 = unk_0xC651C43AB13A15E5(Var0, vParam2, fParam3, false, false, false);
				unk_0x1B2303F9DC2D90D5(*iParam0, 1084227584);
				unk_0xD5386CD3834C2895(*iParam0, 0);
				unk_0x26D5EA44545890ED(*iParam0, 0);
				unk_0x09993E7216CF52C4(*iParam0, true);
...
void func_379(int iParam0, struct<98> Param1)
{
	...
	if (Param1.f_9)
	{
		unk_0xD6D2420F0051065A(*iParam0, Param1.f_4);
	}
	else
	{
		unk_0x65EA11CF317FE4FA(*iParam0, Param1.f_5, Param1.f_6);
	}
	if (Param1.f_10)
	{
		unk_0x4A7AB87632044178(*iParam0, Param1.f_7, Param1.f_8);
	}
	unk_0x62B7B895D641DC81(*iParam0, Param1.f_2);
	unk_0x7FC2040EB34E0E31(*iParam0, Param1.f_3, 0);
	iVar0 = 0;
	while (iVar0 < 12)
	{
		unk_0x3A3707C1ECABF993(*iParam0, iVar0 + 1, !Param1.f_11[iVar0]);
		iVar0++;
	}
	if (Param1.f_24)
	{
	...
	{
		unk_0x6F10E9B95245828B(*iParam0, &uVar2);
		unk_0x177C85C6D06E7E04(*iParam0, iVar1);
	}
	else if (!unk_0x786AF4A44E1B5B4B(&(Param1.f_27)))
	{
		unk_0x6F10E9B95245828B(*iParam0, &(Param1.f_27));
		if (Param1.f_26 >= 0 && Param1.f_26 < unk_0x0E8FDE8C0E616A4C())
		{
			unk_0x177C85C6D06E7E04(*iParam0, Param1.f_26);
		}
	}
	unk_0x4D394438E3492CCE(*iParam0, Param1.f_84, Param1.f_85, Param1.f_86);
	unk_0x4459178BAF2918E1(*iParam0, Param1.f_88);
	unk_0xBF98CE54BD141AFF(*iParam0, Param1.f_87);
	unk_0xB8A3AC2A7B2465FD(*iParam0, Param1.f_93, Param1.f_94, Param1.f_95);
	unk_0xA7CD654BB1AF9419(*iParam0, 2, unk_0x0E4018692D92041D(Param1.f_92, 28));
	unk_0xA7CD654BB1AF9419(*iParam0, 3, unk_0x0E4018692D92041D(Param1.f_92, 29));
	unk_0xA7CD654BB1AF9419(*iParam0, 0, unk_0x0E4018692D92041D(Param1.f_92, 30));
	unk_0xA7CD654BB1AF9419(*iParam0, 1, unk_0x0E4018692D92041D(Param1.f_92, 31));
	if (unk_0x864DE9BC3905751B(*iParam0) > 1 && Param1.f_89 >= 0)
	{
		unk_0x40DFA7AAEFC8F34C(*iParam0, Param1.f_89);
	}
	if (Param1.f_90 > -1)
	{
		if (!unk_0xC3622EC0E0215A79(unk_0x541D5C57194E73C4(*iParam0)))
		{
			if (unk_0x9E374B5F44A76AE2(unk_0x541D5C57194E73C4(*iParam0)))
			{
				if (Param1.f_90 == 6)
				{
					unk_0x4FF8F6D30BFBB224(*iParam0, Param1.f_90);
				}
			}
			else
			{
	...
	unk_0x90425F35DD715133(*iParam0, Param1.f_96);
}
...
int func_382(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_386(unk_0x541D5C57194E73C4(*iParam0), 1) && unk_0xEECA910C75BFF02B(*iParam0, 24) != func_385(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xB4B3AEABE432069B(*iParam0, 24, func_385(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_384(iParam0);
	if (func_383(*iParam0))
	{
...
int func_388(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	...
	{
		func_33(iParam0);
		*iParam0 = unk_0x9BA5CF280376EEA4(26, iVar0, vParam1, fParam2, 0, false);
...
void func_389()
{
	switch (iLocal_53)
	{
		...
		case 1:
			if (!func_2())
			{
				if (iLocal_255 && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					iLocal_255 = 0;
					func_182(1);
				}
				...
				else if (func_56(unk_0x33CD235DF1E6A94E(), vLocal_321, 200f))
				{
					iLocal_53 = 2;
				}
			}
		...
		case 2:
			...
			{
				unk_0x0483D0035D6E46FD(sLocal_246);
				unk_0xAF9EA4E314ED45C2(Local_332[0 /*3*/], Local_332[1 /*3*/], Local_332.f_7, 0, false, 1);
				iLocal_333 = unk_0x0335D8135051EA56(227.4f, -66.5f, 67.5f, 249f, -30.8f, 72.5f, 0, 1, 1, 1);
				unk_0xCE04CE961AF41AB9(vLocal_321, 30f, 0, 0, 0, false);
				unk_0xB7350047030F7672(vLocal_321, 30f, 0, 0, 0, 0, false, 0);
				iLocal_53 = 0;
				iLocal_52 = 2;
			}
			break;
...
int func_391(vector3 vParam0, bool bParam1)
{
	...
	iVar0 = unk_0x2C0ED4741A007C6A(vParam0);
	unk_0xC51C58C963968740(iVar0, 7);
	unk_0xCE5C49921A521962(iVar0, 0.7f);
	...
	if (unk_0x765F6FEEFF39224F(Global_97130.f_4))
	{
		if (unk_0x91D5C8283D19AF49(Global_97130.f_4, 0))
		{
			if (func_423(24) != Global_97130.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_420(unk_0xFBB1F99A825CAB09(Global_97130.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_424()
{
	...
	if (bLocal_278 && (unk_0xE3903F59E2F22150() - iLocal_281) > 8000)
	{
		unk_0xB5D26BFA756D0D11((2.5f + 8f), 1073741824, 3);
		iLocal_280 = 1;
	}
	if (!bLocal_278 && (unk_0xE3903F59E2F22150() - iLocal_281) > 2000)
	{
...
int func_426()
{
	...
	else if (iLocal_243)
	{
		...
		{
			unk_0xCBDEE923F851F500(iLocal_239, 0);
		}
	}
	return 0;
}
...
int func_427()
{
	if (unk_0x948A37B10533FA15(iLocal_233))
	{
		if (iLocal_235)
		{
			if ((unk_0xE3903F59E2F22150() - iLocal_236) > 7000)
			{
				return 1;
			}
		}
...
int func_428()
{
	...
	if (!unk_0x91D5C8283D19AF49(iLocal_233, 0))
	{
		return 1;
	}
	return 0;
...
void func_430()
{
	switch (iLocal_53)
	{
		case 0:
			func_27(&iLocal_247);
			if (unk_0x786AF4A44E1B5B4B(sLocal_340))
			{
				sLocal_340 = "DEFAULT";
			}
			if (unk_0xCE3CFF625BEBAA04(sLocal_340, "DEFAULT"))
			{
				func_434(0);
			}
			else
...
void func_441(bool bParam0, bool bParam1)
{
	...
	{
		vVar0[0 /*3*/] = { func_458() };
		if (unk_0x5A5015CF0B2DE07A(vVar0[0 /*3*/], &(vVar0[1 /*3*/]), &fVar1, 1, 1077936128, 0))
		{
		}
		else
		{
		...
		fLocal_358 = fVar1;
		unk_0xB7350047030F7672(vLocal_357, 10f, 0, 0, 0, 0, false, 0);
	...
	else if ((((iLocal_52 == 3 || iLocal_52 == 4) || iLocal_52 == 5) && func_26(iLocal_233)) && func_26(iLocal_239))
	{
		if (func_26(unk_0x33CD235DF1E6A94E()))
		{
			if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0))
			{
				func_453(unk_0x33CD235DF1E6A94E(), iLocal_233, -1);
				vLocal_357 = { unk_0xFBB1F99A825CAB09(iLocal_233, true) };
			}
		}
	}
	else
	{
		...
		unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), vLocal_357, 1, false, 0, 1);
	...
	if (bParam0)
	{
		...
		if (!bParam1)
		{
			while (!unk_0xE9CCF312047EBEE0(sLocal_246))
			{
				wait(0);
			}
		}
...
void func_453(int iParam0, int iParam1, int iParam2)
{
	if (func_41(iParam0))
	{
		if (func_26(iParam1))
		{
			...
			{
				unk_0xF70578F5CD9822CB(unk_0xF7E6C8C5BD75E317(iParam0), false);
			}
			else
			{
...
void func_454(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		{
			unk_0x094626C0798AE1F8(iLocal_239, iLocal_233, 0);
		}
	}
	else
	{
	...
	if (func_26(iLocal_233))
	{
		unk_0x474234FD6A8029F8(iLocal_233, 1);
		unk_0xA155CCFA52A9A0C4(iLocal_233, true);
		unk_0x9FABD0AB045A5D6E(iLocal_233, true, true, 0);
		unk_0x320D9994786BCA17(iLocal_233);
		unk_0x09993E7216CF52C4(iLocal_233, true);
		func_358(iLocal_233, 1);
		iLocal_234 = 1;
...
void func_455()
{
	...
	if (iLocal_234)
	{
		unk_0x251D428435E55081(iLocal_233);
		iLocal_234 = 0;
	}
	func_31(&iLocal_233);
}
...
void func_459()
{
	...
	if (unk_0x765F6FEEFF39224F(Local_237))
	{
		if (iLocal_267)
		{
			unk_0x251D428435E55081(Local_237);
			iLocal_267 = 0;
		}
		unk_0xA6E32819044BBB6A(Local_237, 0);
		func_31(&Local_237);
	}
}
...
void func_460(bool bParam0)
{
	...
	else
	{
		if (func_26(unk_0x33CD235DF1E6A94E()))
		{
			unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), Local_325[3 /*8*/], Local_325[3 /*8*/].f_1, (Local_325[3 /*8*/].f_2 + 8f), 1, false, 0, 1);
			func_454(Local_325[3 /*8*/], 71.4f, 1);
			func_453(unk_0x33CD235DF1E6A94E(), iLocal_233, -1);
		}
		if (func_26(iLocal_233))
		{
			unk_0xB7350047030F7672(unk_0x2CA911E7569D12EA(iLocal_233, 0f, -8f, 0f), 6f, 0, 0, 0, 0, false, 0);
		}
	}
...
void func_461(bool bParam0)
{
	...
	if (func_26(unk_0x33CD235DF1E6A94E()))
	{
		if (bParam0)
		{
			if (func_491())
			{
				...
				fLocal_358 = 251.1f;
				bLocal_359 = true;
				unk_0xB7350047030F7672(99.6208f, -21.0027f, 67.0114f, 7f, 0, 0, 0, 0, false, 0);
				func_489();
				while (!func_488())
				{
					wait(0);
			...
			{
				unk_0xCE04CE961AF41AB9(181.2331f, -33.9939f, 67.2522f, 3f, 1, 0, 0, false);
		...
		{
			if ((func_26(iLocal_233) && unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), iLocal_233, 0)) || (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && !unk_0x91D5C8283D19AF49(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), 0)))
			{
				unk_0xCE04CE961AF41AB9(181.2331f, -33.9939f, 67.2522f, 3f, 1, 0, 0, false);
				unk_0xBEADAF07D2339505(unk_0x33CD235DF1E6A94E(), 181.2331f, -33.9939f, 67.2522f, 1, false, 0, 1);
			...
			{
				unk_0xB7350047030F7672(99.6208f, -21.0027f, 67.0114f, 7f, 0, 0, 0, 0, false, 0);
				iLocal_360 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
				unk_0xBEADAF07D2339505(iLocal_360, 99.6208f, -21.0027f, 67.0114f, 1, false, 0, 1);
				unk_0x3C990C409B3845DE(iLocal_360, 251.1f);
				unk_0x1B2303F9DC2D90D5(iLocal_360, 1084227584);
				vLocal_357 = { 99.6208f, -21.0027f, 67.0114f };
				bLocal_359 = true;
			}
		}
	...
	iLocal_52 = 1;
	iLocal_53 = 0;
	if ((func_26(unk_0x33CD235DF1E6A94E()) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0)) || bLocal_359)
	{
		func_182(1);
	}
	else
	...
	if (bLocal_359)
	{
		...
		{
			unk_0x9FABD0AB045A5D6E(iLocal_360, true, true, 0);
			unk_0x4522AD7364B6AA54(iLocal_360, 10f);
		}
		wait(0);
	}
}
...
void func_462()
{
	iLocal_251 = unk_0x020A28FAE1C09250();
	iLocal_252 = unk_0x13348E86D5B8A052();
	iLocal_253 = unk_0x7EA67BD818402745();
}
...
int func_469(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_471(iParam0, uVar1[iVar3], 1) && func_470(unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_235(vParam1, 0f, 0f, 0f, 0)) || unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(uVar1[iVar3], true), true) < 10f)
					{
						unk_0x7AC8DF0B83EB4C6B(&iParam0);
						return 1;
					}
...
void func_496(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	else if (unk_0x5A5015CF0B2DE07A(vVar0, &vVar0, &fVar1, 1, 1077936128, 0))
	{
		func_497(iParam0, vVar0, fVar1, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
}
...
void func_537()
{
	...
	unk_0x8C4EA5F6857553AE(Local_237.f_1, true);
	unk_0x8C4EA5F6857553AE(joaat("issi2"), true);
	func_538(1);
	iLocal_267 = 0;
	iLocal_274 = 0;
	iLocal_243 = 0;
	func_21(&uLocal_56, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
	sLocal_340 = "DEFAULT";
	func_462();
	iLocal_54 = 0;
	iLocal_55 = 0;
...
{
	unk_0x8C4EA5F6857553AE(joaat("bus"), bParam0);
	unk_0x8C4EA5F6857553AE(joaat("coach"), bParam0);
	unk_0x8C4EA5F6857553AE(joaat("mixer"), bParam0);
	unk_0x8C4EA5F6857553AE(joaat("mixer2"), bParam0);
	...
	unk_0x8C4EA5F6857553AE(joaat("scrap"), bParam0);
	unk_0x8C4EA5F6857553AE(joaat("biff"), bParam0);
	unk_0x8C4EA5F6857553AE(joaat("packer"), bParam0);
	unk_0x8C4EA5F6857553AE(joaat("phantom"), bParam0);
...
void func_550(bool bParam0, bool bParam1)
{
	...
	if (iLocal_244)
	{
		unk_0xCEE359851F3C8198(iLocal_245);
	}
	if (func_26(iLocal_233) && iLocal_234)
	{
		unk_0x6FF8EF6DC21D25B9(iLocal_233);
		iLocal_234 = 0;
	}
	if (bParam0)
	{
	...
	else
	{
		if (!bParam1)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_239))
			{
				if (!unk_0xD62C4419A41F106A(iLocal_239, 0))
				{
					unk_0xED68CDDDE25A144E(iLocal_239);
					unk_0x4A852F02088ECC9D(iLocal_239, false);
	...
	unk_0x78713C03966ED44F(Local_332[0 /*3*/], Local_332[1 /*3*/], Local_332.f_7, 1);
	unk_0xF1CFA0046BB67893(iLocal_333, 0);
	unk_0x29074975F22A27B9(0);
	unk_0x8C4EA5F6857553AE(Local_237.f_1, false);
	unk_0x8C4EA5F6857553AE(joaat("issi2"), false);
	func_538(0);
