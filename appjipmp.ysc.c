		...
		if (!func_291())
		{
			...
			if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) > 0)
			{
				...
				if (iVar5 > 0)
				{
					...
					{
						unk_0xAE44886DE0F3D443(iVar5, &Var8, false, 1);
					}
				}
			}
			func_87();
...
Vector3 func_25(int iParam0)
{
	...
	{
		vVar1 = { func_83(func_84(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_25)) };
		if (vmag(vVar1) > 0f)
		{
			return vVar1;
		}
...
void func_114(int iParam0, int iParam1)
{
	...
	while (iVar0 < 32)
	{
		...
		if ((unk_0xC4DEA49C5B465481(iVar2) && iVar2 != unk_0x95B959F18401C09A()) && Global_2449538.f_3868 < iParam1)
		{
			Var1 = { func_104(iVar2) };
...
{
	if (unk_0x1771F6BAF60B44FA(iParam0, iParam1))
	{
		if (unk_0x4CE1DD5CFC1F941E())
		{
			if (unk_0x86CF3D110E5DD82F() == 0 || (unk_0xE3F7CBC28F745843() && unk_0x5D79F3D06EB318A0(2)))
...
int func_201()
{
	...
	iVar0 = func_200();
	if (unk_0x8AF8FB62F0BE628C(iVar0, false, true, 0, -1, 0) || func_202(1) >= iVar0)
	{
		return 1;
	}
	return 0;
...
int func_207()
{
	...
	{
		iVar2 = unk_0x7C1C88877E8AAA50(iVar0);
		if (unk_0xC4DEA49C5B465481(iVar2) && iVar2 != unk_0x95B959F18401C09A())
		{
			Var1 = { func_104(iVar2) };
...
void func_208()
{
	if (unk_0x786AF4A44E1B5B4B(&vLocal_336))
	{
		return;
	}
...
void func_216()
{
	...
	if ((iLocal_342 == 0 && iLocal_360 > 0) && !bLocal_343)
	{
		if (func_2(2, Global_14522, 0))
		{
			...
			iLocal_359 = unk_0x614EE52A69097A4C();
			while (!unk_0xBFCC17D9792F43AF(iLocal_359))
			{
				wait(0);
			}
			iLocal_353 = unk_0x82D58DA03789627A(iLocal_359);
			iLocal_320 = 3;
			Global_14553.f_1 = 8;
			if (iLocal_354[iLocal_348] == 13 || iLocal_354[iLocal_348] == 12)
			{
...
void func_217()
{
	...
	func_205(Global_14534, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_324, 0, 0, 0, 0);
...
void func_223()
{
	...
	if (iLocal_342 == 0 && iLocal_360 > 0)
	{
		if (func_2(2, Global_14522, 0))
		{
			...
			iLocal_349 = unk_0x82D58DA03789627A(iLocal_359);
...
void func_225()
{
	...
	if (iLocal_342 == 0 && iLocal_360 > 0)
	{
		if (func_2(2, Global_14522, 0))
		{
			...
			iLocal_348 = unk_0x82D58DA03789627A(iLocal_359);
	...
	if (iLocal_342 == 0 && func_175())
	{
		...
		while (iVar0 <= 4)
		{
			if (func_229(iVar0))
			{
				unk_0xBB698266C5FDF0A7(Global_14534, "SET_DATA_SLOT");
				unk_0x4D9DA18AB3C2A466(18);
				unk_0x4D9DA18AB3C2A466(iLocal_361);
				unk_0x4D9DA18AB3C2A466(0);
...
int func_236(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	else
	{
		...
		else
		{
			...
			Var2.f_3.f_1 = 4;
			Var3.f_19.f_1 = 4;
			Var5 = { func_104(unk_0x95B959F18401C09A()) };
			Var1 = iParam0;
			...
			switch (*uParam1)
			{
				case 0:
					...
					{
						func_239(&Var4, &Var1);
						if (*uParam3 && unk_0xA8F2705CC9772956(&Var4))
						{
							if (Var4.f_3 > 0)
							{
								unk_0x753CDA136F226B28(0, &Var3);
								if (unk_0xCE3CFF625BEBAA04(&(Var3.f_13), ""))
								{
									*uParam1 = 1;
									*uParam4 = 0;
								}
	...
	if (iLocal_342 == 0 && func_175())
	{
		...
		while (iVar0 <= 26)
		{
			if (func_152(iVar0))
			{
				unk_0xBB698266C5FDF0A7(Global_14534, "SET_DATA_SLOT");
				unk_0x4D9DA18AB3C2A466(18);
				unk_0x4D9DA18AB3C2A466(iLocal_360);
				if (iVar0 == 24)
				{
...
int func_294(var uParam0, int iParam1)
{
	...
	if (unk_0xB331FCEB94EB05C8())
	{
		if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) > 0)
		{
			if (unk_0x43E505744A9B715D())
			{
				if (!unk_0x8AF8FB62F0BE628C((func_320(iParam1, iVar0, 0, -1) + func_105(20)), false, false, 1, -1, 0))
				{
					return 1;
				}
			}
		...
		if (unk_0x43E505744A9B715D())
		{
			if (!unk_0x8AF8FB62F0BE628C(func_320(iParam1, iVar0, 0, -1), false, false, 1, -1, 0))
			{
				return 3;
			}
		}
...
int func_310(int iParam0, int iParam1, int iParam2)
{
	if (iParam1 != -1)
	{
		if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iParam0, 1), func_311(iParam1), true) <= IntToFloat(iParam2))
		{
			return 1;
		}
	}
