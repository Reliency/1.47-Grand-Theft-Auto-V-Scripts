...
void func_186(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_190(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xE3903F59E2F22150() - iParam0->f_60) > iParam6) && func_190(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_219(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_219(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_226(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_219(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_239(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !unk_0xE9CCF312047EBEE0(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_251(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !unk_0xE9CCF312047EBEE0(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_126(uParam0->f_41[0]))
			{
				iLocal_54 = unk_0x38A6890195DD00D1(unk_0xFBB1F99A825CAB09(uParam0->f_41[0], true), unk_0x60B5C1FD066CB864(uParam0->f_41[0], 2), 2);
				unk_0xCF73ED7F74F29138(uParam0->f_41[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0x6359F1F7F5174D4A(iLocal_54, true);
				if (func_126(uParam0->f_28[0]))
				{
					unk_0x08798CBF817BA887(uParam0->f_28[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_126(uParam0->f_41[1]))
				{
					unk_0xCF73ED7F74F29138(uParam0->f_41[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_126(uParam0->f_41[2]))
				{
					unk_0xCF73ED7F74F29138(uParam0->f_41[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_126(uParam0->f_28[0]) && func_126(unk_0x33CD235DF1E6A94E()))
			{
				...
				iLocal_54 = unk_0x38A6890195DD00D1(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				unk_0x6359F1F7F5174D4A(iLocal_54, true);
				unk_0x08798CBF817BA887(uParam0->f_28[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
		...
		case 3:
			if (func_126(uParam0->f_28[0]))
			{
				if (unk_0xE9CCF312047EBEE0("rcmpaparazzo1beckon"))
				{
					...
					unk_0x108754262311D34F(0, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_254(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				unk_0x5856B9BF2B4E98C4(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, false, 1);
				unk_0x7F327D8D184FAB7F(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				unk_0x5856B9BF2B4E98C4(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, true, 1);
			}
			break;
	}
}
...
void func_268(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			case 46:
				unk_0x71CA80D41E1338B4(iLocal_53);
				func_270(iParam0, 0, 0, 0);
				break;
			
			case 47:
				unk_0xCC323859A8DA2B88("WORLD_HUMAN_PAPARAZZI", 1);
				unk_0xF1CFA0046BB67893(iLocal_56, 0);
				func_270(iParam0, 0, 0, 0);
				break;
			
			case 48:
				unk_0x1BFBC1E2615E22FC(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), true);
				unk_0x1BFBC1E2615E22FC(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), true);
				unk_0x1BFBC1E2615E22FC(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), true);
