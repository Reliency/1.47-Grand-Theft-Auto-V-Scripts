...
void func_190()
{
	...
	{
		case 0:
			if ((unk_0xE3903F59E2F22150() - iLocal_222) > 100 && bLocal_223 == 0)
			{
				iLocal_56 = 1;
			}
			break;
...
int func_200(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_199(unk_0x33CD235DF1E6A94E()) && func_199(iParam0->f_28[0])) && !func_144()) && (unk_0xE3903F59E2F22150() - iParam0->f_60) > iParam6) && func_211(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_202(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_211(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_205(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_211(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_207(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !unk_0x1CE8F0A08E65CA6A(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_215(uParam1) && uParam1->f_4 == 0) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_231(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_231(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_238(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_231(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_199(uParam0->f_28[0]))
			{
				...
				iLocal_54 = unk_0x38A6890195DD00D1(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0x6359F1F7F5174D4A(iLocal_54, true);
				unk_0x08798CBF817BA887(uParam0->f_28[0], iLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_268(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			unk_0x252F9CE6A90B6B86(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				unk_0x71CA80D41E1338B4(iVar0[iVar1]);
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (unk_0xE38E3CF1625A4145(iLocal_224))
	{
		unk_0x1ABDB383C83A336A(&iLocal_224);
	}
