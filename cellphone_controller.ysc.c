...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else if (unk_0xB331FCEB94EB05C8())
		{
			...
			if (iLocal_79 == 2)
			{
				iLocal_80 = unk_0x33FB28D990016403();
				switch (iLocal_80)
				{
					case 3:
						break;
		...
		if (iLocal_77 == 0)
		{
			...
			{
				unk_0x75D54ED6C1AD1642(joaat("sp_cellphone_sleep_time"), &iLocal_76, -1);
		...
		else if (!unk_0x0E4018692D92041D(Global_2423, 25))
		{
			...
			iLocal_77 = 0;
			unk_0x12B6E23F244DDB0F(joaat("sp_cellphone_sleep_time"), (iLocal_76 + (iLocal_75 - iLocal_74)), 1);
		}
		func_68();
		func_67();
		func_66();
...
void func_1()
{
	iLocal_54 = unk_0x7971758CE6D9F156(Global_16905);
	switch (iLocal_54)
	{
		case 0:
			Global_16901 = 4;
...
void func_3()
{
	if (unk_0xB331FCEB94EB05C8())
	{
		iLocal_52 = unk_0x5009A219B22D2352(unk_0x78DCC5D0CB43DEBA(), iLocal_50);
	}
	else
	{
...
void func_4()
{
	iLocal_54 = unk_0x92539C2A7085B235();
	switch (iLocal_54)
	{
		case 0:
			if (unk_0xB331FCEB94EB05C8())
			{
				iLocal_50 = unk_0x78DCC5D0CB43DEBA();
			}
			else
			{
...
void func_7()
{
	iLocal_54 = unk_0x9641B16CD71C5D05(1);
	switch (iLocal_54)
	{
		case 0:
			Global_16901 = 9;
...
void func_8()
{
	iLocal_54 = unk_0x0F50C2E8138C028F(iLocal_55);
	switch (iLocal_54)
	{
		case 0:
...
void func_9()
{
	if (unk_0x6A0D1BF409E67AB1(iLocal_55))
	{
		Global_16901 = 5;
	}
	else
...
void func_10()
{
	iLocal_54 = unk_0x003F7B930C5E2ACC();
	switch (iLocal_54)
	{
		case 0:
			Global_16901 = 4;
...
int func_15()
{
	...
	if ((func_21(2, Global_14520, 0) && !unk_0xB31F7B7798441CF3(19)) && !unk_0xC99322FFEB21BC08())
	{
		...
		if (unk_0xDCC802BBCEA5F607() == Global_16923 && unk_0xDCC802BBCEA5F607() != -1)
		{
			...
			iLocal_60 = 0;
			iLocal_61 = 0;
			while (((func_19(2, Global_14520) && iLocal_60 < 250) && Global_14733 == 0) && !unk_0xB31F7B7798441CF3(19))
			{
				if (Global_3127 > 0)
				{
					func_16();
...
void func_16()
{
	...
	if (Global_16931)
	{
		fLocal_71 = -0.055f;
		fLocal_72 = 0.745f;
		fLocal_67 = unk_0x5972EE9BF3C1BE95();
		...
		if (!func_18())
		{
			...
			unk_0x5A2C46836B4DF5B3(iLocal_37, fLocal_68, fLocal_69, 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
							...
							if (!unk_0xE51F6AFEA84C2923(unk_0x95B959F18401C09A(), 1))
							{
								...
								if (!func_18())
								{
									...
									if (Global_2416063.f_1486)
									{
										...
										{
											unk_0x5A2C46836B4DF5B3(iLocal_37, (fLocal_68 + fLocal_39), (fLocal_69 + fLocal_40), 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
										}
									}
									else
									{
			...
			else if (Global_15866 == 4 || Global_15866 == 3)
			{
				...
				else
				{
					...
					if (Global_106565.f_28044[Global_1738 /*29*/].f_24[Global_14553] == 0)
					{
						...
						func_27(Global_14534, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_1738 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_30(Global_14534, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_27(Global_14534, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), &(Global_106565.f_28044[Global_1738 /*29*/].f_7), &cVar0, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), 0);
					}
				}
				func_30(Global_14534, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_27(Global_14534, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2430[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_45()
{
	...
	if (((((((Global_4268043[Global_4269292 /*104*/].f_32 == 4 || Global_4268043[Global_4269292 /*104*/].f_32 == 5) || Global_4268043[Global_4269292 /*104*/].f_32 == 6) || Global_4268043[Global_4269292 /*104*/].f_32 == 7) || Global_4268043[Global_4269292 /*104*/].f_32 == 8) || Global_4268043[Global_4269292 /*104*/].f_32 == 9) || Global_4268043[Global_4269292 /*104*/].f_32 == 10) || Global_4268043[Global_4269292 /*104*/].f_32 == 11)
	{
		...
		while (iVar1 < Global_4268043[Global_4269292 /*104*/].f_49)
		{
			...
			{
				case 4:
					unk_0xFA6BEE2B1507FF1E(&(Global_2528542.f_1653[iVar1 /*4*/]));
					break;
				
				case 5:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657086[iVar1 /*4*/]));
					break;
				
				case 6:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657127[iVar1 /*4*/]));
					break;
				
				case 7:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657148[iVar1 /*4*/]));
					break;
				
				case 8:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657165[iVar1 /*4*/]));
					break;
				
				case 9:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657178[iVar1 /*4*/]));
					break;
				
				case 10:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657191[iVar1 /*4*/]));
					break;
				
				case 11:
					unk_0xFA6BEE2B1507FF1E(&(Global_1657204[iVar1 /*4*/]));
					break;
			}
			iVar1++;
		}
		StringCopy(&cVar2, unk_0x434854E9CAE13C4A(&(Global_106565.f_28044[Global_4268043[Global_4269292 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 2, &cVar2, 0);
	...
	else
	{
		...
		if (Global_4268043[Global_4269292 /*104*/].f_17 == 145)
		{
			...
			uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 2, &cVar3, 0);
			unk_0x8950ED5730F62EE8(&Global_4269308, 1);
			Global_16924 = 1;
			Global_16923 = uLocal_48;
		}
		...
		{
			StringCopy(&cVar4, unk_0x434854E9CAE13C4A(&(Global_106565.f_28044[Global_4268043[Global_4269292 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_4268043[Global_4269292 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar5, &cVar4, 64);
				uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 2, &cVar5, 0);
			}
			else
			{
				uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 2, &cVar4, 0);
			}
			unk_0x8950ED5730F62EE8(&Global_4269308, 1);
			Global_16924 = 1;
			Global_16923 = uLocal_48;
...
void func_47()
{
	if (unk_0x0E4018692D92041D(Global_2423, 1))
	{
		...
		if (unk_0xB331FCEB94EB05C8())
		{
			iLocal_45[Global_14553] = unk_0x78DCC5D0CB43DEBA();
			iLocal_43[Global_14553] = 1;
		}
		else if (!unk_0x0E4018692D92041D(Global_2423, 10))
		{
			iLocal_44[Global_14553] = unk_0xE3903F59E2F22150();
			iLocal_43[Global_14553] = 1;
		}
		else
		{
			iLocal_44[0] = unk_0xE3903F59E2F22150();
			iLocal_44[2] = unk_0xE3903F59E2F22150();
			iLocal_44[1] = unk_0xE3903F59E2F22150();
			iLocal_43[0] = 1;
			iLocal_43[2] = 1;
			iLocal_43[1] = 1;
		}
...
void func_50()
{
	...
	if (((((((Global_106565.f_14135[Global_16933 /*104*/].f_32 == 4 || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 5) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 6) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 7) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 8) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 9) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 10) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 11)
	{
		...
		StringCopy(&cVar2, unk_0x434854E9CAE13C4A(&(Global_106565.f_28044[Global_106565.f_14135[Global_16933 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 1, &cVar2, 0);
		Global_16924 = 3;
		Global_16923 = uLocal_48;
		Global_16927 = 0;
	}
	else
	{
		...
		if (Global_106565.f_14135[Global_16933 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar3, &Global_3111, 64);
			StringConCat(&cVar3, "</C>", 64);
			uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 1, &cVar3, 0);
			Global_16924 = 3;
			Global_16923 = uLocal_48;
		}
		else
		{
			StringCopy(&cVar4, unk_0x434854E9CAE13C4A(&(Global_106565.f_28044[Global_106565.f_14135[Global_16933 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_106565.f_14135[Global_16933 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar5, &cVar4, 64);
				uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 1, &cVar5, 0);
			}
			else
			{
				uLocal_48 = unk_0xDE1BA36E3BACF7C1(&cVar0, &cVar0, 0, 1, &cVar4, 0);
			}
			Global_16924 = 3;
			Global_16923 = uLocal_48;
			Global_16927 = 0;
...
void func_52()
{
	if (iLocal_43[Global_14553] == 1)
	{
		if (unk_0xB331FCEB94EB05C8())
		{
			iLocal_47 = unk_0x5009A219B22D2352(unk_0x78DCC5D0CB43DEBA(), iLocal_45[Global_14553]);
		}
		else
		{
			iLocal_46[Global_14553] = unk_0xE3903F59E2F22150();
		...
		if (!func_44())
		{
			...
			if (iLocal_64 == 0)
			{
				if (Global_3099[Global_14553])
				{
					...
					if (unk_0xB331FCEB94EB05C8())
					{
						iLocal_62 = unk_0x78DCC5D0CB43DEBA();
					}
					else
					{
			...
			else
			{
				if (unk_0xB331FCEB94EB05C8())
				{
					iLocal_63 = unk_0x5009A219B22D2352(unk_0x78DCC5D0CB43DEBA(), iLocal_62);
				}
				else
				{
...
void func_64()
{
	if (unk_0x0E4018692D92041D(Global_2423, 6))
	{
		if (Global_3127 > 0)
		{
			if (unk_0x0E4018692D92041D(Global_2424, 11))
			{
				if (iLocal_41)
				{
					...
					if (unk_0x0E4018692D92041D(Global_2423, 25))
					{
						unk_0xBB698266C5FDF0A7(iLocal_37, "CREATE_ALERT");
		...
		if (Global_3127 < 1)
		{
			unk_0x83A1D480DB0B52CC(&iLocal_37);
	...
	{
		iLocal_37 = unk_0x199B24FF79A52CCF("cellphone_alert_popup");
		while (!unk_0x11AE7F6A404414C9(iLocal_37))
		{
			wait(0);
		}
		unk_0x5C58D0ADA22491FA(4);
...
int func_78(int iParam0, bool bParam1, int iParam2)
{
	...
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 439.4357f, -997.4747f, 28.9584f, 428.3288f, -997.0398f, 24.8372f, 8f, 0, true, 0))
	{
		return 9;
	}
...
int func_82(int iParam0)
{
	...
	if (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), 207.4336f, -1019.795f, -100.4728f, 189.9338f, -1019.623f, -95.56883f, 17.1875f, 0, true, 0) && unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 1))
	{
		return 5;
	}
	vVar0 = { func_91(unk_0x95B959F18401C09A()) };
