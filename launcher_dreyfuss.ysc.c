...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xE3903F59E2F22150() - iParam0->f_60) > iParam6) && func_169(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_189(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_169(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_192(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_169(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_194(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !unk_0x1CE8F0A08E65CA6A(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
		...
		case 2:
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_35[0]))
			{
				...
				if (func_126(uParam0->f_35[0]))
				{
					...
					unk_0x8C4EA5F6857553AE(iLocal_53, true);
				}
			}
			if (bVar2)
			{
...
void func_267(int iParam0, bool bParam1)
{
	...
	func_268(sVar0);
	unk_0x8C4EA5F6857553AE(iLocal_53, false);
