...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (unk_0xD62C4419A41F106A(iLocal_91, 0) && !iLocal_95 == 7)
			{
		...
		switch (iLocal_95)
		{
			case 0:
				if ((unk_0xA80721FDC3BDCCDB() && !func_33()) && !func_12())
				{
					if (func_11())
					{
						iLocal_91 = unk_0x9BA5CF280376EEA4(26, iLocal_88, vLocal_89, fLocal_90, 1, true);
						unk_0x4A852F02088ECC9D(iLocal_91, true);
						iLocal_92 = unk_0x7CA67831169E8AA6(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, true, true, false);
						unk_0x3C990C409B3845DE(iLocal_92, (233.8288f + 180f));
						unk_0x73D993BCA1CEC58D(iLocal_91, 0, 0, 0, false);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_97 = unk_0x38A6890195DD00D1(vLocal_89 + Vector(1f, 0f, 0f), 0f, 0f, fLocal_90, 2);
				unk_0x08798CBF817BA887(iLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0x65E4765895B11589("MNT_DNC", iLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (unk_0x0F1ADC233BE18A66(iLocal_97, "MNT_DNC") == 1)
				{
					unk_0xCD2F9B1910503400(iLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				vVar0 = { unk_0xFBB1F99A825CAB09(iLocal_91, true) };
				unk_0x0F74B05FB8108F9C(iLocal_91, 3f);
				if (func_10(unk_0x33CD235DF1E6A94E(), iLocal_91) < 10f)
				{
					unk_0xC87D718F567156BE(unk_0x33CD235DF1E6A94E(), 1, iLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0xC87D718F567156BE(iLocal_91, 1, unk_0x33CD235DF1E6A94E(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(iLocal_91, unk_0x33CD235DF1E6A94E(), 1) < 25f)
				{
					if (!unk_0xE38E3CF1625A4145(iLocal_96))
					{
						func_5(&iLocal_96, &iLocal_91, 0);
						unk_0xB9E84A421C105943(iLocal_96, 3);
					}
				}
				else if (unk_0xE38E3CF1625A4145(iLocal_96))
				{
					func_4(&iLocal_96);
				}
				if (unk_0x4EDDCE9AAE0FC976(iLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (unk_0x3AF2B3B68DD52355(iLocal_91))
				{
					unk_0xBAAE4EDEBAEC4378(iLocal_97);
					iLocal_95 = 4;
				}
				if (((((unk_0xBC2FC12AD0FBF72E(iLocal_91) || unk_0x416C37C19CCE0077(vVar0, 50f, 1)) || unk_0x416C37C19CCE0077(vVar0, 50f, 0)) || unk_0x34DB0AC28A1FDE20(vVar0, 20f, 20f, 20f, 0)) || unk_0xCA12322D8FBBDBEE(-1, vVar0, 50f)) || (((unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_91) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_91)) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vVar0, true) < 25f) && func_1(iLocal_91, unk_0x33CD235DF1E6A94E(), 1126825984, 0)))
				{
					unk_0xBAAE4EDEBAEC4378(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!unk_0x3AF2B3B68DD52355(iLocal_91))
				{
					if (iLocal_93 == 1)
					{
						unk_0x7E268975AF5EA74F(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x7E268975AF5EA74F(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0x897EF720254BBEA3(iLocal_91, true);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (unk_0xD76D6BCC14B95CE1(iLocal_91, 713668775) != 1 && unk_0xD76D6BCC14B95CE1(iLocal_91, 713668775) != 0)
				{
					unk_0x4A852F02088ECC9D(iLocal_91, false);
					if (iLocal_93 == 1)
					{
						unk_0xECCD4FDA45197F97(iLocal_91, unk_0x33CD235DF1E6A94E(), 100f, -1, 0, 0);
					}
					else
					{
						unk_0xBD4591245C650283(iLocal_91, 1193033728, 0);
					}
					unk_0x897EF720254BBEA3(iLocal_91, true);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((unk_0xC30D5C4DCAC8020A(iLocal_91) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(iLocal_91, true), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), true) > 50f) && !unk_0xA80721FDC3BDCCDB())
				{
					func_36(1);
				}
				break;
...
int func_1(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_3(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_3(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_7(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_8(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_8(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(iVar0, bParam1);
	}
...
int func_11()
{
	...
	unk_0x0483D0035D6E46FD(sLocal_94);
	if (unk_0x5D98D654CDC2165A(iLocal_88) && unk_0xE9CCF312047EBEE0(sLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (vmag2(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_26())
		{
			return 0;
		}
	}
...
void func_36(bool bParam0)
{
	...
	{
		unk_0xEC26F4BFC9942A0C(&iLocal_92);
	}
	if (unk_0xE38E3CF1625A4145(iLocal_96))
	{
		func_4(&iLocal_96);
	...
	if (unk_0x765F6FEEFF39224F(iLocal_91))
	{
		if (bParam0)
		{
			unk_0x4B8B69DAE5BAC592(&iLocal_91);
		}
		else
		{
			unk_0x1F45B4626AC4A4C0(&iLocal_91);
		}
	}
