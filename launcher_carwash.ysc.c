...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_62(unk_0x33CD235DF1E6A94E(), vVar2, 0) > (100f + 20f))
		{
			func_70();
		}
		bVar0 = false;
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
		{
			...
			bLocal_58 = unk_0xF5029120950E3101(iVar1);
			func_57(bLocal_58);
		}
		iVar3 = 0;
...
void func_56(int iParam0)
{
	...
	{
		if (unk_0xE3903F59E2F22150() > uLocal_60[iParam0])
		{
			iLocal_61[iParam0] = unk_0xBD1087ABD1970B9C(vLocal_59[iParam0 /*3*/], vLocal_59[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), 4);
		}
	}
	else
	{
		iVar0 = unk_0x819B6E76423AE494(iLocal_61[iParam0], &iVar4, &uVar2, &uVar3, &iVar1);
		if (iVar0 == 2)
		{
			Local_40[iParam0 /*24*/].f_8 = 0;
			if (iVar4 > 0)
		...
		uLocal_60[iParam0] = unk_0xE3903F59E2F22150() + 250;
	}
}
