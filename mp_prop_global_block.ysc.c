...
void func_26(struct<4> Param0, var uParam1, var uParam2, struct<6> Param3, struct<4> Param4, var uParam5, var uParam6, var uParam7)
{
	...
	*uParam7 = { unk_0xCD1EDCB38767B47C(Param4, 0f, vVar0) };
...
int func_34(int iParam0)
{
	...
	if (unk_0xB331FCEB94EB05C8() && func_43())
	{
		...
		iVar3 = unk_0x36163153849DFDA1(&sVar2);
		if (unk_0x5333990AE9AEBC1F(iVar3))
		{
			iVar4 = unk_0x5B9C00971544AAA9(iVar3, 426439576, 1);
