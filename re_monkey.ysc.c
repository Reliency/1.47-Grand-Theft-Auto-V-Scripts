...
void func_45()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_58[iVar1] = unk_0x7CA67831169E8AA6(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, true, true, false);
				unk_0xC7C47D4054903839(iLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0x1C8705F667F673EA(iLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				iLocal_58[iVar1] = unk_0x7CA67831169E8AA6(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, true, true, false);
				unk_0xC7C47D4054903839(iLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0x1C8705F667F673EA(iLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				iLocal_58[iVar1] = unk_0x7CA67831169E8AA6(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, true, true, false);
				unk_0xC7C47D4054903839(iLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0x1C8705F667F673EA(iLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_49()
{
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0xDFB97818AD6C09CC(iLocal_48, 1))
			{
				func_144();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (unk_0x7393AF2DD0E51DD8(30f, 31086, 0.8f, 0.7f, 0.25f, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0xE3903F59E2F22150() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0xE3903F59E2F22150())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_51()
{
	...
	{
		unk_0xB815670C37E03CDE(1813637474);
		if (unk_0x5D98D654CDC2165A(1813637474))
		{
			iLocal_48 = unk_0x9BA5CF280376EEA4(26, 1813637474, vLocal_49, fLocal_50, 1, true);
			unk_0x71CA80D41E1338B4(1813637474);
			iLocal_58[0] = unk_0x7CA67831169E8AA6(joaat("prop_cs_spray_can"), vLocal_59, true, true, false);
			unk_0x2F0A6390D863D337(iLocal_58[0], iLocal_48, unk_0xFCAF61876D23D31D(iLocal_48, 28422), 0f, -0.01f, -0.02f, vLocal_66, 1, 1, 0, 0, 2, 1);
			unk_0x897EF720254BBEA3(iLocal_48, true);
			unk_0x5FEE418CE11E6DDE(iLocal_48, 42, true);
			iLocal_53 = func_62(iLocal_48, 0, 145);
			func_52(1);
			unk_0x0648A75D3F60E864(iLocal_48, 1862763509);
			unk_0x0F74B05FB8108F9C(iLocal_48, 2.5f);
		}
	}
	return 0;
}
...
int func_63(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_64(unk_0xB331FCEB94EB05C8(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_64(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(iVar0, bParam1);
	}
...
{
	func_66();
	if (!unk_0xA80721FDC3BDCCDB() && iLocal_51 < 3)
	{
		func_144();
	}
}
...
void func_66()
{
	...
	if (func_44(iLocal_48))
	{
		...
		vVar2 = { unk_0xFBB1F99A825CAB09(iLocal_48, false) };
		fVar4 = 7.5f;
		vVar5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			vVar3 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false) };
			bVar6 = unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0);
			bVar7 = unk_0xBEAC9DF5323BB074(unk_0x33CD235DF1E6A94E());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0x416C37C19CCE0077(vVar2, fVar4, 0) || unk_0x34DB0AC28A1FDE20(vVar2 - vVar5, vVar2 + vVar5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x0483D0035D6E46FD(sLocal_62);
				if (unk_0xE9CCF312047EBEE0(sLocal_62))
				{
					unk_0x4A852F02088ECC9D(iLocal_48, true);
					unk_0x108754262311D34F(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_76(unk_0x33CD235DF1E6A94E(), iLocal_48, 35f))
				{
					unk_0x99414FB2D30425C1(&iLocal_68);
					unk_0x108754262311D34F(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x108754262311D34F(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0xC734F59A13D39AEF(iLocal_68);
					unk_0x13A2D602CD10CBAC(iLocal_48, iLocal_68);
					unk_0xA7A57E7757ED035E(&iLocal_68);
					unk_0xFF2DEA68E2D3602E(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(unk_0x33CD235DF1E6A94E(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0x33F6BE48E356DA27(iLocal_48, 8, true);
				unk_0x33F6BE48E356DA27(iLocal_48, 32, true);
				unk_0x99414FB2D30425C1(&iLocal_68);
			...
			case 5:
				...
				if (!unk_0x3F219400E5FE4B69(iLocal_48) && vdist2(vVar2, unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false)) > 2500f)
				{
					iLocal_67 = unk_0x36FB861F8CCF0EA4(vVar3, vVar2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0x819B6E76423AE494(iLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0x765F6FEEFF39224F(iLocal_48))
	{
		unk_0xF70578F5CD9822CB(iLocal_48, false);
	}
}
...
int func_67()
{
	...
	{
		case 0:
			if (unk_0x1CE8F0A08E65CA6A(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				vLocal_57 = { vVar0 };
			...
			else if (unk_0x1CE8F0A08E65CA6A(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0x204DEACC5BECF723(iLocal_48, sLocal_62, sLocal_64);
				fLocal_54 = func_71(fLocal_54, 0.2f, 0.349f);
				if (fLocal_54 != 0.2f)
				{
					fVar2 = ((1f / (0.349f - 0.161f)) * to_float(900));
					iLocal_55 = round(((fLocal_54 - 0.161f) * fVar2));
					vLocal_57 = { unk_0xFBB1F99A825CAB09(iLocal_48, false) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			unk_0xF70578F5CD9822CB(iLocal_48, true);
			unk_0x108754262311D34F(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0xE3903F59E2F22150();
			func_70(&iLocal_53);
			func_69();
			if (unk_0x765F6FEEFF39224F(iLocal_58[0]))
			{
				unk_0x35F11A916FDFCF32(iLocal_58[0], 1, true);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0x1CE8F0A08E65CA6A(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0xE3903F59E2F22150() - iLocal_69);
				fVar4 = (to_float(iVar3) / to_float(iLocal_55));
				fVar5 = (fLocal_54 - ((fLocal_54 - 0.161f) * fVar4));
				fVar5 = func_71(fVar5, 0.161f, fLocal_54);
				unk_0x8E2EBAE8CA6648A5(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_71(fVar6, 0f, 0.8f);
				vVar7 = { func_68(vLocal_57, vVar1, fVar6) };
				unk_0xBEADAF07D2339505(iLocal_48, vVar7, 0, true, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0xF70578F5CD9822CB(iLocal_48, false);
					return 1;
...
void func_69()
{
	if (iLocal_60 != 0)
	{
		unk_0x91F3E4311D34B364(iLocal_60, 0);
		iLocal_60 = 0;
	}
}
...
void func_72()
{
	...
	if (unk_0x1CE8F0A08E65CA6A(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0x204DEACC5BECF723(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_69();
		}
	...
	else if (unk_0x1CE8F0A08E65CA6A(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0x204DEACC5BECF723(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_69();
		}
...
void func_73()
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0x36F0667378D07B9C(sLocal_61, iLocal_58[0], vLocal_66, vLocal_66, 1f, 0, 0, 0);
		unk_0xEA3ABFEE23D6171C(iLocal_60, 1f, 1f, 1f, 0);
		unk_0x6082CF5A3BB6D714(iLocal_60, 0.2f);
	}
}
...
bool func_75()
{
	return (unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, true, 0) && !unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, true, 0));
}
...
int func_76(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0x765F6FEEFF39224F(iParam0) && unk_0x765F6FEEFF39224F(iParam1))
	{
		...
		return vdist2(unk_0xFBB1F99A825CAB09(iParam0, false), unk_0xFBB1F99A825CAB09(iParam1, false)) <= fVar0;
	}
	return 0;
}
...
int func_77(int iParam0)
{
	...
	{
		func_70(&iLocal_53);
		unk_0xECCD4FDA45197F97(iLocal_48, unk_0x33CD235DF1E6A94E(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
