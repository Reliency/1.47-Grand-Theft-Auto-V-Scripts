...
{
	iParam0->f_1 = (func_65(unk_0x0E4018692D92041D(*iParam0, 4)) - fParam1);
...
void func_87(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	while (iVar4 < 47)
	{
		if (unk_0x786AF4A44E1B5B4B(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4 = (iVar4 + 1);
	...
	while (iVar4 < 27)
	{
		if (unk_0x786AF4A44E1B5B4B(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0x786AF4A44E1B5B4B(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
struct<4> func_103(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_108(&(Global_106565.f_19955), 8) && iParam1) && iParam0 != 4) && func_106(3) > 0) && unk_0x9562E33C057F7589(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
...
int func_114(char* sParam0)
{
	...
	if (unk_0xCE3CFF625BEBAA04(sParam0, "DRF_SOL1"))
	{
		iVar0 = 1;
	}
	else if (unk_0xCE3CFF625BEBAA04(sParam0, "DRF_EXILE"))
	{
		iVar0 = 2;
	}
	else if (unk_0xCE3CFF625BEBAA04(sParam0, "DRF_SOL2"))
	{
		iVar0 = 1;
	}
	else if (unk_0xCE3CFF625BEBAA04(sParam0, "DRF_MIC2"))
	{
		iVar0 = 1;
	}
	return iVar0;
