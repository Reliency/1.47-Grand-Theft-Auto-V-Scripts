...
int func_2()
{
	...
	if (vdist(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), vLocal_72) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0xD76D6BCC14B95CE1(iParam0, -1146898486) != 1)
				{
					...
					unk_0x897EF720254BBEA3(iLocal_68[iParam1], true);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x786AF4A44E1B5B4B(&(Local_71[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (vdist2(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0x786AF4A44E1B5B4B(&(Local_71[iVar0 /*4*/])))
			{
				unk_0x8F59DE352CFE248B(&(Local_71[iVar0 /*4*/]));
				if (!unk_0x07AB0925A06BD5AD(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x9BA5CF280376EEA4(4, iLocal_69[iVar0], vLocal_72 + vLocal_74[iVar0 /*3*/], 0f, 1, true);
			unk_0x3C990C409B3845DE(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0xC2A270E9C5578803(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			vLocal_74[3 /*3*/] = { Vector(45.5004f, unk_0x9562E33C057F7589(-205.8167f, -210.4254f), unk_0x9562E33C057F7589(-1416.54f, -1428.501f)) - vLocal_72 };
