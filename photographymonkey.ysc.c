		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					bLocal_59 = unk_0x0E4018692D92041D(Global_2424, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
							...
							if (((((fVar7 >= 0.35f && func_97(vVar1, 0f, 1f)) && func_97(vVar2, 0f, 1f)) && func_97(vVar3, 0f, 1f)) && func_97(vVar4, 0f, 1f)) || ((((fVar7 < 0.35f && func_97(vVar1, 0.05f, 0.95f)) && func_97(vVar2, 0.05f, 0.95f)) && func_97(vVar3, 0.05f, 0.95f)) && func_97(vVar4, 0.05f, 0.95f)))
							{
								if (fVar5 >= 0.08f && fVar6 >= 0.101f)
								{
									...
									{
										bVar8 = ((((unk_0x43C3AA6EE008FA3B(iLocal_49) && unk_0x43C3AA6EE008FA3B(iLocal_50)) && unk_0x43C3AA6EE008FA3B(iLocal_51)) && unk_0x43C3AA6EE008FA3B(iLocal_52)) && unk_0x43C3AA6EE008FA3B(iLocal_53));
										iVar9++;
										wait(0);
									}
									if (bVar8)
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_13(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_13(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_24(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_24(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
bool func_93(int iParam0)
{
	...
	return unk_0x0E4018692D92041D(Global_106565.f_10043.f_135[iVar0], iVar1);
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		unk_0x8950ED5730F62EE8(&(Global_106565.f_10043.f_135[iVar0]), iVar1);
	}
	else
	{
...
int func_97(vector3 vParam0, float fParam1, float fParam2)
{
	...
	if (unk_0x2663979B26E8B87E(vParam0, &fVar0, &fVar1))
	{
...
void func_98(vector3 vParam0, vector3 vParam1, vector3 vParam2, float fParam3, float fParam4)
{
	...
	unk_0x2663979B26E8B87E(vParam0, &vVar0, &(vVar0.f_1));
	unk_0x2663979B26E8B87E(vParam1, &vVar1, &(vVar1.f_1));
	unk_0x2663979B26E8B87E(vParam2, &vVar2, &(vVar2.f_1));
...
void func_106()
{
	if (bLocal_58)
	{
		if (unk_0x11AE7F6A404414C9(iLocal_57))
		{
			unk_0x5A2C46836B4DF5B3(iLocal_57, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
		switch (iLocal_56)
		{
			case 0:
				iLocal_60 = unk_0xE3903F59E2F22150() + 2000;
				iLocal_56++;
				break;
			...
			case 1:
				if (iLocal_60 < unk_0xE3903F59E2F22150())
				{
					if (!func_112())
					{
						iLocal_57 = unk_0x199B24FF79A52CCF("MIDSIZED_MESSAGE");
						iLocal_60 = unk_0xE3903F59E2F22150() + 5000;
						iLocal_56++;
					}
				}
				break;
			...
			case 2:
				if (unk_0x11AE7F6A404414C9(iLocal_57) || iLocal_60 < unk_0xE3903F59E2F22150())
				{
					if (iLocal_60 < unk_0xE3903F59E2F22150())
					{
						bLocal_58 = false;
			...
			case 3:
				unk_0xBB698266C5FDF0A7(iLocal_57, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_111("PM_TITLE");
				...
				iLocal_60 = unk_0xE3903F59E2F22150() + 7500;
				unk_0x0F8EAEEC97DDBCB3(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", true);
				iLocal_56++;
				break;
			
			case 4:
				if ((((((iLocal_60 < unk_0xE3903F59E2F22150() || unk_0xBB5E373390A5F824()) || !unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A())) || func_112()) || !unk_0x5A8ABDA4992DA968(unk_0x95B959F18401C09A())) || func_110()) || func_109())
				{
					unk_0xBB698266C5FDF0A7(iLocal_57, "SHARD_ANIM_OUT");
					unk_0x4D9DA18AB3C2A466(1);
					unk_0x8DAB5B12D7B9AD29(0.33f);
					unk_0x818901B332D5541D();
					iLocal_60 = unk_0xE3903F59E2F22150() + 500;
					iLocal_56++;
				}
				break;
			...
			case 6:
				unk_0x83A1D480DB0B52CC(&iLocal_57);
				if (func_105())
				{
