...
void __EntryFunction__()
{
	...
	if (func_470(Local_53.f_35[0]))
	{
		...
		unk_0x09993E7216CF52C4(vLocal_54.x, true);
		unk_0xD303E20CB0AE4AD0(vLocal_54.x, 1);
	}
	if (func_468(unk_0x33CD235DF1E6A94E()))
	{
		iLocal_624 = unk_0xC408CC95C7202D67(unk_0x33CD235DF1E6A94E());
	}
	if (func_467(Local_53.f_28[0]))
	{
		Local_62 = Local_53.f_28[0];
		unk_0x4A852F02088ECC9D(Local_62, 1);
		unk_0x0648A75D3F60E864(Local_62, iLocal_624);
		unk_0x5FEE418CE11E6DDE(Local_62, 132, true);
	}
	func_464();
	...
	while (true)
	{
		...
		if (unk_0xB98788B42580C4A8("SANDY_PLANES"))
		{
			...
			{
				unk_0x8411BDAD24F96365("SANDY_PLANES", false);
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (bLocal_92)
			{
				...
				func_15(&uLocal_459, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
			}
			switch (iLocal_128)
			{
				case 4:
...
void func_3(bool bParam0)
{
	if (bParam0)
	{
		...
		func_6(&vLocal_54);
		unk_0xFF2DEA68E2D3602E(Local_61.f_6);
		func_6(&Local_59);
		if (func_467(Local_62))
		{
			if (unk_0xE214B9FCEDF6364A(Local_62))
			{
				unk_0x5D94F4D6FE7DA516(Local_62);
			}
		}
	...
	else
	{
		...
		if (unk_0x765F6FEEFF39224F(vLocal_54.x))
		{
...
void func_23()
{
	switch (iLocal_70)
	{
		case 0:
			...
			{
				unk_0xD303E20CB0AE4AD0(Local_59, 1);
			}
			if (iLocal_127 != -1)
			{
				unk_0xF4BF002874250DB7(iLocal_127);
				func_510("Navmesh blocking object removed");
			}
			iLocal_117 = (unk_0xE3903F59E2F22150() - 6000);
		...
		case 1:
			...
			else
			{
				...
				if (func_233())
				{
					if (func_232(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1) > 300f && !unk_0x3F219400E5FE4B69(vLocal_54.x))
					{
						unk_0x99414FB2D30425C1(&uLocal_125);
						unk_0x4EA529533F2C0E2A(0, vLocal_54.x, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
						unk_0x4EA529533F2C0E2A(0, vLocal_54.x, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
						unk_0x656E3BB78935070E(uLocal_125, 1);
						unk_0xC734F59A13D39AEF(uLocal_125);
						unk_0x13A2D602CD10CBAC(Local_61, uLocal_125);
						unk_0xA7A57E7757ED035E(&uLocal_125);
						iLocal_70 = 2;
					}
					if (((((!func_22() && !unk_0xD82CBCB7E04DDA8A(Local_61)) && !unk_0x3AF2B3B68DD52355(Local_61)) && !unk_0x96154DF4E29A9998(Local_61)) && !unk_0xBC2FC12AD0FBF72E(Local_61)) && !unk_0xF0D230FB550CD6EB(Local_61, 0))
					{
						if (func_232(Local_61, unk_0x33CD235DF1E6A94E(), 1) <= 2.3f)
						{
							if ((unk_0xE3903F59E2F22150() - iLocal_117) > 8000)
							{
					...
					{
						case 0:
							if (unk_0xEE984ED4E4A374BE(Local_61, vLocal_54.x))
							{
								iLocal_111++;
							}
							break;
						...
						case 1:
							if (!unk_0x4278060E716E1226(vLocal_54.x))
							{
								if (unk_0x371855A6F27F144B(501, "Eps6_Takeoff"))
								{
									unk_0xCCFFBA26C1726838(vLocal_54.x, 501, "Eps6_Takeoff", 1);
									unk_0x2B2AFC30DE3FE922(vLocal_54.x, 1);
							...
							else
							{
								...
								unk_0xE60DB7AA1856455D(vLocal_54.x);
								unk_0x6E15F06772C40AC4(vLocal_54.x, 1f);
								iLocal_111++;
								iLocal_112 = unk_0xE3903F59E2F22150();
							}
							break;
						...
						case 2:
							if (unk_0x4278060E716E1226(vLocal_54.x))
							{
								...
								if (iLocal_113 == 0)
								{
									if ((unk_0xE3903F59E2F22150() - iLocal_112) > 23000)
									{
										func_510(" Retracting Jimmy's landing gear");
										unk_0x6B091F0028E6FE5F(vLocal_54.x, 1);
										iLocal_113 = 1;
									}
								}
							}
							else
							{
								...
								{
									unk_0x9FABD0AB045A5D6E(vLocal_54.x, true, 1, 0);
								}
								unk_0xA7A57E7757ED035E(&uLocal_125);
								iLocal_111++;
							}
				...
				else
				{
					...
					iLocal_70 = 0;
					iLocal_69 = 6;
					if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 0))
					{
						bLocal_101 = true;
					}
					unk_0x65BA35D6D61F1574("EPS_FAIL");
		...
		case 2:
			...
			if (!bLocal_80)
			{
				if (func_233())
				{
					if (unk_0x6379DAF3AD61121F(vLocal_54.x) != 4 || unk_0x6379DAF3AD61121F(vLocal_54.x) != 1)
					{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x51C67A1CC9BD53D6(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 1) || unk_0xEA26831785699C09(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xEA26831785699C09(iParam3, -1757550583, 0) || unk_0xEA26831785699C09(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xC4ED190294E9E658(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_108(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xEA26831785699C09(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_108(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xEA26831785699C09(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x51C67A1CC9BD53D6(iVar1, 7, -1, 0, -1, func_97(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_233()
{
	if (func_470(vLocal_54.x))
	{
		if (unk_0x6379DAF3AD61121F(vLocal_54.x) == 5)
		{
			func_510("Detected plane landing gear is broken");
			return 0;
		}
		else if (unk_0x948A37B10533FA15(vLocal_54.x))
		{
			func_510("Detected plane is stuck on roof");
			return 0;
		}
		else if (unk_0x787CBB9DB6BA1A49(vLocal_54.x) <= 0f)
		{
			func_510("Detected plane engine health is <= 0");
			return 0;
		}
		else if (unk_0x67001C5CC88C66A8(vLocal_54.x, 3, 30000))
		{
...
void func_234()
{
	...
	{
		if (func_238(Local_61, 0, 1116471296, 1126825984, 1, 0, 0, 0) || unk_0x416C37C19CCE0077(unk_0xFBB1F99A825CAB09(Local_61, true), 3f, 1))
		{
		...
		else if ((func_235(unk_0x33CD235DF1E6A94E(), Local_61, 1) || unk_0x416C37C19CCE0077(unk_0xFBB1F99A825CAB09(Local_61, true), 3f, 0)) || unk_0x2E9A4AE2A5B4D8E8(Local_61))
		{
			if (iLocal_69 != 5 && iLocal_69 != 3)
			{
				bLocal_101 = true;
		...
		else if (unk_0x91BBD269506D61D2(Local_61, unk_0x33CD235DF1E6A94E(), 1))
		{
			if (unk_0x792D8D44CDA437C2(Local_61, 0, 2))
			{
				if (iLocal_69 != 5 && iLocal_69 != 3)
				{
					bLocal_101 = true;
...
void func_236()
{
	if (func_467(Local_61))
	{
		unk_0xED68CDDDE25A144E(Local_61);
		unk_0x897EF720254BBEA3(Local_61, true);
		unk_0xECCD4FDA45197F97(Local_61, unk_0x33CD235DF1E6A94E(), 100f, -1, 0, 0);
	}
}
...
int func_245(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_247(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_247(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_255(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_247(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_260()
{
	if (func_233())
	{
		if (unk_0x30267FEB358AA2E4(unk_0xFBB1F99A825CAB09(vLocal_54.x, false), joaat("weapon_stickybomb"), 10f, 0))
		{
...
void func_263()
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			while ((!unk_0x5D98D654CDC2165A(iLocal_626) || !unk_0x5D98D654CDC2165A(iLocal_625)) || !unk_0xE9CCF312047EBEE0("rcm_epsilonism4"))
			{
		...
		case 1:
			unk_0xB815670C37E03CDE(iLocal_625);
			unk_0xB815670C37E03CDE(iLocal_626);
			while (!unk_0x5D98D654CDC2165A(iLocal_625) || !unk_0x5D98D654CDC2165A(iLocal_626))
			{
			...
			func_285();
			func_274();
			unk_0xCBE6AF58552C63B2(iLocal_105);
			unk_0xCBE6AF58552C63B2(iLocal_104);
		...
		case 2:
			unk_0xB815670C37E03CDE(iLocal_625);
			while (!unk_0x5D98D654CDC2165A(iLocal_625))
			{
			...
			if (func_233())
			{
				if (!func_262())
				{
					func_267(unk_0xFBB1F99A825CAB09(vLocal_54.x, true), 200f, 12, 5000, 0, 0);
				}
				if (func_233())
				{
					unk_0xF70578F5CD9822CB(vLocal_54.x, false);
					if (unk_0x371855A6F27F144B(500, "Eps6_LandingSkip"))
					{
						if (!unk_0x4278060E716E1226(vLocal_54.x))
						{
							if (!func_262())
							{
								...
								unk_0xCCFFBA26C1726838(vLocal_54.x, 500, "Eps6_LandingSkip", 1);
							}
						}
					}
				}
		...
		case 3:
			unk_0x0483D0035D6E46FD(Local_61.f_6);
			unk_0xB815670C37E03CDE(iLocal_625);
			unk_0xB815670C37E03CDE(Local_59.f_1);
			func_266(55);
			while (((!unk_0x5D98D654CDC2165A(iLocal_625) || !unk_0x5D98D654CDC2165A(Local_59.f_1)) || !unk_0xE9CCF312047EBEE0(Local_61.f_6)) || !func_265(55))
			{
		...
		case 4:
			...
			unk_0xB815670C37E03CDE(Local_59.f_1);
			unk_0xB815670C37E03CDE(vLocal_54.y);
			unk_0x0483D0035D6E46FD(Local_61.f_6);
			unk_0xD51062C52BCD2AE8(501, "Eps6_Takeoff");
			func_266(55);
			if (!func_262())
			{
				while (((((!unk_0x5D98D654CDC2165A(Local_59.f_1) || !unk_0xC7D0A132A56D5FCB()) || !unk_0x5D98D654CDC2165A(vLocal_54.y)) || !unk_0xE9CCF312047EBEE0(Local_61.f_6)) || !unk_0x371855A6F27F144B(501, "Eps6_Takeoff")) || !func_265(55))
				{
			...
			{
				while ((((!unk_0x5D98D654CDC2165A(Local_59.f_1) || !unk_0x5D98D654CDC2165A(vLocal_54.y)) || !unk_0xE9CCF312047EBEE0(Local_61.f_6)) || !unk_0x371855A6F27F144B(501, "Eps6_Takeoff")) || !func_265(55))
				{
					func_510("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					wait(0);
				}
			...
			if (iLocal_127 == -1)
			{
				iLocal_127 = unk_0x6E6EB18FDAB9A074(1687.954f, 3277.727f, 40.25f, 6f, 6f, 6f, 0f, 0, 7);
...
void func_264()
{
	switch (iLocal_69)
	{
		...
		case 5:
			if (!func_470(Local_59))
			{
				Local_59 = unk_0xC651C43AB13A15E5(Local_59.f_1, Local_59.f_3, Local_59.f_6, 1, 1, 0);
				unk_0x1B2303F9DC2D90D5(Local_59, 1084227584);
				unk_0x9BA79B5A36A430E8(Local_59, 1);
				unk_0x62B7B895D641DC81(Local_59, 13f);
				unk_0x65EA11CF317FE4FA(Local_59, 157, 157);
				unk_0x4A7AB87632044178(Local_59, 157, 5);
			}
			break;
		...
		default:
			if (!func_470(Local_59))
			{
				...
				unk_0x1B2303F9DC2D90D5(Local_59, 1084227584);
				unk_0x9BA79B5A36A430E8(Local_59, 1);
				unk_0xD303E20CB0AE4AD0(Local_59, 3);
				unk_0x62B7B895D641DC81(Local_59, 13f);
				unk_0x65EA11CF317FE4FA(Local_59, 157, 157);
				unk_0x4A7AB87632044178(Local_59, 157, 5);
			}
	...
	unk_0x8C4EA5F6857553AE(Local_59.f_1, 1);
	unk_0x71CA80D41E1338B4(Local_59.f_1);
}
...
void func_274()
{
	switch (iLocal_69)
	{
		case 0:
			if (func_467(Local_62))
			{
				unk_0x3C990C409B3845DE(Local_62, 254.1723f);
				unk_0xBEADAF07D2339505(Local_62, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
				unk_0xED68CDDDE25A144E(Local_62);
				func_275();
			}
			else
			{
				func_4(&Local_62);
				Local_62 = unk_0x9BA5CF280376EEA4(26, iLocal_626, -2881.755f, 3188.125f, 10.1136f, 254.1723f, 1, true);
				unk_0xFDA78B1CA2B4FB0A(Local_62);
				func_275();
			}
			if (func_467(Local_62))
			{
				unk_0xA9E472293522522F(Local_62, 0f);
				unk_0x4A852F02088ECC9D(Local_62, 1);
				unk_0x5FEE418CE11E6DDE(Local_62, 167, true);
				unk_0x9FD099B0593CD91D(Local_62, true);
				unk_0x262617DE7F70A56D(Local_62, true);
				unk_0xF0BE7CB40DE62A2F(Local_62, false);
				unk_0x5FEE418CE11E6DDE(Local_62, 185, true);
				unk_0x5FEE418CE11E6DDE(Local_62, 188, false);
				unk_0x0648A75D3F60E864(Local_62, iLocal_624);
				unk_0x5FEE418CE11E6DDE(Local_62, 132, true);
		...
		case 1:
			...
			{
				unk_0x3C990C409B3845DE(Local_62, 254.1723f);
				unk_0xBEADAF07D2339505(Local_62, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
				unk_0xED68CDDDE25A144E(Local_62);
			}
			else
			{
				func_4(&Local_62);
				Local_62 = unk_0x9BA5CF280376EEA4(26, iLocal_626, -2889.89f, 3198.69f, 10.11f, 254.1723f, 1, true);
				unk_0xFDA78B1CA2B4FB0A(Local_62);
			}
			if (func_467(Local_62))
			{
...
void func_275()
{
	unk_0x697EBA5CF1A6AB57(Local_62, joaat("weapon_digiscanner"), 0, true, true);
	unk_0x8A5F86362E03852B(Local_62, false);
	unk_0x9FD099B0593CD91D(Local_62, true);
	unk_0x262617DE7F70A56D(Local_62, true);
	unk_0xF0BE7CB40DE62A2F(Local_62, false);
	unk_0x99414FB2D30425C1(&uLocal_125);
	unk_0x46F8A470FADAF002(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	unk_0x108754262311D34F(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	unk_0x46F8A470FADAF002(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	unk_0x108754262311D34F(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	unk_0x46F8A470FADAF002(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	unk_0x108754262311D34F(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	unk_0x656E3BB78935070E(uLocal_125, 1);
	unk_0xC734F59A13D39AEF(uLocal_125);
	unk_0x13A2D602CD10CBAC(Local_62, uLocal_125);
}
...
void func_276()
{
	switch (iLocal_69)
	{
		case 0:
			if (unk_0x765F6FEEFF39224F(vLocal_54.x))
			{
				...
				unk_0x7AC8DF0B83EB4C6B(&vLocal_54);
			}
			vLocal_54.x = unk_0xC651C43AB13A15E5(iLocal_625, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
			unk_0x1B2303F9DC2D90D5(vLocal_54.x, 1084227584);
			unk_0x320D9994786BCA17(vLocal_54.x);
			unk_0x65EA11CF317FE4FA(vLocal_54.x, 157, 157);
			unk_0x4A7AB87632044178(vLocal_54.x, 157, 5);
			unk_0x40DFA7AAEFC8F34C(vLocal_54.x, 3);
			unk_0xD460482B9A347153(vLocal_54.x, 0);
			unk_0x09993E7216CF52C4(vLocal_54.x, true);
			func_469(vLocal_54.x, 0);
		...
		case 2:
			...
			{
				unk_0xD303E20CB0AE4AD0(vLocal_54.x, 1);
				unk_0x3C990C409B3845DE(vLocal_54.x, 290.823f);
				unk_0x9FABD0AB045A5D6E(vLocal_54.x, true, 1, 0);
				unk_0x4522AD7364B6AA54(vLocal_54.x, 75f);
				unk_0xD460482B9A347153(vLocal_54.x, 0);
				unk_0x09993E7216CF52C4(vLocal_54.x, true);
				unk_0x6B091F0028E6FE5F(vLocal_54.x, 3);
				unk_0xF70578F5CD9822CB(vLocal_54.x, true);
			}
			else
			{
				vLocal_54.x = unk_0xC651C43AB13A15E5(iLocal_625, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
				unk_0x1B2303F9DC2D90D5(vLocal_54.x, 1084227584);
				unk_0x320D9994786BCA17(vLocal_54.x);
				unk_0x65EA11CF317FE4FA(vLocal_54.x, 157, 157);
				unk_0x4A7AB87632044178(vLocal_54.x, 157, 5);
				...
				if (!func_262())
				{
					unk_0x094626C0798AE1F8(unk_0x33CD235DF1E6A94E(), vLocal_54.x, -1);
				}
				unk_0x6B091F0028E6FE5F(vLocal_54.x, 3);
				unk_0xF70578F5CD9822CB(vLocal_54.x, true);
		...
		case 4:
			...
			if (func_470(vLocal_54.x))
			{
				if (unk_0x4278060E716E1226(vLocal_54.x))
				{
					unk_0x8D50B2BEF003AB31(vLocal_54.x);
				}
				func_5(&vLocal_54);
			}
			vLocal_54.x = unk_0xC651C43AB13A15E5(vLocal_54.y, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
			if (func_470(vLocal_54.x))
			{
				unk_0x1B2303F9DC2D90D5(vLocal_54.x, 1084227584);
				unk_0x320D9994786BCA17(vLocal_54.x);
				unk_0xD303E20CB0AE4AD0(vLocal_54.x, 3);
				unk_0x65EA11CF317FE4FA(vLocal_54.x, 157, 157);
				unk_0x4A7AB87632044178(vLocal_54.x, 157, 5);
				unk_0x40DFA7AAEFC8F34C(vLocal_54.x, 3);
				unk_0xD460482B9A347153(vLocal_54.x, 0);
		...
		case 5:
			...
			if (!bLocal_80)
			{
				...
				vLocal_54.x = unk_0xC651C43AB13A15E5(vLocal_54.y, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
				if (func_470(vLocal_54.x))
				{
					unk_0x1B2303F9DC2D90D5(vLocal_54.x, 1084227584);
					unk_0x320D9994786BCA17(vLocal_54.x);
				...
				if (!unk_0x4278060E716E1226(vLocal_54.x))
				{
					if (unk_0x371855A6F27F144B(501, "Eps6_Takeoff"))
					{
						unk_0xCCFFBA26C1726838(vLocal_54.x, 501, "Eps6_Takeoff", 1);
						unk_0x2B2AFC30DE3FE922(vLocal_54.x, 1);
						unk_0x867B6357BD17A8E5(vLocal_54.x);
	...
	unk_0x8C4EA5F6857553AE(vLocal_54.y, 1);
}
	...
	switch (iLocal_69)
	{
		...
		case 4:
			if (!func_467(Local_61))
			{
				...
				unk_0x4A852F02088ECC9D(Local_61, 1);
				unk_0x1096811DB3A77EC1(Local_61, 0);
				unk_0xF0BE7CB40DE62A2F(Local_61, false);
				unk_0x5FEE418CE11E6DDE(Local_61, 185, true);
				unk_0x73D993BCA1CEC58D(Local_61, 1, 0, 0, false);
				unk_0x0648A75D3F60E864(Local_61, iLocal_624);
				unk_0x5FEE418CE11E6DDE(Local_61, 132, true);
				unk_0x108754262311D34F(Local_61, Local_61.f_6, Local_61.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
			}
			else
			{
			...
			{
				iLocal_126 = unk_0x7CA67831169E8AA6(joaat("p_amb_phone_01"), unk_0xFBB1F99A825CAB09(Local_61, true), 1, true, 0);
			}
			if (!unk_0x9F4718FD61B07058(iLocal_126))
			{
				unk_0x2F0A6390D863D337(iLocal_126, Local_61, unk_0xFCAF61876D23D31D(Local_61, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
			}
			func_281(55);
			break;
		...
		case 5:
			if (!bLocal_80)
			{
				if (!func_467(Local_61))
				{
					...
					unk_0x0648A75D3F60E864(Local_61, iLocal_624);
					unk_0x5FEE418CE11E6DDE(Local_61, 132, true);
					if (!unk_0xE38E3CF1625A4145(Local_61.f_1))
					{
					...
					if (func_467(Local_61) && func_233())
					{
						...
						unk_0xC838CE9837D0ABAF(0, vLocal_54.x, 20000, -1, 2f, 1, 0);
						unk_0xC734F59A13D39AEF(uLocal_125);
						unk_0x13A2D602CD10CBAC(Local_61, uLocal_125);
						unk_0xA7A57E7757ED035E(&uLocal_125);
					}
					unk_0x880B00F3FAE4C022(Local_61, 0, 0);
				}
				else
				{
					...
					unk_0x880B00F3FAE4C022(Local_61, 1, 0);
				}
				func_279(&iLocal_126);
			}
			else
...
void func_285()
{
	switch (iLocal_69)
	{
		...
		case 2:
			if (!func_262())
			{
				if (func_467(unk_0x33CD235DF1E6A94E()) && func_470(vLocal_54.x))
				{
					if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 0))
					{
						unk_0x094626C0798AE1F8(unk_0x33CD235DF1E6A94E(), vLocal_54.x, -1);
...
void func_286(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_220(unk_0xD178EF744F20B712(), 1);
			if (iVar4 != -1)
			{
...
void func_312(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_317(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x078B659F6F2C8960(iVar5, &Var7) && !func_314(Var7.f_1)) && iVar9 < 51)
			{
...
int func_322(var uParam0)
{
	if (!unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		if (func_344())
		{
			*uParam0 = func_327(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), false), 6, -1, 0, 1, -1);
...
int func_327(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_343(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(vParam0, func_328(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_351(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_388(1, 1093140480, 0))
			{
				...
				if (func_233())
				{
					unk_0xBEADAF07D2339505(vLocal_54.x, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
					unk_0x3C990C409B3845DE(vLocal_54.x, 284.26f);
					unk_0x1B2303F9DC2D90D5(vLocal_54.x, 1084227584);
				}
				else
				{
				...
				if (func_467(Local_61))
				{
					unk_0xEF6624A3AFF02A02(Local_61, "Jimmy_Boston", 0, 0, 0);
				}
				if (func_467(unk_0x33CD235DF1E6A94E()))
				{
				...
				{
					unk_0xEF6624A3AFF02A02(vLocal_54.x, "ep_plane", 0, 0, 0);
				}
		...
		case 2:
			...
			{
				unk_0x6BFA9158A12CC006(uLocal_124);
			}
...
void func_372()
{
	if (unk_0x3CA08F647CEAD042("ep_plane", 0))
	{
		...
		if (func_233())
		{
			unk_0xBEADAF07D2339505(vLocal_54.x, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
			unk_0x3C990C409B3845DE(vLocal_54.x, 284.26f);
			unk_0x1B2303F9DC2D90D5(vLocal_54.x, 1084227584);
		}
		else
...
void func_373()
{
	if (func_467(Local_61))
	{
		if (unk_0x3CA08F647CEAD042("Jimmy_Boston", 0))
		{
			...
			unk_0x13C3FE558ED056EE(Local_61, -530524, 0, 1, 0);
		}
	}
}
...
int func_374()
{
	if (func_467(unk_0x33CD235DF1E6A94E()))
	{
		...
		{
			unk_0x13C3FE558ED056EE(unk_0x33CD235DF1E6A94E(), -1871534317, 0, 1, 0);
			unk_0xC7E6A5D90DED6E0B(0f);
			unk_0xD6EDA274D82E8678(0f, 1065353216);
			unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), Local_61, -1, 0, 2);
...
void func_394()
{
	switch (iLocal_70)
	{
		case 0:
			...
			unk_0xD51062C52BCD2AE8(501, "Eps6_Takeoff");
			while ((((!func_265(55) || !unk_0xE9CCF312047EBEE0(Local_61.f_6)) || !unk_0x5D98D654CDC2165A(Local_59.f_1)) || !unk_0x5D98D654CDC2165A(joaat("p_amb_phone_01"))) || !unk_0x371855A6F27F144B(501, "Eps6_Takeoff"))
			{
				wait(0);
			}
			if (iLocal_79)
			...
			if (func_233())
			{
				unk_0x9FABD0AB045A5D6E(vLocal_54.x, false, 0, 0);
			}
			if (!unk_0xE38E3CF1625A4145(Local_61.f_1))
			{
				Local_61.f_1 = func_280(Local_61, 1, 1, 9);
			...
			iLocal_109 = (unk_0xE3903F59E2F22150() - 10000);
			iLocal_84 = 0;
		...
		case 1:
			...
			if (func_467(Local_61))
			{
				if (func_232(unk_0x33CD235DF1E6A94E(), Local_61, 1) < 100f)
				{
				...
				else if (func_232(unk_0x33CD235DF1E6A94E(), Local_61, 1) > 120f)
				{
					if (unk_0xC7D0A132A56D5FCB())
					{
			...
			if (func_233())
			{
				...
				if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
				{
					...
					if (func_395(unk_0x33CD235DF1E6A94E(), Local_61, 13f, 1))
					{
				...
				else if (func_395(unk_0x33CD235DF1E6A94E(), Local_61, 5f, 1))
				{
					if (func_467(unk_0x33CD235DF1E6A94E()) && func_467(Local_61))
					{
						vLocal_628 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) };
						vLocal_629 = { unk_0xFBB1F99A825CAB09(Local_61, true) };
						if (((vLocal_628.z - vLocal_629.z) < 1.5f && !unk_0xE19223B3551F58B8(unk_0x33CD235DF1E6A94E())) && !unk_0x3AF2B3B68DD52355(unk_0x33CD235DF1E6A94E()))
						{
							iLocal_70 = 2;
						}
					}
...
void func_396()
{
	if (func_232(unk_0x33CD235DF1E6A94E(), Local_61, 1) <= 15f)
	{
		if (!unk_0x3C28700239538CD2())
		{
			if (!unk_0xD007040030F44ED2(uLocal_124))
			{
				func_510("Loading streamvol");
				uLocal_124 = unk_0x0043C011D577EDC1(1684.85f, 3276.16f, 39.93f, func_397(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
...
void func_398()
{
	...
	if (func_467(Local_61) && func_467(unk_0x33CD235DF1E6A94E()))
	{
		fVar0 = unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(Local_61, true), true);
	}
	if (fVar0 < 50f)
	{
		fLocal_118 = 100f;
	...
	if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(Local_61, true), true) > fLocal_118)
	{
		if (!iLocal_84)
		{
		...
		else if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(Local_61, true), true) > fLocal_119)
		{
			iLocal_128 = 2;
			iLocal_70 = 0;
			iLocal_69 = 6;
...
void func_400()
{
	if (func_467(Local_61))
	{
		if (func_232(unk_0x33CD235DF1E6A94E(), Local_61, 1) <= 15f)
		{
			if (!unk_0xFB2C4D32FED130AB(Local_61, unk_0x33CD235DF1E6A94E()))
			{
				func_510("Jimmy headlooking");
				unk_0xC4A347124F39D998(Local_61, unk_0x33CD235DF1E6A94E(), -1, 2096, 2);
			}
		}
		else if (func_232(unk_0x33CD235DF1E6A94E(), Local_61, 1) <= 25f && func_22())
		{
			if (!unk_0xFB2C4D32FED130AB(Local_61, unk_0x33CD235DF1E6A94E()))
			{
		...
		else if (unk_0xFB2C4D32FED130AB(Local_61, unk_0x33CD235DF1E6A94E()) && !func_22())
		{
			func_510("Clear Jimmy headlook");
			unk_0xE0DAC4ABE9900D9A(Local_61);
		}
	}
	if (!func_22() && !unk_0xC4B7D5901EDA35B5())
	{
		if (func_467(Local_61) && func_467(unk_0x33CD235DF1E6A94E()))
		{
			if (func_395(unk_0x33CD235DF1E6A94E(), Local_61, 25f, 1))
			{
				if ((unk_0xE3903F59E2F22150() - iLocal_109) > 15000)
				{
	...
	switch (iLocal_70)
	{
			...
			if (func_233())
			{
				...
				if (iLocal_98 == 0)
				{
					if (func_415(vLocal_54.x, Local_60, 1) < 350f)
					{
						...
						if (((unk_0x5D98D654CDC2165A(Local_59.f_1) && func_265(55)) && unk_0xE9CCF312047EBEE0(Local_61.f_6)) && unk_0x5D98D654CDC2165A(joaat("p_amb_phone_01")))
						{
							func_278();
							func_264();
							func_15(&uLocal_459, 3, Local_61, "JIMMYBOSTON", 0, 1);
				...
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 0))
				{
					...
					{
						if (unk_0xD4B4F68F3449CBEC(vLocal_54.x, vLocal_121, vLocal_122, 33.25f, 0, true, 2))
						{
				...
				{
					if (!unk_0xE38E3CF1625A4145(vLocal_54.z))
					{
					...
					func_16(&(Local_60.f_3));
					if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 80f)
					{
						if (func_415(vLocal_54.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 150f)
							{
								if (func_408())
								{
									bLocal_101 = true;
						...
						else if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 250f)
						{
							if (func_408())
							{
								bLocal_101 = true;
		...
		case 2:
			if (func_470(vLocal_54.x))
			{
				...
				{
					func_16(&(vLocal_54.f_2));
					if (unk_0x6379DAF3AD61121F(vLocal_54.x) == 0 || unk_0x6379DAF3AD61121F(vLocal_54.x) == 3)
					{
						if (!unk_0xE38E3CF1625A4145(Local_61.f_1))
						{
							Local_61.f_1 = func_280(Local_61, 1, 1, 9);
						...
						if (func_407() && !unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 0))
						{
							func_510("*** Finishing Landing cleanup");
							func_406("*** Plane 'entity' health: ", unk_0xE80842D7B53F8525(vLocal_54.x));
							func_405("*** Plane engine health: ", unk_0x787CBB9DB6BA1A49(vLocal_54.x));
							func_405("*** Plane petrol tank health: ", unk_0x660BC449336F0502(vLocal_54.x));
							if ((unk_0xE80842D7B53F8525(vLocal_54.x) == 1000 && unk_0x787CBB9DB6BA1A49(vLocal_54.x) == 1000f) && unk_0x660BC449336F0502(vLocal_54.x) == 1000f)
							{
								func_404(751);
							}
							func_16(&(Local_60.f_3));
					...
					if ((unk_0x6379DAF3AD61121F(vLocal_54.x) == 1 || unk_0x6379DAF3AD61121F(vLocal_54.x) == 4) || unk_0x6379DAF3AD61121F(vLocal_54.x) == 5)
					{
				...
				else
				{
					...
					unk_0x9FABD0AB045A5D6E(vLocal_54.x, true, 0, 0);
					unk_0xD303E20CB0AE4AD0(vLocal_54.x, 1);
					iLocal_70 = 1;
				}
			}
...
int func_407()
{
	...
	if (func_233())
	{
		fVar0 = unk_0x8BB475EA09C9A0EB(vLocal_54.x);
...
void func_412()
{
	if (func_467(Local_61))
	{
		if (func_232(Local_61, vLocal_54.x, 1) < 17f)
		{
			if (!bLocal_92)
			{
				if (!func_22())
				{
					if (func_221(&uLocal_459, "EPS6AUD", "EPS6_CLOSE", 9, 0, 0, 0))
					{
						...
						unk_0xED68CDDDE25A144E(Local_61);
						unk_0xC4A347124F39D998(Local_61, unk_0x33CD235DF1E6A94E(), 10000, 48, 2);
			...
			{
				if ((unk_0xE3903F59E2F22150() - iLocal_110) > 10000)
				{
					bLocal_92 = false;
				}
			}
		}
		else if (!unk_0x1CE8F0A08E65CA6A(Local_61, Local_61.f_6, Local_61.f_7, 3))
		{
...
void func_413()
{
	...
	else
	{
		...
		if (!unk_0xE38E3CF1625A4145(Local_60.f_3))
		{
...
void func_416()
{
	if (func_233())
	{
		if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 0))
		{
			if ((unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -2611.599f, 2953.922f, 10.79497f, -2698.713f, 2367.25f, -0.336048f, 3f, 0, true, 0) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -1506.538f, 2717.231f, 15.28982f, -1377.953f, 2609.015f, 0.028772f, 3f, 0, true, 0)) || unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -395.9501f, 2960.714f, 23.47385f, -426.3539f, 2966.561f, 14.00403f, 3f, 0, true, 0))
			{
				if (!iLocal_627)
				{
					iLocal_627 = 1;
...
void func_417()
{
	...
	if (iLocal_69 >= 1)
	{
		...
		if (func_22())
		{
			...
			{
				if (func_415(unk_0x33CD235DF1E6A94E(), vVar0, 1) > 35f)
				{
					if (func_22())
					{
		...
		if (func_415(unk_0x33CD235DF1E6A94E(), vVar0, 1) > 450f)
		{
			func_7(&Local_62, 1, 0, 1);
		}
	}
	...
	switch (iLocal_73)
	{
		case 0:
			...
			else if (iLocal_74 == 1)
			{
				...
				{
					case 0:
						if (func_232(unk_0x33CD235DF1E6A94E(), Local_62, 1) < 50f)
						{
							if (!func_22())
							{
					...
					case 2:
						if ((unk_0xE3903F59E2F22150() - iLocal_115) > 12000)
						{
							iLocal_106 = 0;
						}
						break;
				...
				if (func_467(unk_0x33CD235DF1E6A94E()) && func_470(vLocal_54.x))
				{
					if (func_232(unk_0x33CD235DF1E6A94E(), Local_62, 1) < 10f || func_232(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1) < 10f)
					{
						if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
						{
							if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
							{
								func_258(2);
		...
		case 1:
			if (iLocal_74 == 0)
			{
				...
				{
					unk_0xED68CDDDE25A144E(Local_62);
					unk_0x11C4AF4137F2A4B5(Local_62, unk_0x33CD235DF1E6A94E(), 0);
			...
			{
				if ((func_467(unk_0x33CD235DF1E6A94E()) && func_470(vLocal_54.x)) && func_468(Local_62))
				{
					if (!unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0))
					{
						if (func_232(unk_0x33CD235DF1E6A94E(), Local_62, 1) < 15f || func_232(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1) < 10f)
						{
							if (!unk_0xD4B4F68F3449CBEC(unk_0x33CD235DF1E6A94E(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
							{
								func_258(2);
		...
		case 2:
			if (iLocal_74 == 0)
			{
				if (func_467(Local_62))
				{
					...
					if (unk_0xC4B7D5901EDA35B5())
					{
						...
						unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), Local_62, -1, 0, 2);
						unk_0xC4A347124F39D998(Local_62, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
			...
			else if (iLocal_74 == 1)
			{
				...
				else if ((unk_0xE3903F59E2F22150() - iLocal_116) > 1000 || iLocal_116 == 0)
				{
					if (!func_22())
					{
					...
					if (func_409("EPS6_SPOT"))
					{
						...
						{
							if (func_423(Local_62, unk_0x33CD235DF1E6A94E()) > 10f)
							{
								func_20();
								bLocal_96 = true;
							}
				...
				{
					if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1))
					{
						if (func_22())
						{
							func_20();
		...
		case 3:
			if (iLocal_74 == 0)
			{
				...
				if (iLocal_102 == 0)
				{
					...
					{
						unk_0xED68CDDDE25A144E(Local_62);
						unk_0x8CF360BBBD42762D(Local_62, -1, unk_0x33CD235DF1E6A94E(), -1, 1);
					}
					iLocal_107 = -1;
					iLocal_74 = 1;
				}
			...
			else if (iLocal_74 == 1)
			{
				if (!func_239(Local_62, 1126825984))
				{
					...
					else if ((unk_0xE3903F59E2F22150() - iLocal_107) > 1200)
					{
						unk_0xED68CDDDE25A144E(Local_62);
						unk_0xC4A347124F39D998(Local_62, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
						unk_0x11C4AF4137F2A4B5(Local_62, unk_0x33CD235DF1E6A94E(), 0);
		...
		case 5:
			if (iLocal_74 == 0)
			{
				...
				unk_0x11C4AF4137F2A4B5(Local_62, unk_0x33CD235DF1E6A94E(), -1);
				iLocal_74 = 1;
			}
			else if (iLocal_74 == 1)
			{
				if (iLocal_81 == 0)
				{
					if ((!unk_0xC4B7D5901EDA35B5() && !func_22()) && !unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1))
					{
						unk_0xB5D26BFA756D0D11(3f, 10f, 1);
		...
		case 4:
			if (iLocal_74 == 0)
			{
				if (func_468(Local_62))
				{
					...
					{
						unk_0xED68CDDDE25A144E(Local_62);
						unk_0xE0DAC4ABE9900D9A(Local_62);
						unk_0x99414FB2D30425C1(&uLocal_125);
						...
						unk_0x7E268975AF5EA74F(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 1048576000, 0, 1193033728);
			...
			else if (iLocal_74 == 1)
			{
				if (iLocal_69 == 0)
				{
					if (iLocal_81 == 0)
					{
						if ((!func_409("EPS6_SPOT") && !unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1)) && !unk_0x707FFB0E65C1C546(unk_0x33CD235DF1E6A94E()))
						{
							func_420("EPS6_GETIN", 7500, 1);
...
void func_419()
{
	...
	if (func_468(Local_62))
	{
		...
		unk_0xECCD4FDA45197F97(Local_62, unk_0x33CD235DF1E6A94E(), 500f, -1, 0, 0);
		func_16(&(Local_62.f_1));
	}
}
...
int func_425()
{
	if (func_233() && func_467(Local_62))
	{
		if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 1))
		{
			if (unk_0x91BBD269506D61D2(vLocal_54.x, unk_0x33CD235DF1E6A94E(), 1))
			{
				func_510("Player damaged plane");
				unk_0x0D847D71D9E6142E(vLocal_54.x);
				return 1;
			}
		}
	}
...
void func_427()
{
	if (iLocal_73 == 2)
	{
		switch (iLocal_75)
		{
			...
			case 1:
				if (func_467(Local_62) && func_467(unk_0x33CD235DF1E6A94E()))
				{
					unk_0xED68CDDDE25A144E(Local_62);
					vLocal_628 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true) };
					unk_0x99414FB2D30425C1(&uLocal_125);
					unk_0xC4A347124F39D998(0, unk_0x33CD235DF1E6A94E(), -1, 0, 2);
					unk_0x7E268975AF5EA74F(0, vLocal_628, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0xC734F59A13D39AEF(uLocal_125);
					unk_0x13A2D602CD10CBAC(Local_62, uLocal_125);
					unk_0xA7A57E7757ED035E(&uLocal_125);
					iLocal_75 = 2;
			...
			case 2:
				if (func_467(Local_62) && func_467(unk_0x33CD235DF1E6A94E()))
				{
					if (func_232(Local_62, unk_0x33CD235DF1E6A94E(), 1) < 5f || unk_0xD76D6BCC14B95CE1(Local_62, 242628503) == 7)
					{
						unk_0xED68CDDDE25A144E(Local_62);
						unk_0x11C4AF4137F2A4B5(Local_62, unk_0x33CD235DF1E6A94E(), -1);
						iLocal_75 = 0;
	...
	if (func_467(Local_62))
	{
		switch (iLocal_76)
		{
			case 0:
				...
				if (unk_0xE9CCF312047EBEE0("rcmepsilonism6") && !unk_0x1CE8F0A08E65CA6A(Local_62, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					unk_0x108754262311D34F(Local_62, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_76 = 1;
			...
			case 1:
				...
				{
					unk_0x7E268975AF5EA74F(Local_62, vLocal_78[iLocal_77 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
			...
			case 3:
				unk_0xED68CDDDE25A144E(Local_62);
				unk_0x108754262311D34F(Local_62, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
				unk_0x880B00F3FAE4C022(Local_62, 0, 0);
				iLocal_76 = 4;
				func_510("Eps 6: Done Tom idle anim");
				break;
			
			case 4:
				if (unk_0x1CE8F0A08E65CA6A(Local_62, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (unk_0x204DEACC5BECF723(Local_62, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						if (iLocal_77 >= 2)
						{
							iLocal_77 = 0;
						...
						unk_0x108754262311D34F(Local_62, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						unk_0x880B00F3FAE4C022(Local_62, 0, 0);
						iLocal_76 = 1;
...
int func_433()
{
	if (func_467(unk_0x33CD235DF1E6A94E()) && func_467(Local_62))
	{
		...
		if (unk_0x91BBD269506D61D2(Local_62, unk_0x33CD235DF1E6A94E(), 1))
		{
			func_510("Player damaged cultist");
			return 1;
		}
	}
	else if (unk_0x765F6FEEFF39224F(Local_62))
	{
		if (unk_0x91BBD269506D61D2(Local_62, unk_0x33CD235DF1E6A94E(), 1))
		{
...
void func_434()
{
	...
	if (unk_0x765F6FEEFF39224F(Local_62))
	{
		if (unk_0x91BBD269506D61D2(Local_62, unk_0x33CD235DF1E6A94E(), 1))
		{
			if (unk_0xD62C4419A41F106A(Local_62, 0))
			{
...
int func_435()
{
	if ((func_238(Local_62, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_235(unk_0x33CD235DF1E6A94E(), Local_62, 0)) || func_425())
	{
		if (func_238(Local_62, 0, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			func_510("Player threatened cultist");
		}
		if (func_235(unk_0x33CD235DF1E6A94E(), Local_62, 0))
		{
...
void func_436()
{
	if (bLocal_100 == 0)
	{
		if (func_468(Local_62) && func_467(unk_0x33CD235DF1E6A94E()))
		{
			if (iLocal_99 == 0)
			{
				if (unk_0x4ED4D1D8B2023FD8(unk_0x33CD235DF1E6A94E(), Local_62) && unk_0x3AF2B3B68DD52355(Local_62))
				{
					func_20();
			...
			{
				if (unk_0xF7C907E9E8E2BB22(Local_62) || unk_0xA1248DEAD0B27B8E(Local_62))
				{
					if (!func_22() && !unk_0xC4B7D5901EDA35B5())
					{
...
void func_439()
{
	switch (iLocal_70)
	{
		case 0:
			...
			func_15(&uLocal_294, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
			func_15(&uLocal_129, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
		...
		case 1:
			...
			if (func_233())
			{
				if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), vLocal_54.x, 0))
				{
					...
					if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) == 0)
					{
						if (func_415(unk_0x33CD235DF1E6A94E(), Local_60, 0) < 2300f)
						{
							iLocal_70 = 2;
						}
					}
				...
				else
				{
					...
					if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 80f)
					{
						...
						else if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 120f)
						{
							if (func_408())
							{
								bLocal_101 = true;
	...
	switch (iLocal_71)
	{
		case 0:
			if (unk_0x002F527E1A3238DC(unk_0x95B959F18401C09A()) == 0)
			{
				if (func_233())
				{
					vVar0 = { unk_0xFBB1F99A825CAB09(vLocal_54.x, true) };
					if (vVar0.z > 15f)
					{
		...
		case 1:
			if ((unk_0xE3903F59E2F22150() - iLocal_108) > 12000)
			{
				iLocal_71 = 2;
			}
			break;
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_467(Local_62))
			{
				...
				unk_0x5FEE418CE11E6DDE(Local_62, 185, true);
				unk_0x8A5F86362E03852B(Local_62, false);
				iLocal_104 = unk_0x8CCC0A0504C52531();
				iLocal_105 = unk_0x8CCC0A0504C52531();
				unk_0xE9739440E5BF08EE(iLocal_104, "DEVICE", unk_0x3D74C4F085E721B1(Local_62), "EPSILONISM_04_SOUNDSET", 0, 0);
				unk_0xE9739440E5BF08EE(iLocal_105, "IDLE_BEEP_NPC", unk_0x3D74C4F085E721B1(Local_62), "EPSILONISM_04_SOUNDSET", 0, 0);
			}
			if (!unk_0xE38E3CF1625A4145(Local_62.f_1))
			{
		...
		case 1:
			...
			else if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 50f)
			{
				if (!iLocal_84)
				{
					if (unk_0x12BF789190D82474())
					{
						iLocal_86 = unk_0xF26F606F8B36E2AC();
						vLocal_88 = { func_410() };
						func_20();
						iLocal_85 = 1;
						iLocal_87 = (unk_0xE3903F59E2F22150() - 7500);
					}
					func_399("EPS6_BACKPL", 7500, 1);
					iLocal_84 = 1;
				}
				...
				{
					if ((unk_0xE3903F59E2F22150() - iLocal_87) > 7500 && !unk_0xC4B7D5901EDA35B5())
					{
					...
					if (unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(vLocal_54.x, true), true) > 100f)
					{
						iLocal_128 = 1;
						iLocal_70 = 0;
						iLocal_69 = 6;
...
int func_471(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_474(&iVar0) || !unk_0xE9CCF312047EBEE0(sVar3))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			{
				iVar2 = unk_0x5E65439BE0A05829(-2892.93f, 3192.37f, 11.66f, 11f, iVar0[0], 16390);
				if (func_467(iVar2))
				{
				...
				{
					unk_0xB7350047030F7672(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, false, 0);
			...
			if (unk_0x765F6FEEFF39224F(uParam0->f_35[0]))
			{
				...
				unk_0x09993E7216CF52C4(uParam0->f_35[0], true);
			...
			{
				iVar5 = unk_0xC408CC95C7202D67(unk_0x33CD235DF1E6A94E());
				unk_0x697EBA5CF1A6AB57(uParam0->f_28[0], joaat("weapon_digiscanner"), -1, true, true);
				unk_0xFDA78B1CA2B4FB0A(uParam0->f_28[0]);
				unk_0x262617DE7F70A56D(uParam0->f_28[0], true);
				unk_0xF0BE7CB40DE62A2F(uParam0->f_28[0], false);
				unk_0x5FEE418CE11E6DDE(uParam0->f_28[0], 185, true);
				unk_0x5FEE418CE11E6DDE(uParam0->f_28[0], 188, true);
				unk_0x5FEE418CE11E6DDE(uParam0->f_28[0], 132, true);
				unk_0x9FD099B0593CD91D(uParam0->f_28[0], true);
				unk_0x0648A75D3F60E864(uParam0->f_28[0], iVar5);
...
void func_477()
{
	...
	if (unk_0xB98788B42580C4A8("SANDY_PLANES"))
	{
		if (!unk_0x7FC8FAE3451A21AD("SANDY_PLANES"))
		{
			unk_0x8411BDAD24F96365("SANDY_PLANES", true);
		}
	}
...
int func_493(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_496())
	{
		...
		{
			iVar2 = func_356(unk_0xD178EF744F20B712());
			if (iVar2 > -1)
			{
