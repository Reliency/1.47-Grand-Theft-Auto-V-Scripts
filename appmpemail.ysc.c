...
void __EntryFunction__()
{
	...
	Global_14557 = 0;
	unk_0x4951EE4BB7B6B4F7(&vLocal_39);
	vLocal_38 = { vLocal_39 };
	...
	while (true)
	{
		...
		if ((Global_14553.f_1 != 9 && Global_16900 == 0) && Global_16899 == 0)
		{
			...
			{
				if (unk_0xCE3CFF625BEBAA04(&(Global_4268043[iLocal_24 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_4268043[iLocal_24 /*104*/].f_24 == 1)
	{
		if (Global_14531 == 0)
		{
			if (unk_0xF1CDE9FD207C4CD8(2, Global_14524))
			{
				...
				unk_0x98E765CB9E761233(Global_4268043[iLocal_24 /*104*/].f_16);
				func_53(Global_14534, "SET_DATA_SLOT_EMPTY", 8f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_48();
				if (iLocal_22 > 0)
				{
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_19(Global_14534, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2430[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
		...
		if ((func_3(2, Global_14522, 0) || Global_4269293 == 1) || Global_16926 == 1)
		{
			...
			if (iLocal_22 == iLocal_21 || iLocal_22 > iLocal_21)
			{
				if (Global_14553.f_1 > 3)
				{
					...
					Global_16932 = 1;
					iLocal_23 = iLocal_22;
					unk_0xF3227B8FDF5975BF(iLocal_19[iLocal_22], &Local_45);
				}
				settimerb(0);
				iLocal_28 = 0;
				unk_0xBB698266C5FDF0A7(Global_14534, "GET_CURRENT_SELECTION");
				iLocal_33 = unk_0x614EE52A69097A4C();
				while (!unk_0xBFCC17D9792F43AF(iLocal_33) && iLocal_28 == 0)
				{
					wait(0);
					if (timerb() > 2000)
					{
				...
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_2));
				unk_0x36F3AA9FFAAF8606();
				unk_0x713FEBE56D2BD403("CELL_EMAIL_BCON");
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[0 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[1 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[2 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[3 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[4 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[5 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[6 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[7 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[8 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_56[9 /*16*/]));
				unk_0x36F3AA9FFAAF8606();
			...
			if (Global_4268043[iLocal_24 /*104*/].f_24 != 0)
			{
				...
				else
				{
					...
					{
						iLocal_29 = unk_0x82D58DA03789627A(iLocal_33);
					}
					if (iLocal_29 < 0)
					{
						iLocal_29 = 0;
				...
				{
					unk_0x713FEBE56D2BD403("CELL_FROM_FIELD");
					unk_0xD61E5ED1D4E687A5(&(Global_4268043[iLocal_24 /*104*/].f_50));
					unk_0x36F3AA9FFAAF8606();
				}
				else
				{
					unk_0x713FEBE56D2BD403("CELL_FROM_FIELD");
					unk_0xFA6BEE2B1507FF1E(&(Global_106565.f_28044[Global_4268043[iLocal_24 /*104*/].f_17 /*29*/].f_3));
					unk_0x36F3AA9FFAAF8606();
				}
				switch (Global_4268043[iLocal_24 /*104*/].f_32)
				{
					...
					case 1:
						unk_0x713FEBE56D2BD403(&(Global_4268043[iLocal_24 /*104*/]));
						unk_0xD61E5ED1D4E687A5(&(Global_4268043[iLocal_24 /*104*/].f_33));
						if (Global_4268043[iLocal_24 /*104*/].f_66 == 1 && !unk_0xCE3CFF625BEBAA04(&(Global_4268043[iLocal_24 /*104*/].f_67), "NULL"))
						{
							unk_0xD61E5ED1D4E687A5(&(Global_4268043[iLocal_24 /*104*/].f_67));
						}
						if ((Global_4268043[iLocal_24 /*104*/].f_66 == 2 && !unk_0xCE3CFF625BEBAA04(&(Global_4268043[iLocal_24 /*104*/].f_67), "NULL")) && !unk_0xCE3CFF625BEBAA04(&(Global_4268043[iLocal_24 /*104*/].f_83), "NULL"))
						{
							if (unk_0xEAF855A7DC28BC8D(&(Global_4268043[iLocal_24 /*104*/].f_67)))
							{
								unk_0xFA6BEE2B1507FF1E(&(Global_4268043[iLocal_24 /*104*/].f_67));
							}
							else
							{
								unk_0xD61E5ED1D4E687A5(&(Global_4268043[iLocal_24 /*104*/].f_67));
							}
							if (unk_0xEAF855A7DC28BC8D(&(Global_4268043[iLocal_24 /*104*/].f_83)))
							{
								unk_0xFA6BEE2B1507FF1E(&(Global_4268043[iLocal_24 /*104*/].f_83));
							}
							else
							{
								unk_0xD61E5ED1D4E687A5(&(Global_4268043[iLocal_24 /*104*/].f_83));
							}
						}
						unk_0x36F3AA9FFAAF8606();
						break;
					...
					case 2:
						unk_0x713FEBE56D2BD403(&(Global_4268043[iLocal_24 /*104*/]));
						unk_0xE800DC85FDF60F85(Global_4268043[iLocal_24 /*104*/].f_49);
						unk_0x36F3AA9FFAAF8606();
						break;
...
void func_37()
{
	...
	if (iLocal_37)
	{
		unk_0x30F6F0B876E12AD8(&Local_34);
	}
	iLocal_37 = 0;
	if (Global_4268043[iLocal_24 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 59)
		{
			if (unk_0xCE3CFF625BEBAA04(&(Global_4268043[iLocal_24 /*104*/]), &(Local_35[iVar0 /*6*/])))
			{
				...
				iLocal_37 = 1;
				unk_0x0A06DEFFF267C21E(&Local_34, 0);
				while (!unk_0xD83C9F072D059CC4(&Local_34))
				{
					wait(100);
				}
			}
...
{
	switch (unk_0x36163153849DFDA1(sParam0))
	{
		case 368818696:
		case -242537573:
		case 293851599:
...
float func_41(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_43((to_float((unk_0xE3903F59E2F22150() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
...
void func_46()
{
	if (Global_4269293 == 0)
	{
		...
		func_53(Global_14534, "DISPLAY_VIEW", 8f, to_float(iLocal_23), -1082130432, -1082130432, -1082130432);
		if (Global_14541)
		{
			if (iLocal_20 > 0)
			{
...
void func_48()
{
	...
	while (iVar1 < 11)
	{
		...
		if (Global_4268043[iVar4 /*104*/].f_24 != 0)
		{
			if (Global_4268043[iVar4 /*104*/].f_99[Global_14553] == 1)
			{
				...
				unk_0x4D9DA18AB3C2A466(iLocal_25);
				unk_0x295B86DE57A0721D(false);
				if (Global_4268043[iVar4 /*104*/].f_17 == 145)
				{
					unk_0x713FEBE56D2BD403("CELL_2000");
					unk_0xD61E5ED1D4E687A5(&(Global_4268043[iVar4 /*104*/].f_50));
					unk_0x36F3AA9FFAAF8606();
				}
				else
				{
	...
	while (iVar1 < (iLocal_44 + iLocal_20))
	{
		...
		{
			unk_0xF3227B8FDF5975BF(iVar2, &Local_45);
			if (iVar7[iVar2] == 0)
			{
				unk_0xBB698266C5FDF0A7(Global_14534, "SET_DATA_SLOT");
				unk_0x4D9DA18AB3C2A466(8);
				...
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_23[0 /*16*/]));
				unk_0xD61E5ED1D4E687A5(&(Local_45.f_23[1 /*16*/]));
				unk_0x36F3AA9FFAAF8606();
				unk_0x818901B332D5541D();
				iVar7[iVar2] = 1;
...
void func_54()
{
	...
	{
		wait(0);
		iLocal_43 = unk_0x33FB28D990016403();
		if (func_4())
		{
			Global_14553.f_1 = 3;
			iLocal_41 = 0;
	...
	if (bLocal_42)
	{
		iLocal_44 = unk_0xE1846A40DE9D7CBE();
	}
	else
	{
		iLocal_44 = 0;
