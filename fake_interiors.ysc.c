...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			iLocal_31 = unk_0x33CD235DF1E6A94E();
		}
		if (unk_0xD62C4419A41F106A(iLocal_31, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		vVar0 = { unk_0xFBB1F99A825CAB09(iLocal_31, false) };
		...
		if (vdist2(vVar1, vVar0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0xD4B4F68F3449CBEC(iLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), 0, true, 0))
					{
						bVar2 = true;
					}
				}
			...
			if (bVar2)
			{
				unk_0xD5933DC5FAB0505E(unk_0x36163153849DFDA1(func_13(iLocal_29)), vVar1.x, vVar1.y, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
	if (unk_0xB331FCEB94EB05C8())
	{
		if (func_2())
		{
			if (unk_0x0E4018692D92041D(iLocal_32, 1))
			{
				unk_0xCE689A8E8C42ED78(&iLocal_32, 1);
			}
			if (unk_0xD9C92B0885A075F8())
			{
				if (!unk_0x0E4018692D92041D(iLocal_32, 0))
				{
					unk_0xA0D67403A74C9705(15, 1, -1);
					unk_0x8950ED5730F62EE8(&iLocal_32, 0);
				}
			}
			else if (unk_0x0E4018692D92041D(iLocal_32, 0))
			{
				unk_0xA0D67403A74C9705(15, 0, -1);
				unk_0xCE689A8E8C42ED78(&iLocal_32, 0);
			}
		}
		else if (!unk_0x0E4018692D92041D(iLocal_32, 1))
		{
			unk_0xA0D67403A74C9705(15, 0, -1);
			unk_0xCE689A8E8C42ED78(&iLocal_32, 0);
			unk_0x8950ED5730F62EE8(&iLocal_32, 1);
		}
	}
}
