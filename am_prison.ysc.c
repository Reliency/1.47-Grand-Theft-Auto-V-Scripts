...
int func_28()
{
	switch (Local_117)
	{
		case 0:
			...
			{
				Local_117.f_4 = unk_0x0335D8135051EA56(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
		...
		case 1:
			if (vdist2(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), 1693.164f, 2559.616f, 44.5649f) >= 1030225f)
			{
				Local_117 = 2;
			}
			break;
		...
		case 2:
			if (Global_1573970 || func_23(3))
			{
				unk_0xF1CFA0046BB67893(Local_117.f_4, 0);
			}
			return 1;
			break;
	}
