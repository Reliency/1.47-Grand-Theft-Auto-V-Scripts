...
int func_1()
{
	...
	if ((vdist2(vVar0, vVar1) > 10000f || unk_0xD62C4419A41F106A(iLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0x765F6FEEFF39224F(iLocal_38) && !unk_0xD62C4419A41F106A(iLocal_38, 0))
			{
				if (unk_0x18FB647D79B09657(iLocal_38, vLocal_49, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x13A2D602CD10CBAC(iLocal_38, uVar2);
					unk_0xA7A57E7757ED035E(&uVar2);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0x765F6FEEFF39224F(iLocal_38) && !unk_0xD62C4419A41F106A(iLocal_38, 0))
			{
				if (unk_0x24CA7139A01083BE(iLocal_38) == 1)
				{
					if (!unk_0x765F6FEEFF39224F(iLocal_39))
					{
						...
						{
							fVar3 = unk_0x204DEACC5BECF723(iLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar3 >= 0.157f)
							{
				...
				{
					iVar4 = (unk_0x9EC3B269A34A2BEE(0, 65535) % 2);
					if (iVar4 == 0)
					{
