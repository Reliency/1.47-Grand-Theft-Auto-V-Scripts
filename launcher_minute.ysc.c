...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		unk_0x5856B9BF2B4E98C4(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), false, 1);
		unk_0x7F327D8D184FAB7F(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0xCE04CE961AF41AB9(vVar1, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_57 = func_243();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_205(329.513f, 3402.691f, 36.258f, unk_0xFBB1F99A825CAB09(Var0.f_35[1], true), 1056964608))
				{
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xE3903F59E2F22150() - iParam0->f_60) > iParam6) && func_189(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_176(2))
		{
			if (!func_145())
			{
				if (((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && func_126(iParam0->f_28[1])) && func_189(unk_0x33CD235DF1E6A94E(), vParam1, 1) < 20f)
				{
			...
			else if (((func_192(sParam3) && !*uParam8 == 1) && func_126(unk_0x33CD235DF1E6A94E())) && func_189(unk_0x33CD235DF1E6A94E(), vParam1, 1) >= 20f)
			{
				func_288("pause conversation");
				func_191(1);
				*uParam8 = 1;
			}
			if (func_189(unk_0x33CD235DF1E6A94E(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_194(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_189(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_226(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_226(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_226(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x765F6FEEFF39224F(uParam0->f_35[1]))
			{
				...
				unk_0x8C4EA5F6857553AE(iVar0[1], true);
			}
...
int func_256(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x0483D0035D6E46FD("rcmminute1");
			unk_0xCE04CE961AF41AB9(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			iLocal_51 = 1;
			break;
		...
		case 3:
			if (unk_0xE9CCF312047EBEE0("rcmminute1"))
			{
				...
				if (func_126(uParam0->f_28[1]))
				{
					...
					unk_0x5FEE418CE11E6DDE(uParam0->f_28[1], 185, true);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
void func_271(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x5856B9BF2B4E98C4(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), true, 1);
	}
	else if (*iParam0 == 34)
	{
