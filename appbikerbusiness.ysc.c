...
void __EntryFunction__()
{
	...
	uLocal_753 = unk_0x199B24FF79A52CCF("BIKER_BUSINESSES");
	while (!unk_0x11AE7F6A404414C9(uLocal_753))
	{
		wait(0);
	}
	func_466(1);
	...
	{
		iLocal_582 = func_458(unk_0x95B959F18401C09A());
	}
	else
	{
	...
	{
		vLocal_567 = { unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 1) };
	}
	...
	if (iLocal_582 != 0)
	{
		...
		if (iVar0 != -1)
		{
			if (func_422(unk_0x95B959F18401C09A(), iLocal_582) == func_421(iLocal_582))
			{
	...
	while (func_419())
	{
		if (unk_0x0E4018692D92041D(Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_23, 14) || func_418(unk_0x33CD235DF1E6A94E(), vLocal_567, 1) > 5f)
		{
			func_468(0);
		}
		...
		else if (iLocal_579 != 190)
		{
			...
			else if (func_8(&uLocal_584, 200, 0))
			{
				if (!Global_1671156)
				{
					func_3(unk_0x95B959F18401C09A(), iLocal_582, iLocal_583, 1);
					Global_1671156 = 1;
					func_468(0);
				}
...
void func_11()
{
	...
	{
		unk_0xBB698266C5FDF0A7(uLocal_753, "GET_CURRENT_SELECTION");
		uLocal_754 = unk_0x614EE52A69097A4C();
		unk_0xBB698266C5FDF0A7(uLocal_753, "GET_SELECTED_BUSINESS_ID");
		uLocal_756 = unk_0x614EE52A69097A4C();
		unk_0xBB698266C5FDF0A7(uLocal_753, "GET_CURRENT_SCREEN_ID");
		uLocal_757 = unk_0x614EE52A69097A4C();
		iLocal_570 = 0;
		iLocal_569 = 0;
	}
	if ((unk_0x833B1A3D9F713E03(2, 202) || unk_0x833B1A3D9F713E03(2, 238)) && iLocal_570)
	{
		unk_0xBB698266C5FDF0A7(uLocal_753, "GET_CURRENT_SCREEN_ID");
		uLocal_757 = unk_0x614EE52A69097A4C();
		iLocal_570 = 0;
	}
	if (unk_0xBFCC17D9792F43AF(uLocal_757) && !iLocal_570)
	{
	...
	{
		unk_0xBB698266C5FDF0A7(uLocal_753, "GET_CURRENT_ROLLOVER");
		uLocal_755 = unk_0x614EE52A69097A4C();
		iLocal_575 = 1;
	}
	if (iLocal_575)
	{
		if (unk_0xBFCC17D9792F43AF(uLocal_755))
		{
			iLocal_576 = unk_0x82D58DA03789627A(uLocal_755);
			iLocal_575 = 0;
		}
	}
	if (iLocal_576 == 3014 && func_381())
	{
		...
		unk_0x092150016C06C431(0, 0, true, 8000);
	...
	if (!iLocal_569)
	{
		if (unk_0xBFCC17D9792F43AF(uLocal_754) && unk_0xBFCC17D9792F43AF(uLocal_756))
		{
			iVar1 = unk_0x82D58DA03789627A(uLocal_754);
			iVar2 = unk_0x82D58DA03789627A(uLocal_756);
			iVar3 = -1;
			if (iLocal_582 != 0)
			{
			...
			switch (iVar1)
			{
				...
				case 3014:
					...
					else if (!unk_0x8AF8FB62F0BE628C(iVar7, false, true, 0, -1, 0))
					{
...
void func_18(int iParam0, int iParam1)
{
	...
	else if (func_28(unk_0x95B959F18401C09A(), iLocal_582, iParam0))
	{
		func_190(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (unk_0x8AF8FB62F0BE628C(func_19(iParam0, iLocal_582), false, true, 0, -1, 0))
	{
	...
	switch (iVar0)
	{
		...
		case 5:
			...
			if (unk_0xB331FCEB94EB05C8() && func_25())
			{
				...
				iVar5 = unk_0x36163153849DFDA1(&sVar4);
				if (unk_0x5333990AE9AEBC1F(iVar5))
				{
					iVar6 = unk_0x5B9C00971544AAA9(iVar5, 426439576, 1);
					return iVar6;
				}
			}
			switch (iParam0)
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_100(iParam1, iParam2, iParam3, unk_0x7C1C88877E8AAA50(iParam5), iParam4);
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_137(iParam1, iParam3, iParam4, unk_0x7C1C88877E8AAA50(iParam5), 0, 0, 0);
...
{
	iLocal_577 = iParam0;
	unk_0xBB698266C5FDF0A7(uLocal_753, "SHOW_OVERLAY");
...
void func_191(int iParam0, int iParam1)
{
	...
	if (iVar2 > 0 && !unk_0x8AF8FB62F0BE628C(iVar2, false, true, 0, -1, 0))
	{
...
int func_208(int iParam0)
{
	...
	if (unk_0xB331FCEB94EB05C8() && func_25())
	{
		...
		if (unk_0x5333990AE9AEBC1F(iVar2))
		{
			iVar3 = unk_0x5B9C00971544AAA9(iVar2, 426439576, 1);
...
void func_215(bool bParam0, int iParam1)
{
	...
	unk_0xF8600B0C544D4018(uLocal_753, "HIDE_OVERLAY");
	iLocal_572 = 0;
	if (bParam0)
	{
		switch (iLocal_577)
		{
			case 2001:
				if (iLocal_571)
				{
					unk_0xF8600B0C544D4018(uLocal_753, "SHOW_HOMEPAGE");
					iLocal_571 = 0;
				}
...
int func_219()
{
	...
	while (!func_8(&uVar1, 15000, 0))
	{
		...
		{
			if (unk_0x5487531DB7DA4AB5(1, iVar3) == 223)
			{
				if (unk_0x286A5F0670063839(1, iVar3, &vVar0, 7))
				{
...
void func_220(int iParam0, int iParam1)
{
	...
	iVar4 = unk_0x36163153849DFDA1(func_209(iParam0));
	...
	{
		unk_0xE5B884DE6E6FA75D(iVar3, iVar4, iVar5, iVar2);
	}
}
...
int func_275(int iParam0)
{
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			vVar8.x = unk_0x36163153849DFDA1(func_209(iLocal_582));
			vVar8.y = iVar6;
			vVar8.z = iParam0;
			unk_0xFF6DA45BDAD55783(iVar2, &vVar8, 0, 1);
		}
		iLocal_568 = 1;
		if (func_25())
		{
				...
				if (func_259(func_268()) == 2)
				{
					*uParam5 = 2;
					if (iParam4 != 0)
					{
						...
						{
							unk_0x68642A60A49B0D2B(iParam4, iParam8, 18, 1, false, 0, 0, iParam9, 0, true);
						}
					}
					func_224(func_268());
				}
...
{
	if (!func_28(unk_0x95B959F18401C09A(), iParam1, iParam0) && unk_0x8AF8FB62F0BE628C(func_19(iParam0, iParam1), false, true, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
void func_296()
{
	...
	iVar0 = func_423(iLocal_582);
	if (func_25() && func_422(unk_0x95B959F18401C09A(), iLocal_582) > 0)
	{
		iVar1 = func_269(1);
		iLocal_762 = 1;
		while (!func_258(iVar0, iVar1, &iLocal_765))
		...
		{
			iLocal_765 = 0;
			iVar2 = func_422(unk_0x95B959F18401C09A(), iLocal_582);
			...
			if (iLocal_765 == 2)
			{
				func_297(unk_0x95B959F18401C09A(), iLocal_582, 1, 0, 0, 0);
				func_420(iVar0, 0, 0);
			}
		}
	}
...
void func_326(int iParam0)
{
	...
	bVar4 = false;
	sVar5 = unk_0xE2B961C714AD503C(func_350(iVar0, 0));
	...
	iVar12 = func_422(unk_0x95B959F18401C09A(), iVar0);
	iVar13 = func_348(unk_0x95B959F18401C09A(), iVar0, iVar12);
	iVar14 = 0;
	iVar15 = 0;
	iVar16 = 0;
	iVar17 = 0;
	...
	if (func_7(unk_0x95B959F18401C09A(), iVar0))
	{
		...
		bVar4 = Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar8 /*12*/].f_4 > 0;
	...
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_753, "ADD_BUSINESS_STATS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	...
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_753, "SET_START_PRODUCTION_STATUS");
	unk_0x295B86DE57A0721D(bVar4);
	unk_0x818901B332D5541D();
}
...
int func_362(int iParam0, int iParam1, int iParam2)
{
	...
	iVar4 = ceil((to_float(func_208(iParam0)) * Global_262145.f_77));
	iVar0 = iVar4;
	...
	else
	{
		*iParam1 = func_423(iParam2);
		...
		if (iVar1 > 0)
		{
			if (!unk_0x8AF8FB62F0BE628C(iVar1, false, true, 0, -1, 0))
			{
	...
	vVar11.x = unk_0x36163153849DFDA1(func_209(iParam0));
	...
	if (iParam2 == 0 || iParam2 == 32)
	{
		...
		unk_0x54F6931BFE89203E(iVar4, &vVar11, 0, 1);
	}
	else if (func_328(iParam2) > 0)
	{
		...
		unk_0x06714A444AD32BE2(iVar4, &vVar11, 0, 1);
	}
	if (func_25())
	{
		func_224(func_268());
...
void func_382()
{
	...
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 206, 1);
	if (unk_0x833B1A3D9F713E03(2, 206))
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x33CAB544FAAE661D(2))
	{
		...
		{
			unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		unk_0xAE4810E427AD9203(2, 187, 1);
		if (unk_0x833B1A3D9F713E03(2, 187))
		{
			unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x1771F6BAF60B44FA(2, 187))
		{
			unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x1771F6BAF60B44FA(2, 188))
		{
			unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0x833B1A3D9F713E03(2, 188))
		{
			unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_574 = 1;
		}
		unk_0xAE4810E427AD9203(2, 187, 1);
		if (unk_0x833B1A3D9F713E03(2, 187))
		{
			unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_574 = 1;
		}
	}
	...
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 190, 1);
	if (unk_0x833B1A3D9F713E03(2, 190))
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 201, 1);
	if (unk_0x833B1A3D9F713E03(2, 201))
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 202, 1);
	if (unk_0x833B1A3D9F713E03(2, 202))
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	unk_0xAE4810E427AD9203(2, 204, 1);
	if (unk_0x833B1A3D9F713E03(2, 204))
	{
		unk_0x4A6DCCDF973E702F(uLocal_753, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x33CAB544FAAE661D(2))
	{
		unk_0xBB698266C5FDF0A7(uLocal_753, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			unk_0xBB698266C5FDF0A7(uLocal_753, "SET_ANALOG_STICK_INPUT");
			iLocal_758 = iVar0;
			iLocal_759 = iVar1;
			unk_0x295B86DE57A0721D(true);
			unk_0x4D9DA18AB3C2A466(iLocal_758);
			unk_0x4D9DA18AB3C2A466(iLocal_759);
			unk_0x818901B332D5541D();
			iLocal_574 = 1;
		}
	}
...
void func_383()
{
	...
	unk_0x5C58D0ADA22491FA(1);
	unk_0xFF524AE40FB6301A(uLocal_753, 255, 255, 255, 255, 0);
	func_390();
	func_387(0);
	func_384(1);
}
...
void func_431()
{
	...
	if (func_448())
	{
		...
		if (!func_17(iLocal_582))
		{
			iVar3 = func_348(unk_0x95B959F18401C09A(), iLocal_582, func_422(unk_0x95B959F18401C09A(), iLocal_582));
			fVar4 = (to_float(iVar3) * Global_262145.f_18468);
			iVar5 = round(fVar4);
			func_438(func_237(iLocal_582), &cVar7, &sVar6);
			func_437(iVar1, 1, &sVar6, &cVar7, iVar5, 1);
			func_438(!func_237(iLocal_582), &cVar7, &sVar6);
			fVar4 = (to_float(iVar3) * Global_262145.f_18469);
			iVar5 = round(fVar4);
		...
		while (iVar8 < 12)
		{
			...
			if (func_28(unk_0x95B959F18401C09A(), iLocal_582, iVar9) || Global_1589819[unk_0x95B959F18401C09A() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
			{
				bVar10 = false;
			}
...
{
	unk_0xBB698266C5FDF0A7(uLocal_753, "ADD_BUSINESS_UPGRADE");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
	unk_0x86B03D46DC28E3ED(sParam2);
	unk_0x4D9DA18AB3C2A466(iParam3);
	unk_0x86B03D46DC28E3ED(sParam6);
	unk_0x4D9DA18AB3C2A466(iParam4);
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_753, "SET_BUSINESS_UPGRADE_STATUS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
...
{
	unk_0xBB698266C5FDF0A7(uLocal_753, "ADD_BUSINESS_BUYER");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
	unk_0x86B03D46DC28E3ED(sParam2);
	unk_0x86B03D46DC28E3ED(sParam3);
	unk_0x4D9DA18AB3C2A466(iParam4);
	unk_0x818901B332D5541D();
	unk_0xBB698266C5FDF0A7(uLocal_753, "SET_BUSINESS_BUYER_STATUS");
	unk_0x4D9DA18AB3C2A466(iParam0);
	unk_0x4D9DA18AB3C2A466(iParam1);
	unk_0x295B86DE57A0721D(bParam5);
	unk_0x818901B332D5541D();
...
void func_439(bool bParam0)
{
	...
	sVar0 = func_441(unk_0x95B959F18401C09A());
	if (unk_0x786AF4A44E1B5B4B(sVar0))
	{
		sVar0 = func_440();
	}
	unk_0xBB698266C5FDF0A7(uLocal_753, "SET_PLAYER_DATA");
	unk_0x86B03D46DC28E3ED(sVar0);
...
void func_449(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (unk_0xC4DEA49C5B465481(iParam0) && (unk_0xF272A2699B521CE6(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				if (!func_453(iVar25) && !unk_0x67E42C11097164BA(iVar25))
				{
					if (!bVar21)
					{
...
void func_468(int iParam0)
{
	...
	unk_0x83A1D480DB0B52CC(&uLocal_753);
	func_462(iParam0);
	func_464(0);
	func_472();
