...
int func_20(int iParam0, int iParam1)
{
	...
	while (func_21(&Var7, iParam1, iVar6, 0))
	{
		...
		if (unk_0xCC2C88B9353CAF70(iParam0, iParam1, Var7))
		{
			if (Var7.f_4 == joaat("WAPClip"))
			{
				iVar5 = Var7.f_6;
	...
	if (unk_0x3DB36A480526EEDA(iParam1) > 0 && unk_0x4A37FD3869B2D716(iParam0, iParam1) == 0)
	{
		return 0;
	}
	return 1;
...
int func_22(int iParam0, int iParam1)
{
	...
	if (unk_0xB331FCEB94EB05C8() && func_66())
	{
		...
		func_60(&sVar10, Var11, unk_0x541D5C57194E73C4(unk_0x33CD235DF1E6A94E()), 3, 1, func_62(iParam0), func_61(iParam0), -1, 0, 0);
...
{
	return (shift_right(iParam0, 26) & 31 * func_36(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
bool func_74(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x0E4018692D92041D(iVar0, func_75(iVar1));
}
...
void func_87(int iParam0, var uParam1)
{
	...
	if (!unk_0xBC2FC12AD0FBF72E(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x7D8E16FB3C783D5E(iParam0, func_90(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x078B659F6F2C8960(iVar5, &Var7) && !func_88(Var7.f_1)) && iVar9 < 51)
			{
...
int func_118(bool bParam0)
{
	...
	unk_0x75D54ED6C1AD1642(joaat("num_discipline_gold_earned"), &iVar3, -1);
	if (iVar1 > iVar3 && iVar1 > 0)
	{
		unk_0x12B6E23F244DDB0F(joaat("num_discipline_gold_earned"), iVar1, 1);
		func_132(17, iVar1);
	}
	if (bParam0)
	{
...
void func_148()
{
	...
	if (unk_0xD62C4419A41F106A(unk_0x33CD235DF1E6A94E(), 0))
	{
		iVar0 = unk_0x7A521F1FC4CDF679(unk_0x33CD235DF1E6A94E());
