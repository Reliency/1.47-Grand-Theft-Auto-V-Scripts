	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				unk_0x74E9D455686E1F3A(unk_0x33CD235DF1E6A94E(), uParam0->f_29.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = unk_0x3F2F21BCB3761848(uParam0->f_29.f_1);
			if (unk_0xDB4C79A9697E6A55(iVar7))
			{
				if (unk_0x4EDDCE9AAE0FC976(iVar7) >= 1f)
				{
					...
					func_39(uParam0, &sVar1);
					uParam0->f_29.f_1 = unk_0x6D57E93CB68152FE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0x74E9D455686E1F3A(unk_0x33CD235DF1E6A94E(), uParam0->f_29.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0x930FB6CDE4B41DD2(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 8:
			iVar8 = unk_0x3F2F21BCB3761848(uParam0->f_29.f_1);
...
{
	return unk_0xD4B4F68F3449CBEC(iParam0, 362.0188f, 4823.182f, -59.98693f, 374.756f, 4823.096f, -56.23059f, 9f, 0, 1, 0);
}
