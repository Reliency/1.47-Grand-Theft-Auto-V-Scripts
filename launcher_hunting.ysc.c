...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0x12772FC739A13F81(joaat("weapon_sniperrifle"));
	iLocal_55 = unk_0x70418C66CB4C3F79(joaat("component_at_scope_large"));
	iLocal_56 = unk_0x70418C66CB4C3F79(joaat("component_at_ar_supp_02"));
	...
	unk_0xCE04CE961AF41AB9(vVar1, 3f, 1, 0, 0, false);
	while (true)
	{
		wait(0);
		if (!func_195(&Var0, 1))
		...
		if (func_167(&Var0, 0) && unk_0x7EECA16E87982278((vVar1.z - vVar3.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_258(&Var0, 1);
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0x33CD235DF1E6A94E()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xE3903F59E2F22150() - iParam0->f_60) > iParam6) && func_186(unk_0x33CD235DF1E6A94E(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_187(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()))
	{
		if (!unk_0x786AF4A44E1B5B4B(sParam1))
		{
			...
			{
				if (func_186(unk_0x33CD235DF1E6A94E(), vParam2, 1) <= 100f)
				{
					func_190(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_186(unk_0x33CD235DF1E6A94E(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_198(uParam1) || !unk_0x1CE8F0A08E65CA6A(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_198(uParam1) && uParam1->f_4 == 0) && unk_0x16E00F066AFFEA0D(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_213(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_215(unk_0xFBB1F99A825CAB09(iParam1, true) - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	...
	{
		vVar1 = { func_215(unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 5f, 0f) - unk_0x61B226C460A8FCC2(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_222(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_215(vParam1 - unk_0xFBB1F99A825CAB09(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_234(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				iLocal_58 = unk_0x99D60D17E2820498(joaat("weapon_sniperrifle"), 0, vLocal_57, 0, 1065353216, 0, 0, 1);
				unk_0x062CA5B6A29665F1(iLocal_58, joaat("component_at_scope_large"));
				unk_0x062CA5B6A29665F1(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			if (unk_0x8FCF53827AC6136E(vLocal_57, 1f, iLocal_54, 0))
			{
				unk_0x1C8705F667F673EA(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
