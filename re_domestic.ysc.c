...
void __EntryFunction__()
{
	...
	if (unk_0x9EC5BDC006623C42(11))
	{
		...
		{
			if (unk_0xE214B9FCEDF6364A(iLocal_54))
			{
				unk_0x5D94F4D6FE7DA516(iLocal_54);
			}
		}
		func_221();
	}
	...
	{
		wait(0);
		if ((unk_0xA80721FDC3BDCCDB() || iLocal_47 == 4) || iLocal_60 > 18)
		{
			if (!func_174())
			{
				if (func_173())
					...
					case 1:
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if (!iLocal_81)
								{
									if ((unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, false, true, 0) && unk_0x73E7A21FD53144AB(vLocal_86, 1f)) || unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_86, 20f, 20f, 20f, false, true, 0))
									{
										func_144();
										func_135(1);
										iLocal_81 = 1;
								...
								{
									if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_86, 50f, 50f, 50f, false, true, 0))
									{
										func_133();
									}
									if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
									{
										if (!unk_0x18FB647D79B09657(iLocal_54, vLocal_57, 30f, 30f, 30f, false, true, 0))
										{
											iLocal_47 = 11;
										}
									}
							...
							case 4:
								...
								if (!iLocal_71)
								{
									if (func_51())
									{
										if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_88, 23f, 60f, 20f, false, true, 0))
										{
											func_56(0);
											func_54();
											wait(0);
						...
						{
							if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "f_attack_end", 3))
							{
						...
						if ((func_47() && !func_46()) && iLocal_46 != 2)
						{
							if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
							{
								if (unk_0x18FB647D79B09657(iLocal_54, vLocal_90, 5f, 5f, 5f, false, true, 0))
								{
									if (!unk_0x765F6FEEFF39224F(iLocal_91[8]))
									{
										iLocal_91[8] = unk_0x7CA67831169E8AA6(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, true, true, false);
										unk_0x2F0A6390D863D337(iLocal_91[8], iLocal_54, unk_0xFCAF61876D23D31D(iLocal_54, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
									}
									func_45(0);
									wait(0);
									func_54();
...
void func_1()
{
	...
	if (iLocal_109 && !iLocal_108)
	{
		...
		if (unk_0x765F6FEEFF39224F(iLocal_91[8]))
		{
			iLocal_92 = unk_0x3B3AEF3A73FB80C9(joaat("pickup_weapon_golfclub"), unk_0xFBB1F99A825CAB09(iLocal_91[8], true), unk_0x60B5C1FD066CB864(iLocal_91[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
			unk_0xEC26F4BFC9942A0C(&(iLocal_91[8]));
		}
		unk_0x5856B9BF2B4E98C4(vLocal_57 - Vector(10f, 10f, 10f), vLocal_57 + Vector(10f, 10f, 10f), true, 1);
		unk_0xD2E80177F27FD43F(255, iLocal_111, 1862763509);
		if (bLocal_55)
		{
		...
		if (unk_0xE38E3CF1625A4145(uLocal_84[0]))
		{
			unk_0x1ABDB383C83A336A(&(uLocal_84[0]));
		}
		if (unk_0x765F6FEEFF39224F(iLocal_54))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (!unk_0xF0D230FB550CD6EB(iLocal_54, 0))
				{
					unk_0x69267F2BCC4CAF14(iLocal_54);
				}
				unk_0x5D94F4D6FE7DA516(iLocal_54);
				unk_0x4A852F02088ECC9D(iLocal_54, false);
				unk_0xF0BE7CB40DE62A2F(iLocal_54, true);
			}
		}
		iVar0 = 0;
		while (iVar0 < iLocal_91)
		{
			if (unk_0x765F6FEEFF39224F(iLocal_91[iVar0]))
			{
				unk_0x35F11A916FDFCF32(iLocal_91[iVar0], 1, true);
			}
			iVar0++;
		}
	...
	if ((!unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_57, 80f, 80f, 80f, false, true, 0) || unk_0xC52B92C972695208(iLocal_92)) || !(unk_0x765F6FEEFF39224F(iLocal_91[8]) && !unk_0xECCFCAB0A094EB5B(iLocal_92)))
	{
		func_221();
	}
}
...
int func_44()
{
	if (unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0xBC2FC12AD0FBF72E(iLocal_54))
	{
		return 1;
	}
	return 0;
...
int func_51()
{
	...
	{
		iLocal_110 = unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0);
		if (unk_0x91D5C8283D19AF49(iLocal_110, 0))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (unk_0xEE984ED4E4A374BE(iLocal_54, iLocal_110))
				{
					return 1;
				}
			}
...
void func_56(bool bParam0)
{
	...
	else if ((!iLocal_63 && unk_0x12BF789190D82474()) && !func_61())
	{
		Local_65 = { func_60() };
		Local_64 = { func_59() };
		func_57();
...
void func_75()
{
	switch (iLocal_62)
	{
		case 0:
			...
			{
				unk_0xA9E472293522522F(iLocal_54, 1f);
				if (unk_0x335C0645074963FE(iLocal_54, unk_0x33CD235DF1E6A94E(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (iLocal_60 < 19)
					{
		...
		case 1:
			...
			if (unk_0x765F6FEEFF39224F(iLocal_54))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
				{
					...
					{
						if (unk_0x707FFB0E65C1C546(iLocal_54))
						{
							unk_0xEC26F4BFC9942A0C(&(iLocal_91[8]));
						}
					}
					if (unk_0x5C415D10D5CBF689(iLocal_54))
					{
						func_120();
						func_114();
		...
		case 2:
			...
			if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), vLocal_88, 10f, 10f, 10f, false, true, 0))
			{
			...
			if (unk_0x765F6FEEFF39224F(iLocal_54))
			{
				if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
				{
					if (unk_0x18FB647D79B09657(iLocal_54, vLocal_88, Global_19, true, true, 0) && func_110(1, 0, 1))
					{
						...
						if (unk_0xF0D230FB550CD6EB(iLocal_54, 0))
						{
							unk_0xA4DF1E31BCDF9978(unk_0xF2C96862595654B4(iLocal_54, 0), 10.5f, 3, 0);
							iLocal_62++;
						}
						else
						{
	...
	switch (iLocal_102)
	{
		...
		case 3:
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				...
				iLocal_103 = unk_0xE3903F59E2F22150() + 1000;
				iLocal_102++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_103 < unk_0xE3903F59E2F22150())
			{
				...
				{
					unk_0x3449EA232F9B8EAD(unk_0x95B959F18401C09A(), true, 0);
					iLocal_103 = unk_0xE3903F59E2F22150() + 3000;
					iLocal_102++;
				}
			}
			break;
...
void func_111()
{
	...
	if (!func_150())
	{
		switch (iLocal_100)
		{
			...
			case 6:
				iLocal_101 = unk_0xE3903F59E2F22150() + 1000;
				iLocal_100++;
				break;
			
			case 7:
				if (iLocal_101 < unk_0xE3903F59E2F22150())
				{
					if (func_53() == 0)
					{
			...
			case 13:
				iLocal_101 = unk_0xE3903F59E2F22150() + 600;
				iLocal_100++;
				break;
			...
			case 17:
				iLocal_101 = unk_0xE3903F59E2F22150() + 800;
				iLocal_100++;
				break;
...
void func_112()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
	{
		if (!iLocal_66)
		{
			...
			{
				if (!unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), unk_0x8918EC905FC8975D(), 1) && unk_0x10930B9CAD4111C2(iLocal_54, unk_0x8918EC905FC8975D(), 0))
				{
					func_56(0);
					func_54();
					wait(0);
		...
		{
			if (unk_0x10930B9CAD4111C2(unk_0x33CD235DF1E6A94E(), unk_0x8918EC905FC8975D(), 0) && unk_0x10930B9CAD4111C2(iLocal_54, unk_0x8918EC905FC8975D(), 0))
			{
				iLocal_66 = 0;
			}
		}
...
void func_113()
{
	...
	if ((iLocal_96 - iLocal_95) > 60000)
	{
		...
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
		{
			if (unk_0x18FB647D79B09657(iLocal_54, vLocal_89, 200f, 200f, 200f, false, true, 0))
			{
				unk_0x7E268975AF5EA74F(iLocal_54, vLocal_89, 1f, -1, 1048576000, 0, 1193033728);
			}
			else
			{
...
void func_114()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
	{
		if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 8f, 8f, 8f, 0, 1, 0) || unk_0x0281F3C55C2638AC(unk_0x33CD235DF1E6A94E()))
		{
			if ((unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 0) && !unk_0xF0D230FB550CD6EB(iLocal_54, 0)) && !unk_0x0281F3C55C2638AC(unk_0x33CD235DF1E6A94E()))
			{
				if (!unk_0xE38E3CF1625A4145(uLocal_84[0]))
				{
...
int func_116(vector3 vParam0, bool bParam1)
{
	...
	unk_0xCE5C49921A521962(iVar0, func_117(unk_0xB331FCEB94EB05C8(), 1f, 1f));
...
int func_119(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xCE5C49921A521962(iVar0, func_117(unk_0xB331FCEB94EB05C8(), 0.7f, 0.7f));
		unk_0xBF11C8A43770C598(iVar0, bParam1);
	}
...
void func_120()
{
	...
	while (iVar0 < iLocal_91)
	{
		unk_0x26ABAE1D971CEACD(&(iLocal_91[iVar0]));
		iVar0++;
	}
	...
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
	{
		if (unk_0xF0D230FB550CD6EB(unk_0x33CD235DF1E6A94E(), 1))
		{
			if (!func_125())
			{
				...
				if (unk_0xD76D6BCC14B95CE1(iLocal_54, 1227113341) != 1 && unk_0xD76D6BCC14B95CE1(iLocal_54, 1227113341) != 0)
				{
					unk_0x3C0F6044C54799A8(iLocal_54, unk_0x33CD235DF1E6A94E(), -1, 6f, 2f, 1073741824, 0);
				}
				if (unk_0xF0D230FB550CD6EB(iLocal_54, 0))
				{
					unk_0x07C339D4328CA16C(iLocal_54, 0, 0);
				}
				if (!iLocal_73)
				{
					func_56(0);
		...
		else if (!unk_0xE214B9FCEDF6364A(iLocal_54))
		{
			unk_0x140D4A6561E11695(iLocal_54, func_123());
			unk_0xDD02EC6C22FD1487(iLocal_54, 1);
			unk_0x9AA80CA39F863D9D(iLocal_54, 0);
		}
	}
}
...
void func_126()
{
	switch (iLocal_61)
	{
		...
		case 2:
			...
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 12f, 12f, 5f, 0, 1, 2))
				{
					if (func_125())
					{
						unk_0xD2E80177F27FD43F(255, iLocal_111, 1862763509);
		...
		case 3:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54) && unk_0x765F6FEEFF39224F(iLocal_91[8]))
			{
				unk_0x99414FB2D30425C1(&iLocal_77);
				if (iLocal_60 > 18)
				{
				}
				unk_0x7E268975AF5EA74F(0, unk_0xFBB1F99A825CAB09(iLocal_91[8], true) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_128(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true), unk_0xFBB1F99A825CAB09(iLocal_91[8], true)));
		...
		case 4:
		case 5:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54) && !unk_0xD62C4419A41F106A(iLocal_91[8], 0))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_54, "random@domestic", "pickup_low", 3))
				{
					unk_0x6EB479EB6FF2894D(iLocal_54, iLocal_91[8], false);
					if (unk_0x204DEACC5BECF723(iLocal_54, "random@domestic", "pickup_low") > 0.388f)
					{
						iLocal_61 = 7;
					}
				}
				else if (timerb() > 10000 || unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), unk_0xFBB1F99A825CAB09(iLocal_91[8], true), 1.5f, 1.5f, 3f, false, true, 0))
				{
					if (!unk_0x9F4718FD61B07058(iLocal_91[8]))
					{
						unk_0x99414FB2D30425C1(&iLocal_77);
						unk_0x108754262311D34F(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0, 0, 0, 0);
						unk_0x108754262311D34F(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0, 0, 0, 0);
		...
		case 7:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (unk_0x335C0645074963FE(iLocal_54, unk_0x33CD235DF1E6A94E(), 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0x2F0A6390D863D337(iLocal_91[8], iLocal_54, unk_0xFCAF61876D23D31D(iLocal_54, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
					unk_0x140D4A6561E11695(iLocal_54, unk_0x733DE09777D47CD6(unk_0x95B959F18401C09A()));
					unk_0xDD02EC6C22FD1487(iLocal_54, 1);
					unk_0x9AA80CA39F863D9D(iLocal_54, 0);
					func_127();
					iLocal_47 = 4;
...
void func_130()
{
	if (!iLocal_80)
	{
		if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
		{
			if (unk_0x335C0645074963FE(iLocal_54, unk_0x33CD235DF1E6A94E(), 12f, 12f, 5f, 0, 1, 0))
			{
				unk_0xED68CDDDE25A144E(iLocal_54);
				unk_0x99414FB2D30425C1(&iLocal_77);
				...
				unk_0x13A2D602CD10CBAC(iLocal_54, iLocal_77);
				unk_0xA7A57E7757ED035E(&iLocal_77);
				unk_0xC4A347124F39D998(unk_0x33CD235DF1E6A94E(), iLocal_54, 15000, 0, 2);
				iLocal_80 = 1;
			}
		}
	}
			...
			if (bLocal_97)
			{
				if (bLocal_50)
				{
					...
					if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
					{
						if (!func_150())
						{
							if (unk_0x910FF514D7BC5674(iLocal_54, unk_0x33CD235DF1E6A94E(), 90f))
							{
...
void func_131()
{
	if (unk_0x765F6FEEFF39224F(iLocal_54))
	{
		if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 15f, 15f, 15f, 0, 1, 0))
		{
			if (func_132())
			{
				func_45(0);
...
void func_133()
{
	...
	{
		case 0:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54) && !unk_0xBC2FC12AD0FBF72E(iLocal_53))
			{
				if (unk_0x73E7A21FD53144AB(unk_0xFBB1F99A825CAB09(iLocal_53, true), 3f))
				{
					if (!func_150())
					{
						if (func_149(&uLocal_114, "REDO2AU", "REDO2_ARMA", 4, 0, 0, 0))
						{
							unk_0x108754262311D34F(iLocal_54, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							unk_0x108754262311D34F(iLocal_53, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							iLocal_60++;
						}
					}
				}
		...
		case 1:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0x765F6FEEFF39224F(iLocal_91[8]))
			{
				unk_0x2F0A6390D863D337(iLocal_91[8], iLocal_53, unk_0xFCAF61876D23D31D(iLocal_53, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				iLocal_60++;
			}
			break;
		...
		case 2:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0x765F6FEEFF39224F(iLocal_91[8]))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_53, "random@domestic", "balcony_fight_female") > 0.335f)
					{
						unk_0x35F11A916FDFCF32(iLocal_91[8], 0, true);
						unk_0x0848C95091F9ECB9(iLocal_91[8], 1, 0f, 6f, 4f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_60++;
					}
				}
			}
		...
		case 3:
			if (!iLocal_70 && unk_0x765F6FEEFF39224F(iLocal_91[8]))
			{
				if (unk_0x0D386FBDF1E8CD84(iLocal_91[8]))
				{
					unk_0xE9739440E5BF08EE(-1, "CLOTHES_THROWN", iLocal_91[8], "RE_DOMESTIC_SOUNDSET", false, 0);
					iLocal_70 = 1;
				}
			}
		...
		case 4:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0x765F6FEEFF39224F(iLocal_91[9]))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_53, "random@domestic", "balcony_fight_female") > 0.473f)
					{
						unk_0x2F0A6390D863D337(iLocal_91[9], iLocal_53, unk_0xFCAF61876D23D31D(iLocal_53, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_60++;
					}
				}
			}
		...
		case 6:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0x765F6FEEFF39224F(iLocal_91[9]))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_53, "random@domestic", "balcony_fight_female") > 0.55f)
					{
						unk_0x35F11A916FDFCF32(iLocal_91[9], 0, true);
						unk_0x0848C95091F9ECB9(iLocal_91[9], 1, 1f, 2f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_60++;
					}
				}
			}
		...
		case 7:
			if (!iLocal_70 && unk_0x765F6FEEFF39224F(iLocal_91[9]))
			{
				if (unk_0x0D386FBDF1E8CD84(iLocal_91[9]))
				{
					unk_0xE9739440E5BF08EE(-1, "CLOTHES_THROWN", iLocal_91[9], "RE_DOMESTIC_SOUNDSET", false, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_150() || func_132())
		...
		case 8:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0x765F6FEEFF39224F(iLocal_91[10]))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_53, "random@domestic", "balcony_fight_female") > 0.705f)
					{
						unk_0x2F0A6390D863D337(iLocal_91[10], iLocal_53, unk_0xFCAF61876D23D31D(iLocal_53, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_60++;
					}
				}
			}
		...
		case 9:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && unk_0x765F6FEEFF39224F(iLocal_91[10]))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_53, "random@domestic", "balcony_fight_female") > 0.838f)
					{
						unk_0x35F11A916FDFCF32(iLocal_91[10], 0, true);
						unk_0x0848C95091F9ECB9(iLocal_91[10], 1, 1f, 3f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_60++;
					}
				}
			}
		...
		case 10:
			if (!iLocal_70 && unk_0x765F6FEEFF39224F(iLocal_91[10]))
			{
				if (unk_0x0D386FBDF1E8CD84(iLocal_91[10]))
				{
					unk_0xE9739440E5BF08EE(-1, "CLOTHES_THROWN", iLocal_91[10], "RE_DOMESTIC_SOUNDSET", false, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_150() || func_132())
		...
		case 11:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_53) && !unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (unk_0x1CE8F0A08E65CA6A(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x204DEACC5BECF723(iLocal_53, "random@domestic", "balcony_fight_female") > 0.94f)
					{
						unk_0x11C4AF4137F2A4B5(iLocal_53, iLocal_54, 0);
					}
				}
			}
			if (!func_150() || func_132())
		...
		case 16:
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				...
				unk_0x9F878FE3F23E2C8B(0, vLocal_87, 0);
				unk_0xC734F59A13D39AEF(iLocal_77);
				unk_0x13A2D602CD10CBAC(iLocal_54, iLocal_77);
				unk_0xA7A57E7757ED035E(&iLocal_77);
				iLocal_60++;
		...
		case 17:
			if (unk_0x765F6FEEFF39224F(iLocal_53))
			{
				...
				{
					if (unk_0x18FB647D79B09657(iLocal_53, vLocal_87, 1f, 1f, 5f, false, true, 0) && unk_0xC30D5C4DCAC8020A(iLocal_53))
					{
						unk_0x4B8B69DAE5BAC592(&iLocal_53);
					}
				}
			}
			if (iLocal_75 < unk_0xE3903F59E2F22150())
			{
				if (!func_150())
				{
					if (func_149(&uLocal_114, "REDO2AU", "REDO2_INS1", 4, 0, 0, 0))
					{
						iLocal_75 = unk_0xE3903F59E2F22150() + 5000;
						iLocal_76++;
					}
				}
			}
	...
	if (!bLocal_50)
	{
		if (iLocal_60 > 2 && iLocal_60 < 8)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 6f, 4f, 5f, 0, 1, 0) || (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 12f, 12f, 5f, 0, 1, 2) && unk_0x1578197A616E70FA(unk_0x95B959F18401C09A())))
				{
					unk_0xED68CDDDE25A144E(iLocal_54);
					func_134();
					if (iLocal_60 > 18)
		...
		else if (iLocal_60 > 7)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				if (unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 6f, 8f, 5f, 0, 1, 0))
				{
					if (unk_0xE38E3CF1625A4145(uLocal_84[0]))
					{
						unk_0x983D75D9630FD905(uLocal_84[0], true);
					}
					unk_0xED68CDDDE25A144E(iLocal_54);
					func_134();
					if (iLocal_60 > 18)
	...
	if (bLocal_52)
	{
		if (iLocal_51 < unk_0xE3903F59E2F22150())
		{
			func_57();
			if (unk_0x765F6FEEFF39224F(iLocal_53))
			{
...
void func_134()
{
	...
	{
		unk_0x99414FB2D30425C1(&iLocal_77);
		unk_0x2A25AECBD792A364(0, vLocal_87, 1f, -1, 1193033728, 1056964608);
...
void func_144()
{
	...
	{
		uLocal_84[0] = func_118(iLocal_54, 0, 145);
		unk_0x983D75D9630FD905(uLocal_84[0], false);
	}
}
...
void func_145()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	unk_0xCE04CE961AF41AB9(vLocal_57, 2f, 1, 0, 0, false);
	unk_0xCE04CE961AF41AB9(vLocal_56, 2f, 1, 0, 0, false);
	unk_0x5856B9BF2B4E98C4(vLocal_57 - Vector(10f, 10f, 10f), vLocal_57 + Vector(10f, 10f, 10f), false, 1);
	unk_0xAF9EA4E314ED45C2(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 0, false, 1);
	unk_0x0335D8135051EA56(vLocal_57 - Vector(10f, 10f, 10f), vLocal_57 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	unk_0x0335D8135051EA56(vLocal_88 - Vector(3f, 2f, 2f), vLocal_88 + Vector(3f, 2f, 2f), 0, 1, 1, 1);
	...
	unk_0x9315FCF6CFE2AB41("rghDomestic", &iLocal_111);
	unk_0xD2E80177F27FD43F(5, iLocal_111, 1862763509);
	iLocal_53 = unk_0x9BA5CF280376EEA4(26, iLocal_78, vLocal_56, fLocal_58, 1, true);
	unk_0x4A852F02088ECC9D(iLocal_53, true);
	unk_0x28F648743D7DE312(iLocal_53, 17, true);
	unk_0x28F648743D7DE312(iLocal_53, 8, false);
	unk_0x33F6BE48E356DA27(iLocal_53, 1, false);
	unk_0x33F6BE48E356DA27(iLocal_53, 2, false);
	unk_0x33F6BE48E356DA27(iLocal_53, 128, true);
	unk_0x33F6BE48E356DA27(iLocal_53, 8, false);
	unk_0x108754262311D34F(iLocal_53, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x0648A75D3F60E864(iLocal_53, iLocal_111);
	func_148(iLocal_53, "GENERIC_WHATEVER", 24);
	unk_0x71CA80D41E1338B4(iLocal_78);
	unk_0x5FEE418CE11E6DDE(iLocal_53, 185, true);
	iLocal_54 = unk_0x9BA5CF280376EEA4(26, iLocal_79, vLocal_57, fLocal_59, 1, true);
	unk_0x4A852F02088ECC9D(iLocal_54, true);
	unk_0x33F6BE48E356DA27(iLocal_54, 1, true);
	unk_0x33F6BE48E356DA27(iLocal_54, 2, false);
	unk_0x33F6BE48E356DA27(iLocal_54, 128, true);
	unk_0x33F6BE48E356DA27(iLocal_54, 8, false);
	unk_0x33F6BE48E356DA27(iLocal_54, 65536, true);
	unk_0x5FEE418CE11E6DDE(iLocal_54, 185, true);
	unk_0x5FEE418CE11E6DDE(iLocal_54, 206, true);
	unk_0x2B4A2E9ED65D5C93(iLocal_54, 0);
	unk_0xF0BE7CB40DE62A2F(iLocal_54, false);
	unk_0x108754262311D34F(iLocal_54, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x0648A75D3F60E864(iLocal_54, iLocal_111);
	func_148(iLocal_54, "GENERIC_WHATEVER", 24);
	unk_0x71CA80D41E1338B4(iLocal_79);
	unk_0xC4A347124F39D998(iLocal_54, iLocal_53, -1, 0, 2);
	unk_0xC4A347124F39D998(iLocal_53, iLocal_54, -1, 0, 2);
	unk_0x93AA93DA1B137032(iLocal_53, 0, 1, 0, 0);
	unk_0x93AA93DA1B137032(iLocal_53, 2, 1, 1, 0);
	unk_0x93AA93DA1B137032(iLocal_53, 3, 1, 1, 0);
	unk_0x93AA93DA1B137032(iLocal_53, 4, 1, 2, 0);
	unk_0x93AA93DA1B137032(iLocal_54, 0, 0, 0, 0);
	unk_0x93AA93DA1B137032(iLocal_54, 2, 1, 0, 0);
	unk_0x93AA93DA1B137032(iLocal_54, 3, 1, 2, 0);
	unk_0x93AA93DA1B137032(iLocal_54, 4, 1, 1, 0);
	unk_0x93AA93DA1B137032(iLocal_54, 8, 0, 0, 0);
	func_147();
	unk_0x8950ED5730F62EE8(&uLocal_93, 5);
	if (func_53() == 0)
	{
		func_146(&uLocal_114, 0, unk_0x33CD235DF1E6A94E(), "MICHAEL", 0, 1);
	}
	if (func_53() == 1)
	{
		func_146(&uLocal_114, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
	}
	if (func_53() == 2)
	{
		func_146(&uLocal_114, 2, unk_0x33CD235DF1E6A94E(), "TREVOR", 0, 1);
	}
	func_146(&uLocal_114, 3, iLocal_54, "REDOCastro", 0, 1);
	unk_0x5464B9731013E08C(iLocal_54, sLocal_112);
	func_146(&uLocal_114, 4, iLocal_53, "NATHALIA", 0, 1);
	unk_0x5464B9731013E08C(iLocal_53, sLocal_113);
	settimera(0);
	iLocal_109 = 1;
}
...
void func_147()
{
	iLocal_91[0] = unk_0x7CA67831169E8AA6(joaat("prop_ld_tshirt_02"), -470.3661f, 541.385f, 120.0205f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[0], -13.7262f, 0.5001f, -0.5886f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[0], true);
	unk_0x71CA80D41E1338B4(joaat("prop_ld_tshirt_02"));
	iLocal_91[1] = unk_0x7CA67831169E8AA6(joaat("prop_ld_jeans_02"), -470.8998f, 540.7595f, 120.169f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[1], -7.3906f, -12.8136f, -63.733f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[1], true);
	unk_0x71CA80D41E1338B4(joaat("prop_ld_jeans_02"));
	iLocal_91[2] = unk_0x7CA67831169E8AA6(joaat("prop_ld_shoe_01"), -468.3266f, 540.7725f, 120.1762f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[2], -7.041683f, 10.17298f, 45.7617f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[2], true);
	unk_0x71CA80D41E1338B4(joaat("prop_ld_shoe_01"));
	iLocal_91[3] = unk_0x7CA67831169E8AA6(joaat("prop_ld_jeans_01"), -468.7787f, 541.864f, 119.9098f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[3], -8.5884f, 12.6893f, 57.1792f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[3], true);
	unk_0x71CA80D41E1338B4(joaat("prop_ld_jeans_01"));
	iLocal_91[4] = unk_0x7CA67831169E8AA6(joaat("prop_ld_shoe_02"), -470.9009f, 541.2538f, 120.0578f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[4], -16.4886f, 2.4979f, -3.8769f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[4], true);
	unk_0x71CA80D41E1338B4(joaat("prop_ld_shoe_02"));
	iLocal_91[5] = unk_0x7CA67831169E8AA6(joaat("prop_ld_shirt_01"), -472.0366f, 542.0591f, 119.8243f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[5], -3.5946f, -15.0978f, -75.5026f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[5], true);
	unk_0x71CA80D41E1338B4(joaat("prop_ld_shirt_01"));
	iLocal_91[6] = unk_0x7CA67831169E8AA6(joaat("prop_porn_mag_03"), -472.7543f, 542.3022f, 119.7628f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[6], 6.402527f, -15.68665f, -104.1308f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[6], true);
	unk_0x71CA80D41E1338B4(joaat("prop_porn_mag_03"));
	iLocal_91[7] = unk_0x7CA67831169E8AA6(joaat("prop_porn_mag_01"), -471.8675f, 543.6655f, 119.4991f, true, true, false);
	unk_0x1C8705F667F673EA(iLocal_91[7], -8.3642f, 1.9344f, 2.6889f, 2, 1);
	unk_0xF70578F5CD9822CB(iLocal_91[7], true);
	unk_0x71CA80D41E1338B4(joaat("prop_porn_mag_01"));
	iLocal_91[8] = unk_0x7CA67831169E8AA6(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, true, true, false);
	iLocal_91[9] = unk_0x7CA67831169E8AA6(joaat("prop_cs_rub_binbag_01"), -473.195f, 537.2585f, 123.3303f, true, true, false);
	unk_0x71CA80D41E1338B4(joaat("prop_cs_rub_binbag_01"));
	iLocal_91[10] = unk_0x7CA67831169E8AA6(joaat("prop_golf_bag_01"), -473.4f, 536.8035f, 123.2482f, true, true, false);
...
void func_151()
{
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_54) && !unk_0xBC2FC12AD0FBF72E(iLocal_53))
	{
		...
		{
			if (unk_0xDAAA48CE50D80F52(iLocal_54, unk_0x33CD235DF1E6A94E()) || unk_0xDAAA48CE50D80F52(iLocal_53, unk_0x33CD235DF1E6A94E()))
			{
				if (((unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_54) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_54)) || unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), iLocal_53)) || unk_0xAC6A512C64D9A9C0(unk_0x95B959F18401C09A(), iLocal_53))
				{
					if (iLocal_94 == -1)
					{
			...
			if ((iLocal_94 != -1 && unk_0xE3903F59E2F22150() > iLocal_94 + 500) || unk_0x5DACF31D3AC5ED8D(unk_0x33CD235DF1E6A94E()))
			{
				func_158();
			}
		}
	...
	if (unk_0x18FB647D79B09657(unk_0x33CD235DF1E6A94E(), -471.1757f, 535.356f, 124.8557f, 3f, 2.5f, 1.5f, false, true, 0))
	{
		func_155();
	}
	if (unk_0x765F6FEEFF39224F(iLocal_53))
	...
	if (unk_0x765F6FEEFF39224F(iLocal_54))
	{
		if (func_154(iLocal_54) || unk_0x91BBD269506D61D2(iLocal_54, unk_0x33CD235DF1E6A94E(), 1))
		{
			func_152();
		}
	}
	if (unk_0x765F6FEEFF39224F(iLocal_53))
	{
		if (func_154(iLocal_53) || unk_0x91BBD269506D61D2(iLocal_53, unk_0x33CD235DF1E6A94E(), 1))
		{
			func_152();
		}
	}
	if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
	{
		if (!unk_0x335C0645074963FE(unk_0x33CD235DF1E6A94E(), iLocal_54, 250f, 250f, 250f, 0, 1, 0) || unk_0x8AE34E8B10270D31(iLocal_54))
		{
			iLocal_47 = 11;
		}
	}
...
void func_156()
{
	...
	{
		unk_0xED68CDDDE25A144E(iLocal_54);
		unk_0x6DA4DBA91F234052(iLocal_54, unk_0xFBB1F99A825CAB09(unk_0xF2C96862595654B4(unk_0x33CD235DF1E6A94E(), 0), true), 150f, -1, 0, 0);
		unk_0x897EF720254BBEA3(iLocal_54, true);
	}
	iLocal_47 = 11;
}
...
int func_161()
{
	if (unk_0xF272A2699B521CE6(unk_0x95B959F18401C09A()) && !unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
	{
		...
		if (vmag2(unk_0x43D8A2CCB19FE8A8(unk_0x33CD235DF1E6A94E())) > 1369f && !func_172())
		{
			return 0;
		}
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_192(unk_0x0E4018692D92041D(iParam0, 31), -1, 1)) + 2011;
}
...
void func_221()
{
	...
	if (iLocal_109 && !iLocal_108)
	{
		...
		if (unk_0x765F6FEEFF39224F(iLocal_54))
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_54))
			{
				unk_0x5FEE418CE11E6DDE(iLocal_54, 317, true);
				if (!unk_0xF0D230FB550CD6EB(iLocal_54, 0))
				{
					unk_0x69267F2BCC4CAF14(iLocal_54);
				}
