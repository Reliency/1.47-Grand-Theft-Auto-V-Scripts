	...
	while (iLocal_289 && func_127(2, 0))
	{
		...
		switch (iLocal_98)
		{
			...
			case 2:
				if (func_123())
				{
					func_122(&uLocal_100, 0, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
...
void func_3(int iParam0)
{
	...
	{
		if (!iLocal_369 && unk_0x91BBD269506D61D2(iParam0, unk_0x33CD235DF1E6A94E(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_100(75, unk_0xFBB1F99A825CAB09(iParam0, false), 250f, -1);
	...
	fVar4 = vdist2(unk_0xFBB1F99A825CAB09(iParam0, true), unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), true));
	if (fVar4 > (8f * 8f))
	{
		iLocal_367 = -1;
	}
	else if (unk_0x8B76D954998C9E96(iParam0))
	{
		iLocal_367 = -1;
	}
	else
	{
		...
		if (iLocal_367 > 0)
		{
			if (iLocal_368 == 0)
			{
				if (iLocal_367 + 15000 < unk_0xE3903F59E2F22150())
				{
			...
			else if (iLocal_367 + 10000 < unk_0xE3903F59E2F22150())
			{
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)
{
	...
	{
		if (unk_0x7EECA16E87982278((vVar1.z - vVar0.z)) > 2f)
		{
			return 0;
		}
	}
	else if (!unk_0x3F219400E5FE4B69(iParam0) || !unk_0x042B0E494045A7DF(iParam0))
	{
		return 0;
	}
	bVar5 = false;
	...
	if (!bVar5)
	{
		iVar6 = unk_0x90D54DCF679C0BBE(iParam0);
	...
	if (unk_0xEAF855A7DC28BC8D(&cVar7))
	{
		iVar8 = 1;
	}
	else
...
{
	if (unk_0x65F173513F5EF79C(sParam0, iParam1))
	{
		return 1;
	}
...
int func_26(char* sParam0, char* sParam1, var uParam2)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		while (iVar6 < *uParam2)
		{
			if (!unk_0x786AF4A44E1B5B4B(uParam2[iVar6 /*4*/]))
			{
				iVar7 = 0;
				while (iVar7 < Var3)
				{
					if (!unk_0x786AF4A44E1B5B4B(&(Var3[iVar7 /*4*/])))
					{
						if (unk_0xCE3CFF625BEBAA04(uParam2[iVar6 /*4*/], &(Var3[iVar7 /*4*/])))
						{
							iVar8 = iVar7;
							while (iVar8 <= (Var3 - 1))
							{
		...
		iVar9 = unk_0x9EC3B269A34A2BEE(0, iVar5 + 1);
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_80(Global_14534, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2430[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
int func_115(int iParam0, int iParam1)
{
	...
	if (unk_0x765F6FEEFF39224F(*iParam0))
	{
		...
		{
			case 0:
				if (unk_0x1CE8F0A08E65CA6A(*iParam0, &cLocal_349, &(Local_359[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_366;
					fVar2 = -1f;
					fVar3 = -1f;
					if (unk_0x5D19BF64E3AC6863(&cLocal_349, &(Local_359[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (unk_0x4EDDCE9AAE0FC976(Global_91042) > fVar1)
					{
						...
						if (unk_0xBC2FC12AD0FBF72E(*iParam0))
						{
							...
							unk_0x2A25AECBD792A364(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
							unk_0x13C3FE558ED056EE(*iParam0, -668482597, false, 1, 0);
							unk_0x880B00F3FAE4C022(*iParam0, 0, 0);
							unk_0x45C6E26B40E7F5EF(*iParam0, 2);
						}
						wait(0);
						iLocal_292[iParam1] = 1;
						return 1;
			...
			case 1:
				if (unk_0xD76D6BCC14B95CE1(*iParam0, 2106541073) != 1)
				{
					unk_0x7E268975AF5EA74F(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_292[iParam1] = 2;
					return 1;
				}
				fVar5 = vmag(vLocal_298[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), vLocal_295) >= fVar5)
				{
					if (!func_120() && !unk_0x3F219400E5FE4B69(*iParam0))
					{
						unk_0x7E268975AF5EA74F(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
						iLocal_292[iParam1] = 2;
						return 1;
				...
				if (unk_0xC2ECB90E2DFA5802(unk_0x95B959F18401C09A(), *iParam0) || unk_0x71E0DAA57FE7D5C7(*iParam0, 0))
				{
			...
			case 2:
				...
				if (unk_0xD76D6BCC14B95CE1(*iParam0, 713668775) != 1)
				{
					...
					unk_0x126A03BD41622048(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (unk_0xC69DD20C20C463E6(sLocal_365))
				{
					unk_0xCC323859A8DA2B88(sLocal_365, false);
				}
				if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), vLocal_295 + vLocal_298[iParam1 /*3*/]) < (fLocal_300[iParam1] * fLocal_300[iParam1]))
				{
					if (unk_0x89F20C4A841A3473(vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1))
					{
						unk_0xA9128AA30F3036C7(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					if (unk_0xD76D6BCC14B95CE1(*iParam0, 1647992574) == 1)
					{
					}
					else if (unk_0xFC05F8C42B023B2E(vVar6, 0, &vVar7, 14))
					{
						if (vdist2(unk_0xFBB1F99A825CAB09(*iParam0, true), vVar7) > 100f)
						{
							unk_0x7E268975AF5EA74F(*iParam0, vVar7, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_292[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				unk_0xD2E80177F27FD43F(5, iLocal_293, 1862763509);
				unk_0xD2E80177F27FD43F(5, 1862763509, iLocal_293);
				unk_0xD2E80177F27FD43F(5, iLocal_293, Global_88716);
				unk_0xD2E80177F27FD43F(5, Global_88716, iLocal_293);
				unk_0x77631BBB824DF500(*iParam0, 15f, 0);
...
Vector3 func_116(vector3 vParam0, float fParam1, float fParam2)
{
	...
	while (iVar3 < 10)
	{
		vVar0 = { unk_0x9562E33C057F7589(-fParam1, fParam1), unk_0x9562E33C057F7589(-fParam1, fParam1), 0f };
		if (((vVar0.x * vVar0.x) + (vVar0.y * vVar0.y)) <= fVar1)
		{
			fVar2 = (fParam2 / 2f);
			vVar0.z = unk_0x9562E33C057F7589(-fVar2, fVar2);
...
Vector3 func_117(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_118(vVar0, unk_0x9562E33C057F7589(0f, fParam1)) };
	...
	if (!func_124())
	{
		if (unk_0xDB4C79A9697E6A55(Global_91042))
		{
			...
			while (iVar0 < iLocal_290)
			{
				...
				{
					unk_0x08798CBF817BA887(iLocal_290[iVar0], Global_91042, &cLocal_349, &(Local_359[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_292[iVar0] = 0;
				}
				else
				{
...
int func_126()
{
	...
	if (unk_0xDB4C79A9697E6A55(Global_91041))
	{
		...
		while (iVar0 < iLocal_290)
		{
			if (!unk_0xBC2FC12AD0FBF72E(iLocal_290[iVar0]))
			{
				unk_0x08798CBF817BA887(iLocal_290[iVar0], Global_91041, &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!unk_0xBC2FC12AD0FBF72E(unk_0x33CD235DF1E6A94E()))
		{
			func_122(&uLocal_100, 1, unk_0x33CD235DF1E6A94E(), "FRANKLIN", 0, 1);
		}
...
void func_135()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_290)
		{
			...
			{
				unk_0xB815670C37E03CDE(iLocal_291[iVar0]);
				if (!unk_0x5D98D654CDC2165A(iLocal_291[iVar0]))
				{
					bVar2 = false;
					unk_0xB815670C37E03CDE(iLocal_291[iVar0]);
				}
		...
		if (!unk_0x786AF4A44E1B5B4B(&cLocal_349))
		{
			unk_0x0483D0035D6E46FD(&cLocal_349);
			if (!unk_0xE9CCF312047EBEE0(&cLocal_349))
			{
				bVar2 = false;
				unk_0x0483D0035D6E46FD(&cLocal_349);
			}
	...
	if (unk_0x765F6FEEFF39224F(Global_93403))
	{
		...
		{
			unk_0x0D21E1FDE062ED99(Global_93403, true, 1);
		}
		func_136(&Global_93403, Global_88716);
		unk_0x5FEE418CE11E6DDE(Global_93403, 132, true);
		unk_0x5FEE418CE11E6DDE(Global_93403, 317, true);
		func_136(&Global_93403, Global_88716);
	}
	unk_0x9315FCF6CFE2AB41("TAUNTERS", &iLocal_293);
	iVar0 = 0;
	while (iVar0 < iLocal_290)
	{
		if (iLocal_291[iVar0] != 0)
		{
			iLocal_290[iVar0] = unk_0x9BA5CF280376EEA4(iLocal_294, iLocal_291[iVar0], vLocal_295 + vLocal_297[iVar0 /*3*/], 0f, 1, true);
			unk_0x3C990C409B3845DE(iLocal_290[iVar0], (fLocal_296 + fLocal_299[iVar0]));
			unk_0xC475906893AEB995(iLocal_290[iVar0], 0);
			unk_0x0648A75D3F60E864(iLocal_290[iVar0], iLocal_293);
			unk_0x108754262311D34F(iLocal_290[iVar0], &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			unk_0x5FEE418CE11E6DDE(iLocal_290[iVar0], 317, true);
			if (iLocal_294 == 6)
			{
				unk_0x697EBA5CF1A6AB57(iLocal_290[iVar0], joaat("weapon_stungun"), 1000, false, true);
			}
		}
		iVar0++;
	}
...
void func_137()
{
	...
	{
		case 218:
			vLocal_297[0 /*3*/] = { unk_0x9562E33C057F7589(-10f, 10f), unk_0x9562E33C057F7589(-10f, 10f), 0f };
			vLocal_297[1 /*3*/] = { unk_0x9562E33C057F7589(-10f, 10f), unk_0x9562E33C057F7589(-10f, 10f), 0f };
			vLocal_298[0 /*3*/] = { -77.3f, -4.1f, 1f };
			vLocal_298[1 /*3*/] = { vLocal_298[0 /*3*/] };
			vLocal_298[iLocal_290 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_299[0] = unk_0x9562E33C057F7589(-180f, 180f);
			fLocal_299[1] = unk_0x9562E33C057F7589(-180f, 180f);
			fLocal_300[0] = 30f;
...
void func_148()
{
	...
	while (iVar0 < iLocal_291)
	{
		if (iLocal_291[iVar0] != 0)
		{
			unk_0x1F45B4626AC4A4C0(&(iLocal_290[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_291)
	{
		if (iLocal_291[iVar0] != 0)
		{
			unk_0x71CA80D41E1338B4(iLocal_291[iVar0]);
		}
		iVar0++;
	}
	unk_0xCEE359851F3C8198(iLocal_293);
	if (!unk_0xC69DD20C20C463E6(sLocal_365))
	{
		unk_0xCC323859A8DA2B88(sLocal_365, true);
	}
