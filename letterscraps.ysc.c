	...
	switch (iLocal_43)
	{
				...
				if (unk_0x73DA1542B2F0C458())
				{
					if (!func_19())
					{
						if (((!unk_0xA30F14B621E3269D() && !func_13()) && !func_12()) && !func_11())
						{
							...
							iLocal_55 = unk_0x199B24FF79A52CCF("LETTER_SCRAPS");
							while (!unk_0x11AE7F6A404414C9(iLocal_55))
							{
								wait(0);
							}
							unk_0xBB698266C5FDF0A7(iLocal_55, "SET_LETTER_TEXT");
							func_10(sLocal_57[0]);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				unk_0xFF524AE40FB6301A(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						unk_0xDE956657835D8A15((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
...
int func_39(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		if ((vdist2(vParam2, unk_0x0F77516D457A04F5((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_59(13)) || func_59(14))
		{
...
void func_74()
{
	...
	unk_0x83A1D480DB0B52CC(&iLocal_55);
