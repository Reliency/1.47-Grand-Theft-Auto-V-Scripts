...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (vdist2(unk_0xFBB1F99A825CAB09(unk_0x33CD235DF1E6A94E(), 0), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
...
int func_76(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam1 == 6 || iParam1 == func_92(iVar0))
		{
			...
			{
				fVar1 = unk_0x16E00F066AFFEA0D(vParam0, func_77(iVar0, 0), 1);
